...
| -- | ---- | ---- | --------- | ----- | ----------- | ------------- | ---------------- | ----------------- |
| `Location` | `Location` | `Location` | Location | Details and position information for a place | 0..* | Location |  |  |
...
| `Location.characteristic` | `Location.characteristic` | `characteristic` | Location.characteristic | Collection of characteristics (attributes) | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/location-characteristic` |
| `Location.contact` | `Location.contact` | `contact` | Location.contact | Official contact details for the location | 0..* | ExtendedContactDetail |  |  |
| `Location.contained` | `Location.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `Location.description` | `Location.description` | `description` | Location.description | Additional details about the location that could be displayed as further information to identify the location beyond its name | 0..1 | markdown |  |  |
...
| `Location.form` | `Location.form` | `form` | Location.form | Physical form of the location | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/location-form` |
| `Location.hoursOfOperation` | `Location.hoursOfOperation` | `hoursOfOperation` | Location.hoursOfOperation | What days/times during a week is this location usually open (including exceptions) | 0..* | Availability |  |  |
...
| `Location.language` | `Location.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
...
| `Location.mode` | `Location.mode` | `mode` | Location.mode | instance \| kind | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/location-mode|5.0.0` |
...
| `Location.status` | `Location.status` | `status` | Location.status | active \| suspended \| inactive | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/location-status|5.0.0` |
...
| `Location.virtualService` | `Location.virtualService` | `virtualService` | Location.virtualService | Connection details of a virtual service (e.g. conference call) | 0..* | VirtualServiceDetail |  |  |
### Mapping Table
...
This group is centered on the Structure Definition Location from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Location](/docs/R2/Resources/Location.md)| Relationship | [R3 Location](/docs/R3/Resources/Location.md)| Relationship | [R4 Location](/docs/R4/Resources/Location.md)| Relationship | [R4B Location](/docs/R4B/Resources/Location.md)| Relationship | R5 Location
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *27 of 27 elements used* | | *30 of 30 elements used* | | *31 of 39 elements used* | | *31 of 39 elements used* | | *33 of 33 elements used* 
