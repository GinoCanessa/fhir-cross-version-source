...
| `CompartmentDefinition.code` | `CompartmentDefinition.code` | `code` | CompartmentDefinition.code | Patient \| Encounter \| RelatedPerson \| Practitioner \| Device \| EpisodeOfCare | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/compartment-type|5.0.0` |
...
| `CompartmentDefinition.language` | `CompartmentDefinition.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
...
| `CompartmentDefinition.publisher` | `CompartmentDefinition.publisher` | `publisher` | CompartmentDefinition.publisher | Name of the publisher/steward (organization or individual) | 0..1 | string |  |  |
...
| `CompartmentDefinition.resource.code` | `CompartmentDefinition.resource.code` | `code` | CompartmentDefinition.resource.code | Name of resource type | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/resource-types|5.0.0` |
...
| `CompartmentDefinition.resource.endParam` | `CompartmentDefinition.resource.endParam` | `endParam` | CompartmentDefinition.resource.endParam | Search Param for interpreting $everything.end | 0..1 | uri |  |  |
...
| `CompartmentDefinition.resource.startParam` | `CompartmentDefinition.resource.startParam` | `startParam` | CompartmentDefinition.resource.startParam | Search Param for interpreting $everything.start | 0..1 | uri |  |  |
...
| `CompartmentDefinition.status` | `CompartmentDefinition.status` | `status` | CompartmentDefinition.status | draft \| active \| retired \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status|5.0.0` |
...
| `CompartmentDefinition.title` | `CompartmentDefinition.title` | `title` | CompartmentDefinition.title | Name for this compartment definition (human friendly) | 0..1 | string |  |  |
...
| `CompartmentDefinition.versionAlgorithm[x]` | `CompartmentDefinition.versionAlgorithm[x]` | `versionAlgorithm[x]` | CompartmentDefinition.versionAlgorithm[x] | How to compare versions | 0..1 | Coding, string | `Extensible` | `http://hl7.org/fhir/ValueSet/version-algorithm` |
### Mapping Table
...
This group is centered on the Structure Definition CompartmentDefinition from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 CompartmentDefinition](/docs/R3/Resources/CompartmentDefinition.md)| Relationship | [R4 CompartmentDefinition](/docs/R4/Resources/CompartmentDefinition.md)| Relationship | [R4B CompartmentDefinition](/docs/R4B/Resources/CompartmentDefinition.md)| Relationship | R5 CompartmentDefinition
| --- | --- | --- | --- | --- | --- | --- | --- | ---
