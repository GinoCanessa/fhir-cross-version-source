...
| | | `RiskAssessment.reason[x]`| →→→→ _RelatedTo_ →→→→ <br/>(1278)<hr/>←←←← _RelatedTo_ ←←←← <br/>(1662)| `RiskAssessment.reasonCode`| _Equivalent_<br/>(32830/32831)| `RiskAssessment.reasonCode`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(1945)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(2183)| **`RiskAssessment.reason`**
