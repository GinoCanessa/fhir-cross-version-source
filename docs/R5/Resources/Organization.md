...
| `Organization.contact` | `Organization.contact` | `contact` | Organization.contact | Official contact details for the Organization | 0..* | ExtendedContactDetail |  |  |
| `Organization.contained` | `Organization.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `Organization.description` | `Organization.description` | `description` | Organization.description | Additional details about the Organization that could be displayed as further information to identify the Organization beyond its name | 0..1 | markdown |  |  |
...
| `Organization.language` | `Organization.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
...
| `Organization.qualification` | `Organization.qualification` | `qualification` | Organization.qualification | Qualifications, certifications, accreditations, licenses, training, etc. pertaining to the provision of care | 0..* | BackboneElement |  |  |
| `Organization.qualification.code` | `Organization.qualification.code` | `code` | Organization.qualification.code | Coded representation of the qualification | 1..1 | CodeableConcept | `Example` |  |
| `Organization.qualification.extension` | `Organization.qualification.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `Organization.qualification.id` | `Organization.qualification.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Organization.qualification.identifier` | `Organization.qualification.identifier` | `identifier` | Organization.qualification.identifier | An identifier for this qualification for the organization | 0..* | Identifier |  |  |
| `Organization.qualification.issuer` | `Organization.qualification.issuer` | `issuer` | Organization.qualification.issuer | Organization that regulates and issues the qualification | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization) |  |  |
| `Organization.qualification.modifierExtension` | `Organization.qualification.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Organization.qualification.period` | `Organization.qualification.period` | `period` | Organization.qualification.period | Period during which the qualification is valid | 0..1 | Period |  |  |
...
This group is centered on the Structure Definition Organization from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Organization](/docs/R2/Resources/Organization.md)| Relationship | [R3 Organization](/docs/R3/Resources/Organization.md)| Relationship | [R4 Organization](/docs/R4/Resources/Organization.md)| Relationship | [R4B Organization](/docs/R4B/Resources/Organization.md)| Relationship | R5 Organization
| --- | --- | --- | --- | --- | --- | --- | --- | ---
