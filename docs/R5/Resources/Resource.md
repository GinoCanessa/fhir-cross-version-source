...
| `Resource.language` | `Resource.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
...
This group is centered on the Structure Definition Resource from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Resource](/docs/R2/Resources/Resource.md)| Relationship | [R3 Resource](/docs/R3/Resources/Resource.md)| Relationship | [R4 Resource](/docs/R4/Resources/Resource.md)| Relationship | [R4B Resource](/docs/R4B/Resources/Resource.md)| Relationship | R5 Resource
| --- | --- | --- | --- | --- | --- | --- | --- | ---
