...
| `Practitioner.active` | `Practitioner.active` | `active` | Practitioner.active | Whether this practitioner's record is in active use | 0..1 | boolean |  |  |
| `Practitioner.address` | `Practitioner.address` | `address` | Practitioner.address | Address(es) of the practitioner that are not role specific (typically home address) | 0..* | Address |  |  |
| `Practitioner.birthDate` | `Practitioner.birthDate` | `birthDate` | Practitioner.birthDate | The date  on which the practitioner was born | 0..1 | date |  |  |
| `Practitioner.communication` | `Practitioner.communication` | `communication` | Practitioner.communication | A language which may be used to communicate with the practitioner | 0..* | BackboneElement |  |  |
| `Practitioner.communication.extension` | `Practitioner.communication.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `Practitioner.communication.id` | `Practitioner.communication.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Practitioner.communication.language` | `Practitioner.communication.language` | `language` | Practitioner.communication.language | The language code used to communicate with the practitioner | 1..1 | CodeableConcept | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
| `Practitioner.communication.modifierExtension` | `Practitioner.communication.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Practitioner.communication.preferred` | `Practitioner.communication.preferred` | `preferred` | Practitioner.communication.preferred | Language preference indicator | 0..1 | boolean |  |  |
| `Practitioner.contained` | `Practitioner.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `Practitioner.deceased[x]` | `Practitioner.deceased[x]` | `deceased[x]` | Practitioner.deceased[x] | Indicates if the practitioner is deceased or not | 0..1 | boolean, dateTime |  |  |
...
| `Practitioner.gender` | `Practitioner.gender` | `gender` | Practitioner.gender | male \| female \| other \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/administrative-gender|5.0.0` |
| `Practitioner.id` | `Practitioner.id` | `id` | Resource.id | Logical id of this artifact | 0..1 | id |  |  |
| `Practitioner.identifier` | `Practitioner.identifier` | `identifier` | Practitioner.identifier | An identifier for the person as this agent | 0..* | Identifier |  |  |
...
| `Practitioner.language` | `Practitioner.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
...
| `Practitioner.name` | `Practitioner.name` | `name` | Practitioner.name | The name(s) associated with the practitioner | 0..* | HumanName |  |  |
| `Practitioner.photo` | `Practitioner.photo` | `photo` | Practitioner.photo | Image of the person | 0..* | Attachment |  |  |
| `Practitioner.qualification` | `Practitioner.qualification` | `qualification` | Practitioner.qualification | Qualifications, certifications, accreditations, licenses, training, etc. pertaining to the provision of care | 0..* | BackboneElement |  |  |
| `Practitioner.qualification.code` | `Practitioner.qualification.code` | `code` | Practitioner.qualification.code | Coded representation of the qualification | 1..1 | CodeableConcept | `Example` | `http://terminology.hl7.org/ValueSet/v2-0360` |
...
| `Practitioner.qualification.id` | `Practitioner.qualification.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Practitioner.qualification.identifier` | `Practitioner.qualification.identifier` | `identifier` | Practitioner.qualification.identifier | An identifier for this qualification for the practitioner | 0..* | Identifier |  |  |
| `Practitioner.qualification.issuer` | `Practitioner.qualification.issuer` | `issuer` | Practitioner.qualification.issuer | Organization that regulates and issues the qualification | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization) |  |  |
| `Practitioner.qualification.modifierExtension` | `Practitioner.qualification.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Practitioner.qualification.period` | `Practitioner.qualification.period` | `period` | Practitioner.qualification.period | Period during which the qualification is valid | 0..1 | Period |  |  |
| `Practitioner.telecom` | `Practitioner.telecom` | `telecom` | Practitioner.telecom | A contact detail for the practitioner (that apply to all roles) | 0..* | ContactPoint |  |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [Practitioner](/docs/R2/Resources/Practitioner.md)<br/> `http://hl7.org/fhir/StructureDefinition/Practitioner\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `143`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `309`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Practitioner](/docs/R3/Resources/Practitioner.md)<br/> `http://hl7.org/fhir/StructureDefinition/Practitioner\|3.0.2` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `499`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `694`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Practitioner](/docs/R4/Resources/Practitioner.md)<br/> `http://hl7.org/fhir/StructureDefinition/Practitioner\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1581`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1582`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Practitioner](/docs/R4B/Resources/Practitioner.md)<br/> `http://hl7.org/fhir/StructureDefinition/Practitioner\|4.3.0` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `1026`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1255`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Practitioner](/docs/R5/Resources/Practitioner.md)<br/> `http://hl7.org/fhir/StructureDefinition/Practitioner\|5.0.0` 
...
This group is centered on the Structure Definition Practitioner from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Practitioner](/docs/R2/Resources/Practitioner.md)| Relationship | [R3 Practitioner](/docs/R3/Resources/Practitioner.md)| Relationship | [R4 Practitioner](/docs/R4/Resources/Practitioner.md)| Relationship | [R4B Practitioner](/docs/R4B/Resources/Practitioner.md)| Relationship | R5 Practitioner
| --- | --- | --- | --- | --- | --- | --- | --- | ---
