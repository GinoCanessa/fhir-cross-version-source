...
| `DeviceMetric.calibration.state` | `DeviceMetric.calibration.state` | `state` | DeviceMetric.calibration.state | not-calibrated \| calibration-required \| calibrated \| unspecified | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/metric-calibration-state|5.0.0` |
...
| `DeviceMetric.calibration.type` | `DeviceMetric.calibration.type` | `type` | DeviceMetric.calibration.type | unspecified \| offset \| gain \| two-point | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/metric-calibration-type|5.0.0` |
| `DeviceMetric.category` | `DeviceMetric.category` | `category` | DeviceMetric.category | measurement \| setting \| calculation \| unspecified | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/metric-category|5.0.0` |
| `DeviceMetric.color` | `DeviceMetric.color` | `color` | DeviceMetric.color | Color name (from CSS4) or #RRGGBB code | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/color-codes|5.0.0` |
| `DeviceMetric.contained` | `DeviceMetric.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `DeviceMetric.device` | `DeviceMetric.device` | `device` | DeviceMetric.device | Describes the link to the Device | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device) |  |  |
...
| `DeviceMetric.language` | `DeviceMetric.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
| `DeviceMetric.measurementFrequency` | `DeviceMetric.measurementFrequency` | `measurementFrequency` | DeviceMetric.measurementFrequency | Indicates how often the metric is taken or recorded | 0..1 | Quantity |  |  |
...
| `DeviceMetric.operationalStatus` | `DeviceMetric.operationalStatus` | `operationalStatus` | DeviceMetric.operationalStatus | on \| off \| standby \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/metric-operational-status|5.0.0` |
...
| `DeviceMetric.unit` | `DeviceMetric.unit` | `unit` | DeviceMetric.unit | Unit of Measure for the Metric | 0..1 | CodeableConcept | `Preferred` | `http://hl7.org/fhir/ValueSet/ucum-units` |
### Mapping Table
...
This group is centered on the Structure Definition DeviceMetric from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 DeviceMetric](/docs/R2/Resources/DeviceMetric.md)| Relationship | [R3 DeviceMetric](/docs/R3/Resources/DeviceMetric.md)| Relationship | [R4 DeviceMetric](/docs/R4/Resources/DeviceMetric.md)| Relationship | [R4B DeviceMetric](/docs/R4B/Resources/DeviceMetric.md)| Relationship | R5 DeviceMetric
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *23 of 25 elements used* <br/>remaining elements:<br/>`DeviceMetric.measurementPeriod`, `DeviceMetric.source`| | *23 of 25 elements used* <br/>remaining elements:<br/>`DeviceMetric.measurementPeriod`, `DeviceMetric.source`| | *23 of 25 elements used* <br/>remaining elements:<br/>`DeviceMetric.measurementPeriod`, `DeviceMetric.source`| | *23 of 25 elements used* <br/>remaining elements:<br/>`DeviceMetric.measurementPeriod`, `DeviceMetric.source`| | *24 of 24 elements used* 
