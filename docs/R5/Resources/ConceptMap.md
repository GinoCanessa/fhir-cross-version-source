...
| `ConceptMap.additionalAttribute` | `ConceptMap.additionalAttribute` | `additionalAttribute` | ConceptMap.additionalAttribute | Definition of an additional attribute to act as a data source or target | 0..* | BackboneElement |  |  |
| `ConceptMap.additionalAttribute.code` | `ConceptMap.additionalAttribute.code` | `code` | ConceptMap.additionalAttribute.code | Identifies this additional attribute through this resource | 1..1 | code |  |  |
| `ConceptMap.additionalAttribute.description` | `ConceptMap.additionalAttribute.description` | `description` | ConceptMap.additionalAttribute.description | Why the additional attribute is defined, and/or what the data element it refers to is | 0..1 | string |  |  |
| `ConceptMap.additionalAttribute.extension` | `ConceptMap.additionalAttribute.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `ConceptMap.additionalAttribute.id` | `ConceptMap.additionalAttribute.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `ConceptMap.additionalAttribute.modifierExtension` | `ConceptMap.additionalAttribute.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `ConceptMap.additionalAttribute.type` | `ConceptMap.additionalAttribute.type` | `type` | ConceptMap.additionalAttribute.type | code \| Coding \| string \| boolean \| Quantity | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/conceptmap-attribute-type|5.0.0` |
| `ConceptMap.additionalAttribute.uri` | `ConceptMap.additionalAttribute.uri` | `uri` | ConceptMap.additionalAttribute.uri | Formal identifier for the data element referred to in this attribte | 0..1 | uri |  |  |
| `ConceptMap.approvalDate` | `ConceptMap.approvalDate` | `approvalDate` | ConceptMap.approvalDate | When the ConceptMap was approved by publisher | 0..1 | date |  |  |
| `ConceptMap.author` | `ConceptMap.author` | `author` | ConceptMap.author | Who authored the ConceptMap | 0..* | ContactDetail |  |  |
...
| `ConceptMap.copyrightLabel` | `ConceptMap.copyrightLabel` | `copyrightLabel` | ConceptMap.copyrightLabel | Copyright holder and year(s) | 0..1 | string |  |  |
...
| `ConceptMap.editor` | `ConceptMap.editor` | `editor` | ConceptMap.editor | Who edited the ConceptMap | 0..* | ContactDetail |  |  |
| `ConceptMap.effectivePeriod` | `ConceptMap.effectivePeriod` | `effectivePeriod` | ConceptMap.effectivePeriod | When the ConceptMap is expected to be used | 0..1 | Period |  |  |
| `ConceptMap.endorser` | `ConceptMap.endorser` | `endorser` | ConceptMap.endorser | Who endorsed the ConceptMap | 0..* | ContactDetail |  |  |
...
| `ConceptMap.group.element.target.property.id` | `ConceptMap.group.element.target.property.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
...
This group is centered on the Structure Definition ConceptMap from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 ConceptMap](/docs/R2/Resources/ConceptMap.md)| Relationship | [R3 ConceptMap](/docs/R3/Resources/ConceptMap.md)| Relationship | [R4 ConceptMap](/docs/R4/Resources/ConceptMap.md)| Relationship | [R4B ConceptMap](/docs/R4B/Resources/ConceptMap.md)| Relationship | R5 ConceptMap
| --- | --- | --- | --- | --- | --- | --- | --- | ---
