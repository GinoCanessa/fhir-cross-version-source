...
| `Library.copyrightLabel` | `Library.copyrightLabel` | `copyrightLabel` | Library.copyrightLabel | Copyright holder and year(s) | 0..1 | string |  |  |
...
| `Library.language` | `Library.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
| `Library.lastReviewDate` | `Library.lastReviewDate` | `lastReviewDate` | Library.lastReviewDate | When the library was last reviewed by the publisher | 0..1 | date |  |  |
...
| `Library.publisher` | `Library.publisher` | `publisher` | Library.publisher | Name of the publisher/steward (organization or individual) | 0..1 | string |  |  |
...
| `Library.status` | `Library.status` | `status` | Library.status | draft \| active \| retired \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status|5.0.0` |
| `Library.subject[x]` | `Library.subject[x]` | `subject[x]` | Library.subject[x] | Type of individual the library content is focused on | 0..1 | CodeableConcept, Reference(http://hl7.org/fhir/StructureDefinition/Group) | `Extensible` | `http://hl7.org/fhir/ValueSet/participant-resource-types` |
...
| `Library.usage` | `Library.usage` | `usage` | Library.usage | Describes the clinical usage of the library | 0..1 | markdown |  |  |
...
| `Library.versionAlgorithm[x]` | `Library.versionAlgorithm[x]` | `versionAlgorithm[x]` | Library.versionAlgorithm[x] | How to compare versions | 0..1 | Coding, string | `Extensible` | `http://hl7.org/fhir/ValueSet/version-algorithm` |
### Mapping Table
...
This group is centered on the Structure Definition Library from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 Library](/docs/R3/Resources/Library.md)| Relationship | [R4 Library](/docs/R4/Resources/Library.md)| Relationship | [R4B Library](/docs/R4B/Resources/Library.md)| Relationship | R5 Library
| --- | --- | --- | --- | --- | --- | --- | --- | ---
