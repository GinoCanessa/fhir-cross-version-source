...
| `Endpoint.connectionType` | `Endpoint.connectionType` | `connectionType` | Endpoint.connectionType | Protocol/Profile/Standard to be used with this endpoint connection | 1..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/endpoint-connection-type` |
...
| `Endpoint.description` | `Endpoint.description` | `description` | Endpoint.description | Additional details about the endpoint that could be displayed as further information to identify the description beyond its name | 0..1 | string |  |  |
| `Endpoint.environmentType` | `Endpoint.environmentType` | `environmentType` | Endpoint.environmentType | The type of environment(s) exposed at this endpoint | 0..* | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/endpoint-environment` |
...
| `Endpoint.language` | `Endpoint.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
...
| `Endpoint.payload` | `Endpoint.payload` | `payload` | Endpoint.payload | Set of payloads that are provided by this endpoint | 0..* | BackboneElement |  |  |
| `Endpoint.payload.extension` | `Endpoint.payload.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `Endpoint.payload.id` | `Endpoint.payload.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Endpoint.payload.mimeType` | `Endpoint.payload.mimeType` | `mimeType` | Endpoint.payload.mimeType | Mimetype to send. If not specified, the content could be anything (including no payload, if the connectionType defined this) | 0..* | code | `Required` | `http://hl7.org/fhir/ValueSet/mimetypes|5.0.0` |
| `Endpoint.payload.modifierExtension` | `Endpoint.payload.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Endpoint.payload.type` | `Endpoint.payload.type` | `type` | Endpoint.payload.type | The type of content that may be used at this endpoint (e.g. XDS Discharge summaries) | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/endpoint-payload-type` |
| `Endpoint.period` | `Endpoint.period` | `period` | Endpoint.period | Interval the endpoint is expected to be operational | 0..1 | Period |  |  |
| `Endpoint.status` | `Endpoint.status` | `status` | Endpoint.status | active \| suspended \| error \| off \| entered-in-error \| test | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/endpoint-status|5.0.0` |
...
This group is centered on the Structure Definition Endpoint from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 Endpoint](/docs/R3/Resources/Endpoint.md)| Relationship | [R4 Endpoint](/docs/R4/Resources/Endpoint.md)| Relationship | [R4B Endpoint](/docs/R4B/Resources/Endpoint.md)| Relationship | R5 Endpoint
| --- | --- | --- | --- | --- | --- | --- | --- | ---
