...
| Database Key | `2386` |
| Database Snapshot Count | `100` |
| Database Differential Count | `65` |
...
| `StructureMap.const` | `StructureMap.const` | `const` | StructureMap.const | Definition of the constant value used in the map rules | 0..* | BackboneElement |  |  |
| `StructureMap.const.extension` | `StructureMap.const.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `StructureMap.const.id` | `StructureMap.const.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `StructureMap.const.modifierExtension` | `StructureMap.const.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `StructureMap.const.name` | `StructureMap.const.name` | `name` | StructureMap.const.name | Constant name | 0..1 | id |  |  |
| `StructureMap.const.value` | `StructureMap.const.value` | `value` | StructureMap.const.value | FHIRPath exression - value of the constant | 0..1 | string |  |  |
...
| `StructureMap.copyrightLabel` | `StructureMap.copyrightLabel` | `copyrightLabel` | StructureMap.copyrightLabel | Copyright holder and year(s) | 0..1 | string |  |  |
...
| `StructureMap.language` | `StructureMap.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
...
| `StructureMap.publisher` | `StructureMap.publisher` | `publisher` | StructureMap.publisher | Name of the publisher/steward (organization or individual) | 0..1 | string |  |  |
| `StructureMap.purpose` | `StructureMap.purpose` | `purpose` | StructureMap.purpose | Why this structure map is defined | 0..1 | markdown |  |  |
| `StructureMap.status` | `StructureMap.status` | `status` | StructureMap.status | draft \| active \| retired \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status|5.0.0` |
...
| `StructureMap.structure.mode` | `StructureMap.structure.mode` | `mode` | StructureMap.structure.mode | source \| queried \| target \| produced | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/map-model-mode|5.0.0` |
...
| `StructureMap.versionAlgorithm[x]` | `StructureMap.versionAlgorithm[x]` | `versionAlgorithm[x]` | StructureMap.versionAlgorithm[x] | How to compare versions | 0..1 | Coding, string | `Extensible` | `http://hl7.org/fhir/ValueSet/version-algorithm` |
### Mapping Table
...
This group is centered on the Structure Definition StructureMap from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 StructureMap](/docs/R3/Resources/StructureMap.md)| Relationship | [R4 StructureMap](/docs/R4/Resources/StructureMap.md)| Relationship | [R4B StructureMap](/docs/R4B/Resources/StructureMap.md)| Relationship | R5 StructureMap
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| | | | | | | | | **`StructureMap.const`**
| | | | | | | | | **`StructureMap.const.id`**
| | | | | | | | | **`StructureMap.const.extension`**
| | | | | | | | | **`StructureMap.const.modifierExtension`**
...
| | | *91 of 92 elements used* | | *92 of 93 elements used* | | *92 of 93 elements used* | | *100 of 100 elements used* 
