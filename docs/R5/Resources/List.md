...
| `List.language` | `List.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
| `List.meta` | `List.meta` | `meta` | Resource.meta | Metadata about the resource | 0..1 | Meta |  |  |
| `List.mode` | `List.mode` | `mode` | List.mode | working \| snapshot \| changes | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/list-mode|5.0.0` |
...
| `List.source` | `List.source` | `source` | List.source | Who and/or what defined the list contents (aka Author) | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/CareTeam), Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/PractitionerRole), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) |  |  |
| `List.status` | `List.status` | `status` | List.status | current \| retired \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/list-status|5.0.0` |
| `List.subject` | `List.subject` | `subject` | List.subject | If all resources have the same subject(s) | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Resource) |  |  |
...
This group is centered on the Structure Definition List from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 List](/docs/R2/Resources/List.md)| Relationship | [R3 List](/docs/R3/Resources/List.md)| Relationship | [R4 List](/docs/R4/Resources/List.md)| Relationship | [R4B List](/docs/R4B/Resources/List.md)| Relationship | R5 List
| --- | --- | --- | --- | --- | --- | --- | --- | ---
