...
| `DeviceUseRequest.indication`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(183)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(600)| `DeviceRequest.reasonCode`| _Equivalent_<br/>(13057/13058)| `DeviceRequest.reasonCode`| _Equivalent_<br/>(25859/25860)| `DeviceRequest.reasonCode`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(1770)<hr/>←←←← __ ←←←← <br/>()| **`DeviceRequest.reason`**
| | | `DeviceRequest.reasonReference`| →→→→ _RelatedTo_ →→→→ <br/>(13059)<hr/>←←←← _RelatedTo_ ←←←← <br/>(13060)| `DeviceRequest.reasonReference`| _Equivalent_<br/>(25861/25862)| `DeviceRequest.reasonReference`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(1771)<hr/>←←←← __ ←←←← <br/>()| **`DeviceRequest.reason`**
