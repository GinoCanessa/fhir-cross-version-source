...
| `Account.balance` | `Account.balance` | `balance` | Account.balance | Calculated account balance(s) | 0..* | BackboneElement |  |  |
| `Account.balance.aggregate` | `Account.balance.aggregate` | `aggregate` | Account.balance.aggregate | Who is expected to pay this part of the balance | 0..1 | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/account-aggregate` |
| `Account.balance.amount` | `Account.balance.amount` | `amount` | Account.balance.amount | Calculated amount | 1..1 | Money |  |  |
| `Account.balance.estimate` | `Account.balance.estimate` | `estimate` | Account.balance.estimate | Estimated balance | 0..1 | boolean |  |  |
| `Account.balance.extension` | `Account.balance.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `Account.balance.id` | `Account.balance.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Account.balance.modifierExtension` | `Account.balance.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Account.balance.term` | `Account.balance.term` | `term` | Account.balance.term | current \| 30 \| 60 \| 90 \| 120 | 0..1 | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/account-balance-term` |
| `Account.billingStatus` | `Account.billingStatus` | `billingStatus` | Account.billingStatus | Tracks the lifecycle of the account through the billing process | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/account-billing-status` |
| `Account.calculatedAt` | `Account.calculatedAt` | `calculatedAt` | Account.calculatedAt | Time the balance amount was calculated | 0..1 | instant |  |  |
...
| `Account.currency` | `Account.currency` | `currency` | Account.currency | The base or default currency | 0..1 | CodeableConcept | `Required` | `http://hl7.org/fhir/ValueSet/currencies|5.0.0` |
| `Account.description` | `Account.description` | `description` | Account.description | Explanation of purpose/use | 0..1 | markdown |  |  |
| `Account.diagnosis` | `Account.diagnosis` | `diagnosis` | Account.diagnosis | The list of diagnoses relevant to this account | 0..* | BackboneElement |  |  |
...
| `Account.procedure.modifierExtension` | `Account.procedure.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Account.procedure.packageCode` | `Account.procedure.packageCode` | `packageCode` | Account.procedure.packageCode | Package Code specific for billing | 0..* | CodeableConcept | `Example` |  |
| `Account.procedure.sequence` | `Account.procedure.sequence` | `sequence` | Account.procedure.sequence | Ranking of the procedure (for each type) | 0..1 | positiveInt |  |  |
| `Account.procedure.type` | `Account.procedure.type` | `type` | Account.procedure.type | How this procedure value should be used in charging the account | 0..* | CodeableConcept | `Example` |  |
| `Account.relatedAccount` | `Account.relatedAccount` | `relatedAccount` | Account.relatedAccount | Other associated accounts related to this account | 0..* | BackboneElement |  |  |
| `Account.relatedAccount.account` | `Account.relatedAccount.account` | `account` | Account.relatedAccount.account | Reference to an associated Account | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Account) |  |  |
| `Account.relatedAccount.extension` | `Account.relatedAccount.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `Account.relatedAccount.id` | `Account.relatedAccount.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Account.relatedAccount.modifierExtension` | `Account.relatedAccount.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Account.relatedAccount.relationship` | `Account.relatedAccount.relationship` | `relationship` | Account.relatedAccount.relationship | Relationship of the associated Account | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/account-relationship` |
| `Account.servicePeriod` | `Account.servicePeriod` | `servicePeriod` | Account.servicePeriod | Transaction window | 0..1 | Period |  |  |
| `Account.status` | `Account.status` | `status` | Account.status | active \| inactive \| entered-in-error \| on-hold \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/account-status|5.0.0` |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [Account](/docs/R2/Resources/Account.md)<br/> `http://hl7.org/fhir/StructureDefinition/Account\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `72`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `238`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Account](/docs/R3/Resources/Account.md)<br/> `http://hl7.org/fhir/StructureDefinition/Account\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `415`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `611`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Account](/docs/R4/Resources/Account.md)<br/> `http://hl7.org/fhir/StructureDefinition/Account\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1387`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1388`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Account](/docs/R4B/Resources/Account.md)<br/> `http://hl7.org/fhir/StructureDefinition/Account\|4.3.0` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `928`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1157`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Account](/docs/R5/Resources/Account.md)<br/> `http://hl7.org/fhir/StructureDefinition/Account\|5.0.0` 
...
This group is centered on the Structure Definition Account from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Account](/docs/R2/Resources/Account.md)| Relationship | [R3 Account](/docs/R3/Resources/Account.md)| Relationship | [R4 Account](/docs/R4/Resources/Account.md)| Relationship | [R4B Account](/docs/R4B/Resources/Account.md)| Relationship | R5 Account
| --- | --- | --- | --- | --- | --- | --- | --- | ---
