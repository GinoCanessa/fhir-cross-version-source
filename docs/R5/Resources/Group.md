...
| `Group.active` | `Group.active` | `active` | Group.active | Whether this group's record is in active use | 0..1 | boolean |  |  |
| `Group.characteristic` | `Group.characteristic` | `characteristic` | Group.characteristic | Include / Exclude group members by Trait | 0..* | BackboneElement |  |  |
| `Group.characteristic.code` | `Group.characteristic.code` | `code` | Group.characteristic.code | Kind of characteristic | 1..1 | CodeableConcept | `Example` |  |
| `Group.characteristic.exclude` | `Group.characteristic.exclude` | `exclude` | Group.characteristic.exclude | Group includes or excludes | 1..1 | boolean |  |  |
| `Group.characteristic.extension` | `Group.characteristic.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `Group.characteristic.id` | `Group.characteristic.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Group.characteristic.modifierExtension` | `Group.characteristic.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Group.characteristic.period` | `Group.characteristic.period` | `period` | Group.characteristic.period | Period over which characteristic is tested | 0..1 | Period |  |  |
| `Group.characteristic.value[x]` | `Group.characteristic.value[x]` | `value[x]` | Group.characteristic.value[x] | Value held by characteristic | 1..1 | boolean, CodeableConcept, Quantity, Range, Reference | `Example` |  |
| `Group.code` | `Group.code` | `code` | Group.code | Kind of Group members | 0..1 | CodeableConcept | `Example` |  |
| `Group.contained` | `Group.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `Group.description` | `Group.description` | `description` | Group.description | Natural language description of the group | 0..1 | markdown |  |  |
...
| `Group.identifier` | `Group.identifier` | `identifier` | Group.identifier | Business Identifier for this Group | 0..* | Identifier |  |  |
...
| `Group.language` | `Group.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
| `Group.managingEntity` | `Group.managingEntity` | `managingEntity` | Group.managingEntity | Entity that is the custodian of the Group's definition | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/PractitionerRole), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) |  |  |
| `Group.member` | `Group.member` | `member` | Group.member | Who or what is in group | 0..* | BackboneElement |  |  |
| `Group.member.entity` | `Group.member.entity` | `entity` | Group.member.entity | Reference to the group member | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/CareTeam), Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Group), Reference(http://hl7.org/fhir/StructureDefinition/HealthcareService), Reference(http://hl7.org/fhir/StructureDefinition/Location), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/PractitionerRole), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson), Reference(http://hl7.org/fhir/StructureDefinition/Specimen) |  |  |
| `Group.member.extension` | `Group.member.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `Group.member.id` | `Group.member.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Group.member.inactive` | `Group.member.inactive` | `inactive` | Group.member.inactive | If member is no longer in group | 0..1 | boolean |  |  |
| `Group.member.modifierExtension` | `Group.member.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Group.member.period` | `Group.member.period` | `period` | Group.member.period | Period member belonged to the group | 0..1 | Period |  |  |
| `Group.membership` | `Group.membership` | `membership` | Group.membership | definitional \| enumerated | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/group-membership-basis|5.0.0` |
...
| `Group.name` | `Group.name` | `name` | Group.name | Label for Group | 0..1 | string |  |  |
| `Group.quantity` | `Group.quantity` | `quantity` | Group.quantity | Number of members | 0..1 | unsignedInt |  |  |
| `Group.text` | `Group.text` | `text` | DomainResource.text | Text summary of the resource, for human interpretation | 0..1 | Narrative |  |  |
| `Group.type` | `Group.type` | `type` | Group.type | person \| animal \| practitioner \| device \| careteam \| healthcareservice \| location \| organization \| relatedperson \| specimen | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/group-type|5.0.0` |
### Mapping Table

| R2 | Comparison | R3 | Comparison | R4 | Comparison | R4B | Comparison | R5
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [Group](/docs/R2/Resources/Group.md)<br/> `http://hl7.org/fhir/StructureDefinition/Group\|1.0.2` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `114`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `280`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Group](/docs/R3/Resources/Group.md)<br/> `http://hl7.org/fhir/StructureDefinition/Group\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `465`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `659`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Group](/docs/R4/Resources/Group.md)<br/> `http://hl7.org/fhir/StructureDefinition/Group\|4.0.1` | →→→→→→→<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1501`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1502`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Group](/docs/R4B/Resources/Group.md)<br/> `http://hl7.org/fhir/StructureDefinition/Group\|4.3.0` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `984`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1213`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Group](/docs/R5/Resources/Group.md)<br/> `http://hl7.org/fhir/StructureDefinition/Group\|5.0.0` 
...
This group is centered on the Structure Definition Group from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Group](/docs/R2/Resources/Group.md)| Relationship | [R3 Group](/docs/R3/Resources/Group.md)| Relationship | [R4 Group](/docs/R4/Resources/Group.md)| Relationship | [R4B Group](/docs/R4B/Resources/Group.md)| Relationship | R5 Group
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| | | `Group.active`| _Equivalent_<br/>(14679/14680)| `Group.active`| _Equivalent_<br/>(27711/27712)| `Group.active`| _Equivalent_<br/>(42676/42677)| **`Group.active`**
...
| | | | | `Group.managingEntity`| _Equivalent_<br/>(27723/27724)| `Group.managingEntity`| _Equivalent_<br/>(42687/42688)| **`Group.managingEntity`**
...
| *29 of 30 elements used* <br/>remaining elements:<br/>`Group.actual`| | *30 of 31 elements used* <br/>remaining elements:<br/>`Group.actual`| | *31 of 32 elements used* <br/>remaining elements:<br/>`Group.actual`| | *31 of 32 elements used* <br/>remaining elements:<br/>`Group.actual`| | *33 of 33 elements used* 
