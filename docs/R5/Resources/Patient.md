...
| `Patient.active` | `Patient.active` | `active` | Patient.active | Whether this patient's record is in active use | 0..1 | boolean |  |  |
| `Patient.address` | `Patient.address` | `address` | Patient.address | An address for the individual | 0..* | Address |  |  |
| `Patient.birthDate` | `Patient.birthDate` | `birthDate` | Patient.birthDate | The date of birth for the individual | 0..1 | date |  |  |
| `Patient.communication` | `Patient.communication` | `communication` | Patient.communication | A language which may be used to communicate with the patient about his or her health | 0..* | BackboneElement |  |  |
| `Patient.communication.extension` | `Patient.communication.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `Patient.communication.id` | `Patient.communication.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Patient.communication.language` | `Patient.communication.language` | `language` | Patient.communication.language | The language which can be used to communicate with the patient about his or her health | 1..1 | CodeableConcept | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
| `Patient.communication.modifierExtension` | `Patient.communication.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Patient.communication.preferred` | `Patient.communication.preferred` | `preferred` | Patient.communication.preferred | Language preference indicator | 0..1 | boolean |  |  |
| `Patient.contact` | `Patient.contact` | `contact` | Patient.contact | A contact party (e.g. guardian, partner, friend) for the patient | 0..* | BackboneElement |  |  |
| `Patient.contact.address` | `Patient.contact.address` | `address` | Patient.contact.address | Address for the contact person | 0..1 | Address |  |  |
| `Patient.contact.extension` | `Patient.contact.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `Patient.contact.gender` | `Patient.contact.gender` | `gender` | Patient.contact.gender | male \| female \| other \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/administrative-gender|5.0.0` |
| `Patient.contact.id` | `Patient.contact.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Patient.contact.modifierExtension` | `Patient.contact.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Patient.contact.name` | `Patient.contact.name` | `name` | Patient.contact.name | A name associated with the contact person | 0..1 | HumanName |  |  |
| `Patient.contact.organization` | `Patient.contact.organization` | `organization` | Patient.contact.organization | Organization that is associated with the contact | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization) |  |  |
| `Patient.contact.period` | `Patient.contact.period` | `period` | Patient.contact.period | The period during which this contact person or organization is valid to be contacted relating to this patient | 0..1 | Period |  |  |
| `Patient.contact.relationship` | `Patient.contact.relationship` | `relationship` | Patient.contact.relationship | The kind of relationship | 0..* | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/patient-contactrelationship` |
| `Patient.contact.telecom` | `Patient.contact.telecom` | `telecom` | Patient.contact.telecom | A contact detail for the person | 0..* | ContactPoint |  |  |
| `Patient.contained` | `Patient.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `Patient.deceased[x]` | `Patient.deceased[x]` | `deceased[x]` | Patient.deceased[x] | Indicates if the individual is deceased or not | 0..1 | boolean, dateTime |  |  |
...
| `Patient.gender` | `Patient.gender` | `gender` | Patient.gender | male \| female \| other \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/administrative-gender|5.0.0` |
| `Patient.generalPractitioner` | `Patient.generalPractitioner` | `generalPractitioner` | Patient.generalPractitioner | Patient's nominated primary care provider | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/PractitionerRole) |  |  |
| `Patient.id` | `Patient.id` | `id` | Resource.id | Logical id of this artifact | 0..1 | id |  |  |
| `Patient.identifier` | `Patient.identifier` | `identifier` | Patient.identifier | An identifier for this patient | 0..* | Identifier |  |  |
...
| `Patient.language` | `Patient.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
| `Patient.link` | `Patient.link` | `link` | Patient.link | Link to a Patient or RelatedPerson resource that concerns the same actual individual | 0..* | BackboneElement |  |  |
...
| `Patient.link.id` | `Patient.link.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Patient.link.modifierExtension` | `Patient.link.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Patient.link.other` | `Patient.link.other` | `other` | Patient.link.other | The other patient or related person resource that the link refers to | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) |  |  |
| `Patient.link.type` | `Patient.link.type` | `type` | Patient.link.type | replaced-by \| replaces \| refer \| seealso | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/link-type|5.0.0` |
| `Patient.managingOrganization` | `Patient.managingOrganization` | `managingOrganization` | Patient.managingOrganization | Organization that is the custodian of the patient record | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization) |  |  |
| `Patient.maritalStatus` | `Patient.maritalStatus` | `maritalStatus` | Patient.maritalStatus | Marital (civil) status of a patient | 0..1 | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/marital-status` |
...
| `Patient.multipleBirth[x]` | `Patient.multipleBirth[x]` | `multipleBirth[x]` | Patient.multipleBirth[x] | Whether patient is part of a multiple birth | 0..1 | boolean, integer |  |  |
| `Patient.name` | `Patient.name` | `name` | Patient.name | A name associated with the patient | 0..* | HumanName |  |  |
| `Patient.photo` | `Patient.photo` | `photo` | Patient.photo | Image of the patient | 0..* | Attachment |  |  |
| `Patient.telecom` | `Patient.telecom` | `telecom` | Patient.telecom | A contact detail for the individual | 0..* | ContactPoint |  |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [Patient](/docs/R2/Resources/Patient.md)<br/> `http://hl7.org/fhir/StructureDefinition/Patient\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `139`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `305`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Patient](/docs/R3/Resources/Patient.md)<br/> `http://hl7.org/fhir/StructureDefinition/Patient\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `494`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `689`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Patient](/docs/R4/Resources/Patient.md)<br/> `http://hl7.org/fhir/StructureDefinition/Patient\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1571`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1572`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Patient](/docs/R4B/Resources/Patient.md)<br/> `http://hl7.org/fhir/StructureDefinition/Patient\|4.3.0` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `1021`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1250`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Patient](/docs/R5/Resources/Patient.md)<br/> `http://hl7.org/fhir/StructureDefinition/Patient\|5.0.0` 
...
This group is centered on the Structure Definition Patient from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Patient](/docs/R2/Resources/Patient.md)| Relationship | [R3 Patient](/docs/R3/Resources/Patient.md)| Relationship | [R4 Patient](/docs/R4/Resources/Patient.md)| Relationship | [R4B Patient](/docs/R4B/Resources/Patient.md)| Relationship | R5 Patient
| --- | --- | --- | --- | --- | --- | --- | --- | ---
