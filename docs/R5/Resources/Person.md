...
| `Person.active` | `Person.active` | `active` | Person.active | This person's record is in active use | 0..1 | boolean |  |  |
| `Person.address` | `Person.address` | `address` | Person.address | One or more addresses for the person | 0..* | Address |  |  |
| `Person.birthDate` | `Person.birthDate` | `birthDate` | Person.birthDate | The date on which the person was born | 0..1 | date |  |  |
| `Person.communication` | `Person.communication` | `communication` | Person.communication | A language which may be used to communicate with the person about his or her health | 0..* | BackboneElement |  |  |
| `Person.communication.extension` | `Person.communication.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `Person.communication.id` | `Person.communication.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Person.communication.language` | `Person.communication.language` | `language` | Person.communication.language | The language which can be used to communicate with the person about his or her health | 1..1 | CodeableConcept | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
| `Person.communication.modifierExtension` | `Person.communication.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Person.communication.preferred` | `Person.communication.preferred` | `preferred` | Person.communication.preferred | Language preference indicator | 0..1 | boolean |  |  |
| `Person.contained` | `Person.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `Person.deceased[x]` | `Person.deceased[x]` | `deceased[x]` | Person.deceased[x] | Indicates if the individual is deceased or not | 0..1 | boolean, dateTime |  |  |
...
| `Person.gender` | `Person.gender` | `gender` | Person.gender | male \| female \| other \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/administrative-gender|5.0.0` |
| `Person.id` | `Person.id` | `id` | Resource.id | Logical id of this artifact | 0..1 | id |  |  |
| `Person.identifier` | `Person.identifier` | `identifier` | Person.identifier | A human identifier for this person | 0..* | Identifier |  |  |
...
| `Person.language` | `Person.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
| `Person.link` | `Person.link` | `link` | Person.link | Link to a resource that concerns the same actual person | 0..* | BackboneElement |  |  |
| `Person.link.assurance` | `Person.link.assurance` | `assurance` | Person.link.assurance | level1 \| level2 \| level3 \| level4 | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/identity-assuranceLevel|5.0.0` |
...
| `Person.link.id` | `Person.link.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Person.link.modifierExtension` | `Person.link.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Person.link.target` | `Person.link.target` | `target` | Person.link.target | The resource to which this actual person is associated | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Person), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) |  |  |
| `Person.managingOrganization` | `Person.managingOrganization` | `managingOrganization` | Person.managingOrganization | The organization that is the custodian of the person record | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization) |  |  |
| `Person.maritalStatus` | `Person.maritalStatus` | `maritalStatus` | Person.maritalStatus | Marital (civil) status of a person | 0..1 | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/marital-status` |
...
| `Person.name` | `Person.name` | `name` | Person.name | A name associated with the person | 0..* | HumanName |  |  |
| `Person.photo` | `Person.photo` | `photo` | Person.photo | Image of the person | 0..* | Attachment |  |  |
| `Person.telecom` | `Person.telecom` | `telecom` | Person.telecom | A contact detail for the person | 0..* | ContactPoint |  |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [Person](/docs/R2/Resources/Person.md)<br/> `http://hl7.org/fhir/StructureDefinition/Person\|1.0.2` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `142`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `308`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Person](/docs/R3/Resources/Person.md)<br/> `http://hl7.org/fhir/StructureDefinition/Person\|3.0.2` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `497`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `692`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Person](/docs/R4/Resources/Person.md)<br/> `http://hl7.org/fhir/StructureDefinition/Person\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1577`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1578`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Person](/docs/R4B/Resources/Person.md)<br/> `http://hl7.org/fhir/StructureDefinition/Person\|4.3.0` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `1024`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1253`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Person](/docs/R5/Resources/Person.md)<br/> `http://hl7.org/fhir/StructureDefinition/Person\|5.0.0` 
...
This group is centered on the Structure Definition Person from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Person](/docs/R2/Resources/Person.md)| Relationship | [R3 Person](/docs/R3/Resources/Person.md)| Relationship | [R4 Person](/docs/R4/Resources/Person.md)| Relationship | [R4B Person](/docs/R4B/Resources/Person.md)| Relationship | R5 Person
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *24 of 24 elements used* | | *24 of 24 elements used* | | *24 of 24 elements used* | | *24 of 24 elements used* | | *32 of 32 elements used* 
