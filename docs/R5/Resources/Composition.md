...
| `Composition.attester.mode` | `Composition.attester.mode` | `mode` | Composition.attester.mode | personal \| professional \| legal \| official | 1..1 | CodeableConcept | `Preferred` | `http://hl7.org/fhir/ValueSet/composition-attestation-mode` |
...
| `Composition.category` | `Composition.category` | `category` | Composition.category | Categorization of Composition | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/referenced-item-category` |
...
| `Composition.event.detail` | `Composition.event.detail` | `detail` | Composition.event.detail | The event(s) being documented, as code(s), reference(s), or both | 0..* | CodeableReference(http://hl7.org/fhir/StructureDefinition/Resource) | `Example` | `http://terminology.hl7.org/ValueSet/v3-ActCode` |
...
| `Composition.identifier` | `Composition.identifier` | `identifier` | Composition.identifier | Version-independent identifier for the Composition | 0..* | Identifier |  |  |
...
| `Composition.language` | `Composition.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
...
| `Composition.name` | `Composition.name` | `name` | Composition.name | Name for this Composition (computer friendly) | 0..1 | string |  |  |
| `Composition.note` | `Composition.note` | `note` | Composition.note | For any additional notes | 0..* | Annotation |  |  |
| `Composition.relatesTo` | `Composition.relatesTo` | `relatesTo` | Composition.relatesTo | Relationships to other compositions/documents | 0..* | RelatedArtifact |  |  |
...
| `Composition.status` | `Composition.status` | `status` | Composition.status | registered \| partial \| preliminary \| final \| amended \| corrected \| appended \| cancelled \| entered-in-error \| deprecated \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/composition-status|5.0.0` |
| `Composition.subject` | `Composition.subject` | `subject` | Composition.subject | Who and/or what the composition is about | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Resource) |  |  |
...
| `Composition.url` | `Composition.url` | `url` | Composition.url | Canonical identifier for this Composition, represented as a URI (globally unique) | 0..1 | uri |  |  |
| `Composition.useContext` | `Composition.useContext` | `useContext` | Composition.useContext | The context that the content is intended to support | 0..* | UsageContext |  |  |
| `Composition.version` | `Composition.version` | `version` | Composition.version | An explicitly assigned identifer of a variation of the content in the Composition | 0..1 | string |  |  |
### Mapping Table
...
This group is centered on the Structure Definition Composition from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Composition](/docs/R2/Resources/Composition.md)| Relationship | [R3 Composition](/docs/R3/Resources/Composition.md)| Relationship | [R4 Composition](/docs/R4/Resources/Composition.md)| Relationship | [R4B Composition](/docs/R4B/Resources/Composition.md)| Relationship | R5 Composition
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *43 of 46 elements used* | | *44 of 52 elements used* | | *46 of 54 elements used* | | *46 of 54 elements used* | | *51 of 51 elements used* 
