...
| -- | ---- | ---- | --------- | ----- | ----------- | ------------- | ---------------- | ----------------- |
| `Consent` | `Consent` | `Consent` | Consent | A healthcare consumer's  or third party's choices to permit or deny recipients or roles to perform actions for specific purposes and periods of time | 0..* | Consent |  |  |
| `Consent.category` | `Consent.category` | `category` | Consent.category | Classification of the consent statement - for indexing/retrieval | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/consent-category` |
| `Consent.contained` | `Consent.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `Consent.controller` | `Consent.controller` | `controller` | Consent.controller | Consent Enforcer | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/HealthcareService), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner) |  |  |
| `Consent.date` | `Consent.date` | `date` | Consent.date | Fully executed date of the consent | 0..1 | date |  |  |
| `Consent.decision` | `Consent.decision` | `decision` | Consent.decision | deny \| permit | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/consent-provision-type|5.0.0` |
...
| `Consent.grantee` | `Consent.grantee` | `grantee` | Consent.grantee | Who is agreeing to the policy and rules | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/CareTeam), Reference(http://hl7.org/fhir/StructureDefinition/HealthcareService), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/PractitionerRole), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) |  |  |
| `Consent.grantor` | `Consent.grantor` | `grantor` | Consent.grantor | Who is granting rights according to the policy and rules | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/CareTeam), Reference(http://hl7.org/fhir/StructureDefinition/HealthcareService), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/PractitionerRole), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) |  |  |
...
| `Consent.language` | `Consent.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
| `Consent.manager` | `Consent.manager` | `manager` | Consent.manager | Consent workflow management | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/HealthcareService), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner) |  |  |
...
| `Consent.period` | `Consent.period` | `period` | Consent.period | Effective period for this Consent | 0..1 | Period |  |  |
| `Consent.policyBasis` | `Consent.policyBasis` | `policyBasis` | Consent.policyBasis | Computable version of the backing policy | 0..1 | BackboneElement |  |  |
| `Consent.policyBasis.extension` | `Consent.policyBasis.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `Consent.policyBasis.id` | `Consent.policyBasis.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Consent.policyBasis.modifierExtension` | `Consent.policyBasis.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
...
| `Consent.provision.resourceType` | `Consent.provision.resourceType` | `resourceType` | Consent.provision.resourceType | e.g. Resource Type, Profile, etc | 0..* | Coding | `Extensible` | `http://hl7.org/fhir/ValueSet/resource-types` |
| `Consent.provision.securityLabel` | `Consent.provision.securityLabel` | `securityLabel` | Consent.provision.securityLabel | Security Labels that define affected resources | 0..* | Coding | `Example` | `http://hl7.org/fhir/ValueSet/security-label-examples` |
| `Consent.regulatoryBasis` | `Consent.regulatoryBasis` | `regulatoryBasis` | Consent.regulatoryBasis | Regulations establishing base Consent | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/consent-policy` |
| `Consent.sourceAttachment` | `Consent.sourceAttachment` | `sourceAttachment` | Consent.sourceAttachment | Source from which this consent is taken | 0..* | Attachment |  |  |
| `Consent.sourceReference` | `Consent.sourceReference` | `sourceReference` | Consent.sourceReference | Source from which this consent is taken | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Consent), Reference(http://hl7.org/fhir/StructureDefinition/Contract), Reference(http://hl7.org/fhir/StructureDefinition/DocumentReference), Reference(http://hl7.org/fhir/StructureDefinition/QuestionnaireResponse) |  |  |
| `Consent.status` | `Consent.status` | `status` | Consent.status | draft \| active \| inactive \| not-done \| entered-in-error \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/consent-state-codes|5.0.0` |
| `Consent.subject` | `Consent.subject` | `subject` | Consent.subject | Who the consent applies to | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Group), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner) |  |  |
...
| `Consent.verification.verificationDate` | `Consent.verification.verificationDate` | `verificationDate` | Consent.verification.verificationDate | When consent verified | 0..* | dateTime |  |  |
| `Consent.verification.verificationType` | `Consent.verification.verificationType` | `verificationType` | Consent.verification.verificationType | Business case of verification | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/consent-verification` |
...
| `Consent.verification.verifiedBy` | `Consent.verification.verifiedBy` | `verifiedBy` | Consent.verification.verifiedBy | Person conducting verification | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/PractitionerRole) |  |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | [Consent](/docs/R3/Resources/Consent.md)<br/> `http://hl7.org/fhir/StructureDefinition/Consent\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `440`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `636`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Consent](/docs/R4/Resources/Consent.md)<br/> `http://hl7.org/fhir/StructureDefinition/Consent\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1443`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1444`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Consent](/docs/R4B/Resources/Consent.md)<br/> `http://hl7.org/fhir/StructureDefinition/Consent\|4.3.0` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `956`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1185`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Consent](/docs/R5/Resources/Consent.md)<br/> `http://hl7.org/fhir/StructureDefinition/Consent\|5.0.0` 
...
This group is centered on the Structure Definition Consent from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 Consent](/docs/R3/Resources/Consent.md)| Relationship | [R4 Consent](/docs/R4/Resources/Consent.md)| Relationship | [R4B Consent](/docs/R4B/Resources/Consent.md)| Relationship | R5 Consent
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| | | | | | | | | **`Consent.manager`**
| | | | | | | | | **`Consent.controller`**
| | | `Consent.source[x]`| →→→→ _RelatedTo_ →→→→ <br/>(12556)<hr/>←←←← _RelatedTo_ ←←←← <br/>(12557)| `Consent.source[x]`| _Equivalent_<br/>(24383/24384)| `Consent.source[x]`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(1754)<hr/>←←←← _RelatedTo_ ←←←← <br/>(1996)| **`Consent.sourceAttachment`**
...
| | | `Consent.actor`| →→→→ _Equivalent_ →→→→ <br/>(909)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.actor`| _Equivalent_<br/>(24425/24426)| `Consent.provision.actor`| _Equivalent_<br/>(39659/39660)| **`Consent.provision.actor`**
| | | `Consent.except.actor`| →→→→ _Equivalent_ →→→→ <br/>(919)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.actor`| _Equivalent_<br/>(24425/24426)| `Consent.provision.actor`| _Equivalent_<br/>(39659/39660)| **`Consent.provision.actor`**
...
| | | `Consent.actor.role`| →→→→ _Equivalent_ →→→→ <br/>(911)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.actor.role`| _Equivalent_<br/>(24433/24434)| `Consent.provision.actor.role`| →→→→ _Equivalent_ →→→→ <br/>(39667)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(39668)| **`Consent.provision.actor.role`**
| | | `Consent.except.actor.role`| →→→→ _Equivalent_ →→→→ <br/>(921)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.actor.role`| _Equivalent_<br/>(24433/24434)| `Consent.provision.actor.role`| →→→→ _Equivalent_ →→→→ <br/>(39667)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(39668)| **`Consent.provision.actor.role`**
| | | `Consent.actor.reference`| →→→→ _RelatedTo_ →→→→ <br/>(910)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.actor.reference`| _Equivalent_<br/>(24435/24436)| `Consent.provision.actor.reference`| →→→→ _Equivalent_ →→→→ <br/>(39669)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(39670)| **`Consent.provision.actor.reference`**
| | | `Consent.except.actor.reference`| →→→→ _RelatedTo_ →→→→ <br/>(920)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.actor.reference`| _Equivalent_<br/>(24435/24436)| `Consent.provision.actor.reference`| →→→→ _Equivalent_ →→→→ <br/>(39669)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(39670)| **`Consent.provision.actor.reference`**
| | | `Consent.action`| →→→→ _Equivalent_ →→→→ <br/>(908)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.action`| _Equivalent_<br/>(24437/24438)| `Consent.provision.action`| _Equivalent_<br/>(39671/39672)| **`Consent.provision.action`**
| | | `Consent.except.action`| →→→→ _Equivalent_ →→→→ <br/>(918)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.action`| _Equivalent_<br/>(24437/24438)| `Consent.provision.action`| _Equivalent_<br/>(39671/39672)| **`Consent.provision.action`**
| | | `Consent.securityLabel`| →→→→ _Equivalent_ →→→→ <br/>(934)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.securityLabel`| _Equivalent_<br/>(24439/24440)| `Consent.provision.securityLabel`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(39673)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(39674)| **`Consent.provision.securityLabel`**
| | | `Consent.except.securityLabel`| →→→→ _Equivalent_ →→→→ <br/>(930)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.securityLabel`| _Equivalent_<br/>(24439/24440)| `Consent.provision.securityLabel`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(39673)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(39674)| **`Consent.provision.securityLabel`**
| | | `Consent.purpose`| →→→→ _Equivalent_ →→→→ <br/>(933)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.purpose`| _Equivalent_<br/>(24441/24442)| `Consent.provision.purpose`| _Equivalent_<br/>(39675/39676)| **`Consent.provision.purpose`**
| | | `Consent.except.purpose`| →→→→ _Equivalent_ →→→→ <br/>(929)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.purpose`| _Equivalent_<br/>(24441/24442)| `Consent.provision.purpose`| _Equivalent_<br/>(39675/39676)| **`Consent.provision.purpose`**
| | | `Consent.except.class`| _Equivalent_<br/>(922/1430)| `Consent.provision.class`| _Equivalent_<br/>(24443/24444)| `Consent.provision.class`| →→→→ _RelatedTo_ →→→→ <br/>(1753)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(1999)| **`Consent.provision.documentType`**
...
| | | `Consent.dataPeriod`| →→→→ _Equivalent_ →→→→ <br/>(916)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.dataPeriod`| _Equivalent_<br/>(24447/24448)| `Consent.provision.dataPeriod`| _Equivalent_<br/>(39679/39680)| **`Consent.provision.dataPeriod`**
| | | `Consent.except.dataPeriod`| →→→→ _Equivalent_ →→→→ <br/>(927)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.dataPeriod`| _Equivalent_<br/>(24447/24448)| `Consent.provision.dataPeriod`| _Equivalent_<br/>(39679/39680)| **`Consent.provision.dataPeriod`**
| | | `Consent.data`| →→→→ _Equivalent_ →→→→ <br/>(913)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.data`| _Equivalent_<br/>(24449/24450)| `Consent.provision.data`| _Equivalent_<br/>(39681/39682)| **`Consent.provision.data`**
| | | `Consent.except.data`| →→→→ _Equivalent_ →→→→ <br/>(924)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.data`| _Equivalent_<br/>(24449/24450)| `Consent.provision.data`| _Equivalent_<br/>(39681/39682)| **`Consent.provision.data`**
...
| | | `Consent.data.meaning`| →→→→ _Equivalent_ →→→→ <br/>(914)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.data.meaning`| _Equivalent_<br/>(24457/24458)| `Consent.provision.data.meaning`| _Equivalent_<br/>(39689/39690)| **`Consent.provision.data.meaning`**
| | | `Consent.except.data.meaning`| →→→→ _Equivalent_ →→→→ <br/>(925)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.data.meaning`| _Equivalent_<br/>(24457/24458)| `Consent.provision.data.meaning`| _Equivalent_<br/>(39689/39690)| **`Consent.provision.data.meaning`**
| | | `Consent.data.reference`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(915)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.data.reference`| _Equivalent_<br/>(24459/24460)| `Consent.provision.data.reference`| _Equivalent_<br/>(39691/39692)| **`Consent.provision.data.reference`**
| | | `Consent.except.data.reference`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(926)<hr/>←←←← __ ←←←← <br/>()| `Consent.provision.data.reference`| _Equivalent_<br/>(24459/24460)| `Consent.provision.data.reference`| _Equivalent_<br/>(39691/39692)| **`Consent.provision.data.reference`**
