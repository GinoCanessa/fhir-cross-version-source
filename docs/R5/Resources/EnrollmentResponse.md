...
| `EnrollmentResponse.language` | `EnrollmentResponse.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
...
| `EnrollmentResponse.outcome` | `EnrollmentResponse.outcome` | `outcome` | EnrollmentResponse.outcome | queued \| complete \| error \| partial | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/enrollment-outcome|5.0.0` |
...
| `EnrollmentResponse.status` | `EnrollmentResponse.status` | `status` | EnrollmentResponse.status | active \| cancelled \| draft \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/fm-status|5.0.0` |
...
This group is centered on the Structure Definition EnrollmentResponse from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 EnrollmentResponse](/docs/R2/Resources/EnrollmentResponse.md)| Relationship | [R3 EnrollmentResponse](/docs/R3/Resources/EnrollmentResponse.md)| Relationship | [R4 EnrollmentResponse](/docs/R4/Resources/EnrollmentResponse.md)| Relationship | [R4B EnrollmentResponse](/docs/R4B/Resources/EnrollmentResponse.md)| Relationship | R5 EnrollmentResponse
| --- | --- | --- | --- | --- | --- | --- | --- | ---
