...
| `Task.doNotPerform` | `Task.doNotPerform` | `doNotPerform` | Task.doNotPerform | True if Task is prohibiting action | 0..1 | boolean |  |  |
...
| `Task.performer.modifierExtension` | `Task.performer.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Task.priority` | `Task.priority` | `priority` | Task.priority | routine \| urgent \| asap \| stat | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/request-priority|5.0.0` |
| `Task.reason` | `Task.reason` | `reason` | Task.reason | Why task is needed | 0..* | CodeableReference | `Example` |  |
...
| `Task.requestedPerformer` | `Task.requestedPerformer` | `requestedPerformer` | Task.requestedPerformer | Who should perform Task | 0..* | CodeableReference(http://hl7.org/fhir/StructureDefinition/CareTeam), CodeableReference(http://hl7.org/fhir/StructureDefinition/Device), CodeableReference(http://hl7.org/fhir/StructureDefinition/HealthcareService), CodeableReference(http://hl7.org/fhir/StructureDefinition/Organization), CodeableReference(http://hl7.org/fhir/StructureDefinition/Patient), CodeableReference(http://hl7.org/fhir/StructureDefinition/Practitioner), CodeableReference(http://hl7.org/fhir/StructureDefinition/PractitionerRole), CodeableReference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) | `Preferred` | `http://hl7.org/fhir/ValueSet/performer-role` |
| `Task.requestedPeriod` | `Task.requestedPeriod` | `requestedPeriod` | Task.requestedPeriod | When the task should be performed | 0..1 | Period |  |  |
...
| `Task.restriction.period` | `Task.restriction.period` | `period` | Task.restriction.period | When fulfillment is sought | 0..1 | Period |  |  |
...
| `Task.status` | `Task.status` | `status` | Task.status | draft \| requested \| received \| accepted \| + | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/task-status|5.0.0` |
| `Task.statusReason` | `Task.statusReason` | `statusReason` | Task.statusReason | Reason for current status | 0..1 | CodeableReference | `Example` | `http://hl7.org/fhir/ValueSet/task-status-reason` |
...
This group is centered on the Structure Definition Task from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 ProcessRequest](/docs/R2/Resources/ProcessRequest.md)| Relationship | [R3 ProcessRequest](/docs/R3/Resources/ProcessRequest.md)| Relationship | [R4 Task](/docs/R4/Resources/Task.md)| Relationship | [R4B Task](/docs/R4B/Resources/Task.md)| Relationship | R5 Task
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| | | `Task.authoredOn`| _Equivalent_<br/>(19218/19219)| `Task.authoredOn`| _Equivalent_<br/>(34112/34113)| `Task.authoredOn`| _Equivalent_<br/>(48535/48536)| **`Task.authoredOn`**
...
| | | `Task.requester`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(19222)<hr/>←←←← _RelatedTo_ ←←←← <br/>(1683)| `Task.requester`| _Equivalent_<br/>(34116/34117)| `Task.requester`| _Equivalent_<br/>(48539/48540)| **`Task.requester`**
...
| [R2 ProcessResponse](/docs/R2/Resources/ProcessResponse.md)| Relationship | [R3 ProcessResponse](/docs/R3/Resources/ProcessResponse.md)| Relationship | [R4 Task](/docs/R4/Resources/Task.md)| Relationship | [R4B Task](/docs/R4B/Resources/Task.md)| Relationship | R5 Task
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | `Task`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(19172)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(19173)| `Task`| _Equivalent_<br/>(34060/34061)| `Task`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(48483)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(48484)| **`Task`**
| | | `Task.id`| _Equivalent_<br/>(19174/19175)| `Task.id`| _Equivalent_<br/>(34062/34063)| `Task.id`| _Equivalent_<br/>(48485/48486)| **`Task.id`**
| | | `Task.meta`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(19176)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(19177)| `Task.meta`| _Equivalent_<br/>(34064/34065)| `Task.meta`| _Equivalent_<br/>(48487/48488)| **`Task.meta`**
...
| [R2 Order](/docs/R2/Resources/Order.md)| Relationship | [R3 Task](/docs/R3/Resources/Task.md)| Relationship | [R4 Task](/docs/R4/Resources/Task.md)| Relationship | [R4B Task](/docs/R4B/Resources/Task.md)| Relationship | R5 Task
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | `Task`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(19172)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(19173)| `Task`| _Equivalent_<br/>(34060/34061)| `Task`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(48483)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(48484)| **`Task`**
| | | `Task.id`| _Equivalent_<br/>(19174/19175)| `Task.id`| _Equivalent_<br/>(34062/34063)| `Task.id`| _Equivalent_<br/>(48485/48486)| **`Task.id`**
| | | `Task.meta`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(19176)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(19177)| `Task.meta`| _Equivalent_<br/>(34064/34065)| `Task.meta`| _Equivalent_<br/>(48487/48488)| **`Task.meta`**
...
| | | `Task.output.type`| _Equivalent_<br/>(19269/19270)| `Task.output.type`| _Equivalent_<br/>(34168/34169)| `Task.output.type`| _Equivalent_<br/>(48587/48588)| **`Task.output.type`**
| | | `Task.output.value[x]`| →→→→ _RelatedTo_ →→→→ <br/>(19271)<hr/>←←←← _RelatedTo_ ←←←← <br/>(19272)| `Task.output.value[x]`| _Equivalent_<br/>(34170/34171)| `Task.output.value[x]`| →→→→ _RelatedTo_ →→→→ <br/>(48589)<hr/>←←←← _RelatedTo_ ←←←← <br/>(48590)| **`Task.output.value[x]`**
| *2 of 22 elements used* <br/>remaining elements:<br/>`Order`, `Order.contained`, `Order.date`, `Order.detail`, `Order.extension`, `Order.id`, `Order.identifier`, `Order.implicitRules`, `Order.language`, `Order.meta`, `Order.modifierExtension`, `Order.reason[x]`, `Order.source`, `Order.subject`, `Order.target`, `Order.text`, `Order.when`, `Order.when.code`, `Order.when.extension`, `Order.when.id`, `Order.when.modifierExtension`, `Order.when.schedule`| | *52 of 57 elements used* <br/>remaining elements:<br/>`Task.performerType`, `Task.requester.extension`, `Task.requester.id`, `Task.requester.modifierExtension`, `Task.requester.onBehalfOf`| | *54 of 56 elements used* <br/>remaining elements:<br/>`Task.performerType`, `Task.reasonReference`| | *54 of 56 elements used* <br/>remaining elements:<br/>`Task.performerType`, `Task.reasonReference`| | *63 of 63 elements used* 
...
| [R2 OrderResponse](/docs/R2/Resources/OrderResponse.md)| Relationship | [R3 Task](/docs/R3/Resources/Task.md)| Relationship | [R4 Task](/docs/R4/Resources/Task.md)| Relationship | [R4B Task](/docs/R4B/Resources/Task.md)| Relationship | R5 Task
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | `Task`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(19172)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(19173)| `Task`| _Equivalent_<br/>(34060/34061)| `Task`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(48483)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(48484)| **`Task`**
| | | `Task.id`| _Equivalent_<br/>(19174/19175)| `Task.id`| _Equivalent_<br/>(34062/34063)| `Task.id`| _Equivalent_<br/>(48485/48486)| **`Task.id`**
| | | `Task.meta`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(19176)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(19177)| `Task.meta`| _Equivalent_<br/>(34064/34065)| `Task.meta`| _Equivalent_<br/>(48487/48488)| **`Task.meta`**
...
| | | `Task.output.type`| _Equivalent_<br/>(19269/19270)| `Task.output.type`| _Equivalent_<br/>(34168/34169)| `Task.output.type`| _Equivalent_<br/>(48587/48588)| **`Task.output.type`**
| | | `Task.output.value[x]`| →→→→ _RelatedTo_ →→→→ <br/>(19271)<hr/>←←←← _RelatedTo_ ←←←← <br/>(19272)| `Task.output.value[x]`| _Equivalent_<br/>(34170/34171)| `Task.output.value[x]`| →→→→ _RelatedTo_ →→→→ <br/>(48589)<hr/>←←←← _RelatedTo_ ←←←← <br/>(48590)| **`Task.output.value[x]`**
| *2 of 16 elements used* <br/>remaining elements:<br/>`OrderResponse`, `OrderResponse.contained`, `OrderResponse.description`, `OrderResponse.extension`, `OrderResponse.fulfillment`, `OrderResponse.id`, `OrderResponse.identifier`, `OrderResponse.implicitRules`, `OrderResponse.language`, `OrderResponse.meta`, `OrderResponse.modifierExtension`, `OrderResponse.orderStatus`, `OrderResponse.text`, `OrderResponse.who`| | *52 of 57 elements used* <br/>remaining elements:<br/>`Task.performerType`, `Task.requester.extension`, `Task.requester.id`, `Task.requester.modifierExtension`, `Task.requester.onBehalfOf`| | *54 of 56 elements used* <br/>remaining elements:<br/>`Task.performerType`, `Task.reasonReference`| | *54 of 56 elements used* <br/>remaining elements:<br/>`Task.performerType`, `Task.reasonReference`| | *63 of 63 elements used* 
