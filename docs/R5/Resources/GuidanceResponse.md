...
| | | `GuidanceResponse.reason[x]`| →→→→ _RelatedTo_ →→→→ <br/>(1085)<hr/>←←←← _RelatedTo_ ←←←← <br/>(1535)| `GuidanceResponse.reasonCode`| _Equivalent_<br/>(27789/27790)| `GuidanceResponse.reasonCode`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(1883)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(2125)| **`GuidanceResponse.reason`**
