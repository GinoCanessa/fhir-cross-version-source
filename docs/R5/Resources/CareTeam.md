...
| | | `CareTeam.reasonCode`| _Equivalent_<br/>(11111/11112)| `CareTeam.reasonCode`| _Equivalent_<br/>(22699/22700)| `CareTeam.reasonCode`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(1855)<hr/>←←←← __ ←←←← <br/>()| **`CareTeam.reason`**
| | | `CareTeam.reasonReference`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(11113)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(11114)| `CareTeam.reasonReference`| _Equivalent_<br/>(22701/22702)| `CareTeam.reasonReference`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(1856)<hr/>←←←← __ ←←←← <br/>()| **`CareTeam.reason`**
