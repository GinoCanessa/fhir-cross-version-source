...
| `OperationOutcome.issue.code` | `OperationOutcome.issue.code` | `code` | OperationOutcome.issue.code | Error or warning code | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/issue-type|5.0.0` |
...
| `OperationOutcome.issue.severity` | `OperationOutcome.issue.severity` | `severity` | OperationOutcome.issue.severity | fatal \| error \| warning \| information \| success | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/issue-severity|5.0.0` |
| `OperationOutcome.language` | `OperationOutcome.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
