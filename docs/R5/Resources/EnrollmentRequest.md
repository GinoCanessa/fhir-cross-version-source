...
| -- | ---- | ---- | --------- | ----- | ----------- | ------------- | ---------------- | ----------------- |
| `EnrollmentRequest` | `EnrollmentRequest` | `EnrollmentRequest` | EnrollmentRequest | Enroll in coverage | 0..* | EnrollmentRequest |  |  |
| `EnrollmentRequest.candidate` | `EnrollmentRequest.candidate` | `candidate` | EnrollmentRequest.candidate | The subject to be enrolled | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Patient) |  |  |
...
| `EnrollmentRequest.coverage` | `EnrollmentRequest.coverage` | `coverage` | EnrollmentRequest.coverage | Insurance information | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Coverage) |  |  |
| `EnrollmentRequest.created` | `EnrollmentRequest.created` | `created` | EnrollmentRequest.created | Creation date | 0..1 | dateTime |  |  |
...
| `EnrollmentRequest.identifier` | `EnrollmentRequest.identifier` | `identifier` | EnrollmentRequest.identifier | Business Identifier | 0..* | Identifier |  |  |
...
| `EnrollmentRequest.insurer` | `EnrollmentRequest.insurer` | `insurer` | EnrollmentRequest.insurer | Target | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization) |  |  |
| `EnrollmentRequest.language` | `EnrollmentRequest.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
...
| `EnrollmentRequest.provider` | `EnrollmentRequest.provider` | `provider` | EnrollmentRequest.provider | Responsible practitioner | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/PractitionerRole) |  |  |
| `EnrollmentRequest.status` | `EnrollmentRequest.status` | `status` | EnrollmentRequest.status | active \| cancelled \| draft \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/fm-status|5.0.0` |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [EnrollmentRequest](/docs/R2/Resources/EnrollmentRequest.md)<br/> `http://hl7.org/fhir/StructureDefinition/EnrollmentRequest\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `107`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `273`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [EnrollmentRequest](/docs/R3/Resources/EnrollmentRequest.md)<br/> `http://hl7.org/fhir/StructureDefinition/EnrollmentRequest\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `456`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`RelatedTo`<br/>- DBKey: `651`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [EnrollmentRequest](/docs/R4/Resources/EnrollmentRequest.md)<br/> `http://hl7.org/fhir/StructureDefinition/EnrollmentRequest\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1477`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1478`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [EnrollmentRequest](/docs/R4B/Resources/EnrollmentRequest.md)<br/> `http://hl7.org/fhir/StructureDefinition/EnrollmentRequest\|4.3.0` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `971`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1200`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [EnrollmentRequest](/docs/R5/Resources/EnrollmentRequest.md)<br/> `http://hl7.org/fhir/StructureDefinition/EnrollmentRequest\|5.0.0` 
...
This group is centered on the Structure Definition EnrollmentRequest from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 EnrollmentRequest](/docs/R2/Resources/EnrollmentRequest.md)| Relationship | [R3 EnrollmentRequest](/docs/R3/Resources/EnrollmentRequest.md)| Relationship | [R4 EnrollmentRequest](/docs/R4/Resources/EnrollmentRequest.md)| Relationship | [R4B EnrollmentRequest](/docs/R4B/Resources/EnrollmentRequest.md)| Relationship | R5 EnrollmentRequest
| --- | --- | --- | --- | --- | --- | --- | --- | ---
