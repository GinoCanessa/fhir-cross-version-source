...
| `AppointmentResponse.actor` | `AppointmentResponse.actor` | `actor` | AppointmentResponse.actor | Person(s), Location, HealthcareService, or Device | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Group), Reference(http://hl7.org/fhir/StructureDefinition/HealthcareService), Reference(http://hl7.org/fhir/StructureDefinition/Location), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/PractitionerRole), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) |  |  |
| `AppointmentResponse.appointment` | `AppointmentResponse.appointment` | `appointment` | AppointmentResponse.appointment | Appointment this response relates to | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Appointment) |  |  |
| `AppointmentResponse.comment` | `AppointmentResponse.comment` | `comment` | AppointmentResponse.comment | Additional comments | 0..1 | markdown |  |  |
...
| `AppointmentResponse.end` | `AppointmentResponse.end` | `end` | AppointmentResponse.end | Time from appointment, or requested new end time | 0..1 | instant |  |  |
...
| `AppointmentResponse.identifier` | `AppointmentResponse.identifier` | `identifier` | AppointmentResponse.identifier | External Ids for this item | 0..* | Identifier |  |  |
...
| `AppointmentResponse.language` | `AppointmentResponse.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages|5.0.0` |
...
| `AppointmentResponse.occurrenceDate` | `AppointmentResponse.occurrenceDate` | `occurrenceDate` | AppointmentResponse.occurrenceDate | Original date within a recurring request | 0..1 | date |  |  |
| `AppointmentResponse.participantStatus` | `AppointmentResponse.participantStatus` | `participantStatus` | AppointmentResponse.participantStatus | accepted \| declined \| tentative \| needs-action \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/appointmentresponse-status|5.0.0` |
| `AppointmentResponse.participantType` | `AppointmentResponse.participantType` | `participantType` | AppointmentResponse.participantType | Role of participant in the appointment | 0..* | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/encounter-participant-type` |
| `AppointmentResponse.proposedNewTime` | `AppointmentResponse.proposedNewTime` | `proposedNewTime` | AppointmentResponse.proposedNewTime | Indicator for a counter proposal | 0..1 | boolean |  |  |
| `AppointmentResponse.recurrenceId` | `AppointmentResponse.recurrenceId` | `recurrenceId` | AppointmentResponse.recurrenceId | The recurrence ID of the specific recurring request | 0..1 | positiveInt |  |  |
| `AppointmentResponse.recurring` | `AppointmentResponse.recurring` | `recurring` | AppointmentResponse.recurring | This response is for all occurrences in a recurring request | 0..1 | boolean |  |  |
| `AppointmentResponse.start` | `AppointmentResponse.start` | `start` | AppointmentResponse.start | Time from appointment, or requested new start time | 0..1 | instant |  |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [AppointmentResponse](/docs/R2/Resources/AppointmentResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/AppointmentResponse\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `75`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `241`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [AppointmentResponse](/docs/R3/Resources/AppointmentResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/AppointmentResponse\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `420`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `616`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [AppointmentResponse](/docs/R4/Resources/AppointmentResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/AppointmentResponse\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1397`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1398`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [AppointmentResponse](/docs/R4B/Resources/AppointmentResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/AppointmentResponse\|4.3.0` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `934`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1163`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [AppointmentResponse](/docs/R5/Resources/AppointmentResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/AppointmentResponse\|5.0.0` 
...
This group is centered on the Structure Definition AppointmentResponse from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 AppointmentResponse](/docs/R2/Resources/AppointmentResponse.md)| Relationship | [R3 AppointmentResponse](/docs/R3/Resources/AppointmentResponse.md)| Relationship | [R4 AppointmentResponse](/docs/R4/Resources/AppointmentResponse.md)| Relationship | [R4B AppointmentResponse](/docs/R4B/Resources/AppointmentResponse.md)| Relationship | R5 AppointmentResponse
| --- | --- | --- | --- | --- | --- | --- | --- | ---
