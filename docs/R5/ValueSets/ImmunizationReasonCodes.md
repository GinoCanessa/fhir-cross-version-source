...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Immunization` | `Immunization.reason` | `http://hl7.org/fhir/ValueSet/immunization-reason` | `Example` | Why immunization occurred |
