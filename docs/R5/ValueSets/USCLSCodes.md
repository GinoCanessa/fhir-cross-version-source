...
| `http://hl7.org/fhir/StructureDefinition/Claim` | `Claim.item.productOrServiceEnd` | `http://hl7.org/fhir/ValueSet/service-uscls` | `Example` | End of a range of codes |
...
| `http://hl7.org/fhir/StructureDefinition/Claim` | `Claim.item.detail.productOrServiceEnd` | `http://hl7.org/fhir/ValueSet/service-uscls` | `Example` | End of a range of codes |
...
| `http://hl7.org/fhir/StructureDefinition/Claim` | `Claim.item.detail.subDetail.productOrServiceEnd` | `http://hl7.org/fhir/ValueSet/service-uscls` | `Example` | End of a range of codes |
...
| `http://hl7.org/fhir/StructureDefinition/ClaimResponse` | `ClaimResponse.addItem.productOrServiceEnd` | `http://hl7.org/fhir/ValueSet/service-uscls` | `Example` | End of a range of codes |
...
| `http://hl7.org/fhir/StructureDefinition/ClaimResponse` | `ClaimResponse.addItem.detail.productOrServiceEnd` | `http://hl7.org/fhir/ValueSet/service-uscls` | `Example` | End of a range of codes |
...
| `http://hl7.org/fhir/StructureDefinition/ClaimResponse` | `ClaimResponse.addItem.detail.subDetail.productOrServiceEnd` | `http://hl7.org/fhir/ValueSet/service-uscls` | `Example` | End of a range of codes |
...
| `http://hl7.org/fhir/StructureDefinition/ExplanationOfBenefit` | `ExplanationOfBenefit.item.productOrServiceEnd` | `http://hl7.org/fhir/ValueSet/service-uscls` | `Example` | End of a range of codes |
...
| `http://hl7.org/fhir/StructureDefinition/ExplanationOfBenefit` | `ExplanationOfBenefit.item.detail.productOrServiceEnd` | `http://hl7.org/fhir/ValueSet/service-uscls` | `Example` | End of a range of codes |
...
| `http://hl7.org/fhir/StructureDefinition/ExplanationOfBenefit` | `ExplanationOfBenefit.item.detail.subDetail.productOrServiceEnd` | `http://hl7.org/fhir/ValueSet/service-uscls` | `Example` | End of a range of codes |
...
| `http://hl7.org/fhir/StructureDefinition/ExplanationOfBenefit` | `ExplanationOfBenefit.addItem.productOrServiceEnd` | `http://hl7.org/fhir/ValueSet/service-uscls` | `Example` | End of a range of codes |
