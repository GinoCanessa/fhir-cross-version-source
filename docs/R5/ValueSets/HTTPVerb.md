...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Bundle` | `Bundle.entry.request.method` | `http://hl7.org/fhir/ValueSet/http-verb\|5.0.0` | `Required` | GET \| HEAD \| POST \| PUT \| DELETE \| PATCH |
...
This group is centered on the Value Set HTTPVerb from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 HTTPVerb](/docs/R2/ValueSets/HTTPVerb.md)| Relationship | [R3 HTTPVerb](/docs/R3/ValueSets/HTTPVerb.md)| Relationship | [R4 HTTPVerb](/docs/R4/ValueSets/HTTPVerb.md)| Relationship | [R4B HTTPVerb](/docs/R4B/ValueSets/HTTPVerb.md)| Relationship | R5 HTTPVerb
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://hl7.org/fhir/http-verb`
