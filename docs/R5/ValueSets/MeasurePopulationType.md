...
This group is centered on the Value Set MeasurePopulationType from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | *No Map* | Relationship | [R4B MeasurePopulationType](/docs/R4B/ValueSets/MeasurePopulationType.md)| Relationship | R5 MeasurePopulationType
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://terminology.hl7.org/CodeSystem/measure-population`
