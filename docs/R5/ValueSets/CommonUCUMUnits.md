...
| Database Key | `4987` |
| Database Concept Count | `848` |
| Database Active Concept Count | `848` |
### Bindings
...
| `http://unitsofmeasure.org` | `/min/10*3` | per minute per thousand |
...
| `http://unitsofmeasure.org` | `10*-3` | (the number ten for arbitrary powers ^ -3) |
| `http://unitsofmeasure.org` | `10*-6` | the number ten for arbitrary powers ^ -6 |
...
| `http://unitsofmeasure.org` | `U/(10.g)` | enzyme unit per 10 gram |
...
| `http://unitsofmeasure.org` | `U/kg` | enzyme unit per kilogram |
...
| `http://unitsofmeasure.org` | `U/mmol` | enzyme unit per millimole |
...
| `http://unitsofmeasure.org` | `[IU]/10*9` | international unit per billion |
...
| `http://unitsofmeasure.org` | `fmol/mg` | femtomole per milligram |
...
| `http://unitsofmeasure.org` | `mL/min/1.73.m2` | milliliter per minute per 1.73 square meter |
...
| `http://unitsofmeasure.org` | `mU/mmol` | millienzyme Unit per millimole |
...
| `http://unitsofmeasure.org` | `mg/d/1.73.m2` | milligram per day per 1.73 square meter |
...
| `http://unitsofmeasure.org` | `mmol/h/mg` | millimole per hour per milligram |
...
| `http://unitsofmeasure.org` | `nU` | nanoenzyme unit |
...
| `http://unitsofmeasure.org` | `ng/mL` | nanogram per milliliter |
...
| `http://unitsofmeasure.org` | `nmol/L/mmol` | nanomole per liter per millimole |
...
| `http://unitsofmeasure.org` | `nmol/h/mg` | nanomole per hour per milligram |
| `http://unitsofmeasure.org` | `nmol/m/mg` | nanomole per meter per milligram |
...
| `http://unitsofmeasure.org` | `nmol/min/10*6` | nanomole per minute per million |
| `http://unitsofmeasure.org` | `nmol/min/mL` | nanomole per minute per milliliter |
| `http://unitsofmeasure.org` | `nmol/min/mg` | nanomole per minute per milligram |
...
| `http://unitsofmeasure.org` | `pmol/h/mg` | picomole per hour per milligram |
| `http://unitsofmeasure.org` | `pmol/mL` | picomole per milliliter |
| `http://unitsofmeasure.org` | `pmol/mg` | picomole per milligram |
| `http://unitsofmeasure.org` | `pmol/min` | picomole per minute |
| `http://unitsofmeasure.org` | `pmol/min/mg` | picomole per minute per milligram |
...
| `http://unitsofmeasure.org` | `umol/h/mg` | micromole per hour per milligram |
