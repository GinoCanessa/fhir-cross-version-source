...
This group is centered on the Value Set ObservationInterpretationCodes from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | *No Map* | Relationship | [R4B ObservationInterpretationCodes](/docs/R4B/ValueSets/ObservationInterpretationCodes.md)| Relationship | R5 ObservationInterpretationCodes
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://terminology.hl7.org/CodeSystem/v3-ObservationInterpretation`
...
| | | | | | | *39 of 47 codes used* <br/>remaining codes:<br/>| | *49 of 57 codes used* <br/>remaining codes:<br/>
