...
| Database Key | `5045` |
| Database Concept Count | `1302` |
| Database Active Concept Count | `1064` |
### Bindings

| Source | Element | Binding | Strength | Element Short |
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Composition` | `Composition.event.detail` | `http://terminology.hl7.org/ValueSet/v3-ActCode` | `Example` | The event(s) being documented, as code(s), reference(s), or both |
| `http://hl7.org/fhir/StructureDefinition/DocumentReference` | `DocumentReference.event` | `http://terminology.hl7.org/ValueSet/v3-ActCode` | `Example` | Main clinical acts documented |
