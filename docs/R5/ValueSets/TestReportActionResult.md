...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/TestReport` | `TestReport.setup.action.operation.result` | `http://hl7.org/fhir/ValueSet/report-action-result-codes\|5.0.0` | `Required` | pass \| skip \| fail \| warning \| error |
| `http://hl7.org/fhir/StructureDefinition/TestReport` | `TestReport.setup.action.assert.result` | `http://hl7.org/fhir/ValueSet/report-action-result-codes\|5.0.0` | `Required` | pass \| skip \| fail \| warning \| error |
...
This group is centered on the Value Set TestReportActionResult from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 TestReportActionResult](/docs/R3/ValueSets/TestReportActionResult.md)| Relationship | [R4 TestReportActionResult](/docs/R4/ValueSets/TestReportActionResult.md)| Relationship | [R4B TestReportActionResult](/docs/R4B/ValueSets/TestReportActionResult.md)| Relationship | R5 TestReportActionResult
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://hl7.org/fhir/report-action-result-codes`
