...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Endpoint` | `Endpoint.status` | `http://hl7.org/fhir/ValueSet/endpoint-status\|5.0.0` | `Required` | active \| suspended \| error \| off \| entered-in-error \| test |
...
This group is centered on the Value Set EndpointStatus from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 EndpointStatus](/docs/R3/ValueSets/EndpointStatus.md)| Relationship | [R4 EndpointStatus](/docs/R4/ValueSets/EndpointStatus.md)| Relationship | [R4B EndpointStatus](/docs/R4B/ValueSets/EndpointStatus.md)| Relationship | R5 EndpointStatus
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://hl7.org/fhir/endpoint-status`
