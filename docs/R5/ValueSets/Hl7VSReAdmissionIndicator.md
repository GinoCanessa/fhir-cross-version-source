...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Encounter` | `Encounter.admission.reAdmission` | `http://terminology.hl7.org/ValueSet/v2-0092` | `Example` | Indicates that the patient is being re-admitted |
