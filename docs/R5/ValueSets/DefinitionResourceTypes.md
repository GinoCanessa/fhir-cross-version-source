...
| VS Name | DefinitionResourceTypes |
| Canonical URL | `http://hl7.org/fhir/ValueSet/definition-resource-types` |
| Version | 5.0.0 |
| Description | All Resource Types that represent definition resources |
| Status | `Active` |
