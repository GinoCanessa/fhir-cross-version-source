...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/ClaimResponse` | `ClaimResponse.processNote.type` | `http://hl7.org/fhir/ValueSet/note-type` | `Extensible` | Note purpose |
| `http://hl7.org/fhir/StructureDefinition/ExplanationOfBenefit` | `ExplanationOfBenefit.processNote.type` | `http://hl7.org/fhir/ValueSet/note-type` | `Extensible` | Note purpose |
| `http://hl7.org/fhir/StructureDefinition/PaymentReconciliation` | `PaymentReconciliation.processNote.type` | `http://hl7.org/fhir/ValueSet/note-type\|5.0.0` | `Required` | display \| print \| printoper |
...
This group is centered on the Value Set NoteType from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 NoteType](/docs/R2/ValueSets/NoteType.md)| Relationship | [R3 NoteType](/docs/R3/ValueSets/NoteType.md)| Relationship | [R4 NoteType](/docs/R4/ValueSets/NoteType.md)| Relationship | [R4B NoteType](/docs/R4B/ValueSets/NoteType.md)| Relationship | R5 NoteType
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://hl7.org/fhir/note-type`
