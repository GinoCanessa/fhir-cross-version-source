...
| `preconditionFailed`| _Equivalent_ <br/>(1341/2800)| `preconditionFailed`| _Equivalent_ <br/>(4986/7331)| `preconditionFailed`| _Equivalent_ <br/>(14532/14533)| `preconditionFailed`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(9572)<hr/>←←←← __ ←←←← <br/>() | **`preconditionFailed`**
