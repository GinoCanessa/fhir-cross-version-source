...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/AdverseEvent` | `AdverseEvent.seriousness` | `http://hl7.org/fhir/ValueSet/adverse-event-seriousness` | `Example` | Seriousness or gravity of the event |
