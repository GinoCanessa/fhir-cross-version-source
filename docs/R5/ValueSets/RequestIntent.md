...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/ActivityDefinition` | `ActivityDefinition.intent` | `http://hl7.org/fhir/ValueSet/request-intent\|5.0.0` | `Required` | proposal \| plan \| directive \| order \| original-order \| reflex-order \| filler-order \| instance-order \| option |
| `http://hl7.org/fhir/StructureDefinition/CommunicationRequest` | `CommunicationRequest.intent` | `http://hl7.org/fhir/ValueSet/request-intent\|5.0.0` | `Required` | proposal \| plan \| directive \| order \| original-order \| reflex-order \| filler-order \| instance-order \| option |
| `http://hl7.org/fhir/StructureDefinition/DeviceRequest` | `DeviceRequest.intent` | `http://hl7.org/fhir/ValueSet/request-intent\|5.0.0` | `Required` | proposal \| plan \| directive \| order \| original-order \| reflex-order \| filler-order \| instance-order \| option |
| `http://hl7.org/fhir/StructureDefinition/NutritionOrder` | `NutritionOrder.intent` | `http://hl7.org/fhir/ValueSet/request-intent\|5.0.0` | `Required` | proposal \| plan \| directive \| order \| original-order \| reflex-order \| filler-order \| instance-order \| option |
| `http://hl7.org/fhir/StructureDefinition/RequestOrchestration` | `RequestOrchestration.intent` | `http://hl7.org/fhir/ValueSet/request-intent\|5.0.0` | `Required` | proposal \| plan \| directive \| order \| original-order \| reflex-order \| filler-order \| instance-order \| option |
| `http://hl7.org/fhir/StructureDefinition/ServiceRequest` | `ServiceRequest.intent` | `http://hl7.org/fhir/ValueSet/request-intent\|5.0.0` | `Required` | proposal \| plan \| directive \| order + |
...
This group is centered on the Value Set RequestIntent from hl7.fhir.r5.core@5.0.0 (R5, key 5).
