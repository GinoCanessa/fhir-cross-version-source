...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Condition` | `Condition.category` | `http://hl7.org/fhir/ValueSet/condition-category` | `Preferred` | problem-list-item \| encounter-diagnosis |
