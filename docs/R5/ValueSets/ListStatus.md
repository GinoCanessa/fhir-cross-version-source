...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/List` | `List.status` | `http://hl7.org/fhir/ValueSet/list-status\|5.0.0` | `Required` | current \| retired \| entered-in-error |
...
This group is centered on the Value Set ListStatus from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 ListStatus](/docs/R2/ValueSets/ListStatus.md)| Relationship | [R3 ListStatus](/docs/R3/ValueSets/ListStatus.md)| Relationship | [R4 ListStatus](/docs/R4/ValueSets/ListStatus.md)| Relationship | [R4B ListStatus](/docs/R4B/ValueSets/ListStatus.md)| Relationship | R5 ListStatus
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://hl7.org/fhir/list-status`
