...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Invoice` | `Invoice.status` | `http://hl7.org/fhir/ValueSet/invoice-status\|5.0.0` | `Required` | draft \| issued \| balanced \| cancelled \| entered-in-error |
...
This group is centered on the Value Set InvoiceStatus from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | [R4 InvoiceStatus](/docs/R4/ValueSets/InvoiceStatus.md)| Relationship | [R4B InvoiceStatus](/docs/R4B/ValueSets/InvoiceStatus.md)| Relationship | R5 InvoiceStatus
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://hl7.org/fhir/invoice-status`
