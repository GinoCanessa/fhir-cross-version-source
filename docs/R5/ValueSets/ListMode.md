...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/EvidenceReport` | `EvidenceReport.section.mode` | `http://hl7.org/fhir/ValueSet/list-mode\|5.0.0` | `Required` | working \| snapshot \| changes |
| `http://hl7.org/fhir/StructureDefinition/List` | `List.mode` | `http://hl7.org/fhir/ValueSet/list-mode\|5.0.0` | `Required` | working \| snapshot \| changes |
...
This group is centered on the Value Set ListMode from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 ListMode](/docs/R2/ValueSets/ListMode.md)| Relationship | [R3 ListMode](/docs/R3/ValueSets/ListMode.md)| Relationship | [R4 ListMode](/docs/R4/ValueSets/ListMode.md)| Relationship | [R4B ListMode](/docs/R4B/ValueSets/ListMode.md)| Relationship | R5 ListMode
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://hl7.org/fhir/list-mode`
