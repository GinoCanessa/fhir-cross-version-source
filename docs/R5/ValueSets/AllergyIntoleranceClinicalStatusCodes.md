...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/AllergyIntolerance` | `AllergyIntolerance.clinicalStatus` | `http://hl7.org/fhir/ValueSet/allergyintolerance-clinical\|5.0.0` | `Required` | active \| inactive \| resolved |
...
This group is centered on the Value Set AllergyIntoleranceClinicalStatusCodes from hl7.fhir.r5.core@5.0.0 (R5, key 5).
