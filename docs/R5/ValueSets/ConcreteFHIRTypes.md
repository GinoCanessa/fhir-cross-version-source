...
| VS Name | ConcreteFHIRTypes |
| Canonical URL | `http://hl7.org/fhir/ValueSet/concrete-fhir-types` |
| Version | 5.0.0 |
| Description | List of all non-abstract types, data types and resources |
| Status | `Draft` |
| Has Escape Valve Code | `False` |
| Database Key | `4394` |
| Database Concept Count | `221` |
| Database Active Concept Count | `221` |
### Bindings

| Source | Element | Binding | Strength | Element Short |
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/TestScript` | `TestScript.setup.action.operation.resource` | `http://hl7.org/fhir/ValueSet/concrete-fhir-types` | `Extensible` | Resource type |
| `http://hl7.org/fhir/StructureDefinition/TestScript` | `TestScript.setup.action.assert.resource` | `http://hl7.org/fhir/ValueSet/concrete-fhir-types` | `Extensible` | Resource type |
