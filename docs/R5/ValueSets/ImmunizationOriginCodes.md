...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Immunization` | `Immunization.informationSource` | `http://hl7.org/fhir/ValueSet/immunization-origin` | `Example` | Indicates the source of a  reported record |
