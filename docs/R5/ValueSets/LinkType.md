...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Patient` | `Patient.link.type` | `http://hl7.org/fhir/ValueSet/link-type\|5.0.0` | `Required` | replaced-by \| replaces \| refer \| seealso |
...
This group is centered on the Value Set LinkType from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 LinkType](/docs/R2/ValueSets/LinkType.md)| Relationship | [R3 LinkType](/docs/R3/ValueSets/LinkType.md)| Relationship | [R4 LinkType](/docs/R4/ValueSets/LinkType.md)| Relationship | [R4B LinkType](/docs/R4B/ValueSets/LinkType.md)| Relationship | R5 LinkType
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://hl7.org/fhir/link-type`
