...
| Database Key | `4569` |
| Database Concept Count | `231` |
| Database Active Concept Count | `231` |
### Bindings

| Source | Element | Binding | Strength | Element Short |
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/DataRequirement` | `DataRequirement.type` | `http://hl7.org/fhir/ValueSet/fhir-types\|5.0.0` | `Required` | The type of the required data |
| `http://hl7.org/fhir/StructureDefinition/ParameterDefinition` | `ParameterDefinition.type` | `http://hl7.org/fhir/ValueSet/fhir-types\|5.0.0` | `Required` | What type of value |
| `http://hl7.org/fhir/StructureDefinition/Measure` | `Measure.basis` | `http://hl7.org/fhir/ValueSet/fhir-types\|5.0.0` | `Required` | Population basis |
| `http://hl7.org/fhir/StructureDefinition/Measure` | `Measure.group.basis` | `http://hl7.org/fhir/ValueSet/fhir-types\|5.0.0` | `Required` | Population basis |
| `http://hl7.org/fhir/StructureDefinition/OperationDefinition` | `OperationDefinition.parameter.type` | `http://hl7.org/fhir/ValueSet/fhir-types\|5.0.0` | `Required` | What type this parameter has |
| `http://hl7.org/fhir/StructureDefinition/OperationDefinition` | `OperationDefinition.parameter.allowedType` | `http://hl7.org/fhir/ValueSet/fhir-types\|5.0.0` | `Required` | Allowed sub-type this parameter can have (if type is abstract) |
| `http://hl7.org/fhir/StructureDefinition/StructureDefinition` | `StructureDefinition.type` | `http://hl7.org/fhir/ValueSet/fhir-types` | `Extensible` | Type defined or constrained by this structure |
