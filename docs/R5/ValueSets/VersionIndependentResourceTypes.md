...
| VS Name | VersionIndependentResourceTypes |
| Canonical URL | `http://hl7.org/fhir/ValueSet/version-independent-resource-types` |
| Version | 5.0.0 |
| Description | Current and past FHIR resource types (deleted or renamed) |
| Status | `Active` |
| Has Escape Valve Code | `False` |
| Database Key | `5014` |
| Database Concept Count | `199` |
| Database Active Concept Count | `199` |
### Bindings
