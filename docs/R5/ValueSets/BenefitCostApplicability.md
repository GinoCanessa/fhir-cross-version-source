...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/InsurancePlan` | `InsurancePlan.plan.specificCost.benefit.cost.applicability` | `http://hl7.org/fhir/ValueSet/insuranceplan-applicability\|5.0.0` | `Required` | in-network \| out-of-network \| other |
...
This group is centered on the Value Set BenefitCostApplicability from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | [R4 BenefitCostApplicability](/docs/R4/ValueSets/BenefitCostApplicability.md)| Relationship | [R4B BenefitCostApplicability](/docs/R4B/ValueSets/BenefitCostApplicability.md)| Relationship | R5 BenefitCostApplicability
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://terminology.hl7.org/CodeSystem/applicability`
