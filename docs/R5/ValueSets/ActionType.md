...
| `http://hl7.org/fhir/StructureDefinition/RequestOrchestration` | `RequestOrchestration.action.type` | `http://hl7.org/fhir/ValueSet/action-type` | `Extensible` | create \| update \| remove \| fire-event |
...
This group is centered on the Value Set ActionType from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | *No Map* | Relationship | [R4B ActionType](/docs/R4B/ValueSets/ActionType.md)| Relationship | R5 ActionType
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://terminology.hl7.org/CodeSystem/action-type`
