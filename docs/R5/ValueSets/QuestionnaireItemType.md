...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Questionnaire` | `Questionnaire.item.type` | `http://hl7.org/fhir/ValueSet/item-type\|5.0.0` | `Required` | group \| display \| boolean \| decimal \| integer \| date \| dateTime + |
...
This group is centered on the Value Set QuestionnaireItemType from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 AnswerFormat](/docs/R2/ValueSets/AnswerFormat.md)| Relationship | [R3 QuestionnaireItemType](/docs/R3/ValueSets/QuestionnaireItemType.md)| Relationship | [R4 QuestionnaireItemType](/docs/R4/ValueSets/QuestionnaireItemType.md)| Relationship | [R4B QuestionnaireItemType](/docs/R4B/ValueSets/QuestionnaireItemType.md)| Relationship | R5 QuestionnaireItemType
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://hl7.org/fhir/item-type`
...
| `choice`| _Equivalent_ <br/>(1084/2486)| `choice`| _Equivalent_ <br/>(4548/6858)| `choice`| _Equivalent_ <br/>(16348/16349)| `choice`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(9268)<hr/>←←←← __ ←←←← <br/>() | **`coding`**
| `open-choice`| _Equivalent_ <br/>(1073/2494)| `open-choice`| _Equivalent_ <br/>(4538/6848)| `open-choice`| _Equivalent_ <br/>(16350/16351)| `open-choice`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(9258)<hr/>←←←← __ ←←←← <br/>() | **`coding`**
...
| | | | | | | | | **`question`**
| *15 of 15 codes used* | | *16 of 16 codes used* | | *16 of 16 codes used* | | *16 of 17 codes used* <br/>remaining codes:<br/>`question`| | *16 of 16 codes used* 
