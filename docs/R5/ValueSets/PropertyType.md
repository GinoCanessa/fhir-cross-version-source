...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/CodeSystem` | `CodeSystem.property.type` | `http://hl7.org/fhir/ValueSet/concept-property-type\|5.0.0` | `Required` | code \| Coding \| string \| integer \| boolean \| dateTime \| decimal |
...
This group is centered on the Value Set PropertyType from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 PropertyType](/docs/R3/ValueSets/PropertyType.md)| Relationship | [R4 PropertyType](/docs/R4/ValueSets/PropertyType.md)| Relationship | [R4B PropertyType](/docs/R4B/ValueSets/PropertyType.md)| Relationship | R5 PropertyType
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://hl7.org/fhir/concept-property-type`
