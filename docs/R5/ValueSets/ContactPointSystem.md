...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/ContactPoint` | `ContactPoint.system` | `http://hl7.org/fhir/ValueSet/contact-point-system\|5.0.0` | `Required` | phone \| fax \| email \| pager \| url \| sms \| other |
...
This group is centered on the Value Set ContactPointSystem from hl7.fhir.r5.core@5.0.0 (R5, key 5).
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R5** System: `http://hl7.org/fhir/contact-point-system`
