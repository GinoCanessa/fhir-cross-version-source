...
| `UsageContext.code` | `UsageContext.code` | `code` | UsageContext.code | Type of context being specified | 1..1 | Coding | `Extensible` | `http://terminology.hl7.org/ValueSet/usage-context-type` |
...
This group is centered on the Structure Definition UsageContext from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 UsageContext](/docs/R3/ComplexTypes/UsageContext.md)| Relationship | [R4 UsageContext](/docs/R4/ComplexTypes/UsageContext.md)| Relationship | [R4B UsageContext](/docs/R4B/ComplexTypes/UsageContext.md)| Relationship | R5 UsageContext
| --- | --- | --- | --- | --- | --- | --- | --- | ---
