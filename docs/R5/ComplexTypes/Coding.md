...
This group is centered on the Structure Definition Coding from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Coding](/docs/R2/ComplexTypes/Coding.md)| Relationship | [R3 Coding](/docs/R3/ComplexTypes/Coding.md)| Relationship | [R4 Coding](/docs/R4/ComplexTypes/Coding.md)| Relationship | [R4B Coding](/docs/R4B/ComplexTypes/Coding.md)| Relationship | R5 Coding
| --- | --- | --- | --- | --- | --- | --- | --- | ---
