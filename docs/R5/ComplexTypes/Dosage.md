...
| `Dosage.asNeeded` | `Dosage.asNeeded` | `asNeeded` | Dosage.asNeeded | Take "as needed" | 0..1 | boolean |  |  |
| `Dosage.asNeededFor` | `Dosage.asNeededFor` | `asNeededFor` | Dosage.asNeededFor | Take "as needed" (for x) | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/medication-as-needed-reason` |
| `Dosage.doseAndRate` | `Dosage.doseAndRate` | `doseAndRate` | Dosage.doseAndRate | Amount of medication administered, to be administered or typical amount to be administered | 0..* | Element |  |  |
...
| `Dosage.doseAndRate.type` | `Dosage.doseAndRate.type` | `type` | Dosage.doseAndRate.type | The kind of dose or rate specified | 0..1 | CodeableConcept | `Example` | `http://terminology.hl7.org/ValueSet/dose-rate-type` |
...
| `Dosage.maxDosePerPeriod` | `Dosage.maxDosePerPeriod` | `maxDosePerPeriod` | Dosage.maxDosePerPeriod | Upper limit on medication per unit of time | 0..* | Ratio |  |  |
...
| `Dosage.modifierExtension` | `Dosage.modifierExtension` | `modifierExtension` | BackboneType.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
...
This group is centered on the Structure Definition Dosage from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 Dosage](/docs/R3/ComplexTypes/Dosage.md)| Relationship | [R4 Dosage](/docs/R4/ComplexTypes/Dosage.md)| Relationship | [R4B Dosage](/docs/R4B/ComplexTypes/Dosage.md)| Relationship | R5 Dosage
| --- | --- | --- | --- | --- | --- | --- | --- | ---
