...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [CodeableConcept](/docs/R2/ComplexTypes/CodeableConcept.md)<br/> `http://hl7.org/fhir/StructureDefinition/CodeableConcept\|1.0.2` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `50`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `217`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [CodeableConcept](/docs/R3/ComplexTypes/CodeableConcept.md)<br/> `http://hl7.org/fhir/StructureDefinition/CodeableConcept\|3.0.2` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `386`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `582`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [CodeableConcept](/docs/R4/ComplexTypes/CodeableConcept.md)<br/> `http://hl7.org/fhir/StructureDefinition/CodeableConcept\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1317`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1318`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [CodeableConcept](/docs/R4B/ComplexTypes/CodeableConcept.md)<br/> `http://hl7.org/fhir/StructureDefinition/CodeableConcept\|4.3.0` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `893`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1122`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [CodeableConcept](/docs/R5/ComplexTypes/CodeableConcept.md)<br/> `http://hl7.org/fhir/StructureDefinition/CodeableConcept\|5.0.0` 
...
This group is centered on the Structure Definition CodeableConcept from hl7.fhir.r5.core@5.0.0 (R5, key 5).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 CodeableConcept](/docs/R2/ComplexTypes/CodeableConcept.md)| Relationship | [R3 CodeableConcept](/docs/R3/ComplexTypes/CodeableConcept.md)| Relationship | [R4 CodeableConcept](/docs/R4/ComplexTypes/CodeableConcept.md)| Relationship | [R4B CodeableConcept](/docs/R4B/ComplexTypes/CodeableConcept.md)| Relationship | R5 CodeableConcept
| --- | --- | --- | --- | --- | --- | --- | --- | ---
