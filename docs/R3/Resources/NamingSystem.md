...
| `NamingSystem.contact` | `NamingSystem.contact` | `contact` |  | Contact details for the publisher | 0..* | ContactDetail |  |  |
| `NamingSystem.contained` | `NamingSystem.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `NamingSystem.date` | `NamingSystem.date` | `date` |  | Date this was last changed | 1..1 | dateTime |  |  |
| `NamingSystem.description` | `NamingSystem.description` | `description` |  | Natural language description of the naming system | 0..1 | markdown |  |  |
...
| `NamingSystem.jurisdiction` | `NamingSystem.jurisdiction` | `jurisdiction` |  | Intended jurisdiction for naming system (if applicable) | 0..* | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/jurisdiction` |
...
| `NamingSystem.language` | `NamingSystem.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `NamingSystem.name` | `NamingSystem.name` | `name` |  | Name for this naming system (computer friendly) | 1..1 | string |  |  |
...
| `NamingSystem.status` | `NamingSystem.status` | `status` |  | draft \| active \| retired \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status` |
...
| `NamingSystem.uniqueId.comment` | `NamingSystem.uniqueId.comment` | `comment` |  | Notes about identifier usage | 0..1 | string |  |  |
...
| `NamingSystem.uniqueId.id` | `NamingSystem.uniqueId.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `NamingSystem.uniqueId.modifierExtension` | `NamingSystem.uniqueId.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `NamingSystem.useContext` | `NamingSystem.useContext` | `useContext` |  | Context the content is intended to support | 0..* | UsageContext |  |  |
### Mapping Table

| R2 | Comparison | R3 | Comparison | R4 | Comparison | R4B | Comparison | R5
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [NamingSystem](/docs/R2/Resources/NamingSystem.md)<br/> `http://hl7.org/fhir/StructureDefinition/NamingSystem\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `130`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `296`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [NamingSystem](/docs/R3/Resources/NamingSystem.md)<br/> `http://hl7.org/fhir/StructureDefinition/NamingSystem\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `487`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `681`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [NamingSystem](/docs/R4/Resources/NamingSystem.md)<br/> `http://hl7.org/fhir/StructureDefinition/NamingSystem\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1553`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1554`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [NamingSystem](/docs/R4B/Resources/NamingSystem.md)<br/> `http://hl7.org/fhir/StructureDefinition/NamingSystem\|4.3.0` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `1012`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1241`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [NamingSystem](/docs/R5/Resources/NamingSystem.md)<br/> `http://hl7.org/fhir/StructureDefinition/NamingSystem\|5.0.0` 
...
This group is centered on the Structure Definition NamingSystem from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 NamingSystem](/docs/R2/Resources/NamingSystem.md)| Relationship | R3 NamingSystem| Relationship | [R4 NamingSystem](/docs/R4/Resources/NamingSystem.md)| Relationship | [R4B NamingSystem](/docs/R4B/Resources/NamingSystem.md)| Relationship | [R5 NamingSystem](/docs/R5/Resources/NamingSystem.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
