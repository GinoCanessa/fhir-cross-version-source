...
| `Provenance.activity` | `Provenance.activity` | `activity` |  | Activity that occurred | 0..1 | Coding | `Extensible` | `http://hl7.org/fhir/ValueSet/provenance-activity-type` |
| `Provenance.agent` | `Provenance.agent` | `agent` |  | Actor involved | 1..* | BackboneElement |  |  |
...
| `Provenance.agent.id` | `Provenance.agent.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Provenance.agent.modifierExtension` | `Provenance.agent.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Provenance.agent.onBehalfOf[x]` | `Provenance.agent.onBehalfOf[x]` | `onBehalfOf[x]` |  | Who the agent is representing | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson), uri |  |  |
| `Provenance.agent.relatedAgentType` | `Provenance.agent.relatedAgentType` | `relatedAgentType` |  | Type of relationship between agents | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/v3-RoleLinkType` |
| `Provenance.agent.role` | `Provenance.agent.role` | `role` |  | What the agents role was | 0..* | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/security-role-type` |
| `Provenance.agent.who[x]` | `Provenance.agent.who[x]` | `who[x]` |  | Who participated | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson), uri |  |  |
...
| `Provenance.entity.agent` | `Provenance.entity.agent` | `agent` |  | Entity is attributed to this agent | 0..* | Provenance.agent |  |  |
...
| `Provenance.entity.id` | `Provenance.entity.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Provenance.entity.modifierExtension` | `Provenance.entity.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Provenance.entity.role` | `Provenance.entity.role` | `role` |  | derivation \| revision \| quotation \| source \| removal | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/provenance-entity-role` |
| `Provenance.entity.what[x]` | `Provenance.entity.what[x]` | `what[x]` |  | Identity of entity | 1..1 | Identifier, Reference(http://hl7.org/fhir/StructureDefinition/Resource), uri |  |  |
...
| `Provenance.language` | `Provenance.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `Provenance.reason` | `Provenance.reason` | `reason` |  | Reason the activity is occurring | 0..* | Coding | `Extensible` | `http://hl7.org/fhir/ValueSet/v3-PurposeOfUse` |
...
This group is centered on the Structure Definition Provenance from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Provenance](/docs/R2/Resources/Provenance.md)| Relationship | R3 Provenance| Relationship | [R4 Provenance](/docs/R4/Resources/Provenance.md)| Relationship | [R4B Provenance](/docs/R4B/Resources/Provenance.md)| Relationship | [R5 Provenance](/docs/R5/Resources/Provenance.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| `Provenance.agent`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(7469)<hr/>←←←← __ ←←←← <br/>()| **`Provenance.agent`**| _Equivalent_<br/>(17621/17622)| `Provenance.agent`| _Equivalent_<br/>(32029/32030)| `Provenance.agent`| _Equivalent_<br/>(46609/46610)| `Provenance.agent`
| `Provenance.agent.relatedAgent`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(355)<hr/>←←←← __ ←←←← <br/>()| **`Provenance.agent`**| _Equivalent_<br/>(17621/17622)| `Provenance.agent`| _Equivalent_<br/>(32029/32030)| `Provenance.agent`| _Equivalent_<br/>(46609/46610)| `Provenance.agent`
