...
| `Slot.appointmentType` | `Slot.appointmentType` | `appointmentType` |  | The style of appointment or patient that may be booked in the slot (not service type) | 0..1 | CodeableConcept | `Preferred` | `http://hl7.org/fhir/ValueSet/v2-0276` |
...
| `Slot.language` | `Slot.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `Slot.serviceCategory` | `Slot.serviceCategory` | `serviceCategory` |  | A broad categorisation of the service that is to be performed during this appointment | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/service-category` |
| `Slot.serviceType` | `Slot.serviceType` | `serviceType` |  | The type of appointments that can be booked into this slot (ideally this would be an identifiable service - which is at a location, rather than the location itself). If provided then this overrides the value provided on the availability resource | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/service-type` |
| `Slot.specialty` | `Slot.specialty` | `specialty` |  | The specialty of a practitioner that would be required to perform the service requested in this appointment | 0..* | CodeableConcept | `Preferred` | `http://hl7.org/fhir/ValueSet/c80-practice-codes` |
| `Slot.start` | `Slot.start` | `start` |  | Date/Time that the slot is to begin | 1..1 | instant |  |  |
| `Slot.status` | `Slot.status` | `status` |  | busy \| free \| busy-unavailable \| busy-tentative \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/slotstatus` |
...
This group is centered on the Structure Definition Slot from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Slot](/docs/R2/Resources/Slot.md)| Relationship | R3 Slot| Relationship | [R4 Slot](/docs/R4/Resources/Slot.md)| Relationship | [R4B Slot](/docs/R4B/Resources/Slot.md)| Relationship | [R5 Slot](/docs/R5/Resources/Slot.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
