...
| `RelatedPerson.active` | `RelatedPerson.active` | `active` |  | Whether this related person's record is in active use | 0..1 | boolean |  |  |
...
| `RelatedPerson.language` | `RelatedPerson.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `RelatedPerson.name` | `RelatedPerson.name` | `name` |  | A name associated with the person | 0..* | HumanName |  |  |
...
| `RelatedPerson.relationship` | `RelatedPerson.relationship` | `relationship` |  | The nature of the relationship | 0..1 | CodeableConcept | `Preferred` | `http://hl7.org/fhir/ValueSet/relatedperson-relationshiptype` |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [RelatedPerson](/docs/R2/Resources/RelatedPerson.md)<br/> `http://hl7.org/fhir/StructureDefinition/RelatedPerson\|1.0.2` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `151`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `317`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [RelatedPerson](/docs/R3/Resources/RelatedPerson.md)<br/> `http://hl7.org/fhir/StructureDefinition/RelatedPerson\|3.0.2` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `508`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `700`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [RelatedPerson](/docs/R4/Resources/RelatedPerson.md)<br/> `http://hl7.org/fhir/StructureDefinition/RelatedPerson\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1593`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1594`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [RelatedPerson](/docs/R4B/Resources/RelatedPerson.md)<br/> `http://hl7.org/fhir/StructureDefinition/RelatedPerson\|4.3.0` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `1033`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1262`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [RelatedPerson](/docs/R5/Resources/RelatedPerson.md)<br/> `http://hl7.org/fhir/StructureDefinition/RelatedPerson\|5.0.0` 
...
This group is centered on the Structure Definition RelatedPerson from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 RelatedPerson](/docs/R2/Resources/RelatedPerson.md)| Relationship | R3 RelatedPerson| Relationship | [R4 RelatedPerson](/docs/R4/Resources/RelatedPerson.md)| Relationship | [R4B RelatedPerson](/docs/R4B/Resources/RelatedPerson.md)| Relationship | [R5 RelatedPerson](/docs/R5/Resources/RelatedPerson.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *19 of 19 elements used* | | *20 of 20 elements used* | | *20 of 26 elements used* <br/>remaining elements:<br/>`RelatedPerson.communication`, `RelatedPerson.communication.extension`, `RelatedPerson.communication.id`, `RelatedPerson.communication.language`, `RelatedPerson.communication.modifierExtension`, `RelatedPerson.communication.preferred`| | *20 of 26 elements used* <br/>remaining elements:<br/>`RelatedPerson.communication`, `RelatedPerson.communication.extension`, `RelatedPerson.communication.id`, `RelatedPerson.communication.language`, `RelatedPerson.communication.modifierExtension`, `RelatedPerson.communication.preferred`| | *20 of 26 elements used* <br/>remaining elements:<br/>`RelatedPerson.communication`, `RelatedPerson.communication.extension`, `RelatedPerson.communication.id`, `RelatedPerson.communication.language`, `RelatedPerson.communication.modifierExtension`, `RelatedPerson.communication.preferred`
