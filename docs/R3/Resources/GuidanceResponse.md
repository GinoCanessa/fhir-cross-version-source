...
| `GuidanceResponse.context` | `GuidanceResponse.context` | `context` |  | Encounter or Episode during which the response was returned | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Encounter), Reference(http://hl7.org/fhir/StructureDefinition/EpisodeOfCare) |  |  |
| `GuidanceResponse.dataRequirement` | `GuidanceResponse.dataRequirement` | `dataRequirement` |  | Additional required data | 0..* | DataRequirement |  |  |
| `GuidanceResponse.evaluationMessage` | `GuidanceResponse.evaluationMessage` | `evaluationMessage` |  | Messages resulting from the evaluation of the artifact or artifacts | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/OperationOutcome) |  |  |
...
| `GuidanceResponse.identifier` | `GuidanceResponse.identifier` | `identifier` |  | Business identifier | 0..1 | Identifier |  |  |
...
| `GuidanceResponse.language` | `GuidanceResponse.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `GuidanceResponse.module` | `GuidanceResponse.module` | `module` |  | A reference to a knowledge module | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/ServiceDefinition) |  |  |
| `GuidanceResponse.note` | `GuidanceResponse.note` | `note` |  | Additional notes about the response | 0..* | Annotation |  |  |
| `GuidanceResponse.occurrenceDateTime` | `GuidanceResponse.occurrenceDateTime` | `occurrenceDateTime` |  | When the guidance response was processed | 0..1 | dateTime |  |  |
| `GuidanceResponse.outputParameters` | `GuidanceResponse.outputParameters` | `outputParameters` |  | The output parameters of the evaluation, if any | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Parameters) |  |  |
| `GuidanceResponse.performer` | `GuidanceResponse.performer` | `performer` |  | Device returning the guidance | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device) |  |  |
| `GuidanceResponse.reason[x]` | `GuidanceResponse.reason[x]` | `reason[x]` |  | Reason for the response | 0..1 | CodeableConcept, Reference(http://hl7.org/fhir/StructureDefinition/Resource) |  |  |
| `GuidanceResponse.requestId` | `GuidanceResponse.requestId` | `requestId` |  | The id of the request associated with this response, if any | 0..1 | id |  |  |
| `GuidanceResponse.result` | `GuidanceResponse.result` | `result` |  | Proposed actions, if any | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/CarePlan), Reference(http://hl7.org/fhir/StructureDefinition/RequestGroup) |  |  |
| `GuidanceResponse.status` | `GuidanceResponse.status` | `status` |  | success \| data-requested \| data-required \| in-progress \| failure \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/guidance-response-status` |
| `GuidanceResponse.subject` | `GuidanceResponse.subject` | `subject` |  | Patient the request was performed for | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Group), Reference(http://hl7.org/fhir/StructureDefinition/Patient) |  |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | [GuidanceResponse](/docs/R3/Resources/GuidanceResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/GuidanceResponse\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `466`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`RelatedTo`<br/>- DBKey: `660`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [GuidanceResponse](/docs/R4/Resources/GuidanceResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/GuidanceResponse\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1503`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1504`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [GuidanceResponse](/docs/R4B/Resources/GuidanceResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/GuidanceResponse\|4.3.0` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `985`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `1214`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [GuidanceResponse](/docs/R5/Resources/GuidanceResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/GuidanceResponse\|5.0.0` 
...
This group is centered on the Structure Definition GuidanceResponse from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | R3 GuidanceResponse| Relationship | [R4 GuidanceResponse](/docs/R4/Resources/GuidanceResponse.md)| Relationship | [R4B GuidanceResponse](/docs/R4B/Resources/GuidanceResponse.md)| Relationship | [R5 GuidanceResponse](/docs/R5/Resources/GuidanceResponse.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
