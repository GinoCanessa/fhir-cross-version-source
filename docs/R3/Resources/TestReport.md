...
| `TestReport.identifier` | `TestReport.identifier` | `identifier` |  | External identifier | 0..1 | Identifier |  |  |
...
| `TestReport.issued` | `TestReport.issued` | `issued` |  | When the TestScript was executed and this TestReport was generated | 0..1 | dateTime |  |  |
| `TestReport.language` | `TestReport.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `TestReport.name` | `TestReport.name` | `name` |  | Informal name of the executed TestScript | 0..1 | string |  |  |
| `TestReport.participant` | `TestReport.participant` | `participant` |  | A participant in the test execution, either the execution engine, a client, or a server | 0..* | BackboneElement |  |  |
| `TestReport.participant.display` | `TestReport.participant.display` | `display` |  | The display name of the participant | 0..1 | string |  |  |
...
| `TestReport.participant.id` | `TestReport.participant.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `TestReport.participant.modifierExtension` | `TestReport.participant.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `TestReport.participant.type` | `TestReport.participant.type` | `type` |  | test-engine \| client \| server | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/report-participant-type` |
| `TestReport.participant.uri` | `TestReport.participant.uri` | `uri` |  | The uri of the participant. An absolute URL is preferred | 1..1 | uri |  |  |
| `TestReport.result` | `TestReport.result` | `result` |  | pass \| fail \| pending | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/report-result-codes` |
| `TestReport.score` | `TestReport.score` | `score` |  | The final score (percentage of tests passed) resulting from the execution of the TestScript | 0..1 | decimal |  |  |
| `TestReport.setup` | `TestReport.setup` | `setup` |  | The results of the series of required setup operations before the tests were executed | 0..1 | BackboneElement |  |  |
...
| `TestReport.test.action.assert` | `TestReport.test.action.assert` | `assert` |  | The assertion performed | 0..1 | TestReport.setup.action.assert |  |  |
...
| `TestReport.test.action.id` | `TestReport.test.action.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `TestReport.test.action.modifierExtension` | `TestReport.test.action.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `TestReport.test.action.operation` | `TestReport.test.action.operation` | `operation` |  | The operation performed | 0..1 | TestReport.setup.action.operation |  |  |
| `TestReport.test.description` | `TestReport.test.description` | `description` |  | Tracking/reporting short description of the test | 0..1 | string |  |  |
...
| `TestReport.test.id` | `TestReport.test.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `TestReport.test.modifierExtension` | `TestReport.test.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `TestReport.test.name` | `TestReport.test.name` | `name` |  | Tracking/logging name of this test | 0..1 | string |  |  |
| `TestReport.testScript` | `TestReport.testScript` | `testScript` |  | Reference to the  version-specific TestScript that was executed to produce this TestReport | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/TestScript) |  |  |
| `TestReport.tester` | `TestReport.tester` | `tester` |  | Name of the tester producing this report (Organization or individual) | 0..1 | string |  |  |
...
This group is centered on the Structure Definition TestReport from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | R3 TestReport| Relationship | [R4 TestReport](/docs/R4/Resources/TestReport.md)| Relationship | [R4B TestReport](/docs/R4B/Resources/TestReport.md)| Relationship | [R5 TestReport](/docs/R5/Resources/TestReport.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
