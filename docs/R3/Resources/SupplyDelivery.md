...
| `SupplyDelivery.basedOn` | `SupplyDelivery.basedOn` | `basedOn` |  | Fulfills plan, proposal or order | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/SupplyRequest) |  |  |
...
| `SupplyDelivery.destination` | `SupplyDelivery.destination` | `destination` |  | Where the Supply was sent | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Location) |  |  |
...
| `SupplyDelivery.identifier` | `SupplyDelivery.identifier` | `identifier` |  | External identifier | 0..1 | Identifier |  |  |
...
| `SupplyDelivery.language` | `SupplyDelivery.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `SupplyDelivery.occurrence[x]` | `SupplyDelivery.occurrence[x]` | `occurrence[x]` |  | When event occurred | 0..1 | dateTime, Period, Timing |  |  |
| `SupplyDelivery.partOf` | `SupplyDelivery.partOf` | `partOf` |  | Part of referenced event | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Contract), Reference(http://hl7.org/fhir/StructureDefinition/SupplyDelivery) |  |  |
| `SupplyDelivery.patient` | `SupplyDelivery.patient` | `patient` |  | Patient for whom the item is supplied | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Patient) |  |  |
| `SupplyDelivery.receiver` | `SupplyDelivery.receiver` | `receiver` |  | Who collected the Supply | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Practitioner) |  |  |
| `SupplyDelivery.status` | `SupplyDelivery.status` | `status` |  | in-progress \| completed \| abandoned \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/supplydelivery-status` |
| `SupplyDelivery.suppliedItem` | `SupplyDelivery.suppliedItem` | `suppliedItem` |  | The item that is delivered or supplied | 0..1 | BackboneElement |  |  |
...
| `SupplyDelivery.suppliedItem.id` | `SupplyDelivery.suppliedItem.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `SupplyDelivery.suppliedItem.item[x]` | `SupplyDelivery.suppliedItem.item[x]` | `item[x]` |  | Medication, Substance, or Device supplied | 0..1 | CodeableConcept, Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Medication), Reference(http://hl7.org/fhir/StructureDefinition/Substance) | `Example` | `http://hl7.org/fhir/ValueSet/supply-item` |
| `SupplyDelivery.suppliedItem.modifierExtension` | `SupplyDelivery.suppliedItem.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `SupplyDelivery.suppliedItem.quantity` | `SupplyDelivery.suppliedItem.quantity` | `quantity` |  | Amount dispensed | 0..1 | Quantity[http://hl7.org/fhir/StructureDefinition/SimpleQuantity] |  |  |
| `SupplyDelivery.supplier` | `SupplyDelivery.supplier` | `supplier` |  | Dispenser | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner) |  |  |
...
| `SupplyDelivery.type` | `SupplyDelivery.type` | `type` |  | Category of dispense event | 0..1 | CodeableConcept | `Required` | `http://hl7.org/fhir/ValueSet/supplydelivery-type` |
### Mapping Table

| R2 | Comparison | R3 | Comparison | R4 | Comparison | R4B | Comparison | R5
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [SupplyDelivery](/docs/R2/Resources/SupplyDelivery.md)<br/> `http://hl7.org/fhir/StructureDefinition/SupplyDelivery\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `161`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `328`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [SupplyDelivery](/docs/R3/Resources/SupplyDelivery.md)<br/> `http://hl7.org/fhir/StructureDefinition/SupplyDelivery\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `522`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `716`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [SupplyDelivery](/docs/R4/Resources/SupplyDelivery.md)<br/> `http://hl7.org/fhir/StructureDefinition/SupplyDelivery\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1629`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1630`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [SupplyDelivery](/docs/R4B/Resources/SupplyDelivery.md)<br/> `http://hl7.org/fhir/StructureDefinition/SupplyDelivery\|4.3.0` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `1051`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1280`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [SupplyDelivery](/docs/R5/Resources/SupplyDelivery.md)<br/> `http://hl7.org/fhir/StructureDefinition/SupplyDelivery\|5.0.0` 
...
This group is centered on the Structure Definition SupplyDelivery from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 SupplyDelivery](/docs/R2/Resources/SupplyDelivery.md)| Relationship | R3 SupplyDelivery| Relationship | [R4 SupplyDelivery](/docs/R4/Resources/SupplyDelivery.md)| Relationship | [R4B SupplyDelivery](/docs/R4B/Resources/SupplyDelivery.md)| Relationship | [R5 SupplyDelivery](/docs/R5/Resources/SupplyDelivery.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| `SupplyDelivery.extension`| →→→→ _Equivalent_ →→→→ <br/>(8087)<hr/>←←←← __ ←←←← <br/>()| **`SupplyDelivery.extension`**| _Equivalent_<br/>(18970/18971)| `SupplyDelivery.extension`| _Equivalent_<br/>(33843/33844)| `SupplyDelivery.extension`| _Equivalent_<br/>(48395/48396)| `SupplyDelivery.extension`
| `SupplyDelivery.whenPrepared`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(425)<hr/>←←←← __ ←←←← <br/>()| **`SupplyDelivery.extension`**| _Equivalent_<br/>(18970/18971)| `SupplyDelivery.extension`| _Equivalent_<br/>(33843/33844)| `SupplyDelivery.extension`| _Equivalent_<br/>(48395/48396)| `SupplyDelivery.extension`
...
| `SupplyDelivery.whenPrepared`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(424)<hr/>←←←← __ ←←←← <br/>()| **`SupplyDelivery.occurrence[x]`**| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(18998)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(18999)| `SupplyDelivery.occurrence[x]`| _Equivalent_<br/>(33871/33872)| `SupplyDelivery.occurrence[x]`| _Equivalent_<br/>(48423/48424)| `SupplyDelivery.occurrence[x]`
| `SupplyDelivery.time`| →→→→ _Equivalent_ →→→→ <br/>(18955)<hr/>←←←← __ ←←←← <br/>()| **`SupplyDelivery.occurrence[x]`**| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(18998)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(18999)| `SupplyDelivery.occurrence[x]`| _Equivalent_<br/>(33871/33872)| `SupplyDelivery.occurrence[x]`| _Equivalent_<br/>(48423/48424)| `SupplyDelivery.occurrence[x]`
