...
| `SearchParameter.base` | `SearchParameter.base` | `base` |  | The resource type(s) this search parameter applies to | 1..* | code | `Required` | `http://hl7.org/fhir/ValueSet/resource-types` |
| `SearchParameter.chain` | `SearchParameter.chain` | `chain` |  | Chained names supported | 0..* | string |  |  |
| `SearchParameter.code` | `SearchParameter.code` | `code` |  | Code used in URL | 1..1 | code |  |  |
| `SearchParameter.comparator` | `SearchParameter.comparator` | `comparator` |  | eq \| ne \| gt \| lt \| ge \| le \| sa \| eb \| ap | 0..* | code | `Required` | `http://hl7.org/fhir/ValueSet/search-comparator` |
| `SearchParameter.component` | `SearchParameter.component` | `component` |  | For Composite resources to define the parts | 0..* | BackboneElement |  |  |
| `SearchParameter.component.definition` | `SearchParameter.component.definition` | `definition` |  | Defines how the part works | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/SearchParameter) |  |  |
| `SearchParameter.component.expression` | `SearchParameter.component.expression` | `expression` |  | Subexpression relative to main expression | 1..1 | string |  |  |
...
| `SearchParameter.component.id` | `SearchParameter.component.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `SearchParameter.component.modifierExtension` | `SearchParameter.component.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `SearchParameter.contact` | `SearchParameter.contact` | `contact` |  | Contact details for the publisher | 0..* | ContactDetail |  |  |
...
| `SearchParameter.date` | `SearchParameter.date` | `date` |  | Date this was last changed | 0..1 | dateTime |  |  |
| `SearchParameter.derivedFrom` | `SearchParameter.derivedFrom` | `derivedFrom` |  | Original Definition for the search parameter | 0..1 | uri |  |  |
| `SearchParameter.description` | `SearchParameter.description` | `description` |  | Natural language description of the search parameter | 1..1 | markdown |  |  |
| `SearchParameter.experimental` | `SearchParameter.experimental` | `experimental` |  | For testing purposes, not real usage | 0..1 | boolean |  |  |
| `SearchParameter.expression` | `SearchParameter.expression` | `expression` |  | FHIRPath expression that extracts the values | 0..1 | string |  |  |
...
| `SearchParameter.jurisdiction` | `SearchParameter.jurisdiction` | `jurisdiction` |  | Intended jurisdiction for search parameter (if applicable) | 0..* | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/jurisdiction` |
| `SearchParameter.language` | `SearchParameter.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
| `SearchParameter.meta` | `SearchParameter.meta` | `meta` | Resource.meta | Metadata about the resource | 0..1 | Meta |  |  |
| `SearchParameter.modifier` | `SearchParameter.modifier` | `modifier` |  | missing \| exact \| contains \| not \| text \| in \| not-in \| below \| above \| type | 0..* | code | `Required` | `http://hl7.org/fhir/ValueSet/search-modifier-code` |
...
| `SearchParameter.name` | `SearchParameter.name` | `name` |  | Name for this search parameter (computer friendly) | 1..1 | string |  |  |
...
| `SearchParameter.purpose` | `SearchParameter.purpose` | `purpose` |  | Why this search parameter is defined | 0..1 | markdown |  |  |
| `SearchParameter.status` | `SearchParameter.status` | `status` |  | draft \| active \| retired \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status` |
...
| `SearchParameter.url` | `SearchParameter.url` | `url` |  | Logical URI to reference this search parameter (globally unique) | 1..1 | uri |  |  |
| `SearchParameter.useContext` | `SearchParameter.useContext` | `useContext` |  | Context the content is intended to support | 0..* | UsageContext |  |  |
| `SearchParameter.version` | `SearchParameter.version` | `version` |  | Business version of the search parameter | 0..1 | string |  |  |
...
This group is centered on the Structure Definition SearchParameter from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 SearchParameter](/docs/R2/Resources/SearchParameter.md)| Relationship | R3 SearchParameter| Relationship | [R4 SearchParameter](/docs/R4/Resources/SearchParameter.md)| Relationship | [R4B SearchParameter](/docs/R4B/Resources/SearchParameter.md)| Relationship | [R5 SearchParameter](/docs/R5/Resources/SearchParameter.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *24 of 29 elements used* <br/>remaining elements:<br/>`SearchParameter.contact.extension`, `SearchParameter.contact.id`, `SearchParameter.contact.modifierExtension`, `SearchParameter.contact.name`, `SearchParameter.contact.telecom`| | *38 of 38 elements used* | | *38 of 40 elements used* <br/>remaining elements:<br/>`SearchParameter.multipleAnd`, `SearchParameter.multipleOr`| | *38 of 40 elements used* <br/>remaining elements:<br/>`SearchParameter.multipleAnd`, `SearchParameter.multipleOr`| | *37 of 45 elements used* <br/>remaining elements:<br/>`SearchParameter.constraint`, `SearchParameter.copyright`, `SearchParameter.copyrightLabel`, `SearchParameter.identifier`, `SearchParameter.multipleAnd`, `SearchParameter.multipleOr`, `SearchParameter.title`, `SearchParameter.versionAlgorithm[x]`
