...
| `Condition.abatement[x]` | `Condition.abatement[x]` | `abatement[x]` |  | If/when in resolution/remission | 0..1 | Age, boolean, dateTime, Period, Range, string |  |  |
| `Condition.assertedDate` | `Condition.assertedDate` | `assertedDate` |  | Date record was believed accurate | 0..1 | dateTime |  |  |
| `Condition.asserter` | `Condition.asserter` | `asserter` |  | Person who asserts this condition | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) |  |  |
...
| `Condition.category` | `Condition.category` | `category` |  | problem-list-item \| encounter-diagnosis | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/condition-category` |
| `Condition.clinicalStatus` | `Condition.clinicalStatus` | `clinicalStatus` |  | active \| recurrence \| inactive \| remission \| resolved | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/condition-clinical` |
| `Condition.code` | `Condition.code` | `code` |  | Identification of the condition, problem or diagnosis | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/condition-code` |
| `Condition.contained` | `Condition.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `Condition.context` | `Condition.context` | `context` |  | Encounter or episode when condition first asserted | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Encounter), Reference(http://hl7.org/fhir/StructureDefinition/EpisodeOfCare) |  |  |
| `Condition.evidence` | `Condition.evidence` | `evidence` |  | Supporting evidence | 0..* | BackboneElement |  |  |
| `Condition.evidence.code` | `Condition.evidence.code` | `code` |  | Manifestation/symptom | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/manifestation-or-symptom` |
...
| `Condition.evidence.id` | `Condition.evidence.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Condition.evidence.modifierExtension` | `Condition.evidence.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Condition.language` | `Condition.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `Condition.note` | `Condition.note` | `note` |  | Additional information about the Condition | 0..* | Annotation |  |  |
| `Condition.onset[x]` | `Condition.onset[x]` | `onset[x]` |  | Estimated or actual date,  date-time, or age | 0..1 | Age, dateTime, Period, Range, string |  |  |
...
| `Condition.stage.id` | `Condition.stage.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Condition.stage.modifierExtension` | `Condition.stage.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Condition.subject` | `Condition.subject` | `subject` |  | Who has the condition? | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Group), Reference(http://hl7.org/fhir/StructureDefinition/Patient) |  |  |
...
| `Condition.verificationStatus` | `Condition.verificationStatus` | `verificationStatus` |  | provisional \| differential \| confirmed \| refuted \| entered-in-error \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/condition-ver-status` |
### Mapping Table
...
This group is centered on the Structure Definition Condition from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Condition](/docs/R2/Resources/Condition.md)| Relationship | R3 Condition| Relationship | [R4 Condition](/docs/R4/Resources/Condition.md)| Relationship | [R4B Condition](/docs/R4B/Resources/Condition.md)| Relationship | [R5 Condition](/docs/R5/Resources/Condition.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
