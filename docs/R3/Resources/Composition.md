...
| `Composition.attester.id` | `Composition.attester.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
...
| `Composition.attester.modifierExtension` | `Composition.attester.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Composition.attester.time` | `Composition.attester.time` | `time` |  | When the composition was attested | 0..1 | dateTime |  |  |
...
| `Composition.confidentiality` | `Composition.confidentiality` | `confidentiality` |  | As defined by affinity domain | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/v3-ConfidentialityClassification` |
...
| `Composition.event.id` | `Composition.event.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Composition.event.modifierExtension` | `Composition.event.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
This group is centered on the Structure Definition Composition from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Composition](/docs/R2/Resources/Composition.md)| Relationship | R3 Composition| Relationship | [R4 Composition](/docs/R4/Resources/Composition.md)| Relationship | [R4B Composition](/docs/R4B/Resources/Composition.md)| Relationship | [R5 Composition](/docs/R5/Resources/Composition.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *46 of 46 elements used* | | *52 of 52 elements used* | | *52 of 54 elements used* | | *52 of 54 elements used* | | *44 of 51 elements used* 
