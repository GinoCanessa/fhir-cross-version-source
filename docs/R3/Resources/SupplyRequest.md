...
| `SupplyRequest.authoredOn` | `SupplyRequest.authoredOn` | `authoredOn` |  | When the request was made | 0..1 | dateTime |  |  |
| `SupplyRequest.category` | `SupplyRequest.category` | `category` |  | The kind of supply (central, non-stock, etc.) | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/supplyrequest-kind` |
| `SupplyRequest.contained` | `SupplyRequest.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `SupplyRequest.deliverFrom` | `SupplyRequest.deliverFrom` | `deliverFrom` |  | The origin of the supply | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Location), Reference(http://hl7.org/fhir/StructureDefinition/Organization) |  |  |
| `SupplyRequest.deliverTo` | `SupplyRequest.deliverTo` | `deliverTo` |  | The destination of the supply | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Location), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient) |  |  |
...
| `SupplyRequest.language` | `SupplyRequest.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `SupplyRequest.occurrence[x]` | `SupplyRequest.occurrence[x]` | `occurrence[x]` |  | When the request should be fulfilled | 0..1 | dateTime, Period, Timing |  |  |
| `SupplyRequest.orderedItem` | `SupplyRequest.orderedItem` | `orderedItem` |  | The item being requested | 0..1 | BackboneElement |  |  |
| `SupplyRequest.orderedItem.extension` | `SupplyRequest.orderedItem.extension` | `extension` | Element.extension | Additional Content defined by implementations | 0..* | Extension |  |  |
| `SupplyRequest.orderedItem.id` | `SupplyRequest.orderedItem.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `SupplyRequest.orderedItem.item[x]` | `SupplyRequest.orderedItem.item[x]` | `item[x]` |  | Medication, Substance, or Device requested to be supplied | 0..1 | CodeableConcept, Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Medication), Reference(http://hl7.org/fhir/StructureDefinition/Substance) | `Example` | `http://hl7.org/fhir/ValueSet/supply-item` |
| `SupplyRequest.orderedItem.modifierExtension` | `SupplyRequest.orderedItem.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `SupplyRequest.orderedItem.quantity` | `SupplyRequest.orderedItem.quantity` | `quantity` |  | The requested amount of the item indicated | 1..1 | Quantity |  |  |
| `SupplyRequest.priority` | `SupplyRequest.priority` | `priority` |  | routine \| urgent \| asap \| stat | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/request-priority` |
...
| `SupplyRequest.requester` | `SupplyRequest.requester` | `requester` |  | Who/what is requesting service | 0..1 | BackboneElement |  |  |
| `SupplyRequest.requester.agent` | `SupplyRequest.requester.agent` | `agent` |  | Individual making the request | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) |  |  |
| `SupplyRequest.requester.extension` | `SupplyRequest.requester.extension` | `extension` | Element.extension | Additional Content defined by implementations | 0..* | Extension |  |  |
| `SupplyRequest.requester.id` | `SupplyRequest.requester.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `SupplyRequest.requester.modifierExtension` | `SupplyRequest.requester.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `SupplyRequest.requester.onBehalfOf` | `SupplyRequest.requester.onBehalfOf` | `onBehalfOf` |  | Organization agent is acting for | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization) |  |  |
| `SupplyRequest.status` | `SupplyRequest.status` | `status` |  | draft \| active \| suspended + | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/supplyrequest-status` |
...
This group is centered on the Structure Definition SupplyRequest from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 SupplyRequest](/docs/R2/Resources/SupplyRequest.md)| Relationship | R3 SupplyRequest| Relationship | [R4 SupplyRequest](/docs/R4/Resources/SupplyRequest.md)| Relationship | [R4B SupplyRequest](/docs/R4B/Resources/SupplyRequest.md)| Relationship | [R5 SupplyRequest](/docs/R5/Resources/SupplyRequest.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| `SupplyRequest`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(8107)<hr/>←←←← __ ←←←← <br/>()| **`SupplyRequest`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(19020)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(19021)| `SupplyRequest`| _Equivalent_<br/>(33885/33886)| `SupplyRequest`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(48431)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(48432)| `SupplyRequest`
| `SupplyRequest.when`| →→→→ _RelatedTo_ →→→→ <br/>(430)<hr/>←←←← __ ←←←← <br/>()| **`SupplyRequest`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(19020)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(19021)| `SupplyRequest`| _Equivalent_<br/>(33885/33886)| `SupplyRequest`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(48431)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(48432)| `SupplyRequest`
...
| | | **`SupplyRequest.requester`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(19053)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(19054)| `SupplyRequest.requester`| _Equivalent_<br/>(33931/33932)| `SupplyRequest.requester`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(48475)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(48476)| `SupplyRequest.requester`
...
| *20 of 24 elements used* <br/>remaining elements:<br/>`SupplyRequest.when.code`, `SupplyRequest.when.extension`, `SupplyRequest.when.id`, `SupplyRequest.when.modifierExtension`| | *31 of 31 elements used* | | *23 of 29 elements used* <br/>remaining elements:<br/>`SupplyRequest.parameter`, `SupplyRequest.parameter.code`, `SupplyRequest.parameter.extension`, `SupplyRequest.parameter.id`, `SupplyRequest.parameter.modifierExtension`, `SupplyRequest.parameter.value[x]`| | *23 of 29 elements used* <br/>remaining elements:<br/>`SupplyRequest.parameter`, `SupplyRequest.parameter.code`, `SupplyRequest.parameter.extension`, `SupplyRequest.parameter.id`, `SupplyRequest.parameter.modifierExtension`, `SupplyRequest.parameter.value[x]`| | *22 of 30 elements used* <br/>remaining elements:<br/>`SupplyRequest.basedOn`, `SupplyRequest.deliverFor`, `SupplyRequest.parameter`, `SupplyRequest.parameter.code`, `SupplyRequest.parameter.extension`, `SupplyRequest.parameter.id`, `SupplyRequest.parameter.modifierExtension`, `SupplyRequest.parameter.value[x]`
