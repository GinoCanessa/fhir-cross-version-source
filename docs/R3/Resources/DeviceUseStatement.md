...
| `DeviceUseStatement.bodySite` | `DeviceUseStatement.bodySite` | `bodySite` |  | Target body site | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/body-site` |
...
| `DeviceUseStatement.device` | `DeviceUseStatement.device` | `device` |  | Reference to device used | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device) |  |  |
...
| `DeviceUseStatement.identifier` | `DeviceUseStatement.identifier` | `identifier` |  | External identifier for this record | 0..* | Identifier |  |  |
...
| `DeviceUseStatement.indication` | `DeviceUseStatement.indication` | `indication` |  | Why device was used | 0..* | CodeableConcept |  |  |
| `DeviceUseStatement.language` | `DeviceUseStatement.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `DeviceUseStatement.note` | `DeviceUseStatement.note` | `note` |  | Addition details (comments, instructions) | 0..* | Annotation |  |  |
| `DeviceUseStatement.recordedOn` | `DeviceUseStatement.recordedOn` | `recordedOn` |  | When statement was recorded | 0..1 | dateTime |  |  |
| `DeviceUseStatement.source` | `DeviceUseStatement.source` | `source` |  | Who made the statement | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) |  |  |
| `DeviceUseStatement.status` | `DeviceUseStatement.status` | `status` |  | active \| completed \| entered-in-error + | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/device-statement-status` |
| `DeviceUseStatement.subject` | `DeviceUseStatement.subject` | `subject` |  | Patient using device | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Group), Reference(http://hl7.org/fhir/StructureDefinition/Patient) |  |  |
...
| `DeviceUseStatement.timing[x]` | `DeviceUseStatement.timing[x]` | `timing[x]` |  | How often  the device was used | 0..1 | dateTime, Period, Timing |  |  |
| `DeviceUseStatement.whenUsed` | `DeviceUseStatement.whenUsed` | `whenUsed` |  | Period device was used | 0..1 | Period |  |  |
### Mapping Table
...
This group is centered on the Structure Definition DeviceUseStatement from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 DeviceUseStatement](/docs/R2/Resources/DeviceUseStatement.md)| Relationship | R3 DeviceUseStatement| Relationship | [R4 DeviceUseStatement](/docs/R4/Resources/DeviceUseStatement.md)| Relationship | [R4B DeviceUseStatement](/docs/R4B/Resources/DeviceUseStatement.md)| Relationship | [R5 DeviceUsage](/docs/R5/Resources/DeviceUsage.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *18 of 18 elements used* | | *20 of 20 elements used* | | *19 of 22 elements used* | | *19 of 22 elements used* | | *0 of 31 elements used* 
