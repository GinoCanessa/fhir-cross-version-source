...
| `Location.alias` | `Location.alias` | `alias` |  | A list of alternate names that the location is known as, or was known as in the past | 0..* | string |  |  |
| `Location.contained` | `Location.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `Location.description` | `Location.description` | `description` |  | Additional details about the location that could be displayed as further information to identify the location beyond its name | 0..1 | string |  |  |
| `Location.endpoint` | `Location.endpoint` | `endpoint` |  | Technical endpoints providing access to services operated for the location | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Endpoint) |  |  |
...
| `Location.language` | `Location.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `Location.operationalStatus` | `Location.operationalStatus` | `operationalStatus` |  | The Operational status of the location (typically only for a bed/room) | 0..1 | Coding | `Preferred` | `http://hl7.org/fhir/ValueSet/v2-0116` |
...
| `Location.position.id` | `Location.position.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
...
| `Location.position.modifierExtension` | `Location.position.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
This group is centered on the Structure Definition Location from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Location](/docs/R2/Resources/Location.md)| Relationship | R3 Location| Relationship | [R4 Location](/docs/R4/Resources/Location.md)| Relationship | [R4B Location](/docs/R4B/Resources/Location.md)| Relationship | [R5 Location](/docs/R5/Resources/Location.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *27 of 27 elements used* | | *30 of 30 elements used* | | *30 of 39 elements used* | | *30 of 39 elements used* | | *30 of 33 elements used* 
