...
| `Group.active` | `Group.active` | `active` |  | Whether this group's record is in active use | 0..1 | boolean |  |  |
...
| `Group.characteristic.id` | `Group.characteristic.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Group.characteristic.modifierExtension` | `Group.characteristic.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Group.language` | `Group.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `Group.member.id` | `Group.member.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Group.member.inactive` | `Group.member.inactive` | `inactive` |  | If member is no longer in group | 0..1 | boolean |  |  |
| `Group.member.modifierExtension` | `Group.member.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
This group is centered on the Structure Definition Group from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Group](/docs/R2/Resources/Group.md)| Relationship | R3 Group| Relationship | [R4 Group](/docs/R4/Resources/Group.md)| Relationship | [R4B Group](/docs/R4B/Resources/Group.md)| Relationship | [R5 Group](/docs/R5/Resources/Group.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *30 of 30 elements used* | | *31 of 31 elements used* | | *31 of 32 elements used* <br/>remaining elements:<br/>`Group.managingEntity`| | *31 of 32 elements used* <br/>remaining elements:<br/>`Group.managingEntity`| | *30 of 33 elements used* <br/>remaining elements:<br/>`Group.description`, `Group.managingEntity`, `Group.membership`
