...
| | | **`Task.definition[x]`**| →→→→ __ →→→→ <br/>(1294)<hr/>←←←← __ ←←←← <br/>()| `base64Binary`| | | | | 
...
| `Order.source`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(307)<hr/>←←←← __ ←←←← <br/>()| **`Task.requester.agent`**| →→→→ _RelatedTo_ →→→→ <br/>(1296)<hr/>←←←← _RelatedTo_ ←←←← <br/>(1683)| `Task.requester`| _Equivalent_<br/>(34116/34117)| `Task.requester`| _Equivalent_<br/>(48539/48540)| `Task.requester`
| `Order.target`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(309)<hr/>←←←← __ ←←←← <br/>()| **`Task.requester.agent`**| →→→→ _RelatedTo_ →→→→ <br/>(1296)<hr/>←←←← _RelatedTo_ ←←←← <br/>(1683)| `Task.requester`| _Equivalent_<br/>(34116/34117)| `Task.requester`| _Equivalent_<br/>(48539/48540)| `Task.requester`
