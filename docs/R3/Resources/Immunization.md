...
| `Immunization.explanation.extension` | `Immunization.explanation.extension` | `extension` | Element.extension | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Immunization.explanation.id` | `Immunization.explanation.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Immunization.explanation.modifierExtension` | `Immunization.explanation.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Immunization.language` | `Immunization.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `Immunization.notGiven` | `Immunization.notGiven` | `notGiven` |  | Flag for whether immunization was given | 1..1 | boolean |  |  |
...
| `Immunization.practitioner` | `Immunization.practitioner` | `practitioner` |  | Who performed event | 0..* | BackboneElement |  |  |
| `Immunization.practitioner.actor` | `Immunization.practitioner.actor` | `actor` |  | Individual who was performing | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Practitioner) |  |  |
| `Immunization.practitioner.extension` | `Immunization.practitioner.extension` | `extension` | Element.extension | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Immunization.practitioner.id` | `Immunization.practitioner.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Immunization.practitioner.modifierExtension` | `Immunization.practitioner.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Immunization.practitioner.role` | `Immunization.practitioner.role` | `role` |  | What type of performance was done | 0..1 | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/immunization-role` |
| `Immunization.primarySource` | `Immunization.primarySource` | `primarySource` |  | Indicates context the data was recorded in | 1..1 | boolean |  |  |
...
| `Immunization.reaction.id` | `Immunization.reaction.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Immunization.reaction.modifierExtension` | `Immunization.reaction.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Immunization.reaction.reported` | `Immunization.reaction.reported` | `reported` |  | Indicates self-reported reaction | 0..1 | boolean |  |  |
| `Immunization.reportOrigin` | `Immunization.reportOrigin` | `reportOrigin` |  | Indicates the source of a secondarily reported record | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/immunization-origin` |
...
| `Immunization.status` | `Immunization.status` | `status` |  | completed \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/immunization-status` |
...
| `Immunization.vaccinationProtocol.doseSequence` | `Immunization.vaccinationProtocol.doseSequence` | `doseSequence` |  | Dose number within series | 0..1 | positiveInt |  |  |
...
| `Immunization.vaccinationProtocol.extension` | `Immunization.vaccinationProtocol.extension` | `extension` | Element.extension | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Immunization.vaccinationProtocol.id` | `Immunization.vaccinationProtocol.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Immunization.vaccinationProtocol.modifierExtension` | `Immunization.vaccinationProtocol.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
This group is centered on the Structure Definition Immunization from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Immunization](/docs/R2/Resources/Immunization.md)| Relationship | R3 Immunization| Relationship | [R4 Immunization](/docs/R4/Resources/Immunization.md)| Relationship | [R4B Immunization](/docs/R4B/Resources/Immunization.md)| Relationship | [R5 Immunization](/docs/R5/Resources/Immunization.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *51 of 52 elements used* | | *57 of 57 elements used* | | *43 of 63 elements used* | | *43 of 63 elements used* | | *42 of 61 elements used* 
