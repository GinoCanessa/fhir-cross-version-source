...
| `OperationOutcome.issue.expression` | `OperationOutcome.issue.expression` | `expression` |  | FHIRPath of element(s) related to issue | 0..* | string |  |  |
...
| `OperationOutcome.issue.id` | `OperationOutcome.issue.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `OperationOutcome.issue.location` | `OperationOutcome.issue.location` | `location` |  | Path of element(s) related to issue | 0..* | string |  |  |
| `OperationOutcome.issue.modifierExtension` | `OperationOutcome.issue.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `OperationOutcome.language` | `OperationOutcome.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [OperationOutcome](/docs/R2/Resources/OperationOutcome.md)<br/> `http://hl7.org/fhir/StructureDefinition/OperationOutcome\|1.0.2` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `134`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `300`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [OperationOutcome](/docs/R3/Resources/OperationOutcome.md)<br/> `http://hl7.org/fhir/StructureDefinition/OperationOutcome\|3.0.2` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `491`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `685`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [OperationOutcome](/docs/R4/Resources/OperationOutcome.md)<br/> `http://hl7.org/fhir/StructureDefinition/OperationOutcome\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1563`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1564`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [OperationOutcome](/docs/R4B/Resources/OperationOutcome.md)<br/> `http://hl7.org/fhir/StructureDefinition/OperationOutcome\|4.3.0` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `1017`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1246`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [OperationOutcome](/docs/R5/Resources/OperationOutcome.md)<br/> `http://hl7.org/fhir/StructureDefinition/OperationOutcome\|5.0.0` 
