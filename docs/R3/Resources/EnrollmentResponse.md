...
| `EnrollmentResponse.language` | `EnrollmentResponse.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `EnrollmentResponse.outcome` | `EnrollmentResponse.outcome` | `outcome` |  | complete \| error \| partial | 0..1 | CodeableConcept | `Required` | `http://hl7.org/fhir/ValueSet/remittance-outcome` |
...
| `EnrollmentResponse.status` | `EnrollmentResponse.status` | `status` |  | active \| cancelled \| draft \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/fm-status` |
...
This group is centered on the Structure Definition EnrollmentResponse from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 EnrollmentResponse](/docs/R2/Resources/EnrollmentResponse.md)| Relationship | R3 EnrollmentResponse| Relationship | [R4 EnrollmentResponse](/docs/R4/Resources/EnrollmentResponse.md)| Relationship | [R4B EnrollmentResponse](/docs/R4B/Resources/EnrollmentResponse.md)| Relationship | [R5 EnrollmentResponse](/docs/R5/Resources/EnrollmentResponse.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
