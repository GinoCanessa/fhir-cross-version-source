...
| | | **`ActivityDefinition.contributor`**| →→→→ _Equivalent_ →→→→ <br/>(21434)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(1339)| `base64Binary`| | | | | 
| | | **`ActivityDefinition.contributor`**| →→→→ _Equivalent_ →→→→ <br/>(21434)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(1339)| `ActivityDefinition.author`| _Equivalent_<br/>(21504/21505)| `ActivityDefinition.author`| _Equivalent_<br/>(36553/36554)| `ActivityDefinition.author`
| | | **`ActivityDefinition.contributor`**| →→→→ _Equivalent_ →→→→ <br/>(21434)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(1339)| `ActivityDefinition.editor`| _Equivalent_<br/>(21506/21507)| `ActivityDefinition.editor`| _Equivalent_<br/>(36555/36556)| `ActivityDefinition.editor`
| | | **`ActivityDefinition.contributor`**| →→→→ _Equivalent_ →→→→ <br/>(21434)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(1339)| `ActivityDefinition.reviewer`| _Equivalent_<br/>(21508/21509)| `ActivityDefinition.reviewer`| _Equivalent_<br/>(36557/36558)| `ActivityDefinition.reviewer`
