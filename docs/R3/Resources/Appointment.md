...
| `Appointment.appointmentType` | `Appointment.appointmentType` | `appointmentType` |  | The style of appointment or patient that has been booked in the slot (not service type) | 0..1 | CodeableConcept | `Preferred` | `http://hl7.org/fhir/ValueSet/v2-0276` |
...
| `Appointment.created` | `Appointment.created` | `created` |  | The date that this appointment was initially created | 0..1 | dateTime |  |  |
...
| `Appointment.incomingReferral` | `Appointment.incomingReferral` | `incomingReferral` |  | The ReferralRequest provided as information to allocate to the Encounter | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/ReferralRequest) |  |  |
| `Appointment.indication` | `Appointment.indication` | `indication` |  | Reason the appointment is to takes place (resource) | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Condition), Reference(http://hl7.org/fhir/StructureDefinition/Procedure) |  |  |
| `Appointment.language` | `Appointment.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `Appointment.participant.id` | `Appointment.participant.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Appointment.participant.modifierExtension` | `Appointment.participant.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Appointment.participant.type` | `Appointment.participant.type` | `type` |  | Role of participant in the appointment | 0..* | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/encounter-participant-type` |
...
| `Appointment.reason` | `Appointment.reason` | `reason` |  | Reason this appointment is scheduled | 0..* | CodeableConcept | `Preferred` | `http://hl7.org/fhir/ValueSet/encounter-reason` |
| `Appointment.requestedPeriod` | `Appointment.requestedPeriod` | `requestedPeriod` |  | Potential date/time interval(s) requested to allocate the appointment within | 0..* | Period |  |  |
| `Appointment.serviceCategory` | `Appointment.serviceCategory` | `serviceCategory` |  | A broad categorisation of the service that is to be performed during this appointment | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/service-category` |
| `Appointment.serviceType` | `Appointment.serviceType` | `serviceType` |  | The specific service that is to be performed during this appointment | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/service-type` |
| `Appointment.slot` | `Appointment.slot` | `slot` |  | The slots that this appointment is filling | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Slot) |  |  |
| `Appointment.specialty` | `Appointment.specialty` | `specialty` |  | The specialty of a practitioner that would be required to perform the service requested in this appointment | 0..* | CodeableConcept | `Preferred` | `http://hl7.org/fhir/ValueSet/c80-practice-codes` |
| `Appointment.start` | `Appointment.start` | `start` |  | When appointment is to take place | 0..1 | instant |  |  |
| `Appointment.status` | `Appointment.status` | `status` |  | proposed \| pending \| booked \| arrived \| fulfilled \| cancelled \| noshow \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/appointmentstatus` |
| `Appointment.supportingInformation` | `Appointment.supportingInformation` | `supportingInformation` |  | Additional information to support the appointment | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Resource) |  |  |
...
This group is centered on the Structure Definition Appointment from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Appointment](/docs/R2/Resources/Appointment.md)| Relationship | R3 Appointment| Relationship | [R4 Appointment](/docs/R4/Resources/Appointment.md)| Relationship | [R4B Appointment](/docs/R4B/Resources/Appointment.md)| Relationship | [R5 Appointment](/docs/R5/Resources/Appointment.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *28 of 28 elements used* | | *36 of 36 elements used* | | *36 of 39 elements used* | | *36 of 39 elements used* | | *35 of 84 elements used* 
