...
| `AppointmentResponse.language` | `AppointmentResponse.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `AppointmentResponse.participantStatus` | `AppointmentResponse.participantStatus` | `participantStatus` |  | accepted \| declined \| tentative \| in-process \| completed \| needs-action \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/participationstatus` |
| `AppointmentResponse.participantType` | `AppointmentResponse.participantType` | `participantType` |  | Role of participant in the appointment | 0..* | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/encounter-participant-type` |
...
This group is centered on the Structure Definition AppointmentResponse from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 AppointmentResponse](/docs/R2/Resources/AppointmentResponse.md)| Relationship | R3 AppointmentResponse| Relationship | [R4 AppointmentResponse](/docs/R4/Resources/AppointmentResponse.md)| Relationship | [R4B AppointmentResponse](/docs/R4B/Resources/AppointmentResponse.md)| Relationship | [R5 AppointmentResponse](/docs/R5/Resources/AppointmentResponse.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
