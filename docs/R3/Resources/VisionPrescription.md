...
| `VisionPrescription.dispense.brand` | `VisionPrescription.dispense.brand` | `brand` |  | Brand required | 0..1 | string |  |  |
| `VisionPrescription.dispense.color` | `VisionPrescription.dispense.color` | `color` |  | Color required | 0..1 | string |  |  |
...
| `VisionPrescription.dispense.extension` | `VisionPrescription.dispense.extension` | `extension` | Element.extension | Additional Content defined by implementations | 0..* | Extension |  |  |
...
| `VisionPrescription.dispense.id` | `VisionPrescription.dispense.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `VisionPrescription.dispense.modifierExtension` | `VisionPrescription.dispense.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `VisionPrescription.dispense.note` | `VisionPrescription.dispense.note` | `note` |  | Notes for coatings | 0..* | Annotation |  |  |
...
| `VisionPrescription.dispense.product` | `VisionPrescription.dispense.product` | `product` |  | Product to be supplied | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/vision-product` |
...
| `VisionPrescription.language` | `VisionPrescription.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `VisionPrescription.status` | `VisionPrescription.status` | `status` |  | active \| cancelled \| draft \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/fm-status` |
...
This group is centered on the Structure Definition VisionPrescription from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 VisionPrescription](/docs/R2/Resources/VisionPrescription.md)| Relationship | R3 VisionPrescription| Relationship | [R4 VisionPrescription](/docs/R4/Resources/VisionPrescription.md)| Relationship | [R4B VisionPrescription](/docs/R4B/Resources/VisionPrescription.md)| Relationship | [R5 VisionPrescription](/docs/R5/Resources/VisionPrescription.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *34 of 34 elements used* | | *35 of 35 elements used* | | *31 of 39 elements used* | | *31 of 39 elements used* | | *31 of 39 elements used* 
