...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [Communication](/docs/R2/Resources/Communication.md)<br/> `http://hl7.org/fhir/StructureDefinition/Communication\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `86`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `253`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Communication](/docs/R3/Resources/Communication.md)<br/> `http://hl7.org/fhir/StructureDefinition/Communication\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `434`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `630`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Communication](/docs/R4/Resources/Communication.md)<br/> `http://hl7.org/fhir/StructureDefinition/Communication\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1431`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1432`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Communication](/docs/R4B/Resources/Communication.md)<br/> `http://hl7.org/fhir/StructureDefinition/Communication\|4.3.0` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `950`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `1179`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Communication](/docs/R5/Resources/Communication.md)<br/> `http://hl7.org/fhir/StructureDefinition/Communication\|5.0.0` 
...
| | | **`Communication.definition`**| →→→→ __ →→→→ <br/>(894)<hr/>←←←← __ ←←←← <br/>()| `base64Binary`| | | | | 
...
| | | **`Communication.notDone`**| →→→→ __ →→→→ <br/>(895)<hr/>←←←← __ ←←←← <br/>()| `base64Binary`| | | | | 
...
| | | **`Communication.notDoneReason`**| →→→→ __ →→→→ <br/>(896)<hr/>←←←← __ ←←←← <br/>()| `base64Binary`| | | | | 
...
| | | **`Communication.topic`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(897)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(12036)| `Communication.extension`| _Equivalent_<br/>(23825/23826)| `Communication.extension`| _Equivalent_<br/>(39145/39146)| `Communication.extension`
