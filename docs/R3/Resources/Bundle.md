...
| `Bundle.entry.id` | `Bundle.entry.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Bundle.entry.link` | `Bundle.entry.link` | `link` |  | Links related to this entry | 0..* | Bundle.link |  |  |
| `Bundle.entry.modifierExtension` | `Bundle.entry.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Bundle.entry.request.id` | `Bundle.entry.request.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
...
| `Bundle.entry.request.modifierExtension` | `Bundle.entry.request.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Bundle.entry.response.id` | `Bundle.entry.response.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
...
| `Bundle.entry.response.modifierExtension` | `Bundle.entry.response.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Bundle.entry.response.outcome` | `Bundle.entry.response.outcome` | `outcome` |  | OperationOutcome with hints and warnings (for batch/transaction) | 0..1 | Resource |  |  |
| `Bundle.entry.response.status` | `Bundle.entry.response.status` | `status` |  | Status response code (text optional) | 1..1 | string |  |  |
...
| `Bundle.entry.search.id` | `Bundle.entry.search.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
...
| `Bundle.entry.search.modifierExtension` | `Bundle.entry.search.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Bundle.identifier` | `Bundle.identifier` | `identifier` |  | Persistent identifier for the bundle | 0..1 | Identifier |  |  |
...
| `Bundle.language` | `Bundle.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Extensible` | `http://hl7.org/fhir/ValueSet/languages` |
...
| `Bundle.link.id` | `Bundle.link.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Bundle.link.modifierExtension` | `Bundle.link.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Bundle.link.relation` | `Bundle.link.relation` | `relation` |  | See http://www.iana.org/assignments/link-relations/link-relations.xhtml#link-relations-1 | 1..1 | string |  |  |
...
This group is centered on the Structure Definition Bundle from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Bundle](/docs/R2/Resources/Bundle.md)| Relationship | R3 Bundle| Relationship | [R4 Bundle](/docs/R4/Resources/Bundle.md)| Relationship | [R4B Bundle](/docs/R4B/Resources/Bundle.md)| Relationship | [R5 Bundle](/docs/R5/Resources/Bundle.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
