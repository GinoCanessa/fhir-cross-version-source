...
| | | **`Measure.contributor`**| →→→→ __ →→→→ <br/>(1148)<hr/>←←←← __ ←←←← <br/>()| `base64Binary`| | | | | 
...
| | | **`Measure.group.identifier`**| →→→→ __ →→→→ <br/>(1149)<hr/>←←←← __ ←←←← <br/>()| `base64Binary`| | | | | 
...
| | | **`Measure.group.stratifier.identifier`**| →→→→ __ →→→→ <br/>(1153)<hr/>←←←← __ ←←←← <br/>()| `base64Binary`| | | | | 
...
| | | **`Measure.supplementalData.identifier`**| →→→→ __ →→→→ <br/>(1156)<hr/>←←←← __ ←←←← <br/>()| `base64Binary`| | | | | 
