...
| `ParameterDefinition.documentation` | `ParameterDefinition.documentation` | `documentation` |  | A brief description of the parameter | 0..1 | string |  |  |
...
| `ParameterDefinition.id` | `ParameterDefinition.id` | `id` | Element.id | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `ParameterDefinition.max` | `ParameterDefinition.max` | `max` |  | Maximum cardinality (a number of *) | 0..1 | string |  |  |
| `ParameterDefinition.min` | `ParameterDefinition.min` | `min` |  | Minimum cardinality | 0..1 | integer |  |  |
| `ParameterDefinition.name` | `ParameterDefinition.name` | `name` |  | Name used to access the parameter value | 0..1 | code |  |  |
| `ParameterDefinition.profile` | `ParameterDefinition.profile` | `profile` |  | What profile the value is expected to be | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/StructureDefinition) |  |  |
| `ParameterDefinition.type` | `ParameterDefinition.type` | `type` |  | What type of value | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-types` |
| `ParameterDefinition.use` | `ParameterDefinition.use` | `use` |  | in \| out | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/operation-parameter-use` |
### Mapping Table
...
This group is centered on the Structure Definition ParameterDefinition from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | R3 ParameterDefinition| Relationship | [R4 ParameterDefinition](/docs/R4/ComplexTypes/ParameterDefinition.md)| Relationship | [R4B ParameterDefinition](/docs/R4B/ComplexTypes/ParameterDefinition.md)| Relationship | [R5 ParameterDefinition](/docs/R5/ComplexTypes/ParameterDefinition.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
