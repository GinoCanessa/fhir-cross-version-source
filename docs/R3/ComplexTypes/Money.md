...
| | | **`Money.comparator`**| | | | | | | 
| | | **`Money.unit`**| →→→→ _Equivalent_ →→→→ <br/>(21064)<hr/>←←←← _RelatedTo_ ←←←← <br/>(1710)| `base64Binary`| | | | | 
...
| *0 of 8 elements used* | | *8 of 8 elements used* | | *6 of 5 elements used* | | *5 of 5 elements used* | | *5 of 5 elements used* 
