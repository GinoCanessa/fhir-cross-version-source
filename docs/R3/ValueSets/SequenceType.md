...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Sequence` | `Sequence.type` | `http://hl7.org/fhir/ValueSet/sequence-type` | `Example` | aa \| dna \| rna |
...
This group is centered on the Value Set sequenceType from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | R3 sequenceType| Relationship | [R4 sequenceType](/docs/R4/ValueSets/SequenceType.md)| Relationship | [R4B sequenceType](/docs/R4B/ValueSets/SequenceType.md)| Relationship | [R5 SequenceType](/docs/R5/ValueSets/SequenceType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/sequence-type`
