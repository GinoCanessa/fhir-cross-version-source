...
| | | **`enrolled`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4570)<hr/>←←←← _Equivalent_ ←←←← <br/>(6876) | `on-study`| _Equivalent_ <br/>(17062/17063)| `on-study`| | | 
...
| | | **`suspended`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4571)<hr/>←←←← _Equivalent_ ←←←← <br/>(6871) | `follow-up`| _Equivalent_ <br/>(17054/17055)| `follow-up`| | | 
