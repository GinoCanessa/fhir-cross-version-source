...
This group is centered on the Value Set GroupType from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 GroupType](/docs/R2/ValueSets/GroupType.md)| Relationship | R3 GroupType| Relationship | [R4 GroupType](/docs/R4/ValueSets/GroupType.md)| Relationship | [R4B GroupType](/docs/R4B/ValueSets/GroupType.md)| Relationship | [R5 GroupType](/docs/R5/ValueSets/GroupType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/group-type`
