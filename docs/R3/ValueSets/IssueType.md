...
This group is centered on the Value Set IssueType from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 IssueType](/docs/R2/ValueSets/IssueType.md)| Relationship | R3 IssueType| Relationship | [R4 IssueType](/docs/R4/ValueSets/IssueType.md)| Relationship | [R4B IssueType](/docs/R4B/ValueSets/IssueType.md)| Relationship | [R5 IssueType](/docs/R5/ValueSets/IssueType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/issue-type`
