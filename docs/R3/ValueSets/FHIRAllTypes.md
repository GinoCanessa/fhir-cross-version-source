...
| Database Key | `1052` |
| Database Concept Count | `175` |
| Database Active Concept Count | `175` |
### Bindings

| Source | Element | Binding | Strength | Element Short |
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/DataRequirement` | `DataRequirement.type` | `http://hl7.org/fhir/ValueSet/all-types` | `Required` | The type of the required data |
| `http://hl7.org/fhir/StructureDefinition/ParameterDefinition` | `ParameterDefinition.type` | `http://hl7.org/fhir/ValueSet/all-types` | `Required` | What type of value |
| `http://hl7.org/fhir/StructureDefinition/OperationDefinition` | `OperationDefinition.parameter.type` | `http://hl7.org/fhir/ValueSet/all-types` | `Required` | What type this parameter has |
...
This group is centered on the Value Set FHIRAllTypes from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | R3 FHIRAllTypes| Relationship | [R4 FHIRAllTypes](/docs/R4/ValueSets/FHIRAllTypes.md)| Relationship | [R4B FHIRAllTypes](/docs/R4B/ValueSets/FHIRAllTypes.md)| Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| | | *175 of 175 codes used* | | *162 of 213 codes used* | | *162 of 209 codes used* | | 
