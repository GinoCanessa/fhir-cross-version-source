...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Flag` | `Flag.status` | `http://hl7.org/fhir/ValueSet/flag-status` | `Required` | active \| inactive \| entered-in-error |
...
This group is centered on the Value Set FlagStatus from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 FlagStatus](/docs/R2/ValueSets/FlagStatus.md)| Relationship | R3 FlagStatus| Relationship | [R4 FlagStatus](/docs/R4/ValueSets/FlagStatus.md)| Relationship | [R4B FlagStatus](/docs/R4B/ValueSets/FlagStatus.md)| Relationship | [R5 FlagStatus](/docs/R5/ValueSets/FlagStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/flag-status`
