...
| VS Name | v2 Bed Status |
| Canonical URL | `http://hl7.org/fhir/ValueSet/v2-0116` |
| Version | 2.8.2 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Location` | `Location.operationalStatus` | `http://hl7.org/fhir/ValueSet/v2-0116` | `Preferred` | The Operational status of the location (typically only for a bed/room) |
