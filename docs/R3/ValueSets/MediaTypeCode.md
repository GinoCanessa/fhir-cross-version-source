...
This group is centered on the Value Set Media Type Code from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 Media Type Code](/docs/R2/ValueSets/MediaTypeCode.md)| Relationship | R3 Media Type Code| Relationship | [R4 MediaTypeCode](/docs/R4/ValueSets/MediaTypeCode.md)| Relationship | *No Map* | Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
