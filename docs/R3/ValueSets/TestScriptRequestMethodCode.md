...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/TestScript` | `TestScript.setup.action.assert.requestMethod` | `http://hl7.org/fhir/ValueSet/http-operations` | `Required` | delete \| get \| options \| patch \| post \| put |
...
This group is centered on the Value Set TestScriptRequestMethodCode from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | R3 TestScriptRequestMethodCode| Relationship | [R4 TestScriptRequestMethodCode](/docs/R4/ValueSets/TestScriptRequestMethodCode.md)| Relationship | [R4B TestScriptRequestMethodCode](/docs/R4B/ValueSets/TestScriptRequestMethodCode.md)| Relationship | [R5 TestScriptRequestMethodCode](/docs/R5/ValueSets/TestScriptRequestMethodCode.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/http-operations`
