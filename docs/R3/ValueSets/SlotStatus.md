...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Slot` | `Slot.status` | `http://hl7.org/fhir/ValueSet/slotstatus` | `Required` | busy \| free \| busy-unavailable \| busy-tentative \| entered-in-error |
...
This group is centered on the Value Set SlotStatus from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 SlotStatus](/docs/R2/ValueSets/SlotStatus.md)| Relationship | R3 SlotStatus| Relationship | [R4 SlotStatus](/docs/R4/ValueSets/SlotStatus.md)| Relationship | [R4B SlotStatus](/docs/R4B/ValueSets/SlotStatus.md)| Relationship | [R5 SlotStatus](/docs/R5/ValueSets/SlotStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/slotstatus`
