...
| Database Key | `1176` |
| Database Concept Count | `173` |
| Database Active Concept Count | `173` |
### Bindings
...
This group is centered on the Value Set FHIRDefinedType from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 FHIRDefinedType](/docs/R2/ValueSets/FHIRDefinedType.md)| Relationship | R3 FHIRDefinedType| Relationship | [R4 FHIRDefinedType](/docs/R4/ValueSets/FHIRDefinedType.md)| Relationship | [R4B FHIRDefinedType](/docs/R4B/ValueSets/FHIRDefinedType.md)| Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/data-types`
