...
This group is centered on the Value Set SubscriptionStatus from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 SubscriptionStatus](/docs/R2/ValueSets/SubscriptionStatus.md)| Relationship | R3 SubscriptionStatus| Relationship | [R4 SubscriptionStatus](/docs/R4/ValueSets/SubscriptionStatus.md)| Relationship | [R4B SubscriptionStatusCodes](/docs/R4B/ValueSets/SubscriptionStatusCodes.md)| Relationship | [R5 SubscriptionStatusCodes](/docs/R5/ValueSets/SubscriptionStatusCodes.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/subscription-status`
