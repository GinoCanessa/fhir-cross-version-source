...
This group is centered on the Value Set ConditionVerificationStatus from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 ConditionVerificationStatus](/docs/R2/ValueSets/ConditionVerificationStatus.md)| Relationship | R3 ConditionVerificationStatus| Relationship | [R4 ConditionVerificationStatus](/docs/R4/ValueSets/ConditionVerificationStatus.md)| Relationship | [R4B ConditionVerificationStatus](/docs/R4B/ValueSets/ConditionVerificationStatus.md)| Relationship | [R5 ConditionVerificationStatus](/docs/R5/ValueSets/ConditionVerificationStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/condition-ver-status`
