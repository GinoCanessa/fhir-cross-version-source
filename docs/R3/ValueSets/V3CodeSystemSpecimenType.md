...
| `http://hl7.org/fhir/v3/SpecimenType` | `BRN` | Burn |
...
| `http://hl7.org/fhir/v3/SpecimenType` | `GENV` | Genital vaginal |
...
| `http://hl7.org/fhir/v3/SpecimenType` | `SNV` | Synovial fluid (Joint fluid) |
