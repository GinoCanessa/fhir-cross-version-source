...
| `in-progress`| _Equivalent_ <br/>(569/1925)| **`in-progress`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(3720)<hr/>←←←← _Equivalent_ ←←←← <br/>(6004) | `active`| _Equivalent_ <br/>(16068/16069)| `active`| _Equivalent_ <br/>(8302/10607)| `active`
| | | **`on-target`**| | | | | | | 
...
| `sustaining`| _Equivalent_ <br/>(562/1931)| **`sustaining`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(3726)<hr/>←←←← _Equivalent_ ←←←← <br/>(6005) | `active`| _Equivalent_ <br/>(16068/16069)| `active`| _Equivalent_ <br/>(8302/10607)| `active`
