...
This group is centered on the Value Set EventTiming from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 EventTiming](/docs/R2/ValueSets/EventTiming.md)| Relationship | R3 EventTiming| Relationship | [R4 EventTiming](/docs/R4/ValueSets/EventTiming.md)| Relationship | [R4B EventTiming](/docs/R4B/ValueSets/EventTiming.md)| Relationship | [R5 EventTiming](/docs/R5/ValueSets/EventTiming.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/event-timing`
...
| <td colspan="8">**R3** System: `http://hl7.org/fhir/v3/TimingEvent`
