...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/SearchParameter` | `SearchParameter.comparator` | `http://hl7.org/fhir/ValueSet/search-comparator` | `Required` | eq \| ne \| gt \| lt \| ge \| le \| sa \| eb \| ap |
...
This group is centered on the Value Set SearchComparator from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | R3 SearchComparator| Relationship | [R4 SearchComparator](/docs/R4/ValueSets/SearchComparator.md)| Relationship | [R4B SearchComparator](/docs/R4B/ValueSets/SearchComparator.md)| Relationship | [R5 SearchComparator](/docs/R5/ValueSets/SearchComparator.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/search-comparator`
