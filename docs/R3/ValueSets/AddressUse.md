...
This group is centered on the Value Set AddressUse from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 AddressUse](/docs/R2/ValueSets/AddressUse.md)| Relationship | R3 AddressUse| Relationship | [R4 AddressUse](/docs/R4/ValueSets/AddressUse.md)| Relationship | [R4B AddressUse](/docs/R4B/ValueSets/AddressUse.md)| Relationship | [R5 AddressUse](/docs/R5/ValueSets/AddressUse.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/address-use`
