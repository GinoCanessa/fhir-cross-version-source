...
| VS Name | Contract Resource Status Codes |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Contract` | `Contract.status` | `http://hl7.org/fhir/ValueSet/contract-status` | `Required` | amended \| appended \| cancelled \| disputed \| entered-in-error \| executable \| executed \| negotiable \| offered \| policy \| rejected \| renewed \| revoked \| resolved \| terminated |
...
This group is centered on the Value Set Contract Resource Status Codes from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | R3 Contract Resource Status Codes| Relationship | [R4 ContractResourceStatusCodes](/docs/R4/ValueSets/ContractResourceStatusCodes.md)| Relationship | [R4B ContractResourceStatusCodes](/docs/R4B/ValueSets/ContractResourceStatusCodes.md)| Relationship | [R5 ContractResourceStatusCodes](/docs/R5/ValueSets/ContractResourceStatusCodes.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/contract-status`
