...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/StructureMap` | `StructureMap.group.rule.target.transform` | `http://hl7.org/fhir/ValueSet/map-transform` | `Required` | create \| copy + |
...
This group is centered on the Value Set StructureMapTransform from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | R3 StructureMapTransform| Relationship | [R4 StructureMapTransform](/docs/R4/ValueSets/StructureMapTransform.md)| Relationship | [R4B StructureMapTransform](/docs/R4B/ValueSets/StructureMapTransform.md)| Relationship | [R5 StructureMapTransform](/docs/R5/ValueSets/StructureMapTransform.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/map-transform`
