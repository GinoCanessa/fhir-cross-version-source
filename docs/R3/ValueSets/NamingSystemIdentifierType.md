...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/NamingSystem` | `NamingSystem.uniqueId.type` | `http://hl7.org/fhir/ValueSet/namingsystem-identifier-type` | `Required` | oid \| uuid \| uri \| other |
...
This group is centered on the Value Set NamingSystemIdentifierType from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 NamingSystemIdentifierType](/docs/R2/ValueSets/NamingSystemIdentifierType.md)| Relationship | R3 NamingSystemIdentifierType| Relationship | [R4 NamingSystemIdentifierType](/docs/R4/ValueSets/NamingSystemIdentifierType.md)| Relationship | [R4B NamingSystemIdentifierType](/docs/R4B/ValueSets/NamingSystemIdentifierType.md)| Relationship | [R5 NamingSystemIdentifierType](/docs/R5/ValueSets/NamingSystemIdentifierType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/namingsystem-identifier-type`
