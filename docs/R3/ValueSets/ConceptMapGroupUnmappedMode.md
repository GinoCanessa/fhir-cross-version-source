...
| VS Name | ConceptMapGroupUnmappedMode |
| Canonical URL | `http://hl7.org/fhir/ValueSet/conceptmap-unmapped-mode` |
| Version | 3.0.2 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/ConceptMap` | `ConceptMap.group.unmapped.mode` | `http://hl7.org/fhir/ValueSet/conceptmap-unmapped-mode` | `Required` | provided \| fixed \| other-map |
...
This group is centered on the Value Set ConceptMapGroupUnmappedMode from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | R3 ConceptMapGroupUnmappedMode| Relationship | [R4 ConceptMapGroupUnmappedMode](/docs/R4/ValueSets/ConceptMapGroupUnmappedMode.md)| Relationship | [R4B ConceptMapGroupUnmappedMode](/docs/R4B/ValueSets/ConceptMapGroupUnmappedMode.md)| Relationship | [R5 ConceptMapGroupUnmappedMode](/docs/R5/ValueSets/ConceptMapGroupUnmappedMode.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/conceptmap-unmapped-mode`
