...
This group is centered on the Value Set CompositionStatus from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 CompositionStatus](/docs/R2/ValueSets/CompositionStatus.md)| Relationship | R3 CompositionStatus| Relationship | [R4 CompositionStatus](/docs/R4/ValueSets/CompositionStatus.md)| Relationship | [R4B CompositionStatus](/docs/R4B/ValueSets/CompositionStatus.md)| Relationship | [R5 CompositionStatus](/docs/R5/ValueSets/CompositionStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/composition-status`
