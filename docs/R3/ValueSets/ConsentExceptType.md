...
| VS Name | ConsentExceptType |
| Canonical URL | `http://hl7.org/fhir/ValueSet/consent-except-type` |
| Version | 3.0.2 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Consent` | `Consent.except.type` | `http://hl7.org/fhir/ValueSet/consent-except-type` | `Required` | deny \| permit |

### Referenced Systems

* `http://hl7.org/fhir/consent-except-type`
### Mapping Table
...
This group is centered on the Value Set ConsentExceptType from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | R3 ConsentExceptType| Relationship | [R4 ConsentProvisionType](/docs/R4/ValueSets/ConsentProvisionType.md)| Relationship | [R4B ConsentProvisionType](/docs/R4B/ValueSets/ConsentProvisionType.md)| Relationship | [R5 ConsentProvisionType](/docs/R5/ValueSets/ConsentProvisionType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/consent-except-type`
