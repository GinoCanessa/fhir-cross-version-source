...
| Canonical URL | `http://hl7.org/fhir/ValueSet/allergy-verification-status` |
| Version | 3.0.2 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/AllergyIntolerance` | `AllergyIntolerance.verificationStatus` | `http://hl7.org/fhir/ValueSet/allergy-verification-status` | `Required` | unconfirmed \| confirmed \| refuted \| entered-in-error |
