...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/messageheader-response-request` | `Extension.valueCode` | `http://hl7.org/fhir/ValueSet/messageheader-response-request` | `Required` | Value of extension |
...
This group is centered on the Value Set messageheader-response-request from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | R3 messageheader-response-request| Relationship | [R4 messageheader-response-request](/docs/R4/ValueSets/MessageheaderResponseRequest.md)| Relationship | [R4B messageheader-response-request](/docs/R4B/ValueSets/MessageheaderResponseRequest.md)| Relationship | [R5 MessageheaderResponseRequest](/docs/R5/ValueSets/MessageheaderResponseRequest.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/messageheader-response-request`
