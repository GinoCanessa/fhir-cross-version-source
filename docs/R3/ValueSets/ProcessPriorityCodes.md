...
| VS Name | Process Priority Codes |
...
| `http://hl7.org/fhir/StructureDefinition/EligibilityRequest` | `EligibilityRequest.priority` | `http://hl7.org/fhir/ValueSet/process-priority` | `Example` | Desired processing priority |
