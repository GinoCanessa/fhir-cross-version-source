...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/CodeSystem` | `CodeSystem.property.type` | `http://hl7.org/fhir/ValueSet/concept-property-type` | `Required` | code \| Coding \| string \| integer \| boolean \| dateTime |
...
This group is centered on the Value Set PropertyType from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | R3 PropertyType| Relationship | [R4 PropertyType](/docs/R4/ValueSets/PropertyType.md)| Relationship | [R4B PropertyType](/docs/R4B/ValueSets/PropertyType.md)| Relationship | [R5 PropertyType](/docs/R5/ValueSets/PropertyType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/concept-property-type`
