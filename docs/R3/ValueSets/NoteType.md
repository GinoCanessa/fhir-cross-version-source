...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/ClaimResponse` | `ClaimResponse.processNote.type` | `http://hl7.org/fhir/ValueSet/note-type` | `Required` | display \| print \| printoper |
| `http://hl7.org/fhir/StructureDefinition/ExplanationOfBenefit` | `ExplanationOfBenefit.processNote.type` | `http://hl7.org/fhir/ValueSet/note-type` | `Required` | display \| print \| printoper |
| `http://hl7.org/fhir/StructureDefinition/PaymentReconciliation` | `PaymentReconciliation.processNote.type` | `http://hl7.org/fhir/ValueSet/note-type` | `Required` | display \| print \| printoper |
| `http://hl7.org/fhir/StructureDefinition/ProcessResponse` | `ProcessResponse.processNote.type` | `http://hl7.org/fhir/ValueSet/note-type` | `Required` | display \| print \| printoper |
...
This group is centered on the Value Set NoteType from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 NoteType](/docs/R2/ValueSets/NoteType.md)| Relationship | R3 NoteType| Relationship | [R4 NoteType](/docs/R4/ValueSets/NoteType.md)| Relationship | [R4B NoteType](/docs/R4B/ValueSets/NoteType.md)| Relationship | [R5 NoteType](/docs/R5/ValueSets/NoteType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/note-type`
