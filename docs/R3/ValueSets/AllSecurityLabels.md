...
| | | **`SOC`**| →→→→ __ →→→→ <br/>(3381)<hr/>←←←← __ ←←←← <br/>() | `active`| | | | | 
...
| | | **`DECLASSIFYLABEL`**| →→→→ _Equivalent_ →→→→ <br/>(3364)<hr/>←←←← __ ←←←← <br/>() | `DECLASSIFYLABEL`| | | | | 
...
| | | **`DOWNGRDLABEL`**| →→→→ _Equivalent_ →→→→ <br/>(3340)<hr/>←←←← __ ←←←← <br/>() | `DOWNGRDLABEL`| | | | | 
| | | **`DOWNGRDLABEL`**| _Equivalent_ <br/>(3514/5775)| `DOWNGRDLABEL`| | | | | 
| | | **`DRIVLABEL`**| →→→→ _Equivalent_ →→→→ <br/>(3322)<hr/>←←←← __ ←←←← <br/>() | `DRIVLABEL`| | | | | 
...
| | | **`LABEL`**| →→→→ _Equivalent_ →→→→ <br/>(3360)<hr/>←←←← __ ←←←← <br/>() | `LABEL`| | | | | 
...
| | | **`PERSISTLABEL`**| →→→→ _Equivalent_ →→→→ <br/>(3355)<hr/>←←←← __ ←←←← <br/>() | `PERSISTLABEL`| | | | | 
...
| | | **`UPGRDLABEL`**| →→→→ _Equivalent_ →→→→ <br/>(3345)<hr/>←←←← __ ←←←← <br/>() | `UPGRDLABEL`| | | | | 
