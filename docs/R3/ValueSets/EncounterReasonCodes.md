...
| `http://hl7.org/fhir/StructureDefinition/Encounter` | `Encounter.reason` | `http://hl7.org/fhir/ValueSet/encounter-reason` | `Preferred` | Reason the encounter takes place (code) |
