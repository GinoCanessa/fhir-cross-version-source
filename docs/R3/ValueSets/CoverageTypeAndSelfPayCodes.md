...
| VS Name | Coverage Type and Self-Pay Codes |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Coverage` | `Coverage.type` | `http://hl7.org/fhir/ValueSet/coverage-type` | `Preferred` | Type of coverage such as medical or accident |

### Referenced Systems

* `http://hl7.org/fhir/coverage-selfpay`
...
| System | Code | Display |
| ------ | ---- | ------- |
| `http://hl7.org/fhir/coverage-selfpay` | `pay` | Pay |
