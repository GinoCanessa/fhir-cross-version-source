...
| VS Name | SNOMED CT Codes for species |
...
Failed to expand this value set: Error expanding http://hl7.org/fhir/ValueSet/sequence-species|3.0.2: Operation expand failed: creating the required expansion failed with message "The ValueSet expander cannot expand compositional code system 'http://snomed.info/sct', so the expansion cannot be completed.".
