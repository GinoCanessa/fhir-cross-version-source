...
This group is centered on the Value Set CompositeMeasureScoring from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | R3 CompositeMeasureScoring| Relationship | [R4 CompositeMeasureScoring](/docs/R4/ValueSets/CompositeMeasureScoring.md)| Relationship | *No Map* | Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/composite-measure-scoring`
