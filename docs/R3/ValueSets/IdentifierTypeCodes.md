...
| `DL`| _Equivalent_ <br/>(585/1947)| **`DL`**| →→→→ _Equivalent_ →→→→ <br/>(3757)<hr/>←←←← __ ←←←← <br/>() | `DL`| | | | | 
| `DL`| _Equivalent_ <br/>(585/1947)| **`DL`**| _Equivalent_ <br/>(3766/6072)| `DL`| | | | | 
| `PPN`| _Equivalent_ <br/>(592/1954)| **`PPN`**| →→→→ _Equivalent_ →→→→ <br/>(3749)<hr/>←←←← __ ←←←← <br/>() | `PPN`| | | | | 
| `PPN`| _Equivalent_ <br/>(592/1954)| **`PPN`**| _Equivalent_ <br/>(3773/6064)| `PPN`| | | | | 
| `BRN`| _Equivalent_ <br/>(584/1946)| **`BRN`**| →→→→ _Equivalent_ →→→→ <br/>(3756)<hr/>←←←← __ ←←←← <br/>() | `BRN`| | | | | 
| `BRN`| _Equivalent_ <br/>(584/1946)| **`BRN`**| _Equivalent_ <br/>(3774/6071)| `BRN`| | | | | 
| `MR`| _Equivalent_ <br/>(590/1952)| **`MR`**| →→→→ _Equivalent_ →→→→ <br/>(3754)<hr/>←←←← __ ←←←← <br/>() | `MR`| | | | | 
| `MR`| _Equivalent_ <br/>(590/1952)| **`MR`**| _Equivalent_ <br/>(3764/6069)| `MR`| | | | | 
| `MCN`| _Equivalent_ <br/>(588/1950)| **`MCN`**| →→→→ _Equivalent_ →→→→ <br/>(3746)<hr/>←←←← __ ←←←← <br/>() | `MCN`| | | | | 
| `MCN`| _Equivalent_ <br/>(588/1950)| **`MCN`**| _Equivalent_ <br/>(3767/6061)| `MCN`| | | | | 
| `EN`| _Equivalent_ <br/>(587/1949)| **`EN`**| →→→→ _Equivalent_ →→→→ <br/>(3751)<hr/>←←←← __ ←←←← <br/>() | `EN`| | | | | 
| `EN`| _Equivalent_ <br/>(587/1949)| **`EN`**| _Equivalent_ <br/>(3772/6066)| `EN`| | | | | 
| `TAX`| _Equivalent_ <br/>(594/1956)| **`TAX`**| →→→→ _Equivalent_ →→→→ <br/>(3753)<hr/>←←←← __ ←←←← <br/>() | `TAX`| | | | | 
| `TAX`| _Equivalent_ <br/>(594/1956)| **`TAX`**| _Equivalent_ <br/>(3770/6068)| `TAX`| | | | | 
| `NIIP`| _Equivalent_ <br/>(591/1953)| **`NIIP`**| →→→→ _Equivalent_ →→→→ <br/>(3748)<hr/>←←←← __ ←←←← <br/>() | `NIIP`| | | | | 
| `NIIP`| _Equivalent_ <br/>(591/1953)| **`NIIP`**| _Equivalent_ <br/>(3763/6063)| `NIIP`| | | | | 
| `PRN`| _Equivalent_ <br/>(593/1955)| **`PRN`**| →→→→ _Equivalent_ →→→→ <br/>(3752)<hr/>←←←← __ ←←←← <br/>() | `PRN`| | | | | 
| `PRN`| _Equivalent_ <br/>(593/1955)| **`PRN`**| _Equivalent_ <br/>(3769/6067)| `PRN`| | | | | 
| `MD`| _Equivalent_ <br/>(589/1951)| **`MD`**| →→→→ _Equivalent_ →→→→ <br/>(3747)<hr/>←←←← __ ←←←← <br/>() | `MD`| | | | | 
| `MD`| _Equivalent_ <br/>(589/1951)| **`MD`**| _Equivalent_ <br/>(3771/6062)| `MD`| | | | | 
| `DR`| _Equivalent_ <br/>(586/1948)| **`DR`**| →→→→ _Equivalent_ →→→→ <br/>(3755)<hr/>←←←← __ ←←←← <br/>() | `DR`| | | | | 
| `DR`| _Equivalent_ <br/>(586/1948)| **`DR`**| _Equivalent_ <br/>(3765/6070)| `DR`| | | | | 
| | | **`ACSN`**| →→→→ _Equivalent_ →→→→ <br/>(3750)<hr/>←←←← __ ←←←← <br/>() | `ACSN`| | | | | 
| | | **`ACSN`**| _Equivalent_ <br/>(3768/6065)| `ACSN`| | | | | 
| <td colspan="8">**R3** System: `http://hl7.org/fhir/identifier-type`
| `UDI`| _Equivalent_ <br/>(599/1961)| **`UDI`**| →→→→ _Equivalent_ →→→→ <br/>(3758)<hr/>←←←← __ ←←←← <br/>() | `UDI`| | | | | 
| `UDI`| _Equivalent_ <br/>(599/1961)| **`UDI`**| _Equivalent_ <br/>(3775/6079)| `UDI`| | | | | 
| `SNO`| _Equivalent_ <br/>(598/1960)| **`SNO`**| →→→→ _Equivalent_ →→→→ <br/>(3762)<hr/>←←←← __ ←←←← <br/>() | `SNO`| | | | | 
| `SNO`| _Equivalent_ <br/>(598/1960)| **`SNO`**| _Equivalent_ <br/>(3778/6083)| `SNO`| | | | | 
| `SB`| _Equivalent_ <br/>(597/1959)| **`SB`**| →→→→ _Equivalent_ →→→→ <br/>(3759)<hr/>←←←← __ ←←←← <br/>() | `SB`| | | | | 
| `SB`| _Equivalent_ <br/>(597/1959)| **`SB`**| _Equivalent_ <br/>(3779/6080)| `SB`| | | | | 
| `PLAC`| _Equivalent_ <br/>(596/1958)| **`PLAC`**| →→→→ _Equivalent_ →→→→ <br/>(3760)<hr/>←←←← __ ←←←← <br/>() | `PLAC`| | | | | 
| `PLAC`| _Equivalent_ <br/>(596/1958)| **`PLAC`**| _Equivalent_ <br/>(3777/6081)| `PLAC`| | | | | 
| `FILL`| _Equivalent_ <br/>(595/1957)| **`FILL`**| →→→→ _Equivalent_ →→→→ <br/>(3761)<hr/>←←←← __ ←←←← <br/>() | `FILL`| | | | | 
