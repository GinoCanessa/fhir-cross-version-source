...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Claim` | `Claim.use` | `http://hl7.org/fhir/ValueSet/claim-use` | `Required` | complete \| proposed \| exploratory \| other |
...
This group is centered on the Value Set Use from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 Use](/docs/R2/ValueSets/Use.md)| Relationship | R3 Use| Relationship | [R4 Use](/docs/R4/ValueSets/Use.md)| Relationship | [R4B Use](/docs/R4B/ValueSets/Use.md)| Relationship | [R5 Use](/docs/R5/ValueSets/Use.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/claim-use`
