...
This group is centered on the Value Set MessageTransport from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 MessageTransport](/docs/R2/ValueSets/MessageTransport.md)| Relationship | R3 MessageTransport| Relationship | [R4 MessageTransport](/docs/R4/ValueSets/MessageTransport.md)| Relationship | *No Map* | Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/message-transport`
