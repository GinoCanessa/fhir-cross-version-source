...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Patient` | `Patient.link.type` | `http://hl7.org/fhir/ValueSet/link-type` | `Required` | replaced-by \| replaces \| refer \| seealso - type of link |
...
This group is centered on the Value Set LinkType from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 LinkType](/docs/R2/ValueSets/LinkType.md)| Relationship | R3 LinkType| Relationship | [R4 LinkType](/docs/R4/ValueSets/LinkType.md)| Relationship | [R4B LinkType](/docs/R4B/ValueSets/LinkType.md)| Relationship | [R5 LinkType](/docs/R5/ValueSets/LinkType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/link-type`
| | | **`replaced-by`**| _Equivalent_ <br/>(4135/6480)| `replaced-by`| _Equivalent_ <br/>(16358/16359)| `replaced-by`| _Equivalent_ <br/>(9165/11479)| `replaced-by`
