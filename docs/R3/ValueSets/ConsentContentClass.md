...
| Database Key | `1142` |
| Database Concept Count | `195` |
| Database Active Concept Count | `195` |
### Bindings

| Source | Element | Binding | Strength | Element Short |
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Consent` | `Consent.except.class` | `http://hl7.org/fhir/ValueSet/consent-content-class` | `Extensible` | e.g. Resource Type, Profile, or CDA etc |
...
| `urn:ietf:bcp:13` | `application/hl7-cda+xml` | CDA Documents |
| `urn:ietf:rfc:3986` | `http://hl7.org/fhir/StructureDefinition/lipidprofile` | Lipid Lab Report |
| `urn:oid:1.3.6.1.4.1.19376.1.2.3` | `urn:hl7-org:sdwg:ccda-nonXMLBody:1.1` | For documents following C-CDA 1.1 constraints using a non structured body. |
| `urn:oid:1.3.6.1.4.1.19376.1.2.3` | `urn:hl7-org:sdwg:ccda-nonXMLBody:2.1` | For documents following C-CDA 2.1 constraints using a non structured body. |
| `urn:oid:1.3.6.1.4.1.19376.1.2.3` | `urn:hl7-org:sdwg:ccda-structuredBody:1.1` | For documents following C-CDA 1.1 constraints using a structured body. |
| `urn:oid:1.3.6.1.4.1.19376.1.2.3` | `urn:hl7-org:sdwg:ccda-structuredBody:2.1` | For documents following C-CDA 2.1 constraints using a structured body. |
