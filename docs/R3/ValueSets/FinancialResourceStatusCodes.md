...
| | | **`active`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4383)<hr/>←←←← _Equivalent_ ←←←← <br/>(7275) | `received`| | | | | 
| | | **`active`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4383)<hr/>←←←← _Equivalent_ ←←←← <br/>(7275) | `accepted`| | | | | 
| | | **`active`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4383)<hr/>←←←← _Equivalent_ ←←←← <br/>(7275) | `ready`| | | | | 
| | | **`active`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4383)<hr/>←←←← _Equivalent_ ←←←← <br/>(7275) | `in-progress`| | | | | 
| | | **`cancelled`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4387)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(7271) | `rejected`| | | | | 
| | | **`cancelled`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4387)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(7271) | `cancelled`| | | | | 
| | | **`cancelled`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4387)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(7271) | `failed`| | | | | 
| | | **`cancelled`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4387)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(7271) | `completed`| | | | | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/fm-status`
| | | **`active`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4383)<hr/>←←←← _Equivalent_ ←←←← <br/>(7275) | `received`| _Equivalent_ <br/>(18316/18317)| `received`| _Equivalent_ <br/>(9515/11854)| `received`
| | | **`active`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4383)<hr/>←←←← _Equivalent_ ←←←← <br/>(7275) | `accepted`| _Equivalent_ <br/>(18318/18319)| `accepted`| _Equivalent_ <br/>(9513/11852)| `accepted`
| | | **`active`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4383)<hr/>←←←← _Equivalent_ ←←←← <br/>(7275) | `ready`| _Equivalent_ <br/>(18322/18323)| `ready`| _Equivalent_ <br/>(9511/11850)| `ready`
