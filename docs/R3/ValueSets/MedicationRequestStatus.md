...
| Canonical URL | `http://hl7.org/fhir/ValueSet/medication-request-status` |
| Version | 3.0.2 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/MedicationRequest` | `MedicationRequest.status` | `http://hl7.org/fhir/ValueSet/medication-request-status` | `Required` | active \| on-hold \| cancelled \| completed \| entered-in-error \| stopped \| draft \| unknown |
...
This group is centered on the Value Set MedicationRequestStatus from hl7.fhir.r3.core@3.0.2 (R3, key 2).
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/medication-request-status`
