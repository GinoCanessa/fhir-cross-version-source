...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/StructureMap` | `StructureMap.group.typeMode` | `http://hl7.org/fhir/ValueSet/map-group-type-mode` | `Required` | none \| types \| type-and-types |
...
This group is centered on the Value Set StructureMapGroupTypeMode from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | R3 StructureMapGroupTypeMode| Relationship | [R4 StructureMapGroupTypeMode](/docs/R4/ValueSets/StructureMapGroupTypeMode.md)| Relationship | [R4B StructureMapGroupTypeMode](/docs/R4B/ValueSets/StructureMapGroupTypeMode.md)| Relationship | [R5 StructureMapGroupTypeMode](/docs/R5/ValueSets/StructureMapGroupTypeMode.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/map-group-type-mode`
