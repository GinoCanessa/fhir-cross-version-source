...
| *4 of 6 codes used* <br/>remaining codes:<br/>`accepted`, `completed`, `declined`, `in-process`, `needs-action`, `tentative`| | *4 of 4 codes used* | | *4 of 4 codes used* | | *4 of 4 codes used* | | *4 of 5 codes used* <br/>remaining codes:<br/>`entered-in-error`
