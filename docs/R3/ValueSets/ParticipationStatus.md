...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Appointment` | `Appointment.participant.status` | `http://hl7.org/fhir/ValueSet/participationstatus` | `Required` | accepted \| declined \| tentative \| needs-action |
| `http://hl7.org/fhir/StructureDefinition/AppointmentResponse` | `AppointmentResponse.participantStatus` | `http://hl7.org/fhir/ValueSet/participationstatus` | `Required` | accepted \| declined \| tentative \| in-process \| completed \| needs-action \| entered-in-error |
...
This group is centered on the Value Set ParticipationStatus from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 ParticipantStatus](/docs/R2/ValueSets/ParticipantStatus.md)| Relationship | R3 ParticipationStatus| Relationship | [R4 ParticipationStatus](/docs/R4/ValueSets/ParticipationStatus.md)| Relationship | [R4B ParticipationStatus](/docs/R4B/ValueSets/ParticipationStatus.md)| Relationship | [R5 AppointmentResponseStatus](/docs/R5/ValueSets/AppointmentResponseStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/participationstatus`
| `accepted`| →→→→ _Equivalent_ →→→→ <br/>(63)<hr/>←←←← __ ←←←← <br/>() | **`accepted`**| _Equivalent_ <br/>(2928/5129)| `accepted`| _Equivalent_ <br/>(16740/16741)| `accepted`| _Equivalent_ <br/>(7481/9743)| `accepted`
...
| [R2 ParticipationStatus](/docs/R2/ValueSets/ParticipationStatus.md)| Relationship | R3 ParticipationStatus| Relationship | [R4 ParticipationStatus](/docs/R4/ValueSets/ParticipationStatus.md)| Relationship | [R4B ParticipationStatus](/docs/R4B/ValueSets/ParticipationStatus.md)| Relationship | [R5 AppointmentResponseStatus](/docs/R5/ValueSets/AppointmentResponseStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/participationstatus`
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/participationstatus`
| `accepted`| →→→→ _Equivalent_ →→→→ <br/>(63)<hr/>←←←← __ ←←←← <br/>() | **`accepted`**| _Equivalent_ <br/>(2928/5129)| `accepted`| _Equivalent_ <br/>(16740/16741)| `accepted`| _Equivalent_ <br/>(7457/9722)| `accepted`
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/participationstatus`
| `accepted`| →→→→ _Equivalent_ →→→→ <br/>(42)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(1412) | **`accepted`**| _Equivalent_ <br/>(2928/5129)| `accepted`| _Equivalent_ <br/>(16740/16741)| `accepted`| _Equivalent_ <br/>(7457/9722)| `accepted`
