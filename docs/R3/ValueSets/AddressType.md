...
This group is centered on the Value Set AddressType from hl7.fhir.r3.core@3.0.2 (R3, key 2).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 AddressType](/docs/R2/ValueSets/AddressType.md)| Relationship | R3 AddressType| Relationship | [R4 AddressType](/docs/R4/ValueSets/AddressType.md)| Relationship | [R4B AddressType](/docs/R4B/ValueSets/AddressType.md)| Relationship | [R5 AddressType](/docs/R5/ValueSets/AddressType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R3** System: `http://hl7.org/fhir/address-type`
