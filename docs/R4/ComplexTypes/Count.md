...
| `Count.comparator` | `Count.comparator` | `comparator` | Quantity.comparator | < \| <= \| >= \| > - how to understand the value | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/quantity-comparator|4.0.1` |
...
This group is centered on the Structure Definition Count from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Quantity](/docs/R2/ComplexTypes/Quantity.md)| Relationship | [R3 Count](/docs/R3/ComplexTypes/Count.md)| Relationship | R4 Count| Relationship | [R4B Count](/docs/R4B/ComplexTypes/Count.md)| Relationship | [R5 Count](/docs/R5/ComplexTypes/Count.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
