...
This group is centered on the Structure Definition UsageContext from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 UsageContext](/docs/R3/ComplexTypes/UsageContext.md)| Relationship | R4 UsageContext| Relationship | [R4B UsageContext](/docs/R4B/ComplexTypes/UsageContext.md)| Relationship | [R5 UsageContext](/docs/R5/ComplexTypes/UsageContext.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
