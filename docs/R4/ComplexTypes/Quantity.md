...
| `Quantity.comparator` | `Quantity.comparator` | `comparator` | Quantity.comparator | < \| <= \| >= \| > - how to understand the value | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/quantity-comparator|4.0.1` |
...
This group is centered on the Structure Definition Quantity from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Quantity](/docs/R2/ComplexTypes/Quantity.md)| Relationship | [R3 Quantity](/docs/R3/ComplexTypes/Quantity.md)| Relationship | R4 Quantity| Relationship | [R4B Quantity](/docs/R4B/ComplexTypes/Quantity.md)| Relationship | [R5 Quantity](/docs/R5/ComplexTypes/Quantity.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
