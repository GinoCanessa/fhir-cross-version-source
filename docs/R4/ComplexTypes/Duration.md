...
| `Duration.comparator` | `Duration.comparator` | `comparator` | Quantity.comparator | < \| <= \| >= \| > - how to understand the value | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/quantity-comparator|4.0.1` |
...
This group is centered on the Structure Definition Duration from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Quantity](/docs/R2/ComplexTypes/Quantity.md)| Relationship | [R3 Duration](/docs/R3/ComplexTypes/Duration.md)| Relationship | R4 Duration| Relationship | [R4B Duration](/docs/R4B/ComplexTypes/Duration.md)| Relationship | [R5 Duration](/docs/R5/ComplexTypes/Duration.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
