...
| `Identifier.use` | `Identifier.use` | `use` | Identifier.use | usual \| official \| temp \| secondary \| old (If known) | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/identifier-use|4.0.1` |
...
This group is centered on the Structure Definition Identifier from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Identifier](/docs/R2/ComplexTypes/Identifier.md)| Relationship | [R3 Identifier](/docs/R3/ComplexTypes/Identifier.md)| Relationship | R4 Identifier| Relationship | [R4B Identifier](/docs/R4B/ComplexTypes/Identifier.md)| Relationship | [R5 Identifier](/docs/R5/ComplexTypes/Identifier.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
