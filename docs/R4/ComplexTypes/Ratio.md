...
This group is centered on the Structure Definition Ratio from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Ratio](/docs/R2/ComplexTypes/Ratio.md)| Relationship | [R3 Ratio](/docs/R3/ComplexTypes/Ratio.md)| Relationship | R4 Ratio| Relationship | [R4B Ratio](/docs/R4B/ComplexTypes/Ratio.md)| Relationship | [R5 Ratio](/docs/R5/ComplexTypes/Ratio.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
