...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Account` | `Account.status` | `http://hl7.org/fhir/ValueSet/account-status\|4.0.1` | `Required` | active \| inactive \| entered-in-error \| on-hold \| unknown |
...
This group is centered on the Value Set AccountStatus from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 AccountStatus](/docs/R2/ValueSets/AccountStatus.md)| Relationship | [R3 AccountStatus](/docs/R3/ValueSets/AccountStatus.md)| Relationship | R4 AccountStatus| Relationship | [R4B AccountStatus](/docs/R4B/ValueSets/AccountStatus.md)| Relationship | [R5 AccountStatus](/docs/R5/ValueSets/AccountStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/account-status`
