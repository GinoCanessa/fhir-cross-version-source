...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Endpoint` | `Endpoint.status` | `http://hl7.org/fhir/ValueSet/endpoint-status\|4.0.1` | `Required` | active \| suspended \| error \| off \| entered-in-error \| test |
...
This group is centered on the Value Set EndpointStatus from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 EndpointStatus](/docs/R3/ValueSets/EndpointStatus.md)| Relationship | R4 EndpointStatus| Relationship | [R4B EndpointStatus](/docs/R4B/ValueSets/EndpointStatus.md)| Relationship | [R5 EndpointStatus](/docs/R5/ValueSets/EndpointStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/endpoint-status`
