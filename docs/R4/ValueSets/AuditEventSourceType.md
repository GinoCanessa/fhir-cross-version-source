...
This group is centered on the Value Set AuditEventSourceType from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 Audit Event Source Type](/docs/R2/ValueSets/AuditEventSourceType.md)| Relationship | [R3 Audit Event Source Type](/docs/R3/ValueSets/AuditEventSourceType.md)| Relationship | R4 AuditEventSourceType| Relationship | *No Map* | Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://terminology.hl7.org/CodeSystem/security-source-type`
