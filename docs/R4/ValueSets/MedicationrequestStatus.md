...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/MedicationRequest` | `MedicationRequest.status` | `http://hl7.org/fhir/ValueSet/medicationrequest-status\|4.0.1` | `Required` | active \| on-hold \| cancelled \| completed \| entered-in-error \| stopped \| draft \| unknown |
...
This group is centered on the Value Set medicationrequest Status from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 MedicationOrderStatus](/docs/R2/ValueSets/MedicationOrderStatus.md)| Relationship | [R3 MedicationRequestStatus](/docs/R3/ValueSets/MedicationRequestStatus.md)| Relationship | R4 medicationrequest Status| Relationship | [R4B medicationrequest Status](/docs/R4B/ValueSets/MedicationrequestStatus.md)| Relationship | [R5 MedicationrequestStatus](/docs/R5/ValueSets/MedicationrequestStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/CodeSystem/medicationrequest-status`
