...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Communication` | `Communication.status` | `http://hl7.org/fhir/ValueSet/event-status\|4.0.1` | `Required` | preparation \| in-progress \| not-done \| on-hold \| stopped \| completed \| entered-in-error \| unknown |
| `http://hl7.org/fhir/StructureDefinition/Media` | `Media.status` | `http://hl7.org/fhir/ValueSet/event-status\|4.0.1` | `Required` | preparation \| in-progress \| not-done \| on-hold \| stopped \| completed \| entered-in-error \| unknown |
| `http://hl7.org/fhir/StructureDefinition/Procedure` | `Procedure.status` | `http://hl7.org/fhir/ValueSet/event-status\|4.0.1` | `Required` | preparation \| in-progress \| not-done \| on-hold \| stopped \| completed \| entered-in-error \| unknown |
...
This group is centered on the Value Set EventStatus from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 CommunicationStatus](/docs/R2/ValueSets/CommunicationStatus.md)| Relationship | [R3 EventStatus](/docs/R3/ValueSets/EventStatus.md)| Relationship | R4 EventStatus| Relationship | [R4B EventStatus](/docs/R4B/ValueSets/EventStatus.md)| Relationship | [R5 EventStatus](/docs/R5/ValueSets/EventStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/event-status`
...
| `rejected`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(157)<hr/>←←←← __ ←←←← <br/>() | `aborted`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(3054)<hr/>←←←← _Equivalent_ ←←←← <br/>(5264) | **`not-done`**| _Equivalent_ <br/>(15904/15905)| `not-done`| _Equivalent_ <br/>(7571/9841)| `not-done`
| `failed`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(155)<hr/>←←←← __ ←←←← <br/>() | `aborted`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(3054)<hr/>←←←← _Equivalent_ ←←←← <br/>(5264) | **`not-done`**| _Equivalent_ <br/>(15904/15905)| `not-done`| _Equivalent_ <br/>(7571/9841)| `not-done`
...
| `rejected`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(157)<hr/>←←←← __ ←←←← <br/>() | `aborted`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(3055)<hr/>←←←← _Equivalent_ ←←←← <br/>(5267) | **`stopped`**| _Equivalent_ <br/>(15908/15909)| `stopped`| _Equivalent_ <br/>(7569/9839)| `stopped`
| `failed`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(155)<hr/>←←←← __ ←←←← <br/>() | `aborted`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(3055)<hr/>←←←← _Equivalent_ ←←←← <br/>(5267) | **`stopped`**| _Equivalent_ <br/>(15908/15909)| `stopped`| _Equivalent_ <br/>(7569/9839)| `stopped`
...
| [R2 ProcedureStatus](/docs/R2/ValueSets/ProcedureStatus.md)| Relationship | [R3 EventStatus](/docs/R3/ValueSets/EventStatus.md)| Relationship | R4 EventStatus| Relationship | [R4B EventStatus](/docs/R4B/ValueSets/EventStatus.md)| Relationship | [R5 EventStatus](/docs/R5/ValueSets/EventStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/event-status`
| | | `preparation`| _Equivalent_ <br/>(3061/5266)| **`preparation`**| _Equivalent_ <br/>(15900/15901)| `preparation`| _Equivalent_ <br/>(7575/9845)| `preparation`
