...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Patient` | `Patient.link.type` | `http://hl7.org/fhir/ValueSet/link-type\|4.0.1` | `Required` | replaced-by \| replaces \| refer \| seealso |
...
This group is centered on the Value Set LinkType from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 LinkType](/docs/R2/ValueSets/LinkType.md)| Relationship | [R3 LinkType](/docs/R3/ValueSets/LinkType.md)| Relationship | R4 LinkType| Relationship | [R4B LinkType](/docs/R4B/ValueSets/LinkType.md)| Relationship | [R5 LinkType](/docs/R5/ValueSets/LinkType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/link-type`
