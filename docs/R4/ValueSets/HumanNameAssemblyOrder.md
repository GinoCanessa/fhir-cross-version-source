...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/humanname-assembly-order` | `Extension.value[x]` | `http://hl7.org/fhir/ValueSet/name-assembly-order\|4.0.1` | `Required` | Value of extension |
