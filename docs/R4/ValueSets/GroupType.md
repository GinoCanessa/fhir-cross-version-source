...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Group` | `Group.type` | `http://hl7.org/fhir/ValueSet/group-type\|4.0.1` | `Required` | person \| animal \| practitioner \| device \| medication \| substance |
...
This group is centered on the Value Set GroupType from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 GroupType](/docs/R2/ValueSets/GroupType.md)| Relationship | [R3 GroupType](/docs/R3/ValueSets/GroupType.md)| Relationship | R4 GroupType| Relationship | [R4B GroupType](/docs/R4B/ValueSets/GroupType.md)| Relationship | [R5 GroupType](/docs/R5/ValueSets/GroupType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/group-type`
