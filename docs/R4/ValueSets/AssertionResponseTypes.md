...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/TestScript` | `TestScript.setup.action.assert.response` | `http://hl7.org/fhir/ValueSet/assert-response-code-types\|4.0.1` | `Required` | okay \| created \| noContent \| notModified \| bad \| forbidden \| notFound \| methodNotAllowed \| conflict \| gone \| preconditionFailed \| unprocessable |
...
This group is centered on the Value Set AssertionResponseTypes from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 AssertionResponseTypes](/docs/R2/ValueSets/AssertionResponseTypes.md)| Relationship | [R3 AssertionResponseTypes](/docs/R3/ValueSets/AssertionResponseTypes.md)| Relationship | R4 AssertionResponseTypes| Relationship | [R4B AssertionResponseTypes](/docs/R4B/ValueSets/AssertionResponseTypes.md)| Relationship | [R5 AssertionResponseTypes](/docs/R5/ValueSets/AssertionResponseTypes.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/assert-response-code-types`
