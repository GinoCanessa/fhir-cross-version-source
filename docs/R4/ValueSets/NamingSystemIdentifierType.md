...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/NamingSystem` | `NamingSystem.uniqueId.type` | `http://hl7.org/fhir/ValueSet/namingsystem-identifier-type\|4.0.1` | `Required` | oid \| uuid \| uri \| other |
