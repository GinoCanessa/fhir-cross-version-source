...
| VS Name | GenderStatus |
| Canonical URL | `http://hl7.org/fhir/ValueSet/animal-genderstatus` |
| Version | 4.0.1 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/patient-animal` | `Extension.extension.value[x]` | `http://hl7.org/fhir/ValueSet/animal-genderstatus` | `Example` | Value of extension |
