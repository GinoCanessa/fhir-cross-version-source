...
This group is centered on the Value Set MeasureScoring from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 MeasureScoring](/docs/R3/ValueSets/MeasureScoring.md)| Relationship | R4 MeasureScoring| Relationship | *No Map* | Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://terminology.hl7.org/CodeSystem/measure-scoring`
