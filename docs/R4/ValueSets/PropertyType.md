...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/CodeSystem` | `CodeSystem.property.type` | `http://hl7.org/fhir/ValueSet/concept-property-type\|4.0.1` | `Required` | code \| Coding \| string \| integer \| boolean \| dateTime \| decimal |
...
This group is centered on the Value Set PropertyType from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 PropertyType](/docs/R3/ValueSets/PropertyType.md)| Relationship | R4 PropertyType| Relationship | [R4B PropertyType](/docs/R4B/ValueSets/PropertyType.md)| Relationship | [R5 PropertyType](/docs/R5/ValueSets/PropertyType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/concept-property-type`
