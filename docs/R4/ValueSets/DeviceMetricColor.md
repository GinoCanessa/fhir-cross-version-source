...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/DeviceMetric` | `DeviceMetric.color` | `http://hl7.org/fhir/ValueSet/metric-color\|4.0.1` | `Required` | black \| red \| green \| yellow \| blue \| magenta \| cyan \| white |
...
This group is centered on the Value Set DeviceMetricColor from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 DeviceMetricColor](/docs/R2/ValueSets/DeviceMetricColor.md)| Relationship | [R3 DeviceMetricColor](/docs/R3/ValueSets/DeviceMetricColor.md)| Relationship | R4 DeviceMetricColor| Relationship | [R4B DeviceMetricColor](/docs/R4B/ValueSets/DeviceMetricColor.md)| Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/metric-color`
