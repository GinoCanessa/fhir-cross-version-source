...
| Database Key | `2207` |
| Database Concept Count | `213` |
| Database Active Concept Count | `213` |
### Bindings

| Source | Element | Binding | Strength | Element Short |
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/DataRequirement` | `DataRequirement.type` | `http://hl7.org/fhir/ValueSet/all-types\|4.0.1` | `Required` | The type of the required data |
| `http://hl7.org/fhir/StructureDefinition/ParameterDefinition` | `ParameterDefinition.type` | `http://hl7.org/fhir/ValueSet/all-types\|4.0.1` | `Required` | What type of value |
| `http://hl7.org/fhir/StructureDefinition/OperationDefinition` | `OperationDefinition.parameter.type` | `http://hl7.org/fhir/ValueSet/all-types\|4.0.1` | `Required` | What type this parameter has |
...
This group is centered on the Value Set FHIRAllTypes from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 FHIRAllTypes](/docs/R3/ValueSets/FHIRAllTypes.md)| Relationship | R4 FHIRAllTypes| Relationship | [R4B FHIRAllTypes](/docs/R4B/ValueSets/FHIRAllTypes.md)| Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
