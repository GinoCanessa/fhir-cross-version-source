...
| `http://terminology.hl7.org/CodeSystem/v3-ObservationValue` | `ELSTAT` | eligibility indicator |
...
| `http://terminology.hl7.org/CodeSystem/v3-ObservationValue` | `PROP` | real property |
