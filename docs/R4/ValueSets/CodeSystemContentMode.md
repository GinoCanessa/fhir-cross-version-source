...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/CodeSystem` | `CodeSystem.content` | `http://hl7.org/fhir/ValueSet/codesystem-content-mode\|4.0.1` | `Required` | not-present \| example \| fragment \| complete \| supplement |
...
This group is centered on the Value Set CodeSystemContentMode from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 CodeSystemContentMode](/docs/R3/ValueSets/CodeSystemContentMode.md)| Relationship | R4 CodeSystemContentMode| Relationship | [R4B CodeSystemContentMode](/docs/R4B/ValueSets/CodeSystemContentMode.md)| Relationship | [R5 CodeSystemContentMode](/docs/R5/ValueSets/CodeSystemContentMode.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/codesystem-content-mode`
