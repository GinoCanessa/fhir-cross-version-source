...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/iso21090-uncertaintyType` | `Extension.value[x]` | `http://hl7.org/fhir/ValueSet/probability-distribution-type\|4.0.1` | `Required` | Value of extension |
