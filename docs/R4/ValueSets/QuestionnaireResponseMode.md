...
| VS Name | QuestionnaireResponseMode |
| Canonical URL | `http://hl7.org/fhir/ValueSet/questionnaireresponse-mode` |
| Version | 4.0.1 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/questionnaireresponse-completionMode` | `Extension.value[x]` | `http://hl7.org/fhir/ValueSet/questionnaireresponse-mode\|4.0.1` | `Required` | Value of extension |
