...
This group is centered on the Value Set GuideParameterCode from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | R4 GuideParameterCode| Relationship | [R4B GuideParameterCode](/docs/R4B/ValueSets/GuideParameterCode.md)| Relationship | [R5 GuideParameterCode](/docs/R5/ValueSets/GuideParameterCode.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/guide-parameter-code`
