...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Contract` | `Contract.status` | `http://hl7.org/fhir/ValueSet/contract-status\|4.0.1` | `Required` | amended \| appended \| cancelled \| disputed \| entered-in-error \| executable \| executed \| negotiable \| offered \| policy \| rejected \| renewed \| revoked \| resolved \| terminated |
...
This group is centered on the Value Set ContractResourceStatusCodes from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 Contract Resource Status Codes](/docs/R3/ValueSets/ContractResourceStatusCodes.md)| Relationship | R4 ContractResourceStatusCodes| Relationship | [R4B ContractResourceStatusCodes](/docs/R4B/ValueSets/ContractResourceStatusCodes.md)| Relationship | [R5 ContractResourceStatusCodes](/docs/R5/ValueSets/ContractResourceStatusCodes.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/contract-status`
