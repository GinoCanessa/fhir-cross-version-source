...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Timing` | `Timing.repeat.when` | `http://hl7.org/fhir/ValueSet/event-timing\|4.0.1` | `Required` | Code for time period of occurrence |
...
This group is centered on the Value Set EventTiming from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 EventTiming](/docs/R2/ValueSets/EventTiming.md)| Relationship | [R3 EventTiming](/docs/R3/ValueSets/EventTiming.md)| Relationship | R4 EventTiming| Relationship | [R4B EventTiming](/docs/R4B/ValueSets/EventTiming.md)| Relationship | [R5 EventTiming](/docs/R5/ValueSets/EventTiming.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/event-timing`
...
| <td colspan="8">**R4** System: `http://terminology.hl7.org/CodeSystem/v3-TimingEvent`
