...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/DeviceUseStatement` | `DeviceUseStatement.status` | `http://hl7.org/fhir/ValueSet/device-statement-status\|4.0.1` | `Required` | active \| completed \| entered-in-error + |
...
This group is centered on the Value Set DeviceUseStatementStatus from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 DeviceUseStatementStatus](/docs/R3/ValueSets/DeviceUseStatementStatus.md)| Relationship | R4 DeviceUseStatementStatus| Relationship | [R4B DeviceUseStatementStatus](/docs/R4B/ValueSets/DeviceUseStatementStatus.md)| Relationship | [R5 DeviceUsageStatus](/docs/R5/ValueSets/DeviceUsageStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/device-statement-status`
