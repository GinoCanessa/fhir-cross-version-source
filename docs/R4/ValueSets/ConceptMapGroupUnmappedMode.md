...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/ConceptMap` | `ConceptMap.group.unmapped.mode` | `http://hl7.org/fhir/ValueSet/conceptmap-unmapped-mode\|4.0.1` | `Required` | provided \| fixed \| other-map |
...
This group is centered on the Value Set ConceptMapGroupUnmappedMode from hl7.fhir.r4.core@4.0.1 (R4, key 3).
