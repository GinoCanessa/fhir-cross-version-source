...
| VS Name | v3.ContextControl |
| Canonical URL | `http://terminology.hl7.org/ValueSet/v3-ContextControl` |
| Version | 2018-08-12 |
...
| System | Code | Display |
| ------ | ---- | ------- |
| `http://terminology.hl7.org/CodeSystem/v3-ContextControl` | `AN` | additive, non-propagating |
