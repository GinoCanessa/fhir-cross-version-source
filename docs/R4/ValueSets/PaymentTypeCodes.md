...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/PaymentReconciliation` | `PaymentReconciliation.detail.type` | `http://hl7.org/fhir/ValueSet/payment-type` | `Example` | Category of payment |
