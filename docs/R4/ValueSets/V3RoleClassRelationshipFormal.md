...
| VS Name | v3.RoleClassRelationshipFormal |
| Canonical URL | `http://terminology.hl7.org/ValueSet/v3-RoleClassRelationshipFormal` |
| Version | 2014-03-26 |
| Description | A relationship between two entities that is formally recognized, frequently by a contract or similar agreement. |
| Status | `Active` |
