...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Consent` | `Consent.category` | `http://hl7.org/fhir/ValueSet/consent-category` | `Extensible` | Classification of the consent statement - for indexing/retrieval |
