...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/MedicationRequest` | `MedicationRequest.intent` | `http://hl7.org/fhir/ValueSet/medicationrequest-intent\|4.0.1` | `Required` | proposal \| plan \| order \| original-order \| reflex-order \| filler-order \| instance-order \| option |
...
This group is centered on the Value Set medicationRequest Intent from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 MedicationRequestIntent](/docs/R3/ValueSets/MedicationRequestIntent.md)| Relationship | R4 medicationRequest Intent| Relationship | [R4B medicationRequest Intent](/docs/R4B/ValueSets/MedicationRequestIntent.md)| Relationship | [R5 MedicationRequestIntent](/docs/R5/ValueSets/MedicationRequestIntent.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/CodeSystem/medicationrequest-intent`
