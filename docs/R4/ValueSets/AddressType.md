...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Address` | `Address.type` | `http://hl7.org/fhir/ValueSet/address-type\|4.0.1` | `Required` | postal \| physical \| both |
...
This group is centered on the Value Set AddressType from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 AddressType](/docs/R2/ValueSets/AddressType.md)| Relationship | [R3 AddressType](/docs/R3/ValueSets/AddressType.md)| Relationship | R4 AddressType| Relationship | [R4B AddressType](/docs/R4B/ValueSets/AddressType.md)| Relationship | [R5 AddressType](/docs/R5/ValueSets/AddressType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4** System: `http://hl7.org/fhir/address-type`
