...
| `http://terminology.hl7.org/CodeSystem/v3-orderableDrugForm` | `IRSOL` | Irrigation Solution |
...
| `http://terminology.hl7.org/CodeSystem/v3-orderableDrugForm` | `OTDROP` | Otic Drops |
