...
| `http://hl7.org/fhir/StructureDefinition/Claim` | `Claim.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
...
| `http://hl7.org/fhir/StructureDefinition/EffectEvidenceSynthesis` | `EffectEvidenceSynthesis.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
...
| `http://hl7.org/fhir/StructureDefinition/EpisodeOfCare` | `EpisodeOfCare.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
...
| `http://hl7.org/fhir/StructureDefinition/Medication` | `Medication.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
...
| `http://hl7.org/fhir/StructureDefinition/MedicinalProduct` | `MedicinalProduct.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/MedicinalProductAuthorization` | `MedicinalProductAuthorization.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/MedicinalProductContraindication` | `MedicinalProductContraindication.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/MedicinalProductIndication` | `MedicinalProductIndication.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/MedicinalProductIngredient` | `MedicinalProductIngredient.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/MedicinalProductInteraction` | `MedicinalProductInteraction.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/MedicinalProductManufactured` | `MedicinalProductManufactured.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/MedicinalProductPackaged` | `MedicinalProductPackaged.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/MedicinalProductPharmaceutical` | `MedicinalProductPharmaceutical.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/MedicinalProductUndesirableEffect` | `MedicinalProductUndesirableEffect.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
...
| `http://hl7.org/fhir/StructureDefinition/Procedure` | `Procedure.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
...
| `http://hl7.org/fhir/StructureDefinition/RiskEvidenceSynthesis` | `RiskEvidenceSynthesis.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
...
| `http://hl7.org/fhir/StructureDefinition/SubstanceNucleicAcid` | `SubstanceNucleicAcid.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/SubstancePolymer` | `SubstancePolymer.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/SubstanceProtein` | `SubstanceProtein.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/SubstanceReferenceInformation` | `SubstanceReferenceInformation.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/SubstanceSourceMaterial` | `SubstanceSourceMaterial.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
| `http://hl7.org/fhir/StructureDefinition/SubstanceSpecification` | `SubstanceSpecification.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
...
| `http://hl7.org/fhir/StructureDefinition/TestReport` | `TestReport.language` | `http://hl7.org/fhir/ValueSet/all-languages` | `Required` | Language of the resource content |
...
Failed to expand this value set: Error expanding http://hl7.org/fhir/ValueSet/all-languages|4.0.1: Operation expand failed: creating the required expansion failed with message "The ValueSet expander cannot find codesystem 'urn:ietf:bcp:47', so the expansion cannot be completed.".
