...
| VS Name | ProcedureNotPerformedReason(SNOMED-CT) |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Procedure` | `Procedure.statusReason` | `http://hl7.org/fhir/ValueSet/procedure-not-performed-reason` | `Example` | Reason for current status |
