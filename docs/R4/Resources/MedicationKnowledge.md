...
| `MedicationKnowledge.status` | `MedicationKnowledge.status` | `status` | MedicationKnowledge.status | active \| inactive \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/medicationknowledge-status|4.0.1` |
...
This group is centered on the Structure Definition MedicationKnowledge from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | R4 MedicationKnowledge| Relationship | [R4B MedicationKnowledge](/docs/R4B/Resources/MedicationKnowledge.md)| Relationship | [R5 MedicationKnowledge](/docs/R5/Resources/MedicationKnowledge.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
