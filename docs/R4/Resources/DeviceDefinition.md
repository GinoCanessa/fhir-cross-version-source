...
| `DeviceDefinition.deviceName.type` | `DeviceDefinition.deviceName.type` | `type` | DeviceDefinition.deviceName.type | udi-label-name \| user-friendly-name \| patient-reported-name \| manufacturer-name \| model-name \| other | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/device-nametype|4.0.1` |
...
This group is centered on the Structure Definition DeviceDefinition from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | R4 DeviceDefinition| Relationship | [R4B DeviceDefinition](/docs/R4B/Resources/DeviceDefinition.md)| Relationship | [R5 DeviceDefinition](/docs/R5/Resources/DeviceDefinition.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| | | | | *64 of 64 elements used* | | *64 of 64 elements used* | | *47 of 135 elements used* 
