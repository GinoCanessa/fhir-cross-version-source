...
| `List.mode` | `List.mode` | `mode` | List.mode | working \| snapshot \| changes | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/list-mode|4.0.1` |
...
| `List.status` | `List.status` | `status` | List.status | current \| retired \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/list-status|4.0.1` |
...
This group is centered on the Structure Definition List from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 List](/docs/R2/Resources/List.md)| Relationship | [R3 List](/docs/R3/Resources/List.md)| Relationship | R4 List| Relationship | [R4B List](/docs/R4B/Resources/List.md)| Relationship | [R5 List](/docs/R5/Resources/List.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
