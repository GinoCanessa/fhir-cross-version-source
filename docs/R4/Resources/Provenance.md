...
| `Provenance.entity.role` | `Provenance.entity.role` | `role` | Provenance.entity.role | derivation \| revision \| quotation \| source \| removal | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/provenance-entity-role|4.0.1` |
...
This group is centered on the Structure Definition Provenance from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Provenance](/docs/R2/Resources/Provenance.md)| Relationship | [R3 Provenance](/docs/R3/Resources/Provenance.md)| Relationship | R4 Provenance| Relationship | [R4B Provenance](/docs/R4B/Resources/Provenance.md)| Relationship | [R5 Provenance](/docs/R5/Resources/Provenance.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
