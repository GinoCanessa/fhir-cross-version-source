...
| `Measure.definition` | `Measure.definition` | `definition` | Measure.definition | Defined terms used in the measure documentation | 0..* | markdown |  |  |
...
| `Measure.group.code` | `Measure.group.code` | `code` | Measure.group.code | Meaning of the group | 0..1 | CodeableConcept |  |  |
| `Measure.group.description` | `Measure.group.description` | `description` | Measure.group.description | Summary description | 0..1 | string |  |  |
...
| `Measure.group.stratifier.code` | `Measure.group.stratifier.code` | `code` | Measure.group.stratifier.code | Meaning of the stratifier | 0..1 | CodeableConcept |  |  |
...
| `Measure.group.stratifier.component.code` | `Measure.group.stratifier.component.code` | `code` | Measure.group.stratifier.component.code | Meaning of the stratifier component | 0..1 | CodeableConcept |  |  |
...
| `Measure.improvementNotation` | `Measure.improvementNotation` | `improvementNotation` | Measure.improvementNotation | increase \| decrease | 0..1 | CodeableConcept | `Required` | `http://hl7.org/fhir/ValueSet/measure-improvement-notation|4.0.1` |
...
| `Measure.status` | `Measure.status` | `status` | Measure.status | draft \| active \| retired \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status|4.0.1` |
...
| `Measure.supplementalData.code` | `Measure.supplementalData.code` | `code` | Measure.supplementalData.code | Meaning of the supplemental data | 0..1 | CodeableConcept |  |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | [Measure](/docs/R3/Resources/Measure.md)<br/> `http://hl7.org/fhir/StructureDefinition/Measure\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `476`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `670`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Measure](/docs/R4/Resources/Measure.md)<br/> `http://hl7.org/fhir/StructureDefinition/Measure\|4.0.1` | →→→→→→→<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1529`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1530`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Measure](/docs/R4B/Resources/Measure.md)<br/> `http://hl7.org/fhir/StructureDefinition/Measure\|4.3.0` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `1000`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1229`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Measure](/docs/R5/Resources/Measure.md)<br/> `http://hl7.org/fhir/StructureDefinition/Measure\|5.0.0` 
...
This group is centered on the Structure Definition Measure from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 Measure](/docs/R3/Resources/Measure.md)| Relationship | R4 Measure| Relationship | [R4B Measure](/docs/R4B/Resources/Measure.md)| Relationship | [R5 Measure](/docs/R5/Resources/Measure.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| | | `Measure.group.stratifier.extension`| →→→→ _Equivalent_ →→→→ <br/>(15512)<hr/>←←←← __ ←←←← <br/>()| **`Measure.group.stratifier.extension`**| _Equivalent_<br/>(29206/29207)| `Measure.group.stratifier.extension`| _Equivalent_<br/>(44080/44081)| `Measure.group.stratifier.extension`
| | | `Measure.group.stratifier.path`| →→→→ _RelatedTo_ →→→→ <br/>(1154)<hr/>←←←← __ ←←←← <br/>()| **`Measure.group.stratifier.extension`**| _Equivalent_<br/>(29206/29207)| `Measure.group.stratifier.extension`| _Equivalent_<br/>(44080/44081)| `Measure.group.stratifier.extension`
...
| | | `Measure.supplementalData.extension`| →→→→ _Equivalent_ →→→→ <br/>(15523)<hr/>←←←← __ ←←←← <br/>()| **`Measure.supplementalData.extension`**| _Equivalent_<br/>(29234/29235)| `Measure.supplementalData.extension`| _Equivalent_<br/>(44108/44109)| `Measure.supplementalData.extension`
| | | `Measure.supplementalData.path`| →→→→ _RelatedTo_ →→→→ <br/>(1157)<hr/>←←←← __ ←←←← <br/>()| **`Measure.supplementalData.extension`**| _Equivalent_<br/>(29234/29235)| `Measure.supplementalData.extension`| _Equivalent_<br/>(44108/44109)| `Measure.supplementalData.extension`
