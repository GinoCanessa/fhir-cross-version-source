...
| `Patient.contact.gender` | `Patient.contact.gender` | `gender` | Patient.contact.gender | male \| female \| other \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/administrative-gender|4.0.1` |
...
| `Patient.gender` | `Patient.gender` | `gender` | Patient.gender | male \| female \| other \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/administrative-gender|4.0.1` |
...
| `Patient.link.type` | `Patient.link.type` | `type` | Patient.link.type | replaced-by \| replaces \| refer \| seealso | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/link-type|4.0.1` |
...
This group is centered on the Structure Definition Patient from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Patient](/docs/R2/Resources/Patient.md)| Relationship | [R3 Patient](/docs/R3/Resources/Patient.md)| Relationship | R4 Patient| Relationship | [R4B Patient](/docs/R4B/Resources/Patient.md)| Relationship | [R5 Patient](/docs/R5/Resources/Patient.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
