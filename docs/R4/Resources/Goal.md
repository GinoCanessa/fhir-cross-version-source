...
| `Goal.lifecycleStatus` | `Goal.lifecycleStatus` | `lifecycleStatus` | Goal.lifecycleStatus | proposed \| planned \| accepted \| active \| on-hold \| completed \| cancelled \| entered-in-error \| rejected | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/goal-status|4.0.1` |
...
This group is centered on the Structure Definition Goal from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Goal](/docs/R2/Resources/Goal.md)| Relationship | [R3 Goal](/docs/R3/Resources/Goal.md)| Relationship | R4 Goal| Relationship | [R4B Goal](/docs/R4B/Resources/Goal.md)| Relationship | [R5 Goal](/docs/R5/Resources/Goal.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
