...
| `EnrollmentRequest.status` | `EnrollmentRequest.status` | `status` | EnrollmentRequest.status | active \| cancelled \| draft \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/fm-status|4.0.1` |
