...
| `TerminologyCapabilities.codeSearch` | `TerminologyCapabilities.codeSearch` | `codeSearch` | TerminologyCapabilities.codeSearch | explicit \| all | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/code-search-support|4.0.1` |
...
This group is centered on the Structure Definition TerminologyCapabilities from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | R4 TerminologyCapabilities| Relationship | [R4B TerminologyCapabilities](/docs/R4B/Resources/TerminologyCapabilities.md)| Relationship | [R5 TerminologyCapabilities](/docs/R5/Resources/TerminologyCapabilities.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
