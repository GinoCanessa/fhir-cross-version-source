...
| `Medication.status` | `Medication.status` | `status` | Medication.status | active \| inactive \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/medication-status|4.0.1` |
...
This group is centered on the Structure Definition Medication from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Medication](/docs/R2/Resources/Medication.md)| Relationship | [R3 Medication](/docs/R3/Resources/Medication.md)| Relationship | R4 Medication| Relationship | [R4B Medication](/docs/R4B/Resources/Medication.md)| Relationship | [R5 Medication](/docs/R5/Resources/Medication.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| `Medication`| →→→→ _Equivalent_ →→→→ <br/>(6089)<hr/>←←←← __ ←←←← <br/>()| `Medication`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(15682)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(15683)| **`Medication`**| _Equivalent_<br/>(29443/29444)| `Medication`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(44224)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(44225)| `Medication`
| `Medication.product`| →→→→ _RelatedTo_ →→→→ <br/>(264)<hr/>←←←← __ ←←←← <br/>()| `Medication`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(15682)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(15683)| **`Medication`**| _Equivalent_<br/>(29443/29444)| `Medication`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(44224)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(44225)| `Medication`
...
| | | | | **`Medication.amount`**| _Equivalent_<br/>(29471/29472)| `Medication.amount`| →→→→ _RelatedTo_ →→→→ <br/>(1823)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(44248)| `Medication`
