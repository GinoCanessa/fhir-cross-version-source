...
| `MessageDefinition.category` | `MessageDefinition.category` | `category` | MessageDefinition.category | consequence \| currency \| notification | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/message-significance-category|4.0.1` |
...
| `MessageDefinition.focus.code` | `MessageDefinition.focus.code` | `code` | MessageDefinition.focus.code | Type of resource | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/resource-types|4.0.1` |
...
This group is centered on the Structure Definition MessageDefinition from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 MessageDefinition](/docs/R3/Resources/MessageDefinition.md)| Relationship | R4 MessageDefinition| Relationship | [R4B MessageDefinition](/docs/R4B/Resources/MessageDefinition.md)| Relationship | [R5 MessageDefinition](/docs/R5/Resources/MessageDefinition.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
