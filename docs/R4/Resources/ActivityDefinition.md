...
| `ActivityDefinition.status` | `ActivityDefinition.status` | `status` | ActivityDefinition.status | draft \| active \| retired \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status|4.0.1` |
| `ActivityDefinition.subject[x]` | `ActivityDefinition.subject[x]` | `subject[x]` | ActivityDefinition.subject[x] | Type of individual the activity definition is intended for | 0..1 | CodeableConcept, Reference(http://hl7.org/fhir/StructureDefinition/Group) | `Extensible` | `http://hl7.org/fhir/ValueSet/subject-type` |
...
This group is centered on the Structure Definition ActivityDefinition from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 ActivityDefinition](/docs/R3/Resources/ActivityDefinition.md)| Relationship | R4 ActivityDefinition| Relationship | [R4B ActivityDefinition](/docs/R4B/Resources/ActivityDefinition.md)| Relationship | [R5 ActivityDefinition](/docs/R5/Resources/ActivityDefinition.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
