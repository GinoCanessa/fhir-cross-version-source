...
| `AppointmentResponse.participantStatus` | `AppointmentResponse.participantStatus` | `participantStatus` | AppointmentResponse.participantStatus | accepted \| declined \| tentative \| needs-action | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/participationstatus|4.0.1` |
...
This group is centered on the Structure Definition AppointmentResponse from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 AppointmentResponse](/docs/R2/Resources/AppointmentResponse.md)| Relationship | [R3 AppointmentResponse](/docs/R3/Resources/AppointmentResponse.md)| Relationship | R4 AppointmentResponse| Relationship | [R4B AppointmentResponse](/docs/R4B/Resources/AppointmentResponse.md)| Relationship | [R5 AppointmentResponse](/docs/R5/Resources/AppointmentResponse.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
