...
| `Practitioner.gender` | `Practitioner.gender` | `gender` | Practitioner.gender | male \| female \| other \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/administrative-gender|4.0.1` |
...
This group is centered on the Structure Definition Practitioner from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Practitioner](/docs/R2/Resources/Practitioner.md)| Relationship | [R3 Practitioner](/docs/R3/Resources/Practitioner.md)| Relationship | R4 Practitioner| Relationship | [R4B Practitioner](/docs/R4B/Resources/Practitioner.md)| Relationship | [R5 Practitioner](/docs/R5/Resources/Practitioner.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
