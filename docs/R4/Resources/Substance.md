...
| `Substance.status` | `Substance.status` | `status` | Substance.status | active \| inactive \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/substance-status|4.0.1` |
...
This group is centered on the Structure Definition Substance from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Substance](/docs/R2/Resources/Substance.md)| Relationship | [R3 Substance](/docs/R3/Resources/Substance.md)| Relationship | R4 Substance| Relationship | [R4B Substance](/docs/R4B/Resources/Substance.md)| Relationship | [R5 Substance](/docs/R5/Resources/Substance.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
