...
| `Library.status` | `Library.status` | `status` | Library.status | draft \| active \| retired \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status|4.0.1` |
...
This group is centered on the Structure Definition Library from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 Library](/docs/R3/Resources/Library.md)| Relationship | R4 Library| Relationship | [R4B Library](/docs/R4B/Resources/Library.md)| Relationship | [R5 Library](/docs/R5/Resources/Library.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
