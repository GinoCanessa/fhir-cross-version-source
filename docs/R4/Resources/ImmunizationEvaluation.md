...
| `ImmunizationEvaluation.status` | `ImmunizationEvaluation.status` | `status` | ImmunizationEvaluation.status | completed \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/immunization-evaluation-status|4.0.1` |
...
This group is centered on the Structure Definition ImmunizationEvaluation from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | R4 ImmunizationEvaluation| Relationship | [R4B ImmunizationEvaluation](/docs/R4B/Resources/ImmunizationEvaluation.md)| Relationship | [R5 ImmunizationEvaluation](/docs/R5/Resources/ImmunizationEvaluation.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
