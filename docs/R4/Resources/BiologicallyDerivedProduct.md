...
This group is centered on the Structure Definition BiologicallyDerivedProduct from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | R4 BiologicallyDerivedProduct| Relationship | [R4B BiologicallyDerivedProduct](/docs/R4B/Resources/BiologicallyDerivedProduct.md)| Relationship | [R5 BiologicallyDerivedProduct](/docs/R5/Resources/BiologicallyDerivedProduct.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
