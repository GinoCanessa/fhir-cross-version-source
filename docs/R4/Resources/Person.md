...
| `Person.gender` | `Person.gender` | `gender` | Person.gender | male \| female \| other \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/administrative-gender|4.0.1` |
...
| `Person.link.assurance` | `Person.link.assurance` | `assurance` | Person.link.assurance | level1 \| level2 \| level3 \| level4 | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/identity-assuranceLevel|4.0.1` |
...
This group is centered on the Structure Definition Person from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Person](/docs/R2/Resources/Person.md)| Relationship | [R3 Person](/docs/R3/Resources/Person.md)| Relationship | R4 Person| Relationship | [R4B Person](/docs/R4B/Resources/Person.md)| Relationship | [R5 Person](/docs/R5/Resources/Person.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
