...
This group is centered on the Structure Definition InsurancePlan from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | R4 InsurancePlan| Relationship | [R4B InsurancePlan](/docs/R4B/Resources/InsurancePlan.md)| Relationship | [R5 InsurancePlan](/docs/R5/Resources/InsurancePlan.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
