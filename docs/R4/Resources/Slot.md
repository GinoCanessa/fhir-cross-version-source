...
| `Slot.status` | `Slot.status` | `status` | Slot.status | busy \| free \| busy-unavailable \| busy-tentative \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/slotstatus|4.0.1` |
...
This group is centered on the Structure Definition Slot from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Slot](/docs/R2/Resources/Slot.md)| Relationship | [R3 Slot](/docs/R3/Resources/Slot.md)| Relationship | R4 Slot| Relationship | [R4B Slot](/docs/R4B/Resources/Slot.md)| Relationship | [R5 Slot](/docs/R5/Resources/Slot.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
