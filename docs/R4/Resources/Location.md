...
| `Location.hoursOfOperation.daysOfWeek` | `Location.hoursOfOperation.daysOfWeek` | `daysOfWeek` | Location.hoursOfOperation.daysOfWeek | mon \| tue \| wed \| thu \| fri \| sat \| sun | 0..* | code | `Required` | `http://hl7.org/fhir/ValueSet/days-of-week|4.0.1` |
...
| `Location.mode` | `Location.mode` | `mode` | Location.mode | instance \| kind | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/location-mode|4.0.1` |
...
| `Location.status` | `Location.status` | `status` | Location.status | active \| suspended \| inactive | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/location-status|4.0.1` |
...
This group is centered on the Structure Definition Location from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Location](/docs/R2/Resources/Location.md)| Relationship | [R3 Location](/docs/R3/Resources/Location.md)| Relationship | R4 Location| Relationship | [R4B Location](/docs/R4B/Resources/Location.md)| Relationship | [R5 Location](/docs/R5/Resources/Location.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
