...
| `Account.status` | `Account.status` | `status` | Account.status | active \| inactive \| entered-in-error \| on-hold \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/account-status|4.0.1` |
...
This group is centered on the Structure Definition Account from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Account](/docs/R2/Resources/Account.md)| Relationship | [R3 Account](/docs/R3/Resources/Account.md)| Relationship | R4 Account| Relationship | [R4B Account](/docs/R4B/Resources/Account.md)| Relationship | [R5 Account](/docs/R5/Resources/Account.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
