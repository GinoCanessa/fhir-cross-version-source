...
| `OperationOutcome.issue.code` | `OperationOutcome.issue.code` | `code` | OperationOutcome.issue.code | Error or warning code | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/issue-type|4.0.1` |
...
| `OperationOutcome.issue.severity` | `OperationOutcome.issue.severity` | `severity` | OperationOutcome.issue.severity | fatal \| error \| warning \| information | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/issue-severity|4.0.1` |
