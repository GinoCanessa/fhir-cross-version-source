...
| `StructureMap.group.input.mode` | `StructureMap.group.input.mode` | `mode` | StructureMap.group.input.mode | source \| target | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/map-input-mode|4.0.1` |
...
| `StructureMap.status` | `StructureMap.status` | `status` | StructureMap.status | draft \| active \| retired \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status|4.0.1` |
...
| `StructureMap.structure.mode` | `StructureMap.structure.mode` | `mode` | StructureMap.structure.mode | source \| queried \| target \| produced | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/map-model-mode|4.0.1` |
...
This group is centered on the Structure Definition StructureMap from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 StructureMap](/docs/R3/Resources/StructureMap.md)| Relationship | R4 StructureMap| Relationship | [R4B StructureMap](/docs/R4B/Resources/StructureMap.md)| Relationship | [R5 StructureMap](/docs/R5/Resources/StructureMap.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
