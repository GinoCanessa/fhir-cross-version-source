...
| `DocumentManifest.status` | `DocumentManifest.status` | `status` | DocumentManifest.status | current \| superseded \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/document-reference-status|4.0.1` |
...
This group is centered on the Structure Definition DocumentManifest from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 DocumentManifest](/docs/R2/Resources/DocumentManifest.md)| Relationship | [R3 DocumentManifest](/docs/R3/Resources/DocumentManifest.md)| Relationship | R4 DocumentManifest| Relationship | [R4B DocumentManifest](/docs/R4B/Resources/DocumentManifest.md)| Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
