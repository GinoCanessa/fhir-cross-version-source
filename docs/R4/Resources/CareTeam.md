...
| `CareTeam.participant.role` | `CareTeam.participant.role` | `role` | CareTeam.participant.role | Type of involvement | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/participant-role` |
...
| `CareTeam.status` | `CareTeam.status` | `status` | CareTeam.status | proposed \| active \| suspended \| inactive \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/care-team-status|4.0.1` |
...
This group is centered on the Structure Definition CareTeam from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 CareTeam](/docs/R3/Resources/CareTeam.md)| Relationship | R4 CareTeam| Relationship | [R4B CareTeam](/docs/R4B/Resources/CareTeam.md)| Relationship | [R5 CareTeam](/docs/R5/Resources/CareTeam.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
