...
| `Group.type` | `Group.type` | `type` | Group.type | person \| animal \| practitioner \| device \| medication \| substance | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/group-type|4.0.1` |
### Mapping Table
...
This group is centered on the Structure Definition Group from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Group](/docs/R2/Resources/Group.md)| Relationship | [R3 Group](/docs/R3/Resources/Group.md)| Relationship | R4 Group| Relationship | [R4B Group](/docs/R4B/Resources/Group.md)| Relationship | [R5 Group](/docs/R5/Resources/Group.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
