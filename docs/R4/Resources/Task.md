...
| `Task.intent` | `Task.intent` | `intent` | Task.intent | unknown \| proposal \| plan \| order \| original-order \| reflex-order \| filler-order \| instance-order \| option | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/task-intent|4.0.1` |
...
| `Task.priority` | `Task.priority` | `priority` | Task.priority | routine \| urgent \| asap \| stat | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/request-priority|4.0.1` |
...
| `Task.status` | `Task.status` | `status` | Task.status | draft \| requested \| received \| accepted \| + | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/task-status|4.0.1` |
...
This group is centered on the Structure Definition Task from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 ProcessRequest](/docs/R2/Resources/ProcessRequest.md)| Relationship | [R3 ProcessRequest](/docs/R3/Resources/ProcessRequest.md)| Relationship | R4 Task| Relationship | [R4B Task](/docs/R4B/Resources/Task.md)| Relationship | [R5 Task](/docs/R5/Resources/Task.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *0 of 29 elements used* | | *53 of 28 elements used* | | *56 of 56 elements used* | | *56 of 56 elements used* | | *54 of 63 elements used* 
...
| [R2 ProcessResponse](/docs/R2/Resources/ProcessResponse.md)| Relationship | [R3 ProcessResponse](/docs/R3/Resources/ProcessResponse.md)| Relationship | R4 Task| Relationship | [R4B Task](/docs/R4B/Resources/Task.md)| Relationship | [R5 Task](/docs/R5/Resources/Task.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | `Task`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(19172)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(19173)| **`Task`**| _Equivalent_<br/>(34060/34061)| `Task`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(48483)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(48484)| `Task`
| | | `Task.id`| _Equivalent_<br/>(19174/19175)| **`Task.id`**| _Equivalent_<br/>(34062/34063)| `Task.id`| _Equivalent_<br/>(48485/48486)| `Task.id`
| | | `Task.meta`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(19176)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(19177)| **`Task.meta`**| _Equivalent_<br/>(34064/34065)| `Task.meta`| _Equivalent_<br/>(48487/48488)| `Task.meta`
...
| | | `Task.output.type`| _Equivalent_<br/>(19269/19270)| **`Task.output.type`**| _Equivalent_<br/>(34168/34169)| `Task.output.type`| _Equivalent_<br/>(48587/48588)| `Task.output.type`
| | | `Task.output.value[x]`| →→→→ _RelatedTo_ →→→→ <br/>(19271)<hr/>←←←← _RelatedTo_ ←←←← <br/>(19272)| **`Task.output.value[x]`**| _Equivalent_<br/>(34170/34171)| `Task.output.value[x]`| →→→→ _RelatedTo_ →→→→ <br/>(48589)<hr/>←←←← _RelatedTo_ ←←←← <br/>(48590)| `Task.output.value[x]`
| *0 of 27 elements used* | | *53 of 27 elements used* | | *56 of 56 elements used* | | *56 of 56 elements used* | | *54 of 63 elements used* 
...
| [R2 Order](/docs/R2/Resources/Order.md)| Relationship | [R3 Task](/docs/R3/Resources/Task.md)| Relationship | R4 Task| Relationship | [R4B Task](/docs/R4B/Resources/Task.md)| Relationship | [R5 Task](/docs/R5/Resources/Task.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | `Task`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(19172)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(19173)| **`Task`**| _Equivalent_<br/>(34060/34061)| `Task`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(48483)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(48484)| `Task`
| | | `Task.id`| _Equivalent_<br/>(19174/19175)| **`Task.id`**| _Equivalent_<br/>(34062/34063)| `Task.id`| _Equivalent_<br/>(48485/48486)| `Task.id`
| | | `Task.meta`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(19176)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(19177)| **`Task.meta`**| _Equivalent_<br/>(34064/34065)| `Task.meta`| _Equivalent_<br/>(48487/48488)| `Task.meta`
...
| | | `Task.output.type`| _Equivalent_<br/>(19269/19270)| **`Task.output.type`**| _Equivalent_<br/>(34168/34169)| `Task.output.type`| _Equivalent_<br/>(48587/48588)| `Task.output.type`
| | | `Task.output.value[x]`| →→→→ _RelatedTo_ →→→→ <br/>(19271)<hr/>←←←← _RelatedTo_ ←←←← <br/>(19272)| **`Task.output.value[x]`**| _Equivalent_<br/>(34170/34171)| `Task.output.value[x]`| →→→→ _RelatedTo_ →→→→ <br/>(48589)<hr/>←←←← _RelatedTo_ ←←←← <br/>(48590)| `Task.output.value[x]`
| *2 of 22 elements used* | | *53 of 57 elements used* | | *56 of 56 elements used* | | *56 of 56 elements used* | | *54 of 63 elements used* 
...
| [R2 OrderResponse](/docs/R2/Resources/OrderResponse.md)| Relationship | [R3 Task](/docs/R3/Resources/Task.md)| Relationship | R4 Task| Relationship | [R4B Task](/docs/R4B/Resources/Task.md)| Relationship | [R5 Task](/docs/R5/Resources/Task.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | `Task`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(19172)<hr/>←←←← _SourceIsNarrowerThanTarget_ ←←←← <br/>(19173)| **`Task`**| _Equivalent_<br/>(34060/34061)| `Task`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(48483)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(48484)| `Task`
| | | `Task.id`| _Equivalent_<br/>(19174/19175)| **`Task.id`**| _Equivalent_<br/>(34062/34063)| `Task.id`| _Equivalent_<br/>(48485/48486)| `Task.id`
| | | `Task.meta`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(19176)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(19177)| **`Task.meta`**| _Equivalent_<br/>(34064/34065)| `Task.meta`| _Equivalent_<br/>(48487/48488)| `Task.meta`
...
| | | `Task.output.type`| _Equivalent_<br/>(19269/19270)| **`Task.output.type`**| _Equivalent_<br/>(34168/34169)| `Task.output.type`| _Equivalent_<br/>(48587/48588)| `Task.output.type`
| | | `Task.output.value[x]`| →→→→ _RelatedTo_ →→→→ <br/>(19271)<hr/>←←←← _RelatedTo_ ←←←← <br/>(19272)| **`Task.output.value[x]`**| _Equivalent_<br/>(34170/34171)| `Task.output.value[x]`| →→→→ _RelatedTo_ →→→→ <br/>(48589)<hr/>←←←← _RelatedTo_ ←←←← <br/>(48590)| `Task.output.value[x]`
| *2 of 16 elements used* | | *53 of 57 elements used* | | *56 of 56 elements used* | | *56 of 56 elements used* | | *54 of 63 elements used* 
