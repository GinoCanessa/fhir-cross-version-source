...
| `AuditEvent.action` | `AuditEvent.action` | `action` | AuditEvent.action | Type of action performed during the event | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/audit-event-action|4.0.1` |
...
| `AuditEvent.agent.network.type` | `AuditEvent.agent.network.type` | `type` | AuditEvent.agent.network.type | The type of network access point | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/network-type|4.0.1` |
...
This group is centered on the Structure Definition AuditEvent from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 AuditEvent](/docs/R2/Resources/AuditEvent.md)| Relationship | [R3 AuditEvent](/docs/R3/Resources/AuditEvent.md)| Relationship | R4 AuditEvent| Relationship | [R4B AuditEvent](/docs/R4B/Resources/AuditEvent.md)| Relationship | [R5 AuditEvent](/docs/R5/Resources/AuditEvent.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
