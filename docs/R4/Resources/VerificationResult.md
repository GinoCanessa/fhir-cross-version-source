...
This group is centered on the Structure Definition VerificationResult from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | R4 VerificationResult| Relationship | [R4B VerificationResult](/docs/R4B/Resources/VerificationResult.md)| Relationship | [R5 VerificationResult](/docs/R5/Resources/VerificationResult.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
