...
| `RelatedPerson.gender` | `RelatedPerson.gender` | `gender` | RelatedPerson.gender | male \| female \| other \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/administrative-gender|4.0.1` |
...
This group is centered on the Structure Definition RelatedPerson from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 RelatedPerson](/docs/R2/Resources/RelatedPerson.md)| Relationship | [R3 RelatedPerson](/docs/R3/Resources/RelatedPerson.md)| Relationship | R4 RelatedPerson| Relationship | [R4B RelatedPerson](/docs/R4B/Resources/RelatedPerson.md)| Relationship | [R5 RelatedPerson](/docs/R5/Resources/RelatedPerson.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
