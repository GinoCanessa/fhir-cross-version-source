...
| `EnrollmentResponse.outcome` | `EnrollmentResponse.outcome` | `outcome` | EnrollmentResponse.outcome | queued \| complete \| error \| partial | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/remittance-outcome|4.0.1` |
...
| `EnrollmentResponse.status` | `EnrollmentResponse.status` | `status` | EnrollmentResponse.status | active \| cancelled \| draft \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/fm-status|4.0.1` |
...
This group is centered on the Structure Definition EnrollmentResponse from hl7.fhir.r4.core@4.0.1 (R4, key 3).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 EnrollmentResponse](/docs/R2/Resources/EnrollmentResponse.md)| Relationship | [R3 EnrollmentResponse](/docs/R3/Resources/EnrollmentResponse.md)| Relationship | R4 EnrollmentResponse| Relationship | [R4B EnrollmentResponse](/docs/R4B/Resources/EnrollmentResponse.md)| Relationship | [R5 EnrollmentResponse](/docs/R5/Resources/EnrollmentResponse.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
