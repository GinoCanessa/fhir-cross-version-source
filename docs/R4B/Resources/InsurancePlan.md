...
| `InsurancePlan.contact` | `InsurancePlan.contact` | `contact` | InsurancePlan.contact | Contact for the product | 0..* | BackboneElement |  |  |
| `InsurancePlan.contact.address` | `InsurancePlan.contact.address` | `address` | InsurancePlan.contact.address | Visiting or postal addresses for the contact | 0..1 | Address |  |  |
| `InsurancePlan.contact.extension` | `InsurancePlan.contact.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `InsurancePlan.contact.id` | `InsurancePlan.contact.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `InsurancePlan.contact.modifierExtension` | `InsurancePlan.contact.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `InsurancePlan.contact.name` | `InsurancePlan.contact.name` | `name` | InsurancePlan.contact.name | A name associated with the contact | 0..1 | HumanName |  |  |
| `InsurancePlan.contact.purpose` | `InsurancePlan.contact.purpose` | `purpose` | InsurancePlan.contact.purpose | The type of contact | 0..1 | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/contactentity-type` |
| `InsurancePlan.contact.telecom` | `InsurancePlan.contact.telecom` | `telecom` | InsurancePlan.contact.telecom | Contact details (telephone, email, etc.)  for a contact | 0..* | ContactPoint |  |  |
...
This group is centered on the Structure Definition InsurancePlan from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | [R4 InsurancePlan](/docs/R4/Resources/InsurancePlan.md)| Relationship | R4B InsurancePlan| Relationship | [R5 InsurancePlan](/docs/R5/Resources/InsurancePlan.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| | | | | `InsurancePlan.contact.id`| _Equivalent_<br/>(28589/28590)| **`InsurancePlan.contact.id`**| | | 
| | | | | `InsurancePlan.contact.extension`| _Equivalent_<br/>(28591/28592)| **`InsurancePlan.contact.extension`**| | | 
| | | | | `InsurancePlan.contact.modifierExtension`| _Equivalent_<br/>(28593/28594)| **`InsurancePlan.contact.modifierExtension`**| | | 
| | | | | `InsurancePlan.contact.purpose`| _Equivalent_<br/>(28595/28596)| **`InsurancePlan.contact.purpose`**| | | 
| | | | | `InsurancePlan.contact.name`| _Equivalent_<br/>(28597/28598)| **`InsurancePlan.contact.name`**| | | 
| | | | | `InsurancePlan.contact.telecom`| _Equivalent_<br/>(28599/28600)| **`InsurancePlan.contact.telecom`**| | | 
| | | | | `InsurancePlan.contact.address`| _Equivalent_<br/>(28601/28602)| **`InsurancePlan.contact.address`**| | | 
