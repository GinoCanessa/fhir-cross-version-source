...
| `EpisodeOfCare.diagnosis` | `EpisodeOfCare.diagnosis` | `diagnosis` | EpisodeOfCare.diagnosis | The list of diagnosis relevant to this episode of care | 0..* | BackboneElement |  |  |
| `EpisodeOfCare.diagnosis.condition` | `EpisodeOfCare.diagnosis.condition` | `condition` | EpisodeOfCare.diagnosis.condition | Conditions/problems/diagnoses this episode of care is for | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Condition) |  |  |
...
| `EpisodeOfCare.diagnosis.rank` | `EpisodeOfCare.diagnosis.rank` | `rank` | EpisodeOfCare.diagnosis.rank | Ranking of the diagnosis (for each role type) | 0..1 | positiveInt |  |  |
| `EpisodeOfCare.diagnosis.role` | `EpisodeOfCare.diagnosis.role` | `role` | EpisodeOfCare.diagnosis.role | Role that this diagnosis has within the episode of care (e.g. admission, billing, discharge …) | 0..1 | CodeableConcept | `Preferred` | `http://hl7.org/fhir/ValueSet/diagnosis-role` |
...
| `EpisodeOfCare.language` | `EpisodeOfCare.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
| `EpisodeOfCare.managingOrganization` | `EpisodeOfCare.managingOrganization` | `managingOrganization` | EpisodeOfCare.managingOrganization | Organization that assumes care | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization) |  |  |
...
| `EpisodeOfCare.status` | `EpisodeOfCare.status` | `status` | EpisodeOfCare.status | planned \| waitlist \| active \| onhold \| finished \| cancelled \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/episode-of-care-status|4.3.0` |
...
| `EpisodeOfCare.statusHistory.status` | `EpisodeOfCare.statusHistory.status` | `status` | EpisodeOfCare.statusHistory.status | planned \| waitlist \| active \| onhold \| finished \| cancelled \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/episode-of-care-status|4.3.0` |
| `EpisodeOfCare.team` | `EpisodeOfCare.team` | `team` | EpisodeOfCare.team | Other practitioners facilitating this episode of care | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/CareTeam) |  |  |
...
This group is centered on the Structure Definition EpisodeOfCare from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 EpisodeOfCare](/docs/R2/Resources/EpisodeOfCare.md)| Relationship | [R3 EpisodeOfCare](/docs/R3/Resources/EpisodeOfCare.md)| Relationship | [R4 EpisodeOfCare](/docs/R4/Resources/EpisodeOfCare.md)| Relationship | R4B EpisodeOfCare| Relationship | [R5 EpisodeOfCare](/docs/R5/Resources/EpisodeOfCare.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
