...
| `Slot.appointmentType` | `Slot.appointmentType` | `appointmentType` | Slot.appointmentType | The style of appointment or patient that may be booked in the slot (not service type) | 0..1 | CodeableConcept | `Preferred` | `http://terminology.hl7.org/ValueSet/v2-0276` |
...
| `Slot.language` | `Slot.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
...
| `Slot.serviceType` | `Slot.serviceType` | `serviceType` | Slot.serviceType | The type of appointments that can be booked into this slot (ideally this would be an identifiable service - which is at a location, rather than the location itself). If provided then this overrides the value provided on the availability resource | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/service-type` |
...
| `Slot.status` | `Slot.status` | `status` | Slot.status | busy \| free \| busy-unavailable \| busy-tentative \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/slotstatus|4.3.0` |
...
This group is centered on the Structure Definition Slot from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Slot](/docs/R2/Resources/Slot.md)| Relationship | [R3 Slot](/docs/R3/Resources/Slot.md)| Relationship | [R4 Slot](/docs/R4/Resources/Slot.md)| Relationship | R4B Slot| Relationship | [R5 Slot](/docs/R5/Resources/Slot.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
