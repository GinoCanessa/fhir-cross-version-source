...
| `RelatedPerson.communication` | `RelatedPerson.communication` | `communication` | RelatedPerson.communication | A language which may be used to communicate with about the patient's health | 0..* | BackboneElement |  |  |
...
| `RelatedPerson.communication.language` | `RelatedPerson.communication.language` | `language` | RelatedPerson.communication.language | The language which can be used to communicate with the patient about his or her health | 1..1 | CodeableConcept | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
...
| `RelatedPerson.gender` | `RelatedPerson.gender` | `gender` | RelatedPerson.gender | male \| female \| other \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/administrative-gender|4.3.0` |
...
| `RelatedPerson.language` | `RelatedPerson.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
...
| `RelatedPerson.relationship` | `RelatedPerson.relationship` | `relationship` | RelatedPerson.relationship | The nature of the relationship | 0..* | CodeableConcept | `Preferred` | `http://hl7.org/fhir/ValueSet/relatedperson-relationshiptype` |
...
This group is centered on the Structure Definition RelatedPerson from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 RelatedPerson](/docs/R2/Resources/RelatedPerson.md)| Relationship | [R3 RelatedPerson](/docs/R3/Resources/RelatedPerson.md)| Relationship | [R4 RelatedPerson](/docs/R4/Resources/RelatedPerson.md)| Relationship | R4B RelatedPerson| Relationship | [R5 RelatedPerson](/docs/R5/Resources/RelatedPerson.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
