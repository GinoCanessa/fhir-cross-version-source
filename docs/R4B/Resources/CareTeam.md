...
| `CareTeam.encounter` | `CareTeam.encounter` | `encounter` | CareTeam.encounter | Encounter created as part of | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Encounter) |  |  |
...
| `CareTeam.language` | `CareTeam.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
...
| `CareTeam.participant.period` | `CareTeam.participant.period` | `period` | CareTeam.participant.period | Time period of participant | 0..1 | Period |  |  |
| `CareTeam.participant.role` | `CareTeam.participant.role` | `role` | CareTeam.participant.role | Type of involvement | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/careteam-participant-role` |
| `CareTeam.period` | `CareTeam.period` | `period` | CareTeam.period | Time period team covers | 0..1 | Period |  |  |
| `CareTeam.reasonCode` | `CareTeam.reasonCode` | `reasonCode` | CareTeam.reasonCode | Why the care team exists | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/clinical-findings` |
| `CareTeam.reasonReference` | `CareTeam.reasonReference` | `reasonReference` | CareTeam.reasonReference | Why the care team exists | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Condition) |  |  |
| `CareTeam.status` | `CareTeam.status` | `status` | CareTeam.status | proposed \| active \| suspended \| inactive \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/care-team-status|4.3.0` |
...
This group is centered on the Structure Definition CareTeam from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 CareTeam](/docs/R3/Resources/CareTeam.md)| Relationship | [R4 CareTeam](/docs/R4/Resources/CareTeam.md)| Relationship | R4B CareTeam| Relationship | [R5 CareTeam](/docs/R5/Resources/CareTeam.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| | | *28 of 28 elements used* | | *29 of 29 elements used* | | *29 of 29 elements used* | | *27 of 27 elements used* 
