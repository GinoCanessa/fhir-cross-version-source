...
This group is centered on the Structure Definition GraphDefinition from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 GraphDefinition](/docs/R3/Resources/GraphDefinition.md)| Relationship | [R4 GraphDefinition](/docs/R4/Resources/GraphDefinition.md)| Relationship | R4B GraphDefinition| Relationship | [R5 GraphDefinition](/docs/R5/Resources/GraphDefinition.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
