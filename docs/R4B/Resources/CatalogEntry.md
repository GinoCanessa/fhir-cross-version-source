...
| `CatalogEntry.relatedEntry.relationtype` | `CatalogEntry.relatedEntry.relationtype` | `relationtype` | CatalogEntry.relatedEntry.relationtype | triggers \| is-replaced-by | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/relation-type|4.3.0` |
| `CatalogEntry.status` | `CatalogEntry.status` | `status` | CatalogEntry.status | draft \| active \| retired \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status|4.3.0` |
...
This group is centered on the Structure Definition CatalogEntry from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | [R4 CatalogEntry](/docs/R4/Resources/CatalogEntry.md)| Relationship | R4B CatalogEntry| Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
