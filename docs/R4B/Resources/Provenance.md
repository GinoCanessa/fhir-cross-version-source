...
| `Provenance.activity` | `Provenance.activity` | `activity` | Provenance.activity | Activity that occurred | 0..1 | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/provenance-activity-type` |
...
| `Provenance.agent.onBehalfOf` | `Provenance.agent.onBehalfOf` | `onBehalfOf` | Provenance.agent.onBehalfOf | Who the agent is representing | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/PractitionerRole), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) |  |  |
...
| `Provenance.agent.type` | `Provenance.agent.type` | `type` | Provenance.agent.type | How the agent participated | 0..1 | CodeableConcept | `Extensible` | `http://hl7.org/fhir/ValueSet/provenance-agent-type` |
| `Provenance.agent.who` | `Provenance.agent.who` | `who` | Provenance.agent.who | Who participated | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/PractitionerRole), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) |  |  |
...
| `Provenance.entity.role` | `Provenance.entity.role` | `role` | Provenance.entity.role | derivation \| revision \| quotation \| source \| removal | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/provenance-entity-role|4.3.0` |
...
| `Provenance.language` | `Provenance.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
...
| `Provenance.reason` | `Provenance.reason` | `reason` | Provenance.reason | Reason the activity is occurring | 0..* | CodeableConcept | `Extensible` | `http://terminology.hl7.org/ValueSet/v3-PurposeOfUse` |
| `Provenance.recorded` | `Provenance.recorded` | `recorded` | Provenance.recorded | When the activity was recorded / updated | 1..1 | instant |  |  |
...
This group is centered on the Structure Definition Provenance from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Provenance](/docs/R2/Resources/Provenance.md)| Relationship | [R3 Provenance](/docs/R3/Resources/Provenance.md)| Relationship | [R4 Provenance](/docs/R4/Resources/Provenance.md)| Relationship | R4B Provenance| Relationship | [R5 Provenance](/docs/R5/Resources/Provenance.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
