...
| `Group.actual` | `Group.actual` | `actual` | Group.actual | Descriptive or actual | 1..1 | boolean |  |  |
...
| `Group.identifier` | `Group.identifier` | `identifier` | Group.identifier | Unique id | 0..* | Identifier |  |  |
...
| `Group.language` | `Group.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
...
| `Group.member.entity` | `Group.member.entity` | `entity` | Group.member.entity | Reference to the group member | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Group), Reference(http://hl7.org/fhir/StructureDefinition/Medication), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/PractitionerRole), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson), Reference(http://hl7.org/fhir/StructureDefinition/Substance) |  |  |
...
| `Group.type` | `Group.type` | `type` | Group.type | person \| animal \| practitioner \| device \| medication \| substance | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/group-type|4.3.0` |
### Mapping Table
...
This group is centered on the Structure Definition Group from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Group](/docs/R2/Resources/Group.md)| Relationship | [R3 Group](/docs/R3/Resources/Group.md)| Relationship | [R4 Group](/docs/R4/Resources/Group.md)| Relationship | R4B Group| Relationship | [R5 Group](/docs/R5/Resources/Group.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *30 of 30 elements used* | | *31 of 31 elements used* | | *32 of 32 elements used* | | *32 of 32 elements used* | | *31 of 33 elements used* <br/>remaining elements:<br/>`Group.description`, `Group.membership`
