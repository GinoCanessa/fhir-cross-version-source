...
| `Ingredient.language` | `Ingredient.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
...
| `Ingredient.manufacturer.role` | `Ingredient.manufacturer.role` | `role` | Ingredient.manufacturer.role | allowed \| possible \| actual | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/ingredient-manufacturer-role|4.3.0` |
...
| `Ingredient.status` | `Ingredient.status` | `status` | Ingredient.status | draft \| active \| retired \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status|4.3.0` |
...
This group is centered on the Structure Definition Ingredient from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | *No Map* | Relationship | R4B Ingredient| Relationship | [R5 Ingredient](/docs/R5/Resources/Ingredient.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
