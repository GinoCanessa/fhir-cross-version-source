...
| `Person.gender` | `Person.gender` | `gender` | Person.gender | male \| female \| other \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/administrative-gender|4.3.0` |
...
| `Person.language` | `Person.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
| `Person.link` | `Person.link` | `link` | Person.link | Link to a resource that concerns the same actual person | 0..* | BackboneElement |  |  |
| `Person.link.assurance` | `Person.link.assurance` | `assurance` | Person.link.assurance | level1 \| level2 \| level3 \| level4 | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/identity-assuranceLevel|4.3.0` |
...
| `Person.photo` | `Person.photo` | `photo` | Person.photo | Image of the person | 0..1 | Attachment |  |  |
...
This group is centered on the Structure Definition Person from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Person](/docs/R2/Resources/Person.md)| Relationship | [R3 Person](/docs/R3/Resources/Person.md)| Relationship | [R4 Person](/docs/R4/Resources/Person.md)| Relationship | R4B Person| Relationship | [R5 Person](/docs/R5/Resources/Person.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
