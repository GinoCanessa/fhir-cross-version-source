...
This group is centered on the Structure Definition SpecimenDefinition from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | [R4 SpecimenDefinition](/docs/R4/Resources/SpecimenDefinition.md)| Relationship | R4B SpecimenDefinition| Relationship | [R5 SpecimenDefinition](/docs/R5/Resources/SpecimenDefinition.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
