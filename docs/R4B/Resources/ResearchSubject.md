...
This group is centered on the Structure Definition ResearchSubject from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 ResearchSubject](/docs/R3/Resources/ResearchSubject.md)| Relationship | [R4 ResearchSubject](/docs/R4/Resources/ResearchSubject.md)| Relationship | R4B ResearchSubject| Relationship | [R5 ResearchSubject](/docs/R5/Resources/ResearchSubject.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
