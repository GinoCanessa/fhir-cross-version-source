...
| `DocumentManifest.content`| _Equivalent_<br/>(4802/4803)| `DocumentManifest.content`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(13200)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(1491)| `DocumentManifest.content`| _Equivalent_<br/>(26024/26025)| **`DocumentManifest.content`**| | | 
