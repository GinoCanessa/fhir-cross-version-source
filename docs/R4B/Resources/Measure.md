...
This group is centered on the Structure Definition Measure from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 Measure](/docs/R3/Resources/Measure.md)| Relationship | [R4 Measure](/docs/R4/Resources/Measure.md)| Relationship | R4B Measure| Relationship | [R5 Measure](/docs/R5/Resources/Measure.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
