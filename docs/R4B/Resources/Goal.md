...
| `Goal.addresses` | `Goal.addresses` | `addresses` | Goal.addresses | Issues addressed by this goal | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Condition), Reference(http://hl7.org/fhir/StructureDefinition/MedicationStatement), Reference(http://hl7.org/fhir/StructureDefinition/NutritionOrder), Reference(http://hl7.org/fhir/StructureDefinition/Observation), Reference(http://hl7.org/fhir/StructureDefinition/RiskAssessment), Reference(http://hl7.org/fhir/StructureDefinition/ServiceRequest) |  |  |
...
| `Goal.expressedBy` | `Goal.expressedBy` | `expressedBy` | Goal.expressedBy | Who's responsible for creating Goal? | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/PractitionerRole), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson) |  |  |
...
| `Goal.language` | `Goal.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
| `Goal.lifecycleStatus` | `Goal.lifecycleStatus` | `lifecycleStatus` | Goal.lifecycleStatus | proposed \| planned \| accepted \| active \| on-hold \| completed \| cancelled \| entered-in-error \| rejected | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/goal-status|4.3.0` |
...
| `Goal.outcomeCode` | `Goal.outcomeCode` | `outcomeCode` | Goal.outcomeCode | What result was achieved regarding the goal? | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/clinical-findings` |
| `Goal.outcomeReference` | `Goal.outcomeReference` | `outcomeReference` | Goal.outcomeReference | Observation that resulted from goal | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Observation) |  |  |
...
This group is centered on the Structure Definition Goal from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Goal](/docs/R2/Resources/Goal.md)| Relationship | [R3 Goal](/docs/R3/Resources/Goal.md)| Relationship | [R4 Goal](/docs/R4/Resources/Goal.md)| Relationship | R4B Goal| Relationship | [R5 Goal](/docs/R5/Resources/Goal.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
