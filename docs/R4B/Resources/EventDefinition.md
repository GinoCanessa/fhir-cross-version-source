...
| `EventDefinition.status` | `EventDefinition.status` | `status` | EventDefinition.status | draft \| active \| retired \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status|4.3.0` |
...
This group is centered on the Structure Definition EventDefinition from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | [R4 EventDefinition](/docs/R4/Resources/EventDefinition.md)| Relationship | R4B EventDefinition| Relationship | [R5 EventDefinition](/docs/R5/Resources/EventDefinition.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
