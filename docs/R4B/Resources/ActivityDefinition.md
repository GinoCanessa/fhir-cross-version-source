...
| `ActivityDefinition.publisher` | `ActivityDefinition.publisher` | `publisher` | ActivityDefinition.publisher | Name of the publisher (organization or individual) | 0..1 | string |  |  |
...
| `ActivityDefinition.specimenRequirement` | `ActivityDefinition.specimenRequirement` | `specimenRequirement` | ActivityDefinition.specimenRequirement | What specimens are required to perform this action | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/SpecimenDefinition) |  |  |
| `ActivityDefinition.status` | `ActivityDefinition.status` | `status` | ActivityDefinition.status | draft \| active \| retired \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status|4.3.0` |
| `ActivityDefinition.subject[x]` | `ActivityDefinition.subject[x]` | `subject[x]` | ActivityDefinition.subject[x] | Type of individual the activity definition is intended for | 0..1 | canonical, CodeableConcept, Reference(http://hl7.org/fhir/StructureDefinition/Group) | `Extensible` | `http://hl7.org/fhir/ValueSet/subject-type` |
...
| `ActivityDefinition.timing[x]` | `ActivityDefinition.timing[x]` | `timing[x]` | ActivityDefinition.timing[x] | When activity is to occur | 0..1 | Age, dateTime, Duration, Period, Range, Timing |  |  |
...
| `ActivityDefinition.usage` | `ActivityDefinition.usage` | `usage` | ActivityDefinition.usage | Describes the clinical usage of the activity definition | 0..1 | string |  |  |
...
This group is centered on the Structure Definition ActivityDefinition from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 ActivityDefinition](/docs/R3/Resources/ActivityDefinition.md)| Relationship | [R4 ActivityDefinition](/docs/R4/Resources/ActivityDefinition.md)| Relationship | R4B ActivityDefinition| Relationship | [R5 ActivityDefinition](/docs/R5/Resources/ActivityDefinition.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| | | *53 of 55 elements used* | | *65 of 65 elements used* | | *65 of 65 elements used* | | *65 of 71 elements used* 
