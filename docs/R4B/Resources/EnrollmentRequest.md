...
| `EnrollmentRequest.language` | `EnrollmentRequest.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
...
| `EnrollmentRequest.status` | `EnrollmentRequest.status` | `status` | EnrollmentRequest.status | active \| cancelled \| draft \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/fm-status|4.3.0` |
