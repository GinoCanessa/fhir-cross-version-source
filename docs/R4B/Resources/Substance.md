...
| `Substance.code` | `Substance.code` | `code` | Substance.code | What substance this is | 1..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/substance-code` |
| `Substance.contained` | `Substance.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `Substance.description` | `Substance.description` | `description` | Substance.description | Textual description of the substance, comments | 0..1 | string |  |  |
...
| `Substance.instance` | `Substance.instance` | `instance` | Substance.instance | If this describes a specific package/container of the substance | 0..* | BackboneElement |  |  |
| `Substance.instance.expiry` | `Substance.instance.expiry` | `expiry` | Substance.instance.expiry | When no longer valid to use | 0..1 | dateTime |  |  |
| `Substance.instance.extension` | `Substance.instance.extension` | `extension` | Element.extension | Additional content defined by implementations | 0..* | Extension |  |  |
| `Substance.instance.id` | `Substance.instance.id` | `id` | Element.id | Unique id for inter-element referencing | 0..1 | id |  |  |
| `Substance.instance.identifier` | `Substance.instance.identifier` | `identifier` | Substance.instance.identifier | Identifier of the package/container | 0..1 | Identifier |  |  |
| `Substance.instance.modifierExtension` | `Substance.instance.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
| `Substance.instance.quantity` | `Substance.instance.quantity` | `quantity` | Substance.instance.quantity | Amount of substance in the package | 0..1 | Quantity[http://hl7.org/fhir/StructureDefinition/SimpleQuantity] |  |  |
| `Substance.language` | `Substance.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
...
| `Substance.status` | `Substance.status` | `status` | Substance.status | active \| inactive \| entered-in-error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/substance-status|4.3.0` |
...
This group is centered on the Structure Definition Substance from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Substance](/docs/R2/Resources/Substance.md)| Relationship | [R3 Substance](/docs/R3/Resources/Substance.md)| Relationship | [R4 Substance](/docs/R4/Resources/Substance.md)| Relationship | R4B Substance| Relationship | [R5 Substance](/docs/R5/Resources/Substance.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
