...
| `ObservationDefinition.permittedDataType` | `ObservationDefinition.permittedDataType` | `permittedDataType` | ObservationDefinition.permittedDataType | Quantity \| CodeableConcept \| string \| boolean \| integer \| Range \| Ratio \| SampledData \| time \| dateTime \| Period | 0..* | code | `Required` | `http://hl7.org/fhir/ValueSet/permitted-data-type|4.3.0` |
...
This group is centered on the Structure Definition ObservationDefinition from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | [R4 ObservationDefinition](/docs/R4/Resources/ObservationDefinition.md)| Relationship | R4B ObservationDefinition| Relationship | [R5 ObservationDefinition](/docs/R5/Resources/ObservationDefinition.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
