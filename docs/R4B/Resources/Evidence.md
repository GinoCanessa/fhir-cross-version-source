...
| `Evidence.certainty.description` | `Evidence.certainty.description` | `description` | Evidence.certainty.description | Textual description of certainty | 0..1 | string |  |  |
...
This group is centered on the Structure Definition Evidence from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | *No Map* | Relationship | [R4 Evidence](/docs/R4/Resources/Evidence.md)| Relationship | R4B Evidence| Relationship | [R5 Evidence](/docs/R5/Resources/Evidence.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
