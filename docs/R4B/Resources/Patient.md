...
| `Patient.communication.language` | `Patient.communication.language` | `language` | Patient.communication.language | The language which can be used to communicate with the patient about his or her health | 1..1 | CodeableConcept | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
...
| `Patient.contact.gender` | `Patient.contact.gender` | `gender` | Patient.contact.gender | male \| female \| other \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/administrative-gender|4.3.0` |
...
| `Patient.gender` | `Patient.gender` | `gender` | Patient.gender | male \| female \| other \| unknown | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/administrative-gender|4.3.0` |
...
| `Patient.language` | `Patient.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-languages` |
| `Patient.link` | `Patient.link` | `link` | Patient.link | Link to another patient resource that concerns the same actual person | 0..* | BackboneElement |  |  |
...
| `Patient.link.type` | `Patient.link.type` | `type` | Patient.link.type | replaced-by \| replaces \| refer \| seealso | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/link-type|4.3.0` |
...
This group is centered on the Structure Definition Patient from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Patient](/docs/R2/Resources/Patient.md)| Relationship | [R3 Patient](/docs/R3/Resources/Patient.md)| Relationship | [R4 Patient](/docs/R4/Resources/Patient.md)| Relationship | R4B Patient| Relationship | [R5 Patient](/docs/R5/Resources/Patient.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
