...
| `Device.deviceName.name` | `Device.deviceName.name` | `name` | Device.deviceName.name | The name that identifies the device | 1..1 | string |  |  |
| `Device.deviceName.type` | `Device.deviceName.type` | `type` | Device.deviceName.type | udi-label-name \| user-friendly-name \| patient-reported-name \| manufacturer-name \| model-name \| other | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/device-nametype|4.3.0` |
...
| `Device.version.type` | `Device.version.type` | `type` | Device.version.type | The type of the device version, e.g. manufacturer, approved, internal | 0..1 | CodeableConcept |  |  |
...
This group is centered on the Structure Definition Device from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Device](/docs/R2/Resources/Device.md)| Relationship | [R3 Device](/docs/R3/Resources/Device.md)| Relationship | [R4 Device](/docs/R4/Resources/Device.md)| Relationship | R4B Device| Relationship | [R5 Device](/docs/R5/Resources/Device.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
