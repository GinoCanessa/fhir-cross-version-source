...
| `TestReport.participant.type` | `TestReport.participant.type` | `type` | TestReport.participant.type | test-engine \| client \| server | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/report-participant-type|4.3.0` |
...
| `TestReport.result` | `TestReport.result` | `result` | TestReport.result | pass \| fail \| pending | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/report-result-codes|4.3.0` |
...
This group is centered on the Structure Definition TestReport from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 TestReport](/docs/R3/Resources/TestReport.md)| Relationship | [R4 TestReport](/docs/R4/Resources/TestReport.md)| Relationship | R4B TestReport| Relationship | [R5 TestReport](/docs/R5/Resources/TestReport.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
