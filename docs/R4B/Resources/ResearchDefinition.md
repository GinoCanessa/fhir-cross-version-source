...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | | | [ResearchDefinition](/docs/R4/Resources/ResearchDefinition.md)<br/> `http://hl7.org/fhir/StructureDefinition/ResearchDefinition\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1597`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1598`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [ResearchDefinition](/docs/R4B/Resources/ResearchDefinition.md)<br/> `http://hl7.org/fhir/StructureDefinition/ResearchDefinition\|4.3.0` | <br/>*no map*<br/><hr/><br/>*no map*<br/>| | 
### Element Mappings
...
| *No Map* | Relationship | *No Map* | Relationship | [R4 ResearchDefinition](/docs/R4/Resources/ResearchDefinition.md)| Relationship | R4B ResearchDefinition| Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
