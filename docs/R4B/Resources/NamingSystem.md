...
| `NamingSystem.kind` | `NamingSystem.kind` | `kind` | NamingSystem.kind | codesystem \| identifier \| root | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/namingsystem-type|4.3.0` |
...
| `NamingSystem.status` | `NamingSystem.status` | `status` | NamingSystem.status | draft \| active \| retired \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/publication-status|4.3.0` |
...
| `NamingSystem.uniqueId.type` | `NamingSystem.uniqueId.type` | `type` | NamingSystem.uniqueId.type | oid \| uuid \| uri \| other | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/namingsystem-identifier-type|4.3.0` |
...
This group is centered on the Structure Definition NamingSystem from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 NamingSystem](/docs/R2/Resources/NamingSystem.md)| Relationship | [R3 NamingSystem](/docs/R3/Resources/NamingSystem.md)| Relationship | [R4 NamingSystem](/docs/R4/Resources/NamingSystem.md)| Relationship | R4B NamingSystem| Relationship | [R5 NamingSystem](/docs/R5/Resources/NamingSystem.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
