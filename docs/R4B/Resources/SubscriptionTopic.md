...
| `SubscriptionTopic.canFilterBy.modifier` | `SubscriptionTopic.canFilterBy.modifier` | `modifier` | SubscriptionTopic.canFilterBy.modifier | = \| eq \| ne \| gt \| lt \| ge \| le \| sa \| eb \| ap \| above \| below \| in \| not-in \| of-type | 0..* | code | `Required` | `http://hl7.org/fhir/ValueSet/subscription-search-modifier|4.3.0` |
...
| `SubscriptionTopic.canFilterBy.resource` | `SubscriptionTopic.canFilterBy.resource` | `resource` | SubscriptionTopic.canFilterBy.resource | URL of the triggering Resource that this filter applies to | 0..1 | uri | `Extensible` | `http://hl7.org/fhir/ValueSet/defined-types` |
