...
This group is centered on the Structure Definition Period from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Period](/docs/R2/ComplexTypes/Period.md)| Relationship | [R3 Period](/docs/R3/ComplexTypes/Period.md)| Relationship | [R4 Period](/docs/R4/ComplexTypes/Period.md)| Relationship | R4B Period| Relationship | [R5 Period](/docs/R5/ComplexTypes/Period.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
