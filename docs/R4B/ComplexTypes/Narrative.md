...
| `Narrative.status` | `Narrative.status` | `status` | Narrative.status | generated \| extensions \| additional \| empty | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/narrative-status|4.3.0` |
### Mapping Table

| R2 | Comparison | R3 | Comparison | R4 | Comparison | R4B | Comparison | R5
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [Narrative](/docs/R2/ComplexTypes/Narrative.md)<br/> `http://hl7.org/fhir/StructureDefinition/Narrative\|1.0.2` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `58`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `229`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Narrative](/docs/R3/ComplexTypes/Narrative.md)<br/> `http://hl7.org/fhir/StructureDefinition/Narrative\|3.0.2` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `402`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `598`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Narrative](/docs/R4/ComplexTypes/Narrative.md)<br/> `http://hl7.org/fhir/StructureDefinition/Narrative\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1355`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1356`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Narrative](/docs/R4B/ComplexTypes/Narrative.md)<br/> `http://hl7.org/fhir/StructureDefinition/Narrative\|4.3.0` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `911`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1140`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Narrative](/docs/R5/ComplexTypes/Narrative.md)<br/> `http://hl7.org/fhir/StructureDefinition/Narrative\|5.0.0` 
...
This group is centered on the Structure Definition Narrative from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Narrative](/docs/R2/ComplexTypes/Narrative.md)| Relationship | [R3 Narrative](/docs/R3/ComplexTypes/Narrative.md)| Relationship | [R4 Narrative](/docs/R4/ComplexTypes/Narrative.md)| Relationship | R4B Narrative| Relationship | [R5 Narrative](/docs/R5/ComplexTypes/Narrative.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
