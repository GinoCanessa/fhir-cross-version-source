...
This group is centered on the Structure Definition Dosage from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 Dosage](/docs/R3/ComplexTypes/Dosage.md)| Relationship | [R4 Dosage](/docs/R4/ComplexTypes/Dosage.md)| Relationship | R4B Dosage| Relationship | [R5 Dosage](/docs/R5/ComplexTypes/Dosage.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
