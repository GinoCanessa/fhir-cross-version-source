...
| `DataRequirement.sort.direction` | `DataRequirement.sort.direction` | `direction` | DataRequirement.sort.direction | ascending \| descending | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/sort-direction|4.3.0` |
...
| `DataRequirement.subject[x]` | `DataRequirement.subject[x]` | `subject[x]` | DataRequirement.subject[x] | E.g. Patient, Practitioner, RelatedPerson, Organization, Location, Device | 0..1 | CodeableConcept, Reference(http://hl7.org/fhir/StructureDefinition/Group) | `Extensible` | `http://hl7.org/fhir/ValueSet/subject-type` |
| `DataRequirement.type` | `DataRequirement.type` | `type` | DataRequirement.type | The type of the required data | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/all-types|4.3.0` |
### Mapping Table
...
This group is centered on the Structure Definition DataRequirement from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 DataRequirement](/docs/R3/ComplexTypes/DataRequirement.md)| Relationship | [R4 DataRequirement](/docs/R4/ComplexTypes/DataRequirement.md)| Relationship | R4B DataRequirement| Relationship | [R5 DataRequirement](/docs/R5/ComplexTypes/DataRequirement.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| | | *17 of 19 elements used* | | *26 of 26 elements used* | | *26 of 26 elements used* | | *26 of 33 elements used* 
