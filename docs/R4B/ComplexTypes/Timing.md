...
| `Timing.code` | `Timing.code` | `code` | Timing.code | BID \| TID \| QID \| AM \| PM \| QD \| QOD \| + | 0..1 | CodeableConcept | `Preferred` | `http://hl7.org/fhir/ValueSet/timing-abbreviation` |
...
| `Timing.modifierExtension` | `Timing.modifierExtension` | `modifierExtension` | BackboneElement.modifierExtension | Extensions that cannot be ignored even if unrecognized | 0..* | Extension |  |  |
...
| `Timing.repeat.dayOfWeek` | `Timing.repeat.dayOfWeek` | `dayOfWeek` | Timing.repeat.dayOfWeek | mon \| tue \| wed \| thu \| fri \| sat \| sun | 0..* | code | `Required` | `http://hl7.org/fhir/ValueSet/days-of-week|4.3.0` |
...
| `Timing.repeat.durationUnit` | `Timing.repeat.durationUnit` | `durationUnit` | Timing.repeat.durationUnit | s \| min \| h \| d \| wk \| mo \| a - unit of time (UCUM) | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/units-of-time|4.3.0` |
...
| `Timing.repeat.frequency` | `Timing.repeat.frequency` | `frequency` | Timing.repeat.frequency | Event occurs frequency times per period | 0..1 | positiveInt |  |  |
...
| `Timing.repeat.period` | `Timing.repeat.period` | `period` | Timing.repeat.period | Event occurs frequency times per period | 0..1 | decimal |  |  |
...
| `Timing.repeat.periodUnit` | `Timing.repeat.periodUnit` | `periodUnit` | Timing.repeat.periodUnit | s \| min \| h \| d \| wk \| mo \| a - unit of time (UCUM) | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/units-of-time|4.3.0` |
| `Timing.repeat.timeOfDay` | `Timing.repeat.timeOfDay` | `timeOfDay` | Timing.repeat.timeOfDay | Time of day for action | 0..* | time |  |  |
| `Timing.repeat.when` | `Timing.repeat.when` | `when` | Timing.repeat.when | Code for time period of occurrence | 0..* | code | `Required` | `http://hl7.org/fhir/ValueSet/event-timing|4.3.0` |
### Mapping Table

| R2 | Comparison | R3 | Comparison | R4 | Comparison | R4B | Comparison | R5
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [Timing](/docs/R2/ComplexTypes/Timing.md)<br/> `http://hl7.org/fhir/StructureDefinition/Timing\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `71`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `237`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Timing](/docs/R3/ComplexTypes/Timing.md)<br/> `http://hl7.org/fhir/StructureDefinition/Timing\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `412`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `608`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Timing](/docs/R4/ComplexTypes/Timing.md)<br/> `http://hl7.org/fhir/StructureDefinition/Timing\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1381`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1382`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Timing](/docs/R4B/ComplexTypes/Timing.md)<br/> `http://hl7.org/fhir/StructureDefinition/Timing\|4.3.0` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `923`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1152`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Timing](/docs/R5/ComplexTypes/Timing.md)<br/> `http://hl7.org/fhir/StructureDefinition/Timing\|5.0.0` 
...
This group is centered on the Structure Definition Timing from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| [R2 Timing](/docs/R2/ComplexTypes/Timing.md)| Relationship | [R3 Timing](/docs/R3/ComplexTypes/Timing.md)| Relationship | [R4 Timing](/docs/R4/ComplexTypes/Timing.md)| Relationship | R4B Timing| Relationship | [R5 Timing](/docs/R5/ComplexTypes/Timing.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
