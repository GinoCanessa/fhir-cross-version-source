...
| `Contributor.type` | `Contributor.type` | `type` | Contributor.type | author \| editor \| reviewer \| endorser | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/contributor-type|4.3.0` |
### Mapping Table
...
This group is centered on the Structure Definition Contributor from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| *No Map* | Relationship | [R3 Contributor](/docs/R3/ComplexTypes/Contributor.md)| Relationship | [R4 Contributor](/docs/R4/ComplexTypes/Contributor.md)| Relationship | R4B Contributor| Relationship | [R5 Contributor](/docs/R5/ComplexTypes/Contributor.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| | | `Contributor.extension`| →→→→ _Equivalent_ →→→→ <br/>(9268)<hr/>←←←← __ ←←←← <br/>()| `Contributor.extension`| _Equivalent_<br/>(20620/20621)| **`Contributor.extension`**| _Equivalent_<br/>(35745/35746)| `Contributor.extension`
| | | `Contributor.name`| →→→→ _RelatedTo_ →→→→ <br/>(1333)<hr/>←←←← __ ←←←← <br/>()| `Contributor.extension`| _Equivalent_<br/>(20620/20621)| **`Contributor.extension`**| _Equivalent_<br/>(35745/35746)| `Contributor.extension`
