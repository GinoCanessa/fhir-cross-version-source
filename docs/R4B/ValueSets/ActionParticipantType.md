...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/ActivityDefinition` | `ActivityDefinition.participant.type` | `http://hl7.org/fhir/ValueSet/action-participant-type\|4.3.0` | `Required` | patient \| practitioner \| related-person \| device |
| `http://hl7.org/fhir/StructureDefinition/PlanDefinition` | `PlanDefinition.action.participant.type` | `http://hl7.org/fhir/ValueSet/action-participant-type\|4.3.0` | `Required` | patient \| practitioner \| related-person \| device |
...
This group is centered on the Value Set ActionParticipantType from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 ActionParticipantType](/docs/R3/ValueSets/ActionParticipantType.md)| Relationship | [R4 ActionParticipantType](/docs/R4/ValueSets/ActionParticipantType.md)| Relationship | R4B ActionParticipantType| Relationship | [R5 ActionParticipantType](/docs/R5/ValueSets/ActionParticipantType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/action-participant-type`
