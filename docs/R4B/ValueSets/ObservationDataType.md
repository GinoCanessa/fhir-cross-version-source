...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/ObservationDefinition` | `ObservationDefinition.permittedDataType` | `http://hl7.org/fhir/ValueSet/permitted-data-type\|4.3.0` | `Required` | Quantity \| CodeableConcept \| string \| boolean \| integer \| Range \| Ratio \| SampledData \| time \| dateTime \| Period |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | | | [ObservationDataType](/docs/R4/ValueSets/ObservationDataType.md)<br/> `http://hl7.org/fhir/ValueSet/permitted-data-type\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1651`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1652`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [ObservationDataType](/docs/R4B/ValueSets/ObservationDataType.md)<br/> `http://hl7.org/fhir/ValueSet/permitted-data-type\|4.3.0` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `939`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `True`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1200`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `True`<br/>←←←←←←←| [ObservationDataType](/docs/R5/ValueSets/ObservationDataType.md)<br/> `http://hl7.org/fhir/ValueSet/permitted-data-type\|5.0.0` 
...
This group is centered on the Value Set ObservationDataType from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | [R4 ObservationDataType](/docs/R4/ValueSets/ObservationDataType.md)| Relationship | R4B ObservationDataType| Relationship | [R5 ObservationDataType](/docs/R5/ValueSets/ObservationDataType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/permitted-data-type`
