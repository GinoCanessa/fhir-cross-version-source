...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/SpecimenDefinition` | `SpecimenDefinition.typeTested.handling.temperatureQualifier` | `http://hl7.org/fhir/ValueSet/handling-condition` | `Example` | Temperature qualifier |
