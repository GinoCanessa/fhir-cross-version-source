...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/InsurancePlan` | `InsurancePlan.plan.specificCost.benefit.cost.applicability` | `http://hl7.org/fhir/ValueSet/insuranceplan-applicability\|4.3.0` | `Required` | in-network \| out-of-network \| other |
...
This group is centered on the Value Set BenefitCostApplicability from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | [R4 BenefitCostApplicability](/docs/R4/ValueSets/BenefitCostApplicability.md)| Relationship | R4B BenefitCostApplicability| Relationship | [R5 BenefitCostApplicability](/docs/R5/ValueSets/BenefitCostApplicability.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://terminology.hl7.org/CodeSystem/applicability`
