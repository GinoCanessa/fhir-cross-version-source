...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/ClinicalImpression` | `ClinicalImpression.status` | `http://hl7.org/fhir/ValueSet/clinicalimpression-status\|4.3.0` | `Required` | in-progress \| completed \| entered-in-error |
...
This group is centered on the Value Set ClinicalImpressionStatus from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 ClinicalImpressionStatus](/docs/R2/ValueSets/ClinicalImpressionStatus.md)| Relationship | [R3 ClinicalImpressionStatus](/docs/R3/ValueSets/ClinicalImpressionStatus.md)| Relationship | [R4 ClinicalImpressionStatus](/docs/R4/ValueSets/ClinicalImpressionStatus.md)| Relationship | R4B ClinicalImpressionStatus| Relationship | [R5 EventStatus](/docs/R5/ValueSets/EventStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
