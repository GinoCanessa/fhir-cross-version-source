...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | | | | | [StatisticModelCode](/docs/R4B/ValueSets/StatisticModelCode.md)<br/> `http://hl7.org/fhir/ValueSet/statistic-model-code\|4.3.0` | →→→→→→→<br/>``<br/>- DBKey: `881`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>``<br/>- DBKey: `1142`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [StatisticModelCode](/docs/R5/ValueSets/StatisticModelCode.md)<br/> `http://hl7.org/fhir/ValueSet/statistic-model-code\|5.0.0` 
...
This group is centered on the Value Set StatisticModelCode from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | *No Map* | Relationship | R4B StatisticModelCode| Relationship | [R5 StatisticModelCode](/docs/R5/ValueSets/StatisticModelCode.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://terminology.hl7.org/CodeSystem/statistic-model-code`
