...
This group is centered on the Value Set ResearchStudyStatus from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 ResearchStudyStatus](/docs/R3/ValueSets/ResearchStudyStatus.md)| Relationship | [R4 ResearchStudyStatus](/docs/R4/ValueSets/ResearchStudyStatus.md)| Relationship | R4B ResearchStudyStatus| Relationship | [R5 PublicationStatus](/docs/R5/ValueSets/PublicationStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/research-study-status`
...
| | | `completed`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(4572)<hr/>←←←← _Equivalent_ ←←←← <br/>(6886) | `administratively-completed`| _Equivalent_ <br/>(17030/17031)| **`administratively-completed`**| | | 
