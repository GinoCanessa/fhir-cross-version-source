...
This group is centered on the Value Set FocusCharacteristicCode from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | *No Map* | Relationship | R4B FocusCharacteristicCode| Relationship | [R5 FocusCharacteristicCode](/docs/R5/ValueSets/FocusCharacteristicCode.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://terminology.hl7.org/CodeSystem/focus-characteristic-code`
