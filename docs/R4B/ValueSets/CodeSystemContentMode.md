...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/CodeSystem` | `CodeSystem.content` | `http://hl7.org/fhir/ValueSet/codesystem-content-mode\|4.3.0` | `Required` | not-present \| example \| fragment \| complete \| supplement |
...
This group is centered on the Value Set CodeSystemContentMode from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 CodeSystemContentMode](/docs/R3/ValueSets/CodeSystemContentMode.md)| Relationship | [R4 CodeSystemContentMode](/docs/R4/ValueSets/CodeSystemContentMode.md)| Relationship | R4B CodeSystemContentMode| Relationship | [R5 CodeSystemContentMode](/docs/R5/ValueSets/CodeSystemContentMode.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/codesystem-content-mode`
