...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/HumanName` | `HumanName.use` | `http://hl7.org/fhir/ValueSet/name-use\|4.3.0` | `Required` | usual \| official \| temp \| nickname \| anonymous \| old \| maiden |
...
This group is centered on the Value Set NameUse from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 NameUse](/docs/R2/ValueSets/NameUse.md)| Relationship | [R3 NameUse](/docs/R3/ValueSets/NameUse.md)| Relationship | [R4 NameUse](/docs/R4/ValueSets/NameUse.md)| Relationship | R4B NameUse| Relationship | [R5 NameUse](/docs/R5/ValueSets/NameUse.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/name-use`
