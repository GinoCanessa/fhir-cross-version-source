...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/ContactPoint` | `ContactPoint.system` | `http://hl7.org/fhir/ValueSet/contact-point-system\|4.3.0` | `Required` | phone \| fax \| email \| pager \| url \| sms \| other |
