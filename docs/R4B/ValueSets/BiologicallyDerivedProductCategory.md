...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/BiologicallyDerivedProduct` | `BiologicallyDerivedProduct.productCategory` | `http://hl7.org/fhir/ValueSet/product-category\|4.3.0` | `Required` | organ \| tissue \| fluid \| cells \| biologicalAgent |
...
This group is centered on the Value Set BiologicallyDerivedProductCategory from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | [R4 BiologicallyDerivedProductCategory](/docs/R4/ValueSets/BiologicallyDerivedProductCategory.md)| Relationship | R4B BiologicallyDerivedProductCategory| Relationship | [R5 BiologicallyDerivedProductCategory](/docs/R5/ValueSets/BiologicallyDerivedProductCategory.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/product-category`
