...
This group is centered on the Value Set PatientContactRelationship from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | *No Map* | Relationship | R4B PatientContactRelationship| Relationship | [R5 PatientContactRelationship](/docs/R5/ValueSets/PatientContactRelationship.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://terminology.hl7.org/CodeSystem/v2-0131`
