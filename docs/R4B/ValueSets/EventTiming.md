...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Timing` | `Timing.repeat.when` | `http://hl7.org/fhir/ValueSet/event-timing\|4.3.0` | `Required` | Code for time period of occurrence |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [EventTiming](/docs/R2/ValueSets/EventTiming.md)<br/> `http://hl7.org/fhir/ValueSet/event-timing\|1.0.2` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `152`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `310`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [EventTiming](/docs/R3/ValueSets/EventTiming.md)<br/> `http://hl7.org/fhir/ValueSet/event-timing\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `523`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `744`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [EventTiming](/docs/R4/ValueSets/EventTiming.md)<br/> `http://hl7.org/fhir/ValueSet/event-timing\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1501`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1502`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [EventTiming](/docs/R4B/ValueSets/EventTiming.md)<br/> `http://hl7.org/fhir/ValueSet/event-timing\|4.3.0` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `1005`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1266`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [EventTiming](/docs/R5/ValueSets/EventTiming.md)<br/> `http://hl7.org/fhir/ValueSet/event-timing\|5.0.0` 
...
This group is centered on the Value Set EventTiming from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 EventTiming](/docs/R2/ValueSets/EventTiming.md)| Relationship | [R3 EventTiming](/docs/R3/ValueSets/EventTiming.md)| Relationship | [R4 EventTiming](/docs/R4/ValueSets/EventTiming.md)| Relationship | R4B EventTiming| Relationship | [R5 EventTiming](/docs/R5/ValueSets/EventTiming.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/event-timing`
...
| <td colspan="8">**R4B** System: `http://terminology.hl7.org/CodeSystem/v3-TimingEvent`
