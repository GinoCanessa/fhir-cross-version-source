...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Questionnaire` | `Questionnaire.item.enableWhen.operator` | `http://hl7.org/fhir/ValueSet/questionnaire-enable-operator\|4.3.0` | `Required` | exists \| = \| != \| > \| < \| >= \| <= |
...
This group is centered on the Value Set QuestionnaireItemOperator from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | [R4 QuestionnaireItemOperator](/docs/R4/ValueSets/QuestionnaireItemOperator.md)| Relationship | R4B QuestionnaireItemOperator| Relationship | [R5 QuestionnaireItemOperator](/docs/R5/ValueSets/QuestionnaireItemOperator.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/questionnaire-enable-operator`
