...
| `http://hl7.org/fhir/StructureDefinition/ObservationDefinition` | `ObservationDefinition.qualifiedInterval.gender` | `http://hl7.org/fhir/ValueSet/administrative-gender\|4.3.0` | `Required` | male \| female \| other \| unknown |
| `http://hl7.org/fhir/StructureDefinition/Patient` | `Patient.gender` | `http://hl7.org/fhir/ValueSet/administrative-gender\|4.3.0` | `Required` | male \| female \| other \| unknown |
| `http://hl7.org/fhir/StructureDefinition/Patient` | `Patient.contact.gender` | `http://hl7.org/fhir/ValueSet/administrative-gender\|4.3.0` | `Required` | male \| female \| other \| unknown |
| `http://hl7.org/fhir/StructureDefinition/Person` | `Person.gender` | `http://hl7.org/fhir/ValueSet/administrative-gender\|4.3.0` | `Required` | male \| female \| other \| unknown |
| `http://hl7.org/fhir/StructureDefinition/Practitioner` | `Practitioner.gender` | `http://hl7.org/fhir/ValueSet/administrative-gender\|4.3.0` | `Required` | male \| female \| other \| unknown |
| `http://hl7.org/fhir/StructureDefinition/RelatedPerson` | `RelatedPerson.gender` | `http://hl7.org/fhir/ValueSet/administrative-gender\|4.3.0` | `Required` | male \| female \| other \| unknown |
...
This group is centered on the Value Set AdministrativeGender from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 AdministrativeGender](/docs/R2/ValueSets/AdministrativeGender.md)| Relationship | [R3 AdministrativeGender](/docs/R3/ValueSets/AdministrativeGender.md)| Relationship | [R4 AdministrativeGender](/docs/R4/ValueSets/AdministrativeGender.md)| Relationship | R4B AdministrativeGender| Relationship | [R5 AdministrativeGender](/docs/R5/ValueSets/AdministrativeGender.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/administrative-gender`
