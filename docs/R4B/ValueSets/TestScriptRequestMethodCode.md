...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/TestScript` | `TestScript.setup.action.operation.method` | `http://hl7.org/fhir/ValueSet/http-operations\|4.3.0` | `Required` | delete \| get \| options \| patch \| post \| put \| head |
| `http://hl7.org/fhir/StructureDefinition/TestScript` | `TestScript.setup.action.assert.requestMethod` | `http://hl7.org/fhir/ValueSet/http-operations\|4.3.0` | `Required` | delete \| get \| options \| patch \| post \| put \| head |
...
This group is centered on the Value Set TestScriptRequestMethodCode from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 TestScriptRequestMethodCode](/docs/R3/ValueSets/TestScriptRequestMethodCode.md)| Relationship | [R4 TestScriptRequestMethodCode](/docs/R4/ValueSets/TestScriptRequestMethodCode.md)| Relationship | R4B TestScriptRequestMethodCode| Relationship | [R5 TestScriptRequestMethodCode](/docs/R5/ValueSets/TestScriptRequestMethodCode.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/http-operations`
