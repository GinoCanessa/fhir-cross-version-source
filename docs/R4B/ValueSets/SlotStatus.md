...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Slot` | `Slot.status` | `http://hl7.org/fhir/ValueSet/slotstatus\|4.3.0` | `Required` | busy \| free \| busy-unavailable \| busy-tentative \| entered-in-error |
...
This group is centered on the Value Set SlotStatus from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 SlotStatus](/docs/R2/ValueSets/SlotStatus.md)| Relationship | [R3 SlotStatus](/docs/R3/ValueSets/SlotStatus.md)| Relationship | [R4 SlotStatus](/docs/R4/ValueSets/SlotStatus.md)| Relationship | R4B SlotStatus| Relationship | [R5 SlotStatus](/docs/R5/ValueSets/SlotStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/slotstatus`
