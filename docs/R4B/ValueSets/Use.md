...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Claim` | `Claim.use` | `http://hl7.org/fhir/ValueSet/claim-use\|4.3.0` | `Required` | claim \| preauthorization \| predetermination |
| `http://hl7.org/fhir/StructureDefinition/ClaimResponse` | `ClaimResponse.use` | `http://hl7.org/fhir/ValueSet/claim-use\|4.3.0` | `Required` | claim \| preauthorization \| predetermination |
| `http://hl7.org/fhir/StructureDefinition/ExplanationOfBenefit` | `ExplanationOfBenefit.use` | `http://hl7.org/fhir/ValueSet/claim-use\|4.3.0` | `Required` | claim \| preauthorization \| predetermination |
...
This group is centered on the Value Set Use from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 Use](/docs/R2/ValueSets/Use.md)| Relationship | [R3 Use](/docs/R3/ValueSets/Use.md)| Relationship | [R4 Use](/docs/R4/ValueSets/Use.md)| Relationship | R4B Use| Relationship | [R5 Use](/docs/R5/ValueSets/Use.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/claim-use`
