...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Consent` | `Consent.status` | `http://hl7.org/fhir/ValueSet/consent-state-codes\|4.3.0` | `Required` | draft \| proposed \| active \| rejected \| inactive \| entered-in-error |
...
This group is centered on the Value Set ConsentState from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 ConsentState](/docs/R3/ValueSets/ConsentState.md)| Relationship | [R4 ConsentState](/docs/R4/ValueSets/ConsentState.md)| Relationship | R4B ConsentState| Relationship | [R5 ConsentState](/docs/R5/ValueSets/ConsentState.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/consent-state-codes`
