...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/DocumentReference` | `DocumentReference.category` | `http://hl7.org/fhir/ValueSet/doc-classcodes` | `Example` | Categorization of document |
