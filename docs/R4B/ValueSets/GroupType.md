...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Group` | `Group.type` | `http://hl7.org/fhir/ValueSet/group-type\|4.3.0` | `Required` | person \| animal \| practitioner \| device \| medication \| substance |
...
This group is centered on the Value Set GroupType from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 GroupType](/docs/R2/ValueSets/GroupType.md)| Relationship | [R3 GroupType](/docs/R3/ValueSets/GroupType.md)| Relationship | [R4 GroupType](/docs/R4/ValueSets/GroupType.md)| Relationship | R4B GroupType| Relationship | [R5 GroupType](/docs/R5/ValueSets/GroupType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/group-type`
