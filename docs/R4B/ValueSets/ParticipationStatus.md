...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Appointment` | `Appointment.participant.status` | `http://hl7.org/fhir/ValueSet/participationstatus\|4.3.0` | `Required` | accepted \| declined \| tentative \| needs-action |
| `http://hl7.org/fhir/StructureDefinition/AppointmentResponse` | `AppointmentResponse.participantStatus` | `http://hl7.org/fhir/ValueSet/participationstatus\|4.3.0` | `Required` | accepted \| declined \| tentative \| needs-action |
