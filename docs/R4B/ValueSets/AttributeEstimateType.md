...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Evidence` | `Evidence.statistic.attributeEstimate.type` | `http://hl7.org/fhir/ValueSet/attribute-estimate-type` | `Extensible` | The type of attribute estimate, eg confidence interval or p value |
...
This group is centered on the Value Set AttributeEstimateType from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | *No Map* | Relationship | R4B AttributeEstimateType| Relationship | [R5 AttributeEstimateType](/docs/R5/ValueSets/AttributeEstimateType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://terminology.hl7.org/CodeSystem/attribute-estimate-type`
