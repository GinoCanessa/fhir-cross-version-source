...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | | | | | [EvidenceVariableRole](/docs/R4B/ValueSets/EvidenceVariableRole.md)<br/> `http://hl7.org/fhir/ValueSet/variable-role\|4.3.0` | →→→→→→→<br/>``<br/>- DBKey: `884`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>``<br/>- DBKey: `1145`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [EvidenceVariableRole](/docs/R5/ValueSets/EvidenceVariableRole.md)<br/> `http://hl7.org/fhir/ValueSet/variable-role\|5.0.0` 
...
This group is centered on the Value Set EvidenceVariableRole from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | *No Map* | Relationship | R4B EvidenceVariableRole| Relationship | [R5 EvidenceVariableRole](/docs/R5/ValueSets/EvidenceVariableRole.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://terminology.hl7.org/CodeSystem/variable-role`
