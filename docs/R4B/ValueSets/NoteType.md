...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/ClaimResponse` | `ClaimResponse.processNote.type` | `http://hl7.org/fhir/ValueSet/note-type\|4.3.0` | `Required` | display \| print \| printoper |
| `http://hl7.org/fhir/StructureDefinition/ExplanationOfBenefit` | `ExplanationOfBenefit.processNote.type` | `http://hl7.org/fhir/ValueSet/note-type\|4.3.0` | `Required` | display \| print \| printoper |
| `http://hl7.org/fhir/StructureDefinition/PaymentReconciliation` | `PaymentReconciliation.processNote.type` | `http://hl7.org/fhir/ValueSet/note-type\|4.3.0` | `Required` | display \| print \| printoper |
...
This group is centered on the Value Set NoteType from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 NoteType](/docs/R2/ValueSets/NoteType.md)| Relationship | [R3 NoteType](/docs/R3/ValueSets/NoteType.md)| Relationship | [R4 NoteType](/docs/R4/ValueSets/NoteType.md)| Relationship | R4B NoteType| Relationship | [R5 NoteType](/docs/R5/ValueSets/NoteType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/note-type`
