...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Medication` | `Medication.status` | `http://hl7.org/fhir/ValueSet/medication-status\|4.3.0` | `Required` | active \| inactive \| entered-in-error |
...
This group is centered on the Value Set Medication Status Codes from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 MedicationStatus](/docs/R3/ValueSets/MedicationStatus.md)| Relationship | [R4 Medication Status Codes](/docs/R4/ValueSets/MedicationStatusCodes.md)| Relationship | R4B Medication Status Codes| Relationship | [R5 MedicationStatusCodes](/docs/R5/ValueSets/MedicationStatusCodes.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/CodeSystem/medication-status`
