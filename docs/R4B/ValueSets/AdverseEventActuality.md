...
| VS Name | AdverseEventActuality |
| Canonical URL | `http://hl7.org/fhir/ValueSet/adverse-event-actuality` |
| Version | 4.3.0 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/AdverseEvent` | `AdverseEvent.actuality` | `http://hl7.org/fhir/ValueSet/adverse-event-actuality\|4.3.0` | `Required` | actual \| potential |
...
This group is centered on the Value Set AdverseEventActuality from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | [R4 AdverseEventActuality](/docs/R4/ValueSets/AdverseEventActuality.md)| Relationship | R4B AdverseEventActuality| Relationship | [R5 AdverseEventActuality](/docs/R5/ValueSets/AdverseEventActuality.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/adverse-event-actuality`
| | | | | `actual`| _Equivalent_ <br/>(13954/13955)| **`actual`**| _Equivalent_ <br/>(7433/9698)| `actual`
| | | | | `potential`| _Equivalent_ <br/>(13956/13957)| **`potential`**| _Equivalent_ <br/>(7434/9699)| `potential`
