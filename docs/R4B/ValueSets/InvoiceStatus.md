...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Invoice` | `Invoice.status` | `http://hl7.org/fhir/ValueSet/invoice-status\|4.3.0` | `Required` | draft \| issued \| balanced \| cancelled \| entered-in-error |
...
This group is centered on the Value Set InvoiceStatus from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | [R4 InvoiceStatus](/docs/R4/ValueSets/InvoiceStatus.md)| Relationship | R4B InvoiceStatus| Relationship | [R5 InvoiceStatus](/docs/R5/ValueSets/InvoiceStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/invoice-status`
