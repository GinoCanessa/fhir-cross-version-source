...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| | | | | | | [CoverageCopayTypeCodes](/docs/R4B/ValueSets/CoverageCopayTypeCodes.md)<br/> `http://hl7.org/fhir/ValueSet/coverage-copay-type\|4.3.0` | →→→→→→→<br/>``<br/>- DBKey: `805`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>``<br/>- DBKey: `1066`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [CoverageCopayTypeCodes](/docs/R5/ValueSets/CoverageCopayTypeCodes.md)<br/> `http://hl7.org/fhir/ValueSet/coverage-copay-type\|5.0.0` 
...
This group is centered on the Value Set CoverageCopayTypeCodes from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | *No Map* | Relationship | R4B CoverageCopayTypeCodes| Relationship | [R5 CoverageCopayTypeCodes](/docs/R5/ValueSets/CoverageCopayTypeCodes.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://terminology.hl7.org/CodeSystem/coverage-copay-type`
