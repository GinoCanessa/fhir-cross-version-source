...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Communication` | `Communication.status` | `http://hl7.org/fhir/ValueSet/event-status\|4.3.0` | `Required` | preparation \| in-progress \| not-done \| on-hold \| stopped \| completed \| entered-in-error \| unknown |
| `http://hl7.org/fhir/StructureDefinition/Media` | `Media.status` | `http://hl7.org/fhir/ValueSet/event-status\|4.3.0` | `Required` | preparation \| in-progress \| not-done \| on-hold \| stopped \| completed \| entered-in-error \| unknown |
| `http://hl7.org/fhir/StructureDefinition/Procedure` | `Procedure.status` | `http://hl7.org/fhir/ValueSet/event-status\|4.3.0` | `Required` | preparation \| in-progress \| not-done \| on-hold \| stopped \| completed \| entered-in-error \| unknown |
...
This group is centered on the Value Set EventStatus from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 CommunicationStatus](/docs/R2/ValueSets/CommunicationStatus.md)| Relationship | [R3 EventStatus](/docs/R3/ValueSets/EventStatus.md)| Relationship | [R4 EventStatus](/docs/R4/ValueSets/EventStatus.md)| Relationship | R4B EventStatus| Relationship | [R5 EventStatus](/docs/R5/ValueSets/EventStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| [R2 ProcedureStatus](/docs/R2/ValueSets/ProcedureStatus.md)| Relationship | [R3 EventStatus](/docs/R3/ValueSets/EventStatus.md)| Relationship | [R4 EventStatus](/docs/R4/ValueSets/EventStatus.md)| Relationship | R4B EventStatus| Relationship | [R5 EventStatus](/docs/R5/ValueSets/EventStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/event-status`
| | | `preparation`| _Equivalent_ <br/>(3061/5266)| `preparation`| _Equivalent_ <br/>(15900/15901)| **`preparation`**| _Equivalent_ <br/>(7575/9845)| `preparation`
