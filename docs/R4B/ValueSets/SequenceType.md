...
| VS Name | sequenceType |
| Canonical URL | `http://hl7.org/fhir/ValueSet/sequence-type` |
| Version | 4.3.0 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/MolecularSequence` | `MolecularSequence.type` | `http://hl7.org/fhir/ValueSet/sequence-type\|4.3.0` | `Required` | aa \| dna \| rna |
...
This group is centered on the Value Set sequenceType from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 sequenceType](/docs/R3/ValueSets/SequenceType.md)| Relationship | [R4 sequenceType](/docs/R4/ValueSets/SequenceType.md)| Relationship | R4B sequenceType| Relationship | [R5 SequenceType](/docs/R5/ValueSets/SequenceType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/sequence-type`
| | | `aa`| _Equivalent_ <br/>(17495/17494)| `aa`| _Equivalent_ <br/>(17500/17501)| **`aa`**| _Equivalent_ <br/>(9008/11317)| `aa`
| | | `dna`| _Equivalent_ <br/>(17497/17496)| `dna`| _Equivalent_ <br/>(17502/17503)| **`dna`**| _Equivalent_ <br/>(9010/11319)| `dna`
| | | `rna`| _Equivalent_ <br/>(17499/17498)| `rna`| _Equivalent_ <br/>(17504/17505)| **`rna`**| _Equivalent_ <br/>(9009/11318)| `rna`
