...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/SubscriptionTopic` | `SubscriptionTopic.resourceTrigger.supportedInteraction` | `http://hl7.org/fhir/ValueSet/interaction-trigger\|4.3.0` | `Required` | create \| update \| delete |
...
This group is centered on the Value Set InteractionTrigger from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | *No Map* | Relationship | R4B InteractionTrigger| Relationship | [R5 InteractionTrigger](/docs/R5/ValueSets/InteractionTrigger.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
