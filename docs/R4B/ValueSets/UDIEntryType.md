...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Device` | `Device.udiCarrier.entryType` | `http://hl7.org/fhir/ValueSet/udi-entry-type\|4.3.0` | `Required` | barcode \| rfid \| manual + |
...
This group is centered on the Value Set UDIEntryType from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 UDIEntryType](/docs/R3/ValueSets/UDIEntryType.md)| Relationship | [R4 UDIEntryType](/docs/R4/ValueSets/UDIEntryType.md)| Relationship | R4B UDIEntryType| Relationship | [R5 UDIEntryType](/docs/R5/ValueSets/UDIEntryType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/udi-entry-type`
