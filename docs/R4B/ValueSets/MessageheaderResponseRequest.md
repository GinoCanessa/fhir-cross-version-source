...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/MessageDefinition` | `MessageDefinition.responseRequired` | `http://hl7.org/fhir/ValueSet/messageheader-response-request\|4.3.0` | `Required` | always \| on-error \| never \| on-success |
| `http://hl7.org/fhir/StructureDefinition/messageheader-response-request` | `Extension.value[x]` | `http://hl7.org/fhir/ValueSet/messageheader-response-request` | `Required` | Value of extension |
...
This group is centered on the Value Set messageheader-response-request from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | [R3 messageheader-response-request](/docs/R3/ValueSets/MessageheaderResponseRequest.md)| Relationship | [R4 messageheader-response-request](/docs/R4/ValueSets/MessageheaderResponseRequest.md)| Relationship | R4B messageheader-response-request| Relationship | [R5 MessageheaderResponseRequest](/docs/R5/ValueSets/MessageheaderResponseRequest.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/messageheader-response-request`
