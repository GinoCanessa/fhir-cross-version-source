...
| VS Name | AddressType |
| Canonical URL | `http://hl7.org/fhir/ValueSet/address-type` |
| Version | 4.3.0 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Address` | `Address.type` | `http://hl7.org/fhir/ValueSet/address-type\|4.3.0` | `Required` | postal \| physical \| both |
...
This group is centered on the Value Set AddressType from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 AddressType](/docs/R2/ValueSets/AddressType.md)| Relationship | [R3 AddressType](/docs/R3/ValueSets/AddressType.md)| Relationship | [R4 AddressType](/docs/R4/ValueSets/AddressType.md)| Relationship | R4B AddressType| Relationship | [R5 AddressType](/docs/R5/ValueSets/AddressType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/address-type`
| `postal`| _Equivalent_ <br/>(1/1385)| `postal`| _Equivalent_ <br/>(2879/5066)| `postal`| _Equivalent_ <br/>(13930/13931)| **`postal`**| _Equivalent_ <br/>(7404/9663)| `postal`
| `physical`| _Equivalent_ <br/>(2/1386)| `physical`| _Equivalent_ <br/>(2880/5067)| `physical`| _Equivalent_ <br/>(13932/13933)| **`physical`**| _Equivalent_ <br/>(7405/9664)| `physical`
| `both`| _Equivalent_ <br/>(3/1387)| `both`| _Equivalent_ <br/>(2881/5068)| `both`| _Equivalent_ <br/>(13934/13935)| **`both`**| _Equivalent_ <br/>(7406/9665)| `both`
