...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/TerminologyCapabilities` | `TerminologyCapabilities.codeSearch` | `http://hl7.org/fhir/ValueSet/code-search-support\|4.3.0` | `Required` | explicit \| all |
...
This group is centered on the Value Set CodeSearchSupport from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| *No Map* | Relationship | *No Map* | Relationship | [R4 CodeSearchSupport](/docs/R4/ValueSets/CodeSearchSupport.md)| Relationship | R4B CodeSearchSupport| Relationship | [R5 CodeSearchSupport](/docs/R5/ValueSets/CodeSearchSupport.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
