...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Account` | `Account.status` | `http://hl7.org/fhir/ValueSet/account-status\|4.3.0` | `Required` | active \| inactive \| entered-in-error \| on-hold \| unknown |
...
This group is centered on the Value Set AccountStatus from hl7.fhir.r4b.core@4.3.0 (R4B, key 4).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| [R2 AccountStatus](/docs/R2/ValueSets/AccountStatus.md)| Relationship | [R3 AccountStatus](/docs/R3/ValueSets/AccountStatus.md)| Relationship | [R4 AccountStatus](/docs/R4/ValueSets/AccountStatus.md)| Relationship | R4B AccountStatus| Relationship | [R5 AccountStatus](/docs/R5/ValueSets/AccountStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R4B** System: `http://hl7.org/fhir/account-status`
