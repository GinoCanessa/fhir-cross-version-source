...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Evidence` | `Evidence.studyType` | `http://hl7.org/fhir/ValueSet/study-type` | `Extensible` | The type of study that produced this evidence |
