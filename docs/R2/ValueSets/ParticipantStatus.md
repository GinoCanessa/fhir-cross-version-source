...
| **`accepted`**| →→→→ _Equivalent_ →→→→ <br/>(63)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(1436) | `accepted`| _Equivalent_ <br/>(2928/5129)| `accepted`| _Equivalent_ <br/>(16740/16741)| `accepted`| _Equivalent_ <br/>(7481/9743)| `accepted`
