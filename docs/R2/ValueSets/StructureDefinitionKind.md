...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/StructureDefinition` | `StructureDefinition.kind` | `http://hl7.org/fhir/ValueSet/structure-definition-kind` | `Required` | datatype \| resource \| logical |
...
This group is centered on the Value Set StructureDefinitionKind from hl7.fhir.r2.core@1.0.2 (R2, key 1).
