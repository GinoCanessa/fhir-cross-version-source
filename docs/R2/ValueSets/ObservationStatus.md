...
| **`amended`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(900)<hr/>←←←← _Equivalent_ ←←←← <br/>(2268) | `amended`| _Equivalent_ <br/>(3574/5860)| `amended`| _Equivalent_ <br/>(16712/16713)| `amended`| | | 
| **`amended`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(901)<hr/>←←←← _Equivalent_ ←←←← <br/>(2270) | `corrected`| _Equivalent_ <br/>(3580/5866)| `corrected`| _Equivalent_ <br/>(16714/16715)| `corrected`| | | 
