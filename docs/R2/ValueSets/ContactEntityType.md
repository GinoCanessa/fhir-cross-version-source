...
This group is centered on the Value Set ContactEntityType from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 ContactEntityType| Relationship | [R3 ContactEntityType](/docs/R3/ValueSets/ContactEntityType.md)| Relationship | [R4 ContactEntityType](/docs/R4/ValueSets/ContactEntityType.md)| Relationship | *No Map* | Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/contactentity-type`
