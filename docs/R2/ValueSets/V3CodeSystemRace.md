...
| VS Name | v3 Code System Race |
| Canonical URL | `http://hl7.org/fhir/ValueSet/v3-Race` |
| Version | 2015-07-31 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/us-core-race` | `Extension.valueCodeableConcept` | `http://hl7.org/fhir/ValueSet/v3-Race` | `Required` | Value of extension |
