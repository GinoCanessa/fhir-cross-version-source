...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/AuditEvent` | `AuditEvent.participant.media` | `http://hl7.org/fhir/ValueSet/dicm-405-mediatype` | `Extensible` | Type of media |
...
This group is centered on the Value Set Media Type Code from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 Media Type Code| Relationship | [R3 Media Type Code](/docs/R3/ValueSets/MediaTypeCode.md)| Relationship | [R4 MediaTypeCode](/docs/R4/ValueSets/MediaTypeCode.md)| Relationship | *No Map* | Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
