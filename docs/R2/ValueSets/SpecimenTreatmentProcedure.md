...
| VS Name | SpecimenTreatmentProcedure |
| Canonical URL | `http://hl7.org/fhir/ValueSet/specimen-treatment-procedure` |
| Version | 1.0.2 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Specimen` | `Specimen.treatment.procedure` | `http://hl7.org/fhir/ValueSet/specimen-treatment-procedure` | `Example` | Indicates the treatment or processing step  applied to the specimen |
