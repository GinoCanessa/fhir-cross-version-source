...
This group is centered on the Value Set FlagStatus from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 FlagStatus| Relationship | [R3 FlagStatus](/docs/R3/ValueSets/FlagStatus.md)| Relationship | [R4 FlagStatus](/docs/R4/ValueSets/FlagStatus.md)| Relationship | [R4B FlagStatus](/docs/R4B/ValueSets/FlagStatus.md)| Relationship | [R5 FlagStatus](/docs/R5/ValueSets/FlagStatus.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/flag-status`
