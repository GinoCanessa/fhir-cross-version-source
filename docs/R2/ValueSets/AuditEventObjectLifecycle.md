...
| VS Name | AuditEventObjectLifecycle |
| Canonical URL | `http://hl7.org/fhir/ValueSet/object-lifecycle` |
| Version | 1.0.2 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/AuditEvent` | `AuditEvent.object.lifecycle` | `http://hl7.org/fhir/ValueSet/object-lifecycle` | `Extensible` | Life-cycle stage for the object |
...
This group is centered on the Value Set AuditEventObjectLifecycle from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 AuditEventObjectLifecycle| Relationship | [R3 ObjectLifecycleEvents](/docs/R3/ValueSets/ObjectLifecycleEvents.md)| Relationship | [R4 ObjectLifecycleEvents](/docs/R4/ValueSets/ObjectLifecycleEvents.md)| Relationship | *No Map* | Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/object-lifecycle`
| **`1`**| _Equivalent_ <br/>(1195/2591)| `1`| →→→→ _Equivalent_ →→→→ <br/>(4642)<hr/>←←←← __ ←←←← <br/>() | `1`| | | | | 
| **`1`**| _Equivalent_ <br/>(1195/2591)| `1`| _Equivalent_ <br/>(4675/7003)| `1`| | | | | 
| **`1`**| →→→→ _Equivalent_ →→→→ <br/>(1202)<hr/>←←←← __ ←←←← <br/>() | `1`| _Equivalent_ <br/>(4653/6942)| `1`| | | | | 
| **`1`**| _Equivalent_ <br/>(1203/2599)| `1`| _Equivalent_ <br/>(4653/6942)| `1`| | | | | 
| **`2`**| _Equivalent_ <br/>(1191/2587)| `2`| →→→→ _Equivalent_ →→→→ <br/>(4638)<hr/>←←←← __ ←←←← <br/>() | `2`| | | | | 
| **`2`**| _Equivalent_ <br/>(1191/2587)| `2`| _Equivalent_ <br/>(4676/6999)| `2`| | | | | 
| **`2`**| _Equivalent_ <br/>(1196/2592)| `2`| _Equivalent_ <br/>(4645/6934)| `2`| | | | | 
| **`3`**| →→→→ _Equivalent_ →→→→ <br/>(1186)<hr/>←←←← __ ←←←← <br/>() | `3`| →→→→ _Equivalent_ →→→→ <br/>(4630)<hr/>←←←← __ ←←←← <br/>() | `3`| | | | | 
| **`3`**| →→→→ _Equivalent_ →→→→ <br/>(1186)<hr/>←←←← __ ←←←← <br/>() | `3`| _Equivalent_ <br/>(4671/6991)| `3`| | | | | 
| **`3`**| _Equivalent_ <br/>(1187/2583)| `3`| →→→→ _Equivalent_ →→→→ <br/>(4630)<hr/>←←←← __ ←←←← <br/>() | `3`| | | | | 
| **`3`**| _Equivalent_ <br/>(1187/2583)| `3`| _Equivalent_ <br/>(4671/6991)| `3`| | | | | 
| **`3`**| _Equivalent_ <br/>(1211/2607)| `3`| _Equivalent_ <br/>(4652/6941)| `3`| | | | | 
| **`4`**| _Equivalent_ <br/>(1193/2589)| `4`| →→→→ _Equivalent_ →→→→ <br/>(4631)<hr/>←←←← __ ←←←← <br/>() | `4`| | | | | 
| **`4`**| _Equivalent_ <br/>(1193/2589)| `4`| _Equivalent_ <br/>(4669/6992)| `4`| | | | | 
| **`4`**| →→→→ _Equivalent_ →→→→ <br/>(1198)<hr/>←←←← __ ←←←← <br/>() | `4`| _Equivalent_ <br/>(4651/6940)| `4`| | | | | 
| **`4`**| _Equivalent_ <br/>(1199/2595)| `4`| _Equivalent_ <br/>(4651/6940)| `4`| | | | | 
| **`5`**| →→→→ __ →→→→ <br/>(1214)<hr/>←←←← __ ←←←← <br/>() | `active`| | | | | | | 
| **`5`**| →→→→ _Equivalent_ →→→→ <br/>(1181)<hr/>←←←← __ ←←←← <br/>() | `5`| →→→→ _Equivalent_ →→→→ <br/>(4634)<hr/>←←←← __ ←←←← <br/>() | `5`| | | | | 
| **`5`**| →→→→ _Equivalent_ →→→→ <br/>(1181)<hr/>←←←← __ ←←←← <br/>() | `5`| _Equivalent_ <br/>(4668/6995)| `5`| | | | | 
| **`5`**| _Equivalent_ <br/>(1182/2578)| `5`| →→→→ _Equivalent_ →→→→ <br/>(4634)<hr/>←←←← __ ←←←← <br/>() | `5`| | | | | 
| **`5`**| _Equivalent_ <br/>(1182/2578)| `5`| _Equivalent_ <br/>(4668/6995)| `5`| | | | | 
| **`6`**| →→→→ _Equivalent_ →→→→ <br/>(1184)<hr/>←←←← __ ←←←← <br/>() | `6`| →→→→ _Equivalent_ →→→→ <br/>(4641)<hr/>←←←← __ ←←←← <br/>() | `6`| | | | | 
| **`6`**| →→→→ _Equivalent_ →→→→ <br/>(1184)<hr/>←←←← __ ←←←← <br/>() | `6`| _Equivalent_ <br/>(4679/7002)| `6`| | | | | 
| **`6`**| _Equivalent_ <br/>(1185/2581)| `6`| →→→→ _Equivalent_ →→→→ <br/>(4641)<hr/>←←←← __ ←←←← <br/>() | `6`| | | | | 
| **`6`**| _Equivalent_ <br/>(1185/2581)| `6`| _Equivalent_ <br/>(4679/7002)| `6`| | | | | 
| **`6`**| _Equivalent_ <br/>(1210/2606)| `6`| _Equivalent_ <br/>(4644/6933)| `6`| | | | | 
| **`7`**| _Equivalent_ <br/>(1180/2576)| `7`| →→→→ _Equivalent_ →→→→ <br/>(4637)<hr/>←←←← __ ←←←← <br/>() | `7`| | | | | 
| **`7`**| _Equivalent_ <br/>(1180/2576)| `7`| _Equivalent_ <br/>(4670/6998)| `7`| | | | | 
| **`7`**| _Equivalent_ <br/>(1208/2604)| `7`| _Equivalent_ <br/>(4656/6945)| `7`| | | | | 
| **`8`**| _Equivalent_ <br/>(1178/2574)| `8`| →→→→ _Equivalent_ →→→→ <br/>(4628)<hr/>←←←← __ ←←←← <br/>() | `8`| | | | | 
| **`8`**| _Equivalent_ <br/>(1178/2574)| `8`| _Equivalent_ <br/>(4680/6989)| `8`| | | | | 
| **`8`**| _Equivalent_ <br/>(1206/2602)| `8`| _Equivalent_ <br/>(4647/6936)| `8`| | | | | 
| **`9`**| _Equivalent_ <br/>(1179/2575)| `9`| →→→→ _Equivalent_ →→→→ <br/>(4629)<hr/>←←←← __ ←←←← <br/>() | `9`| | | | | 
| **`9`**| _Equivalent_ <br/>(1179/2575)| `9`| _Equivalent_ <br/>(4674/6990)| `9`| | | | | 
| **`9`**| _Equivalent_ <br/>(1209/2605)| `9`| _Equivalent_ <br/>(4650/6939)| `9`| | | | | 
| **`10`**| _Equivalent_ <br/>(1192/2588)| `10`| →→→→ _Equivalent_ →→→→ <br/>(4633)<hr/>←←←← __ ←←←← <br/>() | `10`| | | | | 
| **`10`**| _Equivalent_ <br/>(1192/2588)| `10`| _Equivalent_ <br/>(4678/6994)| `10`| | | | | 
| **`10`**| →→→→ _Equivalent_ →→→→ <br/>(1204)<hr/>←←←← __ ←←←← <br/>() | `10`| _Equivalent_ <br/>(4649/6938)| `10`| | | | | 
| **`10`**| _Equivalent_ <br/>(1205/2601)| `10`| _Equivalent_ <br/>(4649/6938)| `10`| | | | | 
| **`11`**| _Equivalent_ <br/>(1194/2590)| `11`| →→→→ _Equivalent_ →→→→ <br/>(4636)<hr/>←←←← __ ←←←← <br/>() | `11`| | | | | 
| **`11`**| _Equivalent_ <br/>(1194/2590)| `11`| _Equivalent_ <br/>(4677/6997)| `11`| | | | | 
| **`11`**| →→→→ _Equivalent_ →→→→ <br/>(1200)<hr/>←←←← __ ←←←← <br/>() | `11`| _Equivalent_ <br/>(4646/6935)| `11`| | | | | 
| **`11`**| _Equivalent_ <br/>(1201/2597)| `11`| _Equivalent_ <br/>(4646/6935)| `11`| | | | | 
| **`12`**| →→→→ _Equivalent_ →→→→ <br/>(1188)<hr/>←←←← __ ←←←← <br/>() | `12`| →→→→ _Equivalent_ →→→→ <br/>(4640)<hr/>←←←← __ ←←←← <br/>() | `12`| | | | | 
