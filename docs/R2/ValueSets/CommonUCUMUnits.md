...
| `http://unitsofmeasure.org` | `%{baseline}` | percent of baseline |
| `http://unitsofmeasure.org` | `%{binding}` | percent binding |
| `http://unitsofmeasure.org` | `%{blockade}` | percent blockade |
...
| `http://unitsofmeasure.org` | `10*3/L` | Thousand Per Liter |
...
| `http://unitsofmeasure.org` | `L/s` | liter / second |
...
| `http://unitsofmeasure.org` | `U/d` | enzyme unit per day |
...
| `http://unitsofmeasure.org` | `[PNU]` | PROTEIN NITROGEN UNITS |
...
| `http://unitsofmeasure.org` | `kU/h` | kiloUnit / hour |
...
| `http://unitsofmeasure.org` | `mA` | milliAmpère |
...
| `http://unitsofmeasure.org` | `meq/g{Cre}` | milliequivalents / gram Cre |
...
| `http://unitsofmeasure.org` | `mg/h` | milligram per hour |
...
| `http://unitsofmeasure.org` | `mmol/mol{creat}` | millimole per mole of creatinine |
...
| `http://unitsofmeasure.org` | `ng/10*6{RBCs}` | nanogram per million red blood cells |
...
| `http://unitsofmeasure.org` | `nmol/dL` | nanomole per deciliter |
...
| `http://unitsofmeasure.org` | `pmol/{RBC}` | picomole per red blood cell |
...
| `http://unitsofmeasure.org` | `ug/[sft_i]` | microgram per square foot (international) |
...
| `http://unitsofmeasure.org` | `ug/mmol` | microgram per millimole |
| `http://unitsofmeasure.org` | `ug/mmol{creat}` | microgram per millimole of creatinine |
| `http://unitsofmeasure.org` | `ug/ng` | microgram per nanogram |
| `http://unitsofmeasure.org` | `ug/{Specimen}` | microgram / Specimen |
| `http://unitsofmeasure.org` | `ug/{TotalVolume}` | MicroGramsPerTotalVolume |
| `http://unitsofmeasure.org` | `ug/{specimen}` | microgram per specimen |
| `http://unitsofmeasure.org` | `ug{FEU}/mL` | microgram fibrinogen equivalent unit per milliliter |
| `http://unitsofmeasure.org` | `ug{T4}/dL` | microgram T4 / deciliter |
| `http://unitsofmeasure.org` | `ukat` | microkatal |
| `http://unitsofmeasure.org` | `um` | micrometer |
| `http://unitsofmeasure.org` | `um/s` | micrometer per second |
| `http://unitsofmeasure.org` | `umol` | micromole |
| `http://unitsofmeasure.org` | `umol/(2.h)` | micromole per 2 hour |
| `http://unitsofmeasure.org` | `umol/(24.h)` | micromole per 24 hour |
| `http://unitsofmeasure.org` | `umol/(8.h)` | micromole per 8 hour |
| `http://unitsofmeasure.org` | `umol/L` | micromole per liter |
| `http://unitsofmeasure.org` | `umol/L/h` | micromole per liter per hour |
| `http://unitsofmeasure.org` | `umol/L{RBCs}` | micromole per liter of red blood cells |
| `http://unitsofmeasure.org` | `umol/L{rbc}` | micromole per liter of red blood cells |
| `http://unitsofmeasure.org` | `umol/d` | micromole per day |
| `http://unitsofmeasure.org` | `umol/dL` | micromole per deciliter |
| `http://unitsofmeasure.org` | `umol/dL{GF}` | micromole per deciliter of glomerular filtrate |
| `http://unitsofmeasure.org` | `umol/g` | micromole per gram |
| `http://unitsofmeasure.org` | `umol/g{Cre}` | micromole / gram Cre |
| `http://unitsofmeasure.org` | `umol/g{Hb}` | micromole per gram of hemoglobin |
| `http://unitsofmeasure.org` | `umol/g{Hgb}` | micromole / gram Hgb |
| `http://unitsofmeasure.org` | `umol/g{creat}` | micromole per gram of creatinine |
| `http://unitsofmeasure.org` | `umol/g{hemoglobin}` | micromole per gram of hemoglobin |
| `http://unitsofmeasure.org` | `umol/h` | micromole per hour |
| `http://unitsofmeasure.org` | `umol/h/L` | micromole per hour per liter |
| `http://unitsofmeasure.org` | `umol/h/g` | micromole / hour / gram |
| `http://unitsofmeasure.org` | `umol/h/mg{protein}` | micromole per hour per milligram of protein |
| `http://unitsofmeasure.org` | `umol/kg` | micromole per kilogram |
| `http://unitsofmeasure.org` | `umol/kg{feces}` | micromole per kilogram of feces |
| `http://unitsofmeasure.org` | `umol/m` | micromole / meter |
| `http://unitsofmeasure.org` | `umol/mL` | micromole per milliliter |
| `http://unitsofmeasure.org` | `umol/mL/min` | micromole per milliliter per minute |
| `http://unitsofmeasure.org` | `umol/mg` | micromole per milligram |
| `http://unitsofmeasure.org` | `umol/mg{Cre}` | micromole / milligram Cre |
| `http://unitsofmeasure.org` | `umol/mg{creat}` | micromole per milligram of creatinine |
| `http://unitsofmeasure.org` | `umol/min` | micromole per minute |
| `http://unitsofmeasure.org` | `umol/min/L` | micromole per minute per liter |
| `http://unitsofmeasure.org` | `umol/min/g` | micromole per minute per gram |
| `http://unitsofmeasure.org` | `umol/min/g{mucosa}` | micromole per minute per gram of mucosa |
| `http://unitsofmeasure.org` | `umol/min/g{protein}` | micromole per minute per gram of protein |
| `http://unitsofmeasure.org` | `umol/min/g{prot}` | micromole / minute / gram prot |
| `http://unitsofmeasure.org` | `umol/mmol` | micromole per millimole |
| `http://unitsofmeasure.org` | `umol/mmol{creat}` | micromole per millimole of creatinine |
| `http://unitsofmeasure.org` | `umol/mol` | micromole per mole |
| `http://unitsofmeasure.org` | `umol/mol{Cre}` | micromole / mole Cre |
| `http://unitsofmeasure.org` | `umol/mol{Hb}` | micromole per mole of hemoglobin |
| `http://unitsofmeasure.org` | `umol/mol{creat}` | micromole per mole of creatinine |
| `http://unitsofmeasure.org` | `umol/umol` | micromole per micromole |
| `http://unitsofmeasure.org` | `umol/umol{creat}` | micromole per micromole of creatinine |
| `http://unitsofmeasure.org` | `umol{BCE}/mol` | micromole bone collagen equivalent per mole |
...
| `http://unitsofmeasure.org` | `{#}` | # |
| `http://unitsofmeasure.org` | `{#}/L` | number per liter |
| `http://unitsofmeasure.org` | `{#}/[HPF]` | number per high power field |
| `http://unitsofmeasure.org` | `{#}/[LPF]` | number per low power field |
| `http://unitsofmeasure.org` | `{#}/mL` | number per milliliter |
| `http://unitsofmeasure.org` | `{#}/min` | number per minute |
| `http://unitsofmeasure.org` | `{#}/uL` | number per microliter |
| `http://unitsofmeasure.org` | `{2 or 3 times}/d` | 2 or 3 times / day |
| `http://unitsofmeasure.org` | `{3 times}/d` | 3 times / day |
| `http://unitsofmeasure.org` | `{4 times}/d` | 4 times / day |
| `http://unitsofmeasure.org` | `{5 times}/d` | 5 times / day |
| `http://unitsofmeasure.org` | `{AHF'U}` | AHF'U |
| `http://unitsofmeasure.org` | `{APS'U}` | IgA antiphosphatidylserine unit |
| `http://unitsofmeasure.org` | `{ARU}` | aspirin response unit |
| `http://unitsofmeasure.org` | `{Absorbance'U}` | Absorbance'U |
| `http://unitsofmeasure.org` | `{Absorbance'U}/mL` | Absorbance'U / milliliter |
...
| `http://unitsofmeasure.org` | `{Beats}/min` | Beats / minute |
| `http://unitsofmeasure.org` | `{Bottle}` | Bottle |
| `http://unitsofmeasure.org` | `{Bowls}/d` | Bowls / day |
| `http://unitsofmeasure.org` | `{Breaths}/min` | Breaths / minute |
| `http://unitsofmeasure.org` | `{CAE'U}` | complement activity enzyme unit |
| `http://unitsofmeasure.org` | `{CAG_repeats}` | CAG trinucleotide repeats |
| `http://unitsofmeasure.org` | `{CGG_repeats}` | CGG_repeats |
| `http://unitsofmeasure.org` | `{CGG}` | CGG |
| `http://unitsofmeasure.org` | `{CH100'U}` | complement CH100 unit |
| `http://unitsofmeasure.org` | `{CPM}` | counts per minute |
| `http://unitsofmeasure.org` | `{CPM}/10*3{cell}` | counts per minute per thousand cells |
| `http://unitsofmeasure.org` | `{CagRepeat}` | CagRepeat |
| `http://unitsofmeasure.org` | `{Cans}/wk` | Cans / week |
| `http://unitsofmeasure.org` | `{Can}` | Can |
| `http://unitsofmeasure.org` | `{Capsule}` | Capsule |
| `http://unitsofmeasure.org` | `{Cells}/mL` | Cells / milliliter |
...
| `http://unitsofmeasure.org` | `{Copies}/uL` | Copies / microliter |
| `http://unitsofmeasure.org` | `{Counts}/min` | Counts / minute |
| `http://unitsofmeasure.org` | `{Count}` | Count |
| `http://unitsofmeasure.org` | `{Ct}` | crossing threshold |
...
| `http://unitsofmeasure.org` | `{Disintegrations}/min` | Disintegrations / minute |
| `http://unitsofmeasure.org` | `{Dose}` | Dose |
| `http://unitsofmeasure.org` | `{Drinks}/d` | Drinks / day |
| `http://unitsofmeasure.org` | `{EIA'U}` | EIA unit |
| `http://unitsofmeasure.org` | `{EIA'U}/U` | EIA unit per enzyme Unit |
| `http://unitsofmeasure.org` | `{EIAIndex}` | EIA index |
| `http://unitsofmeasure.org` | `{EIATiter}` | EIA titer |
| `http://unitsofmeasure.org` | `{EIA_index}` | EIA index |
| `http://unitsofmeasure.org` | `{EIA_titer}` | EIA titer |
| `http://unitsofmeasure.org` | `{ELISA'U}` | ELISA unit |
| `http://unitsofmeasure.org` | `{ERY}/uL` | erythrocyte per microliter |
| `http://unitsofmeasure.org` | `{EV}` | EIA value |
| `http://unitsofmeasure.org` | `{Each}` | Each |
| `http://unitsofmeasure.org` | `{Ehrlich'U}` | Ehrlich unit |
| `http://unitsofmeasure.org` | `{Ehrlich'U}/(2.h)` | Ehrlich unit per 2 hour |
| `http://unitsofmeasure.org` | `{Ehrlich'U}/100.g` | Ehrlich unit per 100 gram |
| `http://unitsofmeasure.org` | `{Ehrlich'U}/100g` | Ehrlich unit per 100 gram |
| `http://unitsofmeasure.org` | `{Ehrlich'U}/d` | Ehrlich unit per day |
| `http://unitsofmeasure.org` | `{Ehrlich'U}/dL` | Ehrilich unit per deciliter |
| `http://unitsofmeasure.org` | `{Ehrlich'U}/mL` | Ehrlich'U / milliliter |
| `http://unitsofmeasure.org` | `{EhrlichU}/dL` | EhrlichUnitsPerDeciLiter [Arbitrary Concentration Units] |
| `http://unitsofmeasure.org` | `{Ehrlich_U}/dL` | EhrlichUnitsPerDeciLiter |
| `http://unitsofmeasure.org` | `{Elisa'U}/mL` | Elisa'U / milliliter |
| `http://unitsofmeasure.org` | `{ElisaIndex}` | ElisaIndex |
| `http://unitsofmeasure.org` | `{ElisaU}/mL` | ElisaUnitsPerMilliLiter [Arbitrary Concentration Units] |
...
| `http://unitsofmeasure.org` | `{FIU}` | fluorescent intensity unit |
...
| `http://unitsofmeasure.org` | `{GAA_repeats}` | GAA trinucleotide repeats |
| `http://unitsofmeasure.org` | `{GPS'U}` | IgG antiphosphatidylserine unit |
| `http://unitsofmeasure.org` | `{GliadinIndexValue}` | GliadinIndexValue |
| `http://unitsofmeasure.org` | `{Globules}/[HPF]` | globules (drops)  per high power field |
| `http://unitsofmeasure.org` | `{G}U` | G unit |
| `http://unitsofmeasure.org` | `{HA_titer}` | influenza hemagglutination titer |
| `http://unitsofmeasure.org` | `{HaTiter}` | HaTiter |
| `http://unitsofmeasure.org` | `{IFA_index}` | immunofluorescence assay index |
| `http://unitsofmeasure.org` | `{IFA_titer}` | Immunofluorescence assay titer |
| `http://unitsofmeasure.org` | `{INR'unit}` | INR'unit |
| `http://unitsofmeasure.org` | `{INR}` | international normalized ratio |
| `http://unitsofmeasure.org` | `{ISR}` | immune status ratio |
...
| `http://unitsofmeasure.org` | `{ImmuneComplex'U}` | immune complex unit |
...
| `http://unitsofmeasure.org` | `{InhaledTobaccoUsePacks}/d` | InhaledTobaccoUsePacks / day |
| `http://unitsofmeasure.org` | `{JDF'U}` | Juvenile Diabetes Foundation unit |
| `http://unitsofmeasure.org` | `{JDF'U}/L` | Juvenile Diabetes Foundation unit per liter |
| `http://unitsofmeasure.org` | `{JuvenileDiabetesFound'U}` | JuvenileDiabetesFound'U |
| `http://unitsofmeasure.org` | `{KCT'U}` | kaolin clotting time |
| `http://unitsofmeasure.org` | `{KRONU'U}/L` | Kronus unit per liter |
| `http://unitsofmeasure.org` | `{KRONU'U}/mL` | Kronus unit per milliliter |
| `http://unitsofmeasure.org` | `{Log_IU}` | log (base 10) international unit |
| `http://unitsofmeasure.org` | `{Log_IU}/mL` | log (base 10) international unit per milliliter |
| `http://unitsofmeasure.org` | `{Log_copies}/mL` | log (base 10) copies per milliliter |
| `http://unitsofmeasure.org` | `{Log}` | log base 10 |
| `http://unitsofmeasure.org` | `{LymeIndexValue}` | LymeIndexValue |
| `http://unitsofmeasure.org` | `{Lyme_index_value}` | Lyme index value |
| `http://unitsofmeasure.org` | `{M-PortionPhospholipids}` | M-PortionPhospholipids |
| `http://unitsofmeasure.org` | `{M.o.M.}` | M.o.M. |
| `http://unitsofmeasure.org` | `{M.o.M}` | multiple of the median |
| `http://unitsofmeasure.org` | `{MPS'U}` | IgM antiphosphatidylserine unit |
| `http://unitsofmeasure.org` | `{MPS'U}/mL` | IgM antiphosphatidylserine unit per milliliter |
...
| `http://unitsofmeasure.org` | `{NonspecifcOunce}` | NonspecifcOunce |
| `http://unitsofmeasure.org` | `{Number}` | Number |
| `http://unitsofmeasure.org` | `{OD_unit}` | optical density unit |
| `http://unitsofmeasure.org` | `{Once}/d` | Once / day |
...
| `http://unitsofmeasure.org` | `{Packs}/d` | Packs / day |
| `http://unitsofmeasure.org` | `{Pan_Bio'U}` | panbio unit |
| `http://unitsofmeasure.org` | `{Patch}` | Patch |
| `http://unitsofmeasure.org` | `{Percentile}` | Percentile |
| `http://unitsofmeasure.org` | `{Pill}` | Pill |
| `http://unitsofmeasure.org` | `{Pouches}/wk` | Pouches / week |
| `http://unitsofmeasure.org` | `{RBC}/uL` | red blood cell per microliter |
...
| `http://unitsofmeasure.org` | `{Rubella_virus}` | rubella virus |
| `http://unitsofmeasure.org` | `{STDV}` | standard deviation |
...
| `http://unitsofmeasure.org` | `{TSI_index}` | thyroid-stimulating immunoglobulin index |
| `http://unitsofmeasure.org` | `{ThyroxinUptake'U}` | ThyroxinUptake'U |
| `http://unitsofmeasure.org` | `{Times}/wk` | Times / week |
...
| `http://unitsofmeasure.org` | `{WBCs}` | white blood cells |
...
| `http://unitsofmeasure.org` | `{beats}/min` | heart beats per minute |
| `http://unitsofmeasure.org` | `{binding_index}` | binding index |
| `http://unitsofmeasure.org` | `{cells}` | cells |
| `http://unitsofmeasure.org` | `{cells}/[HPF]` | cells per high power field |
| `http://unitsofmeasure.org` | `{cells}/uL` | cells per microliter |
| `http://unitsofmeasure.org` | `{cfu}` | cfu |
| `http://unitsofmeasure.org` | `{cfu}/mL` | cfu / milliliter |
...
| `http://unitsofmeasure.org` | `{copies}/mL` | copies per milliliter |
| `http://unitsofmeasure.org` | `{copies}/ug` | copies per microgram |
| `http://unitsofmeasure.org` | `{count}` | count |
| `http://unitsofmeasure.org` | `{delta_OD}` | change in (delta) optical density |
| `http://unitsofmeasure.org` | `{dilution}` | dilution |
| `http://unitsofmeasure.org` | `{fraction}` | fraction |
| `http://unitsofmeasure.org` | `{genomes}/mL` | genomes per milliliter |
| `http://unitsofmeasure.org` | `{index_val}` | index value |
| `http://unitsofmeasure.org` | `{index}` | index |
| `http://unitsofmeasure.org` | `{kp_C}` | HOMEOPATHIC POTENCY OF CENTESIMAL KORSAKOVIAN SERIES |
| `http://unitsofmeasure.org` | `{lgCopies}/ml` | lgCopies / milliliter |
| `http://unitsofmeasure.org` | `{log_IU}/mL` | log (base 10) international unit per milliliter |
| `http://unitsofmeasure.org` | `{log_copies}/mL` | log (base 10) copies per milliliter |
| `http://unitsofmeasure.org` | `{minidrop}/min` | minidrop per minute |
| `http://unitsofmeasure.org` | `{minidrop}/s` | minidrop per second |
| `http://unitsofmeasure.org` | `{minidrp}` | minidrp |
| `http://unitsofmeasure.org` | `{mm/dd/yyyy}` | month-day-year |
| `http://unitsofmeasure.org` | `{molecule}/{platelet}` | molecule per platelet |
| `http://unitsofmeasure.org` | `{mutation}` | mutation |
| `http://unitsofmeasure.org` | `{percentile}` | percentile |
| `http://unitsofmeasure.org` | `{phenotype}` | phenotype |
| `http://unitsofmeasure.org` | `{ratio}` | ratio |
| `http://unitsofmeasure.org` | `{rbc}` | red blood cell count |
| `http://unitsofmeasure.org` | `{relative_saturation}` | relative saturation |
| `http://unitsofmeasure.org` | `{s_co_ratio}` | signal to cutoff ratio |
| `http://unitsofmeasure.org` | `{saturation}` | saturation |
| `http://unitsofmeasure.org` | `{shift}` | shift |
| `http://unitsofmeasure.org` | `{spermatozoa}/mL` | spermatozoa per milliliter |
| `http://unitsofmeasure.org` | `{spray}` | spray |
| `http://unitsofmeasure.org` | `{tbl}` | tablets |
| `http://unitsofmeasure.org` | `{titer}` | titer |
| `http://unitsofmeasure.org` | `{tot}` | particles total count |
