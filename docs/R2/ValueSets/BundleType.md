...
This group is centered on the Value Set BundleType from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 BundleType| Relationship | [R3 BundleType](/docs/R3/ValueSets/BundleType.md)| Relationship | [R4 BundleType](/docs/R4/ValueSets/BundleType.md)| Relationship | [R4B BundleType](/docs/R4B/ValueSets/BundleType.md)| Relationship | [R5 BundleType](/docs/R5/ValueSets/BundleType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/bundle-type`
