...
| **`cancelled`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(1294)<hr/>←←←← _Equivalent_ ←←←← <br/>(2742) | `cancelled`| _Equivalent_ <br/>(4865/7188)| `cancelled`| _Equivalent_ <br/>(18278/18279)| `cancelled`| _Equivalent_ <br/>(9443/11780)| `cancelled`
