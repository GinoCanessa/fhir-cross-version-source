...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/ValueSet` | `ValueSet.compose.include.filter.op` | `http://hl7.org/fhir/ValueSet/filter-operator` | `Required` | = \| is-a \| is-not-a \| regex \| in \| not-in |
...
This group is centered on the Value Set FilterOperator from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 FilterOperator| Relationship | [R3 FilterOperator](/docs/R3/ValueSets/FilterOperator.md)| Relationship | [R4 FilterOperator](/docs/R4/ValueSets/FilterOperator.md)| Relationship | [R4B FilterOperator](/docs/R4B/ValueSets/FilterOperator.md)| Relationship | [R5 FilterOperator](/docs/R5/ValueSets/FilterOperator.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/filter-operator`
