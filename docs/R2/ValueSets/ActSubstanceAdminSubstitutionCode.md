...
| Canonical URL | `http://hl7.org/fhir/ValueSet/v3-ActSubstanceAdminSubstitutionCode` |
| Version | 2014-03-26 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/MedicationDispense` | `MedicationDispense.substitution.type` | `http://hl7.org/fhir/ValueSet/v3-ActSubstanceAdminSubstitutionCode` | `Example` | Type of substitution |
| `http://hl7.org/fhir/StructureDefinition/MedicationOrder` | `MedicationOrder.substitution.type` | `http://hl7.org/fhir/ValueSet/v3-ActSubstanceAdminSubstitutionCode` | `Example` | generic \| formulary + |
