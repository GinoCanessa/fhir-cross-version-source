...
This group is centered on the Value Set VisionBase from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 VisionBase| Relationship | [R3 VisionBase](/docs/R3/ValueSets/VisionBase.md)| Relationship | [R4 VisionBase](/docs/R4/ValueSets/VisionBase.md)| Relationship | [R4B VisionBase](/docs/R4B/ValueSets/VisionBase.md)| Relationship | [R5 VisionBase](/docs/R5/ValueSets/VisionBase.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/vision-base-codes`
