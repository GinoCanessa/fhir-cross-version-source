...
| Version | 1.0.2 |
| Description | The type of response code to use for assertion.  The response code to expect in the response. |
| Status | `Draft` |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/TestScript` | `TestScript.setup.action.assert.response` | `http://hl7.org/fhir/ValueSet/assert-response-code-types` | `Required` | okay \| created \| noContent \| notModified \| bad \| forbidden \| notFound \| methodNotAllowed \| conflict \| gone \| preconditionFailed \| unprocessable |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [AssertionResponseTypes](/docs/R2/ValueSets/AssertionResponseTypes.md)<br/> `http://hl7.org/fhir/ValueSet/assert-response-code-types\|1.0.2` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `156`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `True`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `314`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `True`<br/>←←←←←←←| [AssertionResponseTypes](/docs/R3/ValueSets/AssertionResponseTypes.md)<br/> `http://hl7.org/fhir/ValueSet/assert-response-code-types\|3.0.2` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `536`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `True`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `758`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `True`<br/>←←←←←←←| [AssertionResponseTypes](/docs/R4/ValueSets/AssertionResponseTypes.md)<br/> `http://hl7.org/fhir/ValueSet/assert-response-code-types\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1391`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1392`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [AssertionResponseTypes](/docs/R4B/ValueSets/AssertionResponseTypes.md)<br/> `http://hl7.org/fhir/ValueSet/assert-response-code-types\|4.3.0` | →→→→→→→<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1019`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`RelatedTo`<br/>- DBKey: `1280`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [AssertionResponseTypes](/docs/R5/ValueSets/AssertionResponseTypes.md)<br/> `http://hl7.org/fhir/ValueSet/assert-response-code-types\|5.0.0` 
...
This group is centered on the Value Set AssertionResponseTypes from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 AssertionResponseTypes| Relationship | [R3 AssertionResponseTypes](/docs/R3/ValueSets/AssertionResponseTypes.md)| Relationship | [R4 AssertionResponseTypes](/docs/R4/ValueSets/AssertionResponseTypes.md)| Relationship | [R4B AssertionResponseTypes](/docs/R4B/ValueSets/AssertionResponseTypes.md)| Relationship | [R5 AssertionResponseTypes](/docs/R5/ValueSets/AssertionResponseTypes.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/assert-response-code-types`
| **`okay`**| _Equivalent_ <br/>(1333/2792)| `okay`| _Equivalent_ <br/>(4978/7323)| `okay`| _Equivalent_ <br/>(14512/14513)| `okay`| →→→→ _Equivalent_ →→→→ <br/>(9563)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(11928) | `okay`
| **`okay`**| _Equivalent_ <br/>(1333/2792)| `okay`| _Equivalent_ <br/>(4978/7323)| `okay`| _Equivalent_ <br/>(14512/14513)| `okay`| →→→→ _Equivalent_ →→→→ <br/>(9564)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(11903) | `accepted`
...
| **`preconditionFailed`**| _Equivalent_ <br/>(1341/2800)| `preconditionFailed`| _Equivalent_ <br/>(4986/7331)| `preconditionFailed`| _Equivalent_ <br/>(14532/14533)| `preconditionFailed`| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(9572)<hr/>←←←← _Equivalent_ ←←←← <br/>(11932) | `preconditionFailed`
