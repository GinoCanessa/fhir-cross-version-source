...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Claim` | `Claim.accidentType` | `http://hl7.org/fhir/ValueSet/v3-ActIncidentCode` | `Required` | Accident Type |
...
This group is centered on the Value Set ActIncidentCode from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 ActIncidentCode| Relationship | [R3 ActIncidentCode](/docs/R3/ValueSets/ActIncidentCode.md)| Relationship | [R4 v3.ActIncidentCode](/docs/R4/ValueSets/V3ActIncidentCode.md)| Relationship | *No Map* | Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
