...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/SupplyDelivery` | `SupplyDelivery.type` | `http://hl7.org/fhir/ValueSet/supplydelivery-type` | `Required` | Category of dispense event |
...
This group is centered on the Value Set Supply Item Type from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 Supply Item Type| Relationship | [R3 Supply Item Type](/docs/R3/ValueSets/SupplyItemType.md)| Relationship | [R4 SupplyItemType](/docs/R4/ValueSets/SupplyItemType.md)| Relationship | [R4B SupplyItemType](/docs/R4B/ValueSets/SupplyItemType.md)| Relationship | [R5 SupplyDeliverySupplyItemType](/docs/R5/ValueSets/SupplyDeliverySupplyItemType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/supply-item-type`
