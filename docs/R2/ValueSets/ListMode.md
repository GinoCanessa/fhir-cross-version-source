...
This group is centered on the Value Set ListMode from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 ListMode| Relationship | [R3 ListMode](/docs/R3/ValueSets/ListMode.md)| Relationship | [R4 ListMode](/docs/R4/ValueSets/ListMode.md)| Relationship | [R4B ListMode](/docs/R4B/ValueSets/ListMode.md)| Relationship | [R5 ListMode](/docs/R5/ValueSets/ListMode.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/list-mode`
