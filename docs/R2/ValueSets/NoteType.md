...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/ClaimResponse` | `ClaimResponse.note.type` | `http://hl7.org/fhir/ValueSet/note-type` | `Required` | display \| print \| printoper |
| `http://hl7.org/fhir/StructureDefinition/PaymentReconciliation` | `PaymentReconciliation.note.type` | `http://hl7.org/fhir/ValueSet/note-type` | `Required` | display \| print \| printoper |
| `http://hl7.org/fhir/StructureDefinition/ProcessResponse` | `ProcessResponse.notes.type` | `http://hl7.org/fhir/ValueSet/note-type` | `Required` | display \| print \| printoper |
...
This group is centered on the Value Set NoteType from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 NoteType| Relationship | [R3 NoteType](/docs/R3/ValueSets/NoteType.md)| Relationship | [R4 NoteType](/docs/R4/ValueSets/NoteType.md)| Relationship | [R4B NoteType](/docs/R4B/ValueSets/NoteType.md)| Relationship | [R5 NoteType](/docs/R5/ValueSets/NoteType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/note-type`
