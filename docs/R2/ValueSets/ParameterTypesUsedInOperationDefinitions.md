...
| VS Name | Parameter Types used in Operation Definitions |
| Canonical URL | `http://hl7.org/fhir/ValueSet/operation-parameter-type` |
| Version | 1.0.2 |
| Description | Parameter Types used in Operation Definitions |
| Status | `Draft` |
| Has Escape Valve Code | `False` |
| Database Key | `262` |
| Database Concept Count | `150` |
| Database Active Concept Count | `150` |
### Bindings

| Source | Element | Binding | Strength | Element Short |
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/OperationDefinition` | `OperationDefinition.parameter.type` | `http://hl7.org/fhir/ValueSet/operation-parameter-type` | `Required` | What type this parameter has |
...
| `http://hl7.org/fhir/resource-types` | `Conformance` | Conformance |
...
| `http://hl7.org/fhir/resource-types` | `DeviceUseRequest` | DeviceUseRequest |
| `http://hl7.org/fhir/resource-types` | `DeviceUseStatement` | DeviceUseStatement |
| `http://hl7.org/fhir/resource-types` | `DiagnosticOrder` | DiagnosticOrder |
...
| `http://hl7.org/fhir/resource-types` | `ImagingObjectSelection` | ImagingObjectSelection |
...
| `http://hl7.org/fhir/resource-types` | `MedicationOrder` | MedicationOrder |
...
| `http://hl7.org/fhir/resource-types` | `Order` | Order |
| `http://hl7.org/fhir/resource-types` | `OrderResponse` | OrderResponse |
...
| `http://hl7.org/fhir/search-param-type` | `date` | Date/DateTime |
