...
| **`proposed`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(438)<hr/>←←←← _Equivalent_ ←←←← <br/>(12273) | `proposal`| _Equivalent_ <br/>(3582/5875)| `proposal`| _Equivalent_ <br/>(16952/16953)| `proposal`| _Equivalent_ <br/>(7412/9671)| `proposal`
| **`draft`**| | | | | | | | | 
...
| **`accepted`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(430)<hr/>←←←← _Equivalent_ ←←←← <br/>(12277) | `instance-order`| _Equivalent_ <br/>(3583/5870)| `instance-order`| _Equivalent_ <br/>(16966/16967)| `instance-order`| _Equivalent_ <br/>(7413/9672)| `instance-order`
...
| **`review`**| | | | | | | | | 
| **`completed`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(433)<hr/>←←←← _Equivalent_ ←←←← <br/>(12279) | `instance-order`| _Equivalent_ <br/>(3583/5870)| `instance-order`| _Equivalent_ <br/>(16966/16967)| `instance-order`| _Equivalent_ <br/>(7413/9672)| `instance-order`
| **`cancelled`**| | | | | | | | | 
| **`suspended`**| | | | | | | | | 
| **`rejected`**| | | | | | | | | 
| **`failed`**| | | | | | | | | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/diagnostic-order-status`
| **`proposed`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(438)<hr/>←←←← _Equivalent_ ←←←← <br/>(12273) | `proposal`| _Equivalent_ <br/>(4923/7254)| `proposal`| _Equivalent_ <br/>(18296/18297)| `proposal`| _Equivalent_ <br/>(9506/11845)| `proposal`
| **`draft`**| | | | | | | | | 
...
| **`accepted`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(430)<hr/>←←←← _Equivalent_ ←←←← <br/>(12277) | `instance-order`| _Equivalent_ <br/>(4918/7249)| `instance-order`| _Equivalent_ <br/>(18308/18309)| `instance-order`| _Equivalent_ <br/>(9501/11840)| `instance-order`
...
| **`review`**| | | | | | | | | 
| **`completed`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(433)<hr/>←←←← _Equivalent_ ←←←← <br/>(12279) | `instance-order`| _Equivalent_ <br/>(4918/7249)| `instance-order`| _Equivalent_ <br/>(18308/18309)| `instance-order`| _Equivalent_ <br/>(9501/11840)| `instance-order`
| **`cancelled`**| | | | | | | | | 
| **`suspended`**| | | | | | | | | 
| **`rejected`**| | | | | | | | | 
| **`failed`**| | | | | | | | | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/diagnostic-order-status`
| **`proposed`**| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(451)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(2389) | `draft`| _Equivalent_ <br/>(3046/5256)| `draft`| _Equivalent_ <br/>(17008/17009)| `draft`| _Equivalent_ <br/>(7562/9832)| `draft`
| **`draft`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(453)<hr/>←←←← _Equivalent_ ←←←← <br/>(2387) | `draft`| _Equivalent_ <br/>(3046/5256)| `draft`| _Equivalent_ <br/>(17008/17009)| `draft`| _Equivalent_ <br/>(7562/9832)| `draft`
| **`planned`**| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(445)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(2388) | `draft`| _Equivalent_ <br/>(3046/5256)| `draft`| _Equivalent_ <br/>(17008/17009)| `draft`| _Equivalent_ <br/>(7562/9832)| `draft`
...
| **`cancelled`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(454)<hr/>←←←← _Equivalent_ ←←←← <br/>(2384) | `cancelled`| _Equivalent_ <br/>(3048/5259)| `revoked`| _Equivalent_ <br/>(17014/17015)| `revoked`| _Equivalent_ <br/>(7565/9835)| `revoked`
