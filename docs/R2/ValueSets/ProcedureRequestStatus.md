...
| **`proposed`**| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(986)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(2374) | `draft`| _Equivalent_ <br/>(3046/5256)| `draft`| _Equivalent_ <br/>(17008/17009)| `draft`| _Equivalent_ <br/>(7562/9832)| `draft`
| **`draft`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(984)<hr/>←←←← _Equivalent_ ←←←← <br/>(2373) | `draft`| _Equivalent_ <br/>(3046/5256)| `draft`| _Equivalent_ <br/>(17008/17009)| `draft`| _Equivalent_ <br/>(7562/9832)| `draft`
| **`requested`**| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(990)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(2375) | `draft`| _Equivalent_ <br/>(3046/5256)| `draft`| _Equivalent_ <br/>(17008/17009)| `draft`| _Equivalent_ <br/>(7562/9832)| `draft`
...
| **`accepted`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(982)<hr/>←←←← _Equivalent_ ←←←← <br/>(2366) | `active`| _Equivalent_ <br/>(3047/5254)| `active`| _Equivalent_ <br/>(17010/17011)| `active`| _Equivalent_ <br/>(7563/9833)| `active`
| **`in-progress`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(985)<hr/>←←←← _Equivalent_ ←←←← <br/>(2367) | `active`| _Equivalent_ <br/>(3047/5254)| `active`| _Equivalent_ <br/>(17010/17011)| `active`| _Equivalent_ <br/>(7563/9833)| `active`
| **`completed`**| →→→→ _SourceIsBroaderThanTarget_ →→→→ <br/>(983)<hr/>←←←← _Equivalent_ ←←←← <br/>(2371) | `completed`| _Equivalent_ <br/>(3049/5255)| `completed`| _Equivalent_ <br/>(17016/17017)| `completed`| _Equivalent_ <br/>(7564/9834)| `completed`
