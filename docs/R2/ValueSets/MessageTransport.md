...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Conformance` | `Conformance.messaging.endpoint.protocol` | `http://hl7.org/fhir/ValueSet/message-transport` | `Extensible` | http \| ftp \| mllp + |
...
This group is centered on the Value Set MessageTransport from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 MessageTransport| Relationship | [R3 MessageTransport](/docs/R3/ValueSets/MessageTransport.md)| Relationship | [R4 MessageTransport](/docs/R4/ValueSets/MessageTransport.md)| Relationship | *No Map* | Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/message-transport`
