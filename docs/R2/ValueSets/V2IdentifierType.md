...
| `http://hl7.org/fhir/v2/0203` | `BC` | Bank Card Number |
...
| `http://hl7.org/fhir/v2/0203` | `MC` | Patient's Medicare number |
...
| `http://hl7.org/fhir/v2/0203` | `RPH` | Pharmacist license number |
