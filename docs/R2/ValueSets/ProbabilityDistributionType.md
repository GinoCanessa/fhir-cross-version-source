...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/iso21090-uncertaintyType` | `Extension.valueCode` | `http://hl7.org/fhir/ValueSet/probability-distribution-type` | `Required` | Value of extension |
