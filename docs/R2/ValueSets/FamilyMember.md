...
| Canonical URL | `http://hl7.org/fhir/ValueSet/v3-FamilyMember` |
| Version | 2014-03-26 |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/FamilyMemberHistory` | `FamilyMemberHistory.relationship` | `http://hl7.org/fhir/ValueSet/v3-FamilyMember` | `Example` | Relationship to the subject |
