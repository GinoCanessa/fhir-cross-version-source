...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Patient` | `Patient.link.type` | `http://hl7.org/fhir/ValueSet/link-type` | `Required` | replace \| refer \| seealso - type of link |
...
This group is centered on the Value Set LinkType from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 LinkType| Relationship | [R3 LinkType](/docs/R3/ValueSets/LinkType.md)| Relationship | [R4 LinkType](/docs/R4/ValueSets/LinkType.md)| Relationship | [R4B LinkType](/docs/R4B/ValueSets/LinkType.md)| Relationship | [R5 LinkType](/docs/R5/ValueSets/LinkType.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/link-type`
