...
This group is centered on the Value Set DaysOfWeek from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All codes from this value set are listed while other value sets only show contents that have relationships with those codes.

| R2 DaysOfWeek| Relationship | [R3 DaysOfWeek](/docs/R3/ValueSets/DaysOfWeek.md)| Relationship | [R4 DaysOfWeek](/docs/R4/ValueSets/DaysOfWeek.md)| Relationship | [R4B DaysOfWeek](/docs/R4B/ValueSets/DaysOfWeek.md)| Relationship | [R5 DaysOfWeek](/docs/R5/ValueSets/DaysOfWeek.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| <td colspan="8">**R2** System: `http://hl7.org/fhir/days-of-week`
