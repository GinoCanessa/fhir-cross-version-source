...
| VS Name | Immunization Reason Codes |
...
| ------ | ------- | ------- | -------- | ------------- |
| `http://hl7.org/fhir/StructureDefinition/Immunization` | `Immunization.explanation.reason` | `http://hl7.org/fhir/ValueSet/immunization-reason` | `Example` | Why immunization occurred |
