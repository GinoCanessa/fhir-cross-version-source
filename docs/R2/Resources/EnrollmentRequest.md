...
| `EnrollmentRequest.coverage` | `EnrollmentRequest.coverage` | `coverage` |  | Insurance information | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Coverage) |  |  |
...
| `EnrollmentRequest.language` | `EnrollmentRequest.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
...
| `EnrollmentRequest.originalRuleset` | `EnrollmentRequest.originalRuleset` | `originalRuleset` |  | Original version | 0..1 | Coding | `Example` | `http://hl7.org/fhir/ValueSet/ruleset` |
...
| `EnrollmentRequest.relationship` | `EnrollmentRequest.relationship` | `relationship` |  | Patient relationship to subscriber | 1..1 | Coding | `Example` | `http://hl7.org/fhir/ValueSet/relationship` |
| `EnrollmentRequest.ruleset` | `EnrollmentRequest.ruleset` | `ruleset` |  | Resource version | 0..1 | Coding | `Example` | `http://hl7.org/fhir/ValueSet/ruleset` |
| `EnrollmentRequest.subject` | `EnrollmentRequest.subject` | `subject` |  | The subject of the Products and Services | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Patient) |  |  |
| `EnrollmentRequest.target` | `EnrollmentRequest.target` | `target` |  | Insurer | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization) |  |  |
...
This group is centered on the Structure Definition EnrollmentRequest from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 EnrollmentRequest| Relationship | [R3 EnrollmentRequest](/docs/R3/Resources/EnrollmentRequest.md)| Relationship | [R4 EnrollmentRequest](/docs/R4/Resources/EnrollmentRequest.md)| Relationship | [R4B EnrollmentRequest](/docs/R4B/Resources/EnrollmentRequest.md)| Relationship | [R5 EnrollmentRequest](/docs/R5/Resources/EnrollmentRequest.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
