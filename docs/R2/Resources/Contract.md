...
| -- | ---- | ---- | --------- | ----- | ----------- | ------------- | ---------------- | ----------------- |
| `Contract` | `Contract` | `Contract` | Contract | Contract | 0..* | Contract |  |  |
| `Contract.action` | `Contract.action` | `action` |  | Contract Action | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/contract-action` |
| `Contract.actionReason` | `Contract.actionReason` | `actionReason` |  | Contract Action Reason | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/v3-PurposeOfUse` |
| `Contract.actor` | `Contract.actor` | `actor` |  | Contract Actor | 0..* | BackboneElement |  |  |
| `Contract.actor.entity` | `Contract.actor.entity` | `entity` |  | Contract Actor Type | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Contract), Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Group), Reference(http://hl7.org/fhir/StructureDefinition/Location), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson), Reference(http://hl7.org/fhir/StructureDefinition/Substance) |  |  |
| `Contract.actor.extension` | `Contract.actor.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Contract.actor.id` | `Contract.actor.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Contract.actor.modifierExtension` | `Contract.actor.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Contract.actor.role` | `Contract.actor.role` | `role` |  | Contract  Actor Role | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/contract-actorrole` |
...
| `Contract.friendly.extension` | `Contract.friendly.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Contract.friendly.id` | `Contract.friendly.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Contract.friendly.modifierExtension` | `Contract.friendly.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Contract.id` | `Contract.id` | `id` | Resource.id | Logical id of this artifact | 0..1 | id |  |  |
| `Contract.identifier` | `Contract.identifier` | `identifier` |  | Contract identifier | 0..1 | Identifier |  |  |
...
| `Contract.language` | `Contract.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
...
| `Contract.legal.extension` | `Contract.legal.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Contract.legal.id` | `Contract.legal.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Contract.legal.modifierExtension` | `Contract.legal.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Contract.rule.extension` | `Contract.rule.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Contract.rule.id` | `Contract.rule.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Contract.rule.modifierExtension` | `Contract.rule.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Contract.signer` | `Contract.signer` | `signer` |  | Contract Signer | 0..* | BackboneElement |  |  |
| `Contract.signer.extension` | `Contract.signer.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Contract.signer.id` | `Contract.signer.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Contract.signer.modifierExtension` | `Contract.signer.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Contract.signer.signature` | `Contract.signer.signature` | `signature` |  | Contract Documentation Signature | 1..1 | string |  |  |
| `Contract.signer.type` | `Contract.signer.type` | `type` |  | Contract Signer Type | 1..1 | Coding | `Preferred` | `http://hl7.org/fhir/ValueSet/contract-signer-type` |
| `Contract.subType` | `Contract.subType` | `subType` |  | Contract Subtype | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/contract-subtype` |
| `Contract.subject` | `Contract.subject` | `subject` |  | Subject of this Contract | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Resource) |  |  |
| `Contract.term` | `Contract.term` | `term` |  | Contract Term List | 0..* | BackboneElement |  |  |
| `Contract.term.action` | `Contract.term.action` | `action` |  | Contract Term Action | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/contract-action` |
| `Contract.term.actionReason` | `Contract.term.actionReason` | `actionReason` |  | Contract Term Action Reason | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/v3-PurposeOfUse` |
| `Contract.term.actor` | `Contract.term.actor` | `actor` |  | Contract Term Actor List | 0..* | BackboneElement |  |  |
| `Contract.term.actor.entity` | `Contract.term.actor.entity` | `entity` |  | Contract Term Actor | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Contract), Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Group), Reference(http://hl7.org/fhir/StructureDefinition/Location), Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner), Reference(http://hl7.org/fhir/StructureDefinition/RelatedPerson), Reference(http://hl7.org/fhir/StructureDefinition/Substance) |  |  |
| `Contract.term.actor.extension` | `Contract.term.actor.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Contract.term.actor.id` | `Contract.term.actor.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Contract.term.actor.modifierExtension` | `Contract.term.actor.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Contract.term.actor.role` | `Contract.term.actor.role` | `role` |  | Contract Term Actor Role | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/contract-actorrole` |
| `Contract.term.applies` | `Contract.term.applies` | `applies` |  | Contract Term Effective Time | 0..1 | Period |  |  |
| `Contract.term.extension` | `Contract.term.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Contract.term.group` | `Contract.term.group` | `group` |  | Nested Contract Term Group | 0..* | Contract.term |  |  |
| `Contract.term.id` | `Contract.term.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Contract.term.identifier` | `Contract.term.identifier` | `identifier` |  | Contract Term identifier | 0..1 | Identifier |  |  |
| `Contract.term.issued` | `Contract.term.issued` | `issued` |  | Contract Term Issue Date Time | 0..1 | dateTime |  |  |
| `Contract.term.modifierExtension` | `Contract.term.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Contract.term.subType` | `Contract.term.subType` | `subType` |  | Contract Term Subtype | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/contract-term-subtype` |
| `Contract.term.subject` | `Contract.term.subject` | `subject` |  | Subject of this Contract Term | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Resource) |  |  |
| `Contract.term.text` | `Contract.term.text` | `text` |  | Human readable Contract term text | 0..1 | string |  |  |
| `Contract.term.type` | `Contract.term.type` | `type` |  | Contract Term Type | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/contract-term-type` |
| `Contract.term.valuedItem` | `Contract.term.valuedItem` | `valuedItem` |  | Contract Term Valued Item | 0..* | BackboneElement |  |  |
...
| `Contract.term.valuedItem.extension` | `Contract.term.valuedItem.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
...
| `Contract.term.valuedItem.id` | `Contract.term.valuedItem.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Contract.term.valuedItem.identifier` | `Contract.term.valuedItem.identifier` | `identifier` |  | Contract Term Valued Item Identifier | 0..1 | Identifier |  |  |
| `Contract.term.valuedItem.modifierExtension` | `Contract.term.valuedItem.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Contract.term.valuedItem.net` | `Contract.term.valuedItem.net` | `net` |  | Total Contract Term Valued Item Value | 0..1 | Quantity[http://hl7.org/fhir/StructureDefinition/Money] |  |  |
...
| `Contract.term.valuedItem.unitPrice` | `Contract.term.valuedItem.unitPrice` | `unitPrice` |  | Contract Term Valued Item fee, charge, or cost | 0..1 | Quantity[http://hl7.org/fhir/StructureDefinition/Money] |  |  |
| `Contract.text` | `Contract.text` | `text` | DomainResource.text | Text summary of the resource, for human interpretation | 0..1 | Narrative |  |  |
| `Contract.type` | `Contract.type` | `type` |  | Contract Tyoe | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/contract-type` |
| `Contract.valuedItem` | `Contract.valuedItem` | `valuedItem` |  | Contract Valued Item | 0..* | BackboneElement |  |  |
...
| `Contract.valuedItem.extension` | `Contract.valuedItem.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Contract.valuedItem.factor` | `Contract.valuedItem.factor` | `factor` |  | Contract Valued Item Price Scaling Factor | 0..1 | decimal |  |  |
| `Contract.valuedItem.id` | `Contract.valuedItem.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Contract.valuedItem.identifier` | `Contract.valuedItem.identifier` | `identifier` |  | Contract Valued Item Identifier | 0..1 | Identifier |  |  |
| `Contract.valuedItem.modifierExtension` | `Contract.valuedItem.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Contract.valuedItem.net` | `Contract.valuedItem.net` | `net` |  | Total Contract Valued Item Value | 0..1 | Quantity[http://hl7.org/fhir/StructureDefinition/Money] |  |  |
...
| `Contract.valuedItem.unitPrice` | `Contract.valuedItem.unitPrice` | `unitPrice` |  | Contract Valued Item fee, charge, or cost | 0..1 | Quantity[http://hl7.org/fhir/StructureDefinition/Money] |  |  |
### Mapping Table
...
This group is centered on the Structure Definition Contract from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 Contract| Relationship | [R3 Contract](/docs/R3/Resources/Contract.md)| Relationship | [R4 Contract](/docs/R4/Resources/Contract.md)| Relationship | [R4B Contract](/docs/R4B/Resources/Contract.md)| Relationship | [R5 Contract](/docs/R5/Resources/Contract.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *92 of 92 elements used* | | *86 of 98 elements used* | | *53 of 183 elements used* | | *53 of 183 elements used* | | *53 of 181 elements used* 
