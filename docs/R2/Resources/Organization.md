...
| `Organization.contact.extension` | `Organization.contact.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Organization.contact.id` | `Organization.contact.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Organization.contact.modifierExtension` | `Organization.contact.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Organization.language` | `Organization.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
...
| `Organization.type` | `Organization.type` | `type` |  | Kind of organization | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/organization-type` |
### Mapping Table
...
This group is centered on the Structure Definition Organization from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 Organization| Relationship | [R3 Organization](/docs/R3/Resources/Organization.md)| Relationship | [R4 Organization](/docs/R4/Resources/Organization.md)| Relationship | [R4B Organization](/docs/R4B/Resources/Organization.md)| Relationship | [R5 Organization](/docs/R5/Resources/Organization.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
