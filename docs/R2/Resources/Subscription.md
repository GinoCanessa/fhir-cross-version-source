...
| -- | ---- | ---- | --------- | ----- | ----------- | ------------- | ---------------- | ----------------- |
| `Subscription` | `Subscription` | `Subscription` | Subscription | A server push subscription criteria | 0..* | Subscription |  |  |
| `Subscription.channel` | `Subscription.channel` | `channel` |  | The channel on which to report matches to the criteria | 1..1 | BackboneElement |  |  |
| `Subscription.channel.endpoint` | `Subscription.channel.endpoint` | `endpoint` |  | Where the channel points to | 0..1 | uri |  |  |
| `Subscription.channel.extension` | `Subscription.channel.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Subscription.channel.header` | `Subscription.channel.header` | `header` |  | Usage depends on the channel type | 0..1 | string |  |  |
| `Subscription.channel.id` | `Subscription.channel.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Subscription.channel.modifierExtension` | `Subscription.channel.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Subscription.channel.payload` | `Subscription.channel.payload` | `payload` |  | Mimetype to send, or blank for no payload | 1..1 | string |  |  |
| `Subscription.channel.type` | `Subscription.channel.type` | `type` |  | rest-hook \| websocket \| email \| sms \| message | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/subscription-channel-type` |
| `Subscription.contact` | `Subscription.contact` | `contact` |  | Contact details for source (e.g. troubleshooting) | 0..* | ContactPoint |  |  |
| `Subscription.contained` | `Subscription.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `Subscription.criteria` | `Subscription.criteria` | `criteria` |  | Rule for server push criteria | 1..1 | string |  |  |
| `Subscription.end` | `Subscription.end` | `end` |  | When to automatically delete the subscription | 0..1 | instant |  |  |
| `Subscription.error` | `Subscription.error` | `error` |  | Latest error note | 0..1 | string |  |  |
...
| `Subscription.language` | `Subscription.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
...
| `Subscription.reason` | `Subscription.reason` | `reason` |  | Description of why this subscription was created | 1..1 | string |  |  |
| `Subscription.status` | `Subscription.status` | `status` |  | requested \| active \| error \| off | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/subscription-status` |
| `Subscription.tag` | `Subscription.tag` | `tag` |  | A tag to add to matching resources | 0..* | Coding | `Example` | `http://hl7.org/fhir/ValueSet/subscription-tag` |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [Subscription](/docs/R2/Resources/Subscription.md)<br/> `http://hl7.org/fhir/StructureDefinition/Subscription\|1.0.2` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `159`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `326`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Subscription](/docs/R3/Resources/Subscription.md)<br/> `http://hl7.org/fhir/StructureDefinition/Subscription\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `520`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `714`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Subscription](/docs/R4/Resources/Subscription.md)<br/> `http://hl7.org/fhir/StructureDefinition/Subscription\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1625`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1626`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Subscription](/docs/R4B/Resources/Subscription.md)<br/> `http://hl7.org/fhir/StructureDefinition/Subscription\|4.3.0` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `1046`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1275`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Subscription](/docs/R5/Resources/Subscription.md)<br/> `http://hl7.org/fhir/StructureDefinition/Subscription\|5.0.0` 
...
This group is centered on the Structure Definition Subscription from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 Subscription| Relationship | [R3 Subscription](/docs/R3/Resources/Subscription.md)| Relationship | [R4 Subscription](/docs/R4/Resources/Subscription.md)| Relationship | [R4B Subscription](/docs/R4B/Resources/Subscription.md)| Relationship | [R5 Subscription](/docs/R5/Resources/Subscription.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
