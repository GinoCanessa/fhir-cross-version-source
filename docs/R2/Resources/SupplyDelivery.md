...
| -- | ---- | ---- | --------- | ----- | ----------- | ------------- | ---------------- | ----------------- |
| `SupplyDelivery` | `SupplyDelivery` | `SupplyDelivery` | SupplyDelivery | Delivery of Supply | 0..* | SupplyDelivery |  |  |
...
| `SupplyDelivery.language` | `SupplyDelivery.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
...
| `SupplyDelivery.quantity` | `SupplyDelivery.quantity` | `quantity` |  | Amount dispensed | 0..1 | Quantity[http://hl7.org/fhir/StructureDefinition/SimpleQuantity] |  |  |
...
| `SupplyDelivery.status` | `SupplyDelivery.status` | `status` |  | in-progress \| completed \| abandoned | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/supplydelivery-status` |
| `SupplyDelivery.suppliedItem` | `SupplyDelivery.suppliedItem` | `suppliedItem` |  | Medication, Substance, or Device supplied | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Medication), Reference(http://hl7.org/fhir/StructureDefinition/Substance) |  |  |
| `SupplyDelivery.supplier` | `SupplyDelivery.supplier` | `supplier` |  | Dispenser | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Practitioner) |  |  |
...
| `SupplyDelivery.time` | `SupplyDelivery.time` | `time` |  | Handover time | 0..1 | dateTime |  |  |
...
| `SupplyDelivery.whenPrepared` | `SupplyDelivery.whenPrepared` | `whenPrepared` |  | Dispensing time | 0..1 | Period |  |  |
### Mapping Table
...
This group is centered on the Structure Definition SupplyDelivery from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 SupplyDelivery| Relationship | [R3 SupplyDelivery](/docs/R3/Resources/SupplyDelivery.md)| Relationship | [R4 SupplyDelivery](/docs/R4/Resources/SupplyDelivery.md)| Relationship | [R4B SupplyDelivery](/docs/R4B/Resources/SupplyDelivery.md)| Relationship | [R5 SupplyDelivery](/docs/R5/Resources/SupplyDelivery.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| **`SupplyDelivery.extension`**| →→→→ _Equivalent_ →→→→ <br/>(8087)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(8088)| `SupplyDelivery.extension`| _Equivalent_<br/>(18970/18971)| `SupplyDelivery.extension`| _Equivalent_<br/>(33843/33844)| `SupplyDelivery.extension`| _Equivalent_<br/>(48395/48396)| `SupplyDelivery.extension`
...
| *20 of 20 elements used* | | *20 of 25 elements used* <br/>remaining elements:<br/>`SupplyDelivery.basedOn`, `SupplyDelivery.partOf`, `SupplyDelivery.suppliedItem.extension`, `SupplyDelivery.suppliedItem.id`, `SupplyDelivery.suppliedItem.item[x]`, `SupplyDelivery.suppliedItem.modifierExtension`| | *19 of 25 elements used* <br/>remaining elements:<br/>`SupplyDelivery.basedOn`, `SupplyDelivery.partOf`, `SupplyDelivery.suppliedItem.extension`, `SupplyDelivery.suppliedItem.id`, `SupplyDelivery.suppliedItem.item[x]`, `SupplyDelivery.suppliedItem.modifierExtension`| | *19 of 25 elements used* <br/>remaining elements:<br/>`SupplyDelivery.basedOn`, `SupplyDelivery.partOf`, `SupplyDelivery.suppliedItem.extension`, `SupplyDelivery.suppliedItem.id`, `SupplyDelivery.suppliedItem.item[x]`, `SupplyDelivery.suppliedItem.modifierExtension`| | *19 of 25 elements used* <br/>remaining elements:<br/>`SupplyDelivery.basedOn`, `SupplyDelivery.partOf`, `SupplyDelivery.suppliedItem.extension`, `SupplyDelivery.suppliedItem.id`, `SupplyDelivery.suppliedItem.item[x]`, `SupplyDelivery.suppliedItem.modifierExtension`
