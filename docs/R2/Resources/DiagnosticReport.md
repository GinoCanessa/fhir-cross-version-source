...
| `DiagnosticReport.effective[x]` | `DiagnosticReport.effective[x]` | `effective[x]` |  | Clinically Relevant time/time-period for report | 1..1 | dateTime, Period |  |  |
| `DiagnosticReport.encounter` | `DiagnosticReport.encounter` | `encounter` |  | Health care event when test ordered | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Encounter) |  |  |
...
| `DiagnosticReport.identifier` | `DiagnosticReport.identifier` | `identifier` |  | Id for external references to this report | 0..* | Identifier |  |  |
...
| `DiagnosticReport.image.extension` | `DiagnosticReport.image.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `DiagnosticReport.image.id` | `DiagnosticReport.image.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
...
| `DiagnosticReport.image.modifierExtension` | `DiagnosticReport.image.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `DiagnosticReport.imagingStudy` | `DiagnosticReport.imagingStudy` | `imagingStudy` |  | Reference to full details of imaging associated with the diagnostic report | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/ImagingObjectSelection), Reference(http://hl7.org/fhir/StructureDefinition/ImagingStudy) |  |  |
...
| `DiagnosticReport.issued` | `DiagnosticReport.issued` | `issued` |  | DateTime this version was released | 1..1 | instant |  |  |
| `DiagnosticReport.language` | `DiagnosticReport.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
...
| `DiagnosticReport.performer` | `DiagnosticReport.performer` | `performer` |  | Responsible Diagnostic Service | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner) |  |  |
| `DiagnosticReport.presentedForm` | `DiagnosticReport.presentedForm` | `presentedForm` |  | Entire report as issued | 0..* | Attachment |  |  |
| `DiagnosticReport.request` | `DiagnosticReport.request` | `request` |  | What was requested | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/DiagnosticOrder), Reference(http://hl7.org/fhir/StructureDefinition/ProcedureRequest), Reference(http://hl7.org/fhir/StructureDefinition/ReferralRequest) |  |  |
...
| `DiagnosticReport.status` | `DiagnosticReport.status` | `status` |  | registered \| partial \| final \| corrected \| appended \| cancelled \| entered-in-error | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/diagnostic-report-status` |
| `DiagnosticReport.subject` | `DiagnosticReport.subject` | `subject` |  | The subject of the report, usually, but not always, the patient | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device), Reference(http://hl7.org/fhir/StructureDefinition/Group), Reference(http://hl7.org/fhir/StructureDefinition/Location), Reference(http://hl7.org/fhir/StructureDefinition/Patient) |  |  |
...
This group is centered on the Structure Definition DiagnosticReport from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 DiagnosticReport| Relationship | [R3 DiagnosticReport](/docs/R3/Resources/DiagnosticReport.md)| Relationship | [R4 DiagnosticReport](/docs/R4/Resources/DiagnosticReport.md)| Relationship | [R4B DiagnosticReport](/docs/R4B/Resources/DiagnosticReport.md)| Relationship | [R5 DiagnosticReport](/docs/R5/Resources/DiagnosticReport.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *31 of 31 elements used* | | *31 of 36 elements used* | | *28 of 32 elements used* | | *28 of 32 elements used* | | *27 of 40 elements used* 
