...
| `Bundle.entry` | `Bundle.entry` | `entry` |  | Entry in the bundle - will have a resource, or information | 0..* | BackboneElement |  |  |
| `Bundle.entry.extension` | `Bundle.entry.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Bundle.entry.fullUrl` | `Bundle.entry.fullUrl` | `fullUrl` |  | Absolute URL for resource (server address, or UUID/OID) | 0..1 | uri |  |  |
| `Bundle.entry.id` | `Bundle.entry.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Bundle.entry.link` | `Bundle.entry.link` | `link` |  | Links related to this entry | 0..* | Bundle.link |  |  |
| `Bundle.entry.modifierExtension` | `Bundle.entry.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Bundle.entry.request` | `Bundle.entry.request` | `request` |  | Transaction Related Information | 0..1 | BackboneElement |  |  |
| `Bundle.entry.request.extension` | `Bundle.entry.request.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Bundle.entry.request.id` | `Bundle.entry.request.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Bundle.entry.request.ifMatch` | `Bundle.entry.request.ifMatch` | `ifMatch` |  | For managing update contention | 0..1 | string |  |  |
| `Bundle.entry.request.ifModifiedSince` | `Bundle.entry.request.ifModifiedSince` | `ifModifiedSince` |  | For managing update contention | 0..1 | instant |  |  |
| `Bundle.entry.request.ifNoneExist` | `Bundle.entry.request.ifNoneExist` | `ifNoneExist` |  | For conditional creates | 0..1 | string |  |  |
| `Bundle.entry.request.ifNoneMatch` | `Bundle.entry.request.ifNoneMatch` | `ifNoneMatch` |  | For managing cache currency | 0..1 | string |  |  |
| `Bundle.entry.request.method` | `Bundle.entry.request.method` | `method` |  | GET \| POST \| PUT \| DELETE | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/http-verb` |
| `Bundle.entry.request.modifierExtension` | `Bundle.entry.request.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Bundle.entry.request.url` | `Bundle.entry.request.url` | `url` |  | URL for HTTP equivalent of this entry | 1..1 | uri |  |  |
| `Bundle.entry.resource` | `Bundle.entry.resource` | `resource` |  | A resource in the bundle | 0..1 | Resource |  |  |
| `Bundle.entry.response` | `Bundle.entry.response` | `response` |  | Transaction Related Information | 0..1 | BackboneElement |  |  |
| `Bundle.entry.response.etag` | `Bundle.entry.response.etag` | `etag` |  | The etag for the resource (if relevant) | 0..1 | string |  |  |
| `Bundle.entry.response.extension` | `Bundle.entry.response.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Bundle.entry.response.id` | `Bundle.entry.response.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Bundle.entry.response.lastModified` | `Bundle.entry.response.lastModified` | `lastModified` |  | Server's date time modified | 0..1 | instant |  |  |
| `Bundle.entry.response.location` | `Bundle.entry.response.location` | `location` |  | The location, if the operation returns a location | 0..1 | uri |  |  |
| `Bundle.entry.response.modifierExtension` | `Bundle.entry.response.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Bundle.entry.response.status` | `Bundle.entry.response.status` | `status` |  | Status return code for entry | 1..1 | string |  |  |
| `Bundle.entry.search` | `Bundle.entry.search` | `search` |  | Search related information | 0..1 | BackboneElement |  |  |
| `Bundle.entry.search.extension` | `Bundle.entry.search.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Bundle.entry.search.id` | `Bundle.entry.search.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Bundle.entry.search.mode` | `Bundle.entry.search.mode` | `mode` |  | match \| include \| outcome - why this is in the result set | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/search-entry-mode` |
| `Bundle.entry.search.modifierExtension` | `Bundle.entry.search.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Bundle.entry.search.score` | `Bundle.entry.search.score` | `score` |  | Search ranking (between 0 and 1) | 0..1 | decimal |  |  |
...
| `Bundle.language` | `Bundle.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
| `Bundle.link` | `Bundle.link` | `link` |  | Links related to this Bundle | 0..* | BackboneElement |  |  |
| `Bundle.link.extension` | `Bundle.link.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Bundle.link.id` | `Bundle.link.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Bundle.link.modifierExtension` | `Bundle.link.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Bundle.link.relation` | `Bundle.link.relation` | `relation` |  | http://www.iana.org/assignments/link-relations/link-relations.xhtml | 1..1 | string |  |  |
| `Bundle.link.url` | `Bundle.link.url` | `url` |  | Reference details for the link | 1..1 | uri |  |  |
| `Bundle.meta` | `Bundle.meta` | `meta` | Resource.meta | Metadata about the resource | 0..1 | Meta |  |  |
| `Bundle.signature` | `Bundle.signature` | `signature` |  | Digital Signature | 0..1 | Signature |  |  |
| `Bundle.total` | `Bundle.total` | `total` |  | If search, the total number of matches | 0..1 | unsignedInt |  |  |
| `Bundle.type` | `Bundle.type` | `type` |  | document \| message \| transaction \| transaction-response \| batch \| batch-response \| history \| searchset \| collection | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/bundle-type` |
### Mapping Table

| R2 | Comparison | R3 | Comparison | R4 | Comparison | R4B | Comparison | R5
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [Bundle](/docs/R2/Resources/Bundle.md)<br/> `http://hl7.org/fhir/StructureDefinition/Bundle\|1.0.2` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `80`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `246`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Bundle](/docs/R3/Resources/Bundle.md)<br/> `http://hl7.org/fhir/StructureDefinition/Bundle\|3.0.2` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `425`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `621`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Bundle](/docs/R4/Resources/Bundle.md)<br/> `http://hl7.org/fhir/StructureDefinition/Bundle\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1409`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1410`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Bundle](/docs/R4B/Resources/Bundle.md)<br/> `http://hl7.org/fhir/StructureDefinition/Bundle\|4.3.0` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `927`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1156`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [Bundle](/docs/R5/Resources/Bundle.md)<br/> `http://hl7.org/fhir/StructureDefinition/Bundle\|5.0.0` 
...
This group is centered on the Structure Definition Bundle from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 Bundle| Relationship | [R3 Bundle](/docs/R3/Resources/Bundle.md)| Relationship | [R4 Bundle](/docs/R4/Resources/Bundle.md)| Relationship | [R4B Bundle](/docs/R4B/Resources/Bundle.md)| Relationship | [R5 Bundle](/docs/R5/Resources/Bundle.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
