...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [MedicationStatement](/docs/R2/Resources/MedicationStatement.md)<br/> `http://hl7.org/fhir/StructureDefinition/MedicationStatement\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `128`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `294`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [MedicationStatement](/docs/R3/Resources/MedicationStatement.md)<br/> `http://hl7.org/fhir/StructureDefinition/MedicationStatement\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `483`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`RelatedTo`<br/>- DBKey: `677`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [MedicationStatement](/docs/R4/Resources/MedicationStatement.md)<br/> `http://hl7.org/fhir/StructureDefinition/MedicationStatement\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1545`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1546`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [MedicationStatement](/docs/R4B/Resources/MedicationStatement.md)<br/> `http://hl7.org/fhir/StructureDefinition/MedicationStatement\|4.3.0` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `1007`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1236`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [MedicationStatement](/docs/R5/Resources/MedicationStatement.md)<br/> `http://hl7.org/fhir/StructureDefinition/MedicationStatement\|5.0.0` 
...
| **`MedicationStatement.wasNotTaken`**| →→→→ __ →→→→ <br/>(295)<hr/>←←←← __ ←←←← <br/>()| `base64Binary`| | | | | | | 
