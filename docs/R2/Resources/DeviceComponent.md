...
| `DeviceComponent.language` | `DeviceComponent.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
| `DeviceComponent.languageCode` | `DeviceComponent.languageCode` | `languageCode` |  | Language code for the human-readable text strings produced by the device | 0..1 | CodeableConcept | `Required` | `http://tools.ietf.org/html/bcp47` |
| `DeviceComponent.lastSystemChange` | `DeviceComponent.lastSystemChange` | `lastSystemChange` |  | Recent system change timestamp | 1..1 | instant |  |  |
...
| `DeviceComponent.operationalStatus` | `DeviceComponent.operationalStatus` | `operationalStatus` |  | Component operational status | 0..* | CodeableConcept | `Example` |  |
| `DeviceComponent.parameterGroup` | `DeviceComponent.parameterGroup` | `parameterGroup` |  | Current supported parameter group | 0..1 | CodeableConcept | `Example` |  |
...
| `DeviceComponent.productionSpecification` | `DeviceComponent.productionSpecification` | `productionSpecification` |  | Production specification of the component | 0..* | BackboneElement |  |  |
...
| `DeviceComponent.productionSpecification.extension` | `DeviceComponent.productionSpecification.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `DeviceComponent.productionSpecification.id` | `DeviceComponent.productionSpecification.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `DeviceComponent.productionSpecification.modifierExtension` | `DeviceComponent.productionSpecification.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `DeviceComponent.productionSpecification.specType` | `DeviceComponent.productionSpecification.specType` | `specType` |  | Specification type | 0..1 | CodeableConcept | `Example` |  |
| `DeviceComponent.source` | `DeviceComponent.source` | `source` |  | A source device of this component | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device) |  |  |
...
| `DeviceComponent.type` | `DeviceComponent.type` | `type` |  | What kind of component it is | 1..1 | CodeableConcept | `Preferred` | `https://rtmms.nist.gov/rtmms/index.htm#!hrosetta` |
### Mapping Table
...
This group is centered on the Structure Definition DeviceComponent from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 DeviceComponent| Relationship | [R3 DeviceComponent](/docs/R3/Resources/DeviceComponent.md)| Relationship | *No Map* | Relationship | *No Map* | Relationship | *No Map* 
| --- | --- | --- | --- | --- | --- | --- | --- | ---
