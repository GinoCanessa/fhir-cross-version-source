...
| `ProcessResponse.error` | `ProcessResponse.error` | `error` |  | Error code | 0..* | Coding | `Required` | `http://hl7.org/fhir/ValueSet/adjudication-error` |
...
| `ProcessResponse.form` | `ProcessResponse.form` | `form` |  | Printed Form Identifier | 0..1 | Coding | `Required` | `http://hl7.org/fhir/ValueSet/forms` |
...
| `ProcessResponse.language` | `ProcessResponse.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
...
| `ProcessResponse.notes` | `ProcessResponse.notes` | `notes` |  | Notes | 0..* | BackboneElement |  |  |
| `ProcessResponse.notes.extension` | `ProcessResponse.notes.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `ProcessResponse.notes.id` | `ProcessResponse.notes.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `ProcessResponse.notes.modifierExtension` | `ProcessResponse.notes.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `ProcessResponse.notes.text` | `ProcessResponse.notes.text` | `text` |  | Notes text | 0..1 | string |  |  |
| `ProcessResponse.notes.type` | `ProcessResponse.notes.type` | `type` |  | display \| print \| printoper | 0..1 | Coding | `Required` | `http://hl7.org/fhir/ValueSet/note-type` |
...
| `ProcessResponse.originalRuleset` | `ProcessResponse.originalRuleset` | `originalRuleset` |  | Original version | 0..1 | Coding | `Example` | `http://hl7.org/fhir/ValueSet/ruleset` |
| `ProcessResponse.outcome` | `ProcessResponse.outcome` | `outcome` |  | Processing outcome | 0..1 | Coding | `Example` | `http://hl7.org/fhir/ValueSet/process-outcome` |
...
| `ProcessResponse.ruleset` | `ProcessResponse.ruleset` | `ruleset` |  | Resource version | 0..1 | Coding | `Example` | `http://hl7.org/fhir/ValueSet/ruleset` |
...
This group is centered on the Structure Definition ProcessResponse from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 ProcessResponse| Relationship | [R3 ProcessResponse](/docs/R3/Resources/ProcessResponse.md)| Relationship | [R4 Task](/docs/R4/Resources/Task.md)| Relationship | [R4B Task](/docs/R4B/Resources/Task.md)| Relationship | [R5 Task](/docs/R5/Resources/Task.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
