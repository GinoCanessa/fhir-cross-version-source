...
| `DeviceMetric.calibration` | `DeviceMetric.calibration` | `calibration` |  | Describes the calibrations that have been performed or that are required to be performed | 0..* | BackboneElement |  |  |
| `DeviceMetric.calibration.extension` | `DeviceMetric.calibration.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `DeviceMetric.calibration.id` | `DeviceMetric.calibration.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `DeviceMetric.calibration.modifierExtension` | `DeviceMetric.calibration.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `DeviceMetric.calibration.state` | `DeviceMetric.calibration.state` | `state` |  | not-calibrated \| calibration-required \| calibrated \| unspecified | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/metric-calibration-state` |
| `DeviceMetric.calibration.time` | `DeviceMetric.calibration.time` | `time` |  | Describes the time last calibration has been performed | 0..1 | instant |  |  |
| `DeviceMetric.calibration.type` | `DeviceMetric.calibration.type` | `type` |  | unspecified \| offset \| gain \| two-point | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/metric-calibration-type` |
| `DeviceMetric.category` | `DeviceMetric.category` | `category` |  | measurement \| setting \| calculation \| unspecified | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/metric-category` |
| `DeviceMetric.color` | `DeviceMetric.color` | `color` |  | black \| red \| green \| yellow \| blue \| magenta \| cyan \| white | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/metric-color` |
...
| `DeviceMetric.identifier` | `DeviceMetric.identifier` | `identifier` |  | Unique identifier of this DeviceMetric | 1..1 | Identifier |  |  |
...
| `DeviceMetric.language` | `DeviceMetric.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
| `DeviceMetric.measurementPeriod` | `DeviceMetric.measurementPeriod` | `measurementPeriod` |  | Describes the measurement repetition time | 0..1 | Timing |  |  |
...
| `DeviceMetric.operationalStatus` | `DeviceMetric.operationalStatus` | `operationalStatus` |  | on \| off \| standby | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/metric-operational-status` |
| `DeviceMetric.parent` | `DeviceMetric.parent` | `parent` |  | Describes the link to the parent DeviceComponent | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/DeviceComponent) |  |  |
| `DeviceMetric.source` | `DeviceMetric.source` | `source` |  | Describes the link to the source Device | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Device) |  |  |
...
| `DeviceMetric.type` | `DeviceMetric.type` | `type` |  | Type of metric | 1..1 | CodeableConcept | `Preferred` | `https://rtmms.nist.gov/rtmms/index.htm#!hrosetta` |
| `DeviceMetric.unit` | `DeviceMetric.unit` | `unit` |  | Unit of metric | 0..1 | CodeableConcept | `Preferred` | `https://rtmms.nist.gov/rtmms/index.htm#!units` |
### Mapping Table

| R2 | Comparison | R3 | Comparison | R4 | Comparison | R4B | Comparison | R5
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [DeviceMetric](/docs/R2/Resources/DeviceMetric.md)<br/> `http://hl7.org/fhir/StructureDefinition/DeviceMetric\|1.0.2` | →→→→→→→<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `99`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `266`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [DeviceMetric](/docs/R3/Resources/DeviceMetric.md)<br/> `http://hl7.org/fhir/StructureDefinition/DeviceMetric\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `448`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `643`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [DeviceMetric](/docs/R4/Resources/DeviceMetric.md)<br/> `http://hl7.org/fhir/StructureDefinition/DeviceMetric\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1459`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1460`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [DeviceMetric](/docs/R4B/Resources/DeviceMetric.md)<br/> `http://hl7.org/fhir/StructureDefinition/DeviceMetric\|4.3.0` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `964`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `1193`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [DeviceMetric](/docs/R5/Resources/DeviceMetric.md)<br/> `http://hl7.org/fhir/StructureDefinition/DeviceMetric\|5.0.0` 
...
This group is centered on the Structure Definition DeviceMetric from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 DeviceMetric| Relationship | [R3 DeviceMetric](/docs/R3/Resources/DeviceMetric.md)| Relationship | [R4 DeviceMetric](/docs/R4/Resources/DeviceMetric.md)| Relationship | [R4B DeviceMetric](/docs/R4B/Resources/DeviceMetric.md)| Relationship | [R5 DeviceMetric](/docs/R5/Resources/DeviceMetric.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
