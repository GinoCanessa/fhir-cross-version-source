...
| `Condition.abatement[x]` | `Condition.abatement[x]` | `abatement[x]` |  | If/when in resolution/remission | 0..1 | boolean, dateTime, Period, Quantity[http://hl7.org/fhir/StructureDefinition/Age], Range, string |  |  |
| `Condition.asserter` | `Condition.asserter` | `asserter` |  | Person who asserts this condition | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Patient), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner) |  |  |
| `Condition.bodySite` | `Condition.bodySite` | `bodySite` |  | Anatomical location, if relevant | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/body-site` |
| `Condition.category` | `Condition.category` | `category` |  | complaint \| symptom \| finding \| diagnosis | 0..1 | CodeableConcept | `Preferred` | `http://hl7.org/fhir/ValueSet/condition-category` |
| `Condition.clinicalStatus` | `Condition.clinicalStatus` | `clinicalStatus` |  | active \| relapse \| remission \| resolved | 0..1 | code | `Preferred` | `http://hl7.org/fhir/ValueSet/condition-clinical` |
| `Condition.code` | `Condition.code` | `code` |  | Identification of the condition, problem or diagnosis | 1..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/condition-code` |
| `Condition.contained` | `Condition.contained` | `contained` | DomainResource.contained | Contained, inline Resources | 0..* | Resource |  |  |
| `Condition.dateRecorded` | `Condition.dateRecorded` | `dateRecorded` |  | When first entered | 0..1 | date |  |  |
| `Condition.encounter` | `Condition.encounter` | `encounter` |  | Encounter when condition first asserted | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Encounter) |  |  |
| `Condition.evidence` | `Condition.evidence` | `evidence` |  | Supporting evidence | 0..* | BackboneElement |  |  |
| `Condition.evidence.code` | `Condition.evidence.code` | `code` |  | Manifestation/symptom | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/manifestation-or-symptom` |
| `Condition.evidence.detail` | `Condition.evidence.detail` | `detail` |  | Supporting information found elsewhere | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Resource) |  |  |
| `Condition.evidence.extension` | `Condition.evidence.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Condition.evidence.id` | `Condition.evidence.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Condition.evidence.modifierExtension` | `Condition.evidence.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Condition.identifier` | `Condition.identifier` | `identifier` |  | External Ids for this condition | 0..* | Identifier |  |  |
...
| `Condition.language` | `Condition.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
...
| `Condition.notes` | `Condition.notes` | `notes` |  | Additional information about the Condition | 0..1 | string |  |  |
| `Condition.onset[x]` | `Condition.onset[x]` | `onset[x]` |  | Estimated or actual date,  date-time, or age | 0..1 | dateTime, Period, Quantity[http://hl7.org/fhir/StructureDefinition/Age], Range, string |  |  |
| `Condition.patient` | `Condition.patient` | `patient` |  | Who has the condition? | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Patient) |  |  |
| `Condition.severity` | `Condition.severity` | `severity` |  | Subjective severity of condition | 0..1 | CodeableConcept | `Preferred` | `http://hl7.org/fhir/ValueSet/condition-severity` |
| `Condition.stage` | `Condition.stage` | `stage` |  | Stage/grade, usually assessed formally | 0..1 | BackboneElement |  |  |
| `Condition.stage.assessment` | `Condition.stage.assessment` | `assessment` |  | Formal record of assessment | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/ClinicalImpression), Reference(http://hl7.org/fhir/StructureDefinition/DiagnosticReport), Reference(http://hl7.org/fhir/StructureDefinition/Observation) |  |  |
| `Condition.stage.extension` | `Condition.stage.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Condition.stage.id` | `Condition.stage.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Condition.stage.modifierExtension` | `Condition.stage.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Condition.stage.summary` | `Condition.stage.summary` | `summary` |  | Simple summary (disease specific) | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/condition-stage` |
...
| `Condition.verificationStatus` | `Condition.verificationStatus` | `verificationStatus` |  | provisional \| differential \| confirmed \| refuted \| entered-in-error \| unknown | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/condition-ver-status` |
### Mapping Table

| R2 | Comparison | R3 | Comparison | R4 | Comparison | R4B | Comparison | R5
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [Condition](/docs/R2/Resources/Condition.md)<br/> `http://hl7.org/fhir/StructureDefinition/Condition\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `90`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `257`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [Condition](/docs/R3/Resources/Condition.md)<br/> `http://hl7.org/fhir/StructureDefinition/Condition\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `439`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `635`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [Condition](/docs/R4/Resources/Condition.md)<br/> `http://hl7.org/fhir/StructureDefinition/Condition\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1441`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1442`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [Condition](/docs/R4B/Resources/Condition.md)<br/> `http://hl7.org/fhir/StructureDefinition/Condition\|4.3.0` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `955`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `1184`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [Condition](/docs/R5/Resources/Condition.md)<br/> `http://hl7.org/fhir/StructureDefinition/Condition\|5.0.0` 
...
This group is centered on the Structure Definition Condition from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 Condition| Relationship | [R3 Condition](/docs/R3/Resources/Condition.md)| Relationship | [R4 Condition](/docs/R4/Resources/Condition.md)| Relationship | [R4B Condition](/docs/R4B/Resources/Condition.md)| Relationship | [R5 Condition](/docs/R5/Resources/Condition.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *35 of 35 elements used* | | *35 of 35 elements used* | | *35 of 37 elements used* <br/>remaining elements:<br/>`Condition.recorder`, `Condition.stage.type`| | *35 of 37 elements used* <br/>remaining elements:<br/>`Condition.recorder`, `Condition.stage.type`| | *29 of 36 elements used* <br/>remaining elements:<br/>`Condition.participant`, `Condition.participant.actor`, `Condition.participant.extension`, `Condition.participant.function`, `Condition.participant.id`, `Condition.participant.modifierExtension`, `Condition.stage.type`
