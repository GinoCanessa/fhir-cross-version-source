...
| *27 of 27 elements used* | | *26 of 30 elements used* <br/>remaining elements:<br/>`Goal.target.extension`, `Goal.target.id`, `Goal.target.measure`, `Goal.target.modifierExtension`| | *27 of 31 elements used* <br/>remaining elements:<br/>`Goal.target.extension`, `Goal.target.id`, `Goal.target.measure`, `Goal.target.modifierExtension`| | *27 of 31 elements used* <br/>remaining elements:<br/>`Goal.target.extension`, `Goal.target.id`, `Goal.target.measure`, `Goal.target.modifierExtension`| | *26 of 31 elements used* <br/>remaining elements:<br/>`Goal.continuous`, `Goal.target.extension`, `Goal.target.id`, `Goal.target.measure`, `Goal.target.modifierExtension`
