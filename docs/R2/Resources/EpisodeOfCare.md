...
| `EpisodeOfCare.careTeam` | `EpisodeOfCare.careTeam` | `careTeam` |  | Other practitioners facilitating this episode of care | 0..* | BackboneElement |  |  |
| `EpisodeOfCare.careTeam.extension` | `EpisodeOfCare.careTeam.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `EpisodeOfCare.careTeam.id` | `EpisodeOfCare.careTeam.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `EpisodeOfCare.careTeam.member` | `EpisodeOfCare.careTeam.member` | `member` |  | The practitioner (or Organization) within the team | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization), Reference(http://hl7.org/fhir/StructureDefinition/Practitioner) |  |  |
| `EpisodeOfCare.careTeam.modifierExtension` | `EpisodeOfCare.careTeam.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `EpisodeOfCare.careTeam.period` | `EpisodeOfCare.careTeam.period` | `period` |  | Period of time for this role | 0..1 | Period |  |  |
| `EpisodeOfCare.careTeam.role` | `EpisodeOfCare.careTeam.role` | `role` |  | Role taken by this team member | 0..* | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/participant-role` |
| `EpisodeOfCare.condition` | `EpisodeOfCare.condition` | `condition` |  | Conditions/problems/diagnoses this episode of care is for | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Condition) |  |  |
...
| `EpisodeOfCare.identifier` | `EpisodeOfCare.identifier` | `identifier` |  | Identifier(s) for the EpisodeOfCare | 0..* | Identifier |  |  |
...
| `EpisodeOfCare.language` | `EpisodeOfCare.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
...
| `EpisodeOfCare.patient` | `EpisodeOfCare.patient` | `patient` |  | Patient for this episode of care | 1..1 | Reference(http://hl7.org/fhir/StructureDefinition/Patient) |  |  |
...
| `EpisodeOfCare.status` | `EpisodeOfCare.status` | `status` |  | planned \| waitlist \| active \| onhold \| finished \| cancelled | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/episode-of-care-status` |
| `EpisodeOfCare.statusHistory` | `EpisodeOfCare.statusHistory` | `statusHistory` |  | Past list of status codes | 0..* | BackboneElement |  |  |
| `EpisodeOfCare.statusHistory.extension` | `EpisodeOfCare.statusHistory.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `EpisodeOfCare.statusHistory.id` | `EpisodeOfCare.statusHistory.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `EpisodeOfCare.statusHistory.modifierExtension` | `EpisodeOfCare.statusHistory.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `EpisodeOfCare.statusHistory.period` | `EpisodeOfCare.statusHistory.period` | `period` |  | Period for the status | 1..1 | Period |  |  |
| `EpisodeOfCare.statusHistory.status` | `EpisodeOfCare.statusHistory.status` | `status` |  | planned \| waitlist \| active \| onhold \| finished \| cancelled | 1..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/episode-of-care-status` |
...
| `EpisodeOfCare.type` | `EpisodeOfCare.type` | `type` |  | Type/class  - e.g. specialist referral, disease management | 0..* | CodeableConcept | `Example` |  |
### Mapping Table

| R2 | Comparison | R3 | Comparison | R4 | Comparison | R4B | Comparison | R5
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [EpisodeOfCare](/docs/R2/Resources/EpisodeOfCare.md)<br/> `http://hl7.org/fhir/StructureDefinition/EpisodeOfCare\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `109`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `275`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [EpisodeOfCare](/docs/R3/Resources/EpisodeOfCare.md)<br/> `http://hl7.org/fhir/StructureDefinition/EpisodeOfCare\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `458`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `653`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [EpisodeOfCare](/docs/R4/Resources/EpisodeOfCare.md)<br/> `http://hl7.org/fhir/StructureDefinition/EpisodeOfCare\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1481`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1482`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [EpisodeOfCare](/docs/R4B/Resources/EpisodeOfCare.md)<br/> `http://hl7.org/fhir/StructureDefinition/EpisodeOfCare\|4.3.0` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `973`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1202`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [EpisodeOfCare](/docs/R5/Resources/EpisodeOfCare.md)<br/> `http://hl7.org/fhir/StructureDefinition/EpisodeOfCare\|5.0.0` 
...
This group is centered on the Structure Definition EpisodeOfCare from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 EpisodeOfCare| Relationship | [R3 EpisodeOfCare](/docs/R3/Resources/EpisodeOfCare.md)| Relationship | [R4 EpisodeOfCare](/docs/R4/Resources/EpisodeOfCare.md)| Relationship | [R4B EpisodeOfCare](/docs/R4B/Resources/EpisodeOfCare.md)| Relationship | [R5 EpisodeOfCare](/docs/R5/Resources/EpisodeOfCare.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| **`EpisodeOfCare`**| →→→→ _Equivalent_ →→→→ <br/>(13680)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(620)| `EpisodeOfCare`| _Equivalent_<br/>(13682/13683)| `EpisodeOfCare`| _Equivalent_<br/>(26402/26403)| `EpisodeOfCare`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(41138)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(41139)| `EpisodeOfCare`
| **`EpisodeOfCare`**| →→→→ _Equivalent_ →→→→ <br/>(13680)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(620)| `EpisodeOfCare.team`| →→→→ _SourceIsNarrowerThanTarget_ →→→→ <br/>(13742)<hr/>←←←← _SourceIsBroaderThanTarget_ ←←←← <br/>(13743)| `EpisodeOfCare.team`| _Equivalent_<br/>(26462/26463)| `EpisodeOfCare.team`| _Equivalent_<br/>(1784/2028)| `EpisodeOfCare.careTeam`
