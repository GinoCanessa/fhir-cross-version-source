...
| `Specimen.collection.comment` | `Specimen.collection.comment` | `comment` |  | Collector comments | 0..* | string |  |  |
| `Specimen.collection.extension` | `Specimen.collection.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Specimen.collection.id` | `Specimen.collection.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
...
| `Specimen.collection.modifierExtension` | `Specimen.collection.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Specimen.container.extension` | `Specimen.container.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Specimen.container.id` | `Specimen.container.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Specimen.container.identifier` | `Specimen.container.identifier` | `identifier` |  | Id for the container | 0..* | Identifier |  |  |
| `Specimen.container.modifierExtension` | `Specimen.container.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
...
| `Specimen.language` | `Specimen.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
...
| `Specimen.treatment` | `Specimen.treatment` | `treatment` |  | Treatment and processing step details | 0..* | BackboneElement |  |  |
| `Specimen.treatment.additive` | `Specimen.treatment.additive` | `additive` |  | Material used in the processing step | 0..* | Reference(http://hl7.org/fhir/StructureDefinition/Substance) |  |  |
| `Specimen.treatment.description` | `Specimen.treatment.description` | `description` |  | Textual description of procedure | 0..1 | string |  |  |
| `Specimen.treatment.extension` | `Specimen.treatment.extension` | `extension` |  | Additional Content defined by implementations | 0..* | Extension |  |  |
| `Specimen.treatment.id` | `Specimen.treatment.id` | `id` |  | xml:id (or equivalent in JSON) | 0..1 | id |  |  |
| `Specimen.treatment.modifierExtension` | `Specimen.treatment.modifierExtension` | `modifierExtension` |  | Extensions that cannot be ignored | 0..* | Extension |  |  |
| `Specimen.treatment.procedure` | `Specimen.treatment.procedure` | `procedure` |  | Indicates the treatment or processing step  applied to the specimen | 0..1 | CodeableConcept | `Example` | `http://hl7.org/fhir/ValueSet/specimen-treatment-procedure` |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [Specimen](/docs/R2/Resources/Specimen.md)<br/> `http://hl7.org/fhir/StructureDefinition/Specimen\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `157`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `324`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [Specimen](/docs/R3/Resources/Specimen.md)<br/> `http://hl7.org/fhir/StructureDefinition/Specimen\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `517`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `710`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [Specimen](/docs/R4/Resources/Specimen.md)<br/> `http://hl7.org/fhir/StructureDefinition/Specimen\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1617`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1618`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [Specimen](/docs/R4B/Resources/Specimen.md)<br/> `http://hl7.org/fhir/StructureDefinition/Specimen\|4.3.0` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `1042`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsBroaderThanTarget`<br/>- DBKey: `1271`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>←←←←←←←| [Specimen](/docs/R5/Resources/Specimen.md)<br/> `http://hl7.org/fhir/StructureDefinition/Specimen\|5.0.0` 
...
This group is centered on the Structure Definition Specimen from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 Specimen| Relationship | [R3 Specimen](/docs/R3/Resources/Specimen.md)| Relationship | [R4 Specimen](/docs/R4/Resources/Specimen.md)| Relationship | [R4B Specimen](/docs/R4B/Resources/Specimen.md)| Relationship | [R5 Specimen](/docs/R5/Resources/Specimen.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
...
| *43 of 43 elements used* | | *39 of 45 elements used* | | *39 of 48 elements used* | | *39 of 48 elements used* | | *34 of 55 elements used* 
