...
| `EnrollmentResponse.created` | `EnrollmentResponse.created` | `created` |  | Creation date | 0..1 | dateTime |  |  |
| `EnrollmentResponse.disposition` | `EnrollmentResponse.disposition` | `disposition` |  | Disposition Message | 0..1 | string |  |  |
...
| `EnrollmentResponse.identifier` | `EnrollmentResponse.identifier` | `identifier` |  | Business Identifier | 0..* | Identifier |  |  |
...
| `EnrollmentResponse.language` | `EnrollmentResponse.language` | `language` | Resource.language | Language of the resource content | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
...
| `EnrollmentResponse.organization` | `EnrollmentResponse.organization` | `organization` |  | Insurer | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization) |  |  |
| `EnrollmentResponse.originalRuleset` | `EnrollmentResponse.originalRuleset` | `originalRuleset` |  | Original version | 0..1 | Coding | `Example` | `http://hl7.org/fhir/ValueSet/ruleset` |
| `EnrollmentResponse.outcome` | `EnrollmentResponse.outcome` | `outcome` |  | complete \| error | 0..1 | code | `Required` | `http://hl7.org/fhir/ValueSet/remittance-outcome` |
| `EnrollmentResponse.request` | `EnrollmentResponse.request` | `request` |  | Claim reference | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/EnrollmentRequest) |  |  |
| `EnrollmentResponse.requestOrganization` | `EnrollmentResponse.requestOrganization` | `requestOrganization` |  | Responsible organization | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Organization) |  |  |
| `EnrollmentResponse.requestProvider` | `EnrollmentResponse.requestProvider` | `requestProvider` |  | Responsible practitioner | 0..1 | Reference(http://hl7.org/fhir/StructureDefinition/Practitioner) |  |  |
| `EnrollmentResponse.ruleset` | `EnrollmentResponse.ruleset` | `ruleset` |  | Resource version | 0..1 | Coding | `Example` | `http://hl7.org/fhir/ValueSet/ruleset` |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---
| [EnrollmentResponse](/docs/R2/Resources/EnrollmentResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/EnrollmentResponse\|1.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `108`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`SourceIsNarrowerThanTarget`<br/>- DBKey: `274`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [EnrollmentResponse](/docs/R3/Resources/EnrollmentResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/EnrollmentResponse\|3.0.2` | →→→→→→→<br/>`RelatedTo`<br/>- DBKey: `457`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`RelatedTo`<br/>- DBKey: `652`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [EnrollmentResponse](/docs/R4/Resources/EnrollmentResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/EnrollmentResponse\|4.0.1` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `1479`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1480`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [EnrollmentResponse](/docs/R4B/Resources/EnrollmentResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/EnrollmentResponse\|4.3.0` | →→→→→→→<br/>`Equivalent`<br/>- DBKey: `972`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>→→→→→→→<hr/>←←←←←←←<br/>`Equivalent`<br/>- DBKey: `1201`<br/>- Reviewed: `n/a`<br/>- By: `n/a`<br/>- Identical: `False`<br/>←←←←←←←| [EnrollmentResponse](/docs/R5/Resources/EnrollmentResponse.md)<br/> `http://hl7.org/fhir/StructureDefinition/EnrollmentResponse\|5.0.0` 
...
This group is centered on the Structure Definition EnrollmentResponse from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 EnrollmentResponse| Relationship | [R3 EnrollmentResponse](/docs/R3/Resources/EnrollmentResponse.md)| Relationship | [R4 EnrollmentResponse](/docs/R4/Resources/EnrollmentResponse.md)| Relationship | [R4B EnrollmentResponse](/docs/R4B/Resources/EnrollmentResponse.md)| Relationship | [R5 EnrollmentResponse](/docs/R5/Resources/EnrollmentResponse.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
