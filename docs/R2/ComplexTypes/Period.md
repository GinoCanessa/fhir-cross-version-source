...
This group is centered on the Structure Definition Period from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 Period| Relationship | [R3 Period](/docs/R3/ComplexTypes/Period.md)| Relationship | [R4 Period](/docs/R4/ComplexTypes/Period.md)| Relationship | [R4B Period](/docs/R4B/ComplexTypes/Period.md)| Relationship | [R5 Period](/docs/R5/ComplexTypes/Period.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
