...
| `Attachment.language` | `Attachment.language` | `language` |  | Human language of the content (BCP-47) | 0..1 | code | `Required` | `http://tools.ietf.org/html/bcp47` |
...
This group is centered on the Structure Definition Attachment from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 Attachment| Relationship | [R3 Attachment](/docs/R3/ComplexTypes/Attachment.md)| Relationship | [R4 Attachment](/docs/R4/ComplexTypes/Attachment.md)| Relationship | [R4B Attachment](/docs/R4B/ComplexTypes/Attachment.md)| Relationship | [R5 Attachment](/docs/R5/ComplexTypes/Attachment.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
