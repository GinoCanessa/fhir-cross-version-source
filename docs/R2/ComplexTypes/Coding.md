...
This group is centered on the Structure Definition Coding from hl7.fhir.r2.core@1.0.2 (R2, key 1).
All elements from this structure are listed while other structures only show contents that have relationships with those elements.

| R2 Coding| Relationship | [R3 Coding](/docs/R3/ComplexTypes/Coding.md)| Relationship | [R4 Coding](/docs/R4/ComplexTypes/Coding.md)| Relationship | [R4B Coding](/docs/R4B/ComplexTypes/Coding.md)| Relationship | [R5 Coding](/docs/R5/ComplexTypes/Coding.md)
| --- | --- | --- | --- | --- | --- | --- | --- | ---
