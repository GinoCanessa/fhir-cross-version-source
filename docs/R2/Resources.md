...
## Resource Overview
| Name | Canonical | Description | Path to R3 | Path to R4 | Path to R4B | Path to R5 |
| --- | --- | --- | --- | --- | --- | --- |
| [Account](Resources/Account.md) | `http://hl7.org/fhir/StructureDefinition/Account\|1.0.2` | Base StructureDefinition for Account Resource | ✔ | ✔ | ✔ | ✔ |
| [AllergyIntolerance](Resources/AllergyIntolerance.md) | `http://hl7.org/fhir/StructureDefinition/AllergyIntolerance\|1.0.2` | Base StructureDefinition for AllergyIntolerance Resource | ✔ | ✔ | ✔ | ✔ |
| [Appointment](Resources/Appointment.md) | `http://hl7.org/fhir/StructureDefinition/Appointment\|1.0.2` | Base StructureDefinition for Appointment Resource | ✔ | ✔ | ✔ | ✔ |
| [AppointmentResponse](Resources/AppointmentResponse.md) | `http://hl7.org/fhir/StructureDefinition/AppointmentResponse\|1.0.2` | Base StructureDefinition for AppointmentResponse Resource | ✔ | ✔ | ✔ | ✔ |
| [AuditEvent](Resources/AuditEvent.md) | `http://hl7.org/fhir/StructureDefinition/AuditEvent\|1.0.2` | Base StructureDefinition for AuditEvent Resource | ✔ | ✔ | ✔ | ✔ |
| [Basic](Resources/Basic.md) | `http://hl7.org/fhir/StructureDefinition/Basic\|1.0.2` | Base StructureDefinition for Basic Resource | ✔ | ✔ | ✔ | ✔ |
| [Binary](Resources/Binary.md) | `http://hl7.org/fhir/StructureDefinition/Binary\|1.0.2` | Base StructureDefinition for Binary Resource | ✔ | ✔ | ✔ | ✔ |
| [BodySite](Resources/BodySite.md) | `http://hl7.org/fhir/StructureDefinition/BodySite\|1.0.2` | Base StructureDefinition for BodySite Resource | ✔ | ✔ | ✔ | ✔ |
| [Bundle](Resources/Bundle.md) | `http://hl7.org/fhir/StructureDefinition/Bundle\|1.0.2` | Base StructureDefinition for Bundle Resource | ✔ | ✔ | ✔ | ✔ |
| [CarePlan](Resources/CarePlan.md) | `http://hl7.org/fhir/StructureDefinition/CarePlan\|1.0.2` | Base StructureDefinition for CarePlan Resource | ✔ | ✔ | ✔ | ✔ |
| [Claim](Resources/Claim.md) | `http://hl7.org/fhir/StructureDefinition/Claim\|1.0.2` | Base StructureDefinition for Claim Resource | ✔ | ✔ | ✔ | ✔ |
| [ClaimResponse](Resources/ClaimResponse.md) | `http://hl7.org/fhir/StructureDefinition/ClaimResponse\|1.0.2` | Base StructureDefinition for ClaimResponse Resource | ✔ | ✔ | ✔ | ✔ |
| [ClinicalImpression](Resources/ClinicalImpression.md) | `http://hl7.org/fhir/StructureDefinition/ClinicalImpression\|1.0.2` | Base StructureDefinition for ClinicalImpression Resource | ✔ | ✔ | ✔ | ✔ |
| [Communication](Resources/Communication.md) | `http://hl7.org/fhir/StructureDefinition/Communication\|1.0.2` | Base StructureDefinition for Communication Resource | ✔ | ✔ | ✔ | ✔ |
| [CommunicationRequest](Resources/CommunicationRequest.md) | `http://hl7.org/fhir/StructureDefinition/CommunicationRequest\|1.0.2` | Base StructureDefinition for CommunicationRequest Resource | ✔ | ✔ | ✔ | ✔ |
| [Composition](Resources/Composition.md) | `http://hl7.org/fhir/StructureDefinition/Composition\|1.0.2` | Base StructureDefinition for Composition Resource | ✔ | ✔ | ✔ | ✔ |
| [ConceptMap](Resources/ConceptMap.md) | `http://hl7.org/fhir/StructureDefinition/ConceptMap\|1.0.2` | Base StructureDefinition for ConceptMap Resource | ✔ | ✔ | ✔ | ✔ |
| [Condition](Resources/Condition.md) | `http://hl7.org/fhir/StructureDefinition/Condition\|1.0.2` | Base StructureDefinition for Condition Resource | ✔ | ✔ | ✔ | ✔ |
| [Conformance](Resources/Conformance.md) | `http://hl7.org/fhir/StructureDefinition/Conformance\|1.0.2` | Base StructureDefinition for Conformance Resource | ✔ | ✔ | ✔ | ✔ |
| [Contract](Resources/Contract.md) | `http://hl7.org/fhir/StructureDefinition/Contract\|1.0.2` | Base StructureDefinition for Contract Resource | ✔ | ✔ | ✔ | ✔ |
| [Coverage](Resources/Coverage.md) | `http://hl7.org/fhir/StructureDefinition/Coverage\|1.0.2` | Base StructureDefinition for Coverage Resource | ✔ | ✔ | ✔ | ✔ |
| [DataElement](Resources/DataElement.md) | `http://hl7.org/fhir/StructureDefinition/DataElement\|1.0.2` | Base StructureDefinition for DataElement Resource | ✔ | ✔ | ✔ | ✔ |
| [DetectedIssue](Resources/DetectedIssue.md) | `http://hl7.org/fhir/StructureDefinition/DetectedIssue\|1.0.2` | Base StructureDefinition for DetectedIssue Resource | ✔ | ✔ | ✔ | ✔ |
| [Device](Resources/Device.md) | `http://hl7.org/fhir/StructureDefinition/Device\|1.0.2` | Base StructureDefinition for Device Resource | ✔ | ✔ | ✔ | ✔ |
| [DeviceComponent](Resources/DeviceComponent.md) | `http://hl7.org/fhir/StructureDefinition/DeviceComponent\|1.0.2` | Base StructureDefinition for DeviceComponent Resource | ✔ |  |  |  |
| [DeviceMetric](Resources/DeviceMetric.md) | `http://hl7.org/fhir/StructureDefinition/DeviceMetric\|1.0.2` | Base StructureDefinition for DeviceMetric Resource | ✔ | ✔ | ✔ | ✔ |
| [DeviceUseRequest](Resources/DeviceUseRequest.md) | `http://hl7.org/fhir/StructureDefinition/DeviceUseRequest\|1.0.2` | Base StructureDefinition for DeviceUseRequest Resource | ✔ | ✔ | ✔ | ✔ |
| [DeviceUseStatement](Resources/DeviceUseStatement.md) | `http://hl7.org/fhir/StructureDefinition/DeviceUseStatement\|1.0.2` | Base StructureDefinition for DeviceUseStatement Resource | ✔ | ✔ | ✔ | ✔ |
| [DiagnosticOrder](Resources/DiagnosticOrder.md) | `http://hl7.org/fhir/StructureDefinition/DiagnosticOrder\|1.0.2` | Base StructureDefinition for DiagnosticOrder Resource | ✔ | ✔ | ✔ | ✔ |
| [DiagnosticReport](Resources/DiagnosticReport.md) | `http://hl7.org/fhir/StructureDefinition/DiagnosticReport\|1.0.2` | Base StructureDefinition for DiagnosticReport Resource | ✔ | ✔ | ✔ | ✔ |
| [DocumentManifest](Resources/DocumentManifest.md) | `http://hl7.org/fhir/StructureDefinition/DocumentManifest\|1.0.2` | Base StructureDefinition for DocumentManifest Resource | ✔ | ✔ | ✔ |  |
| [DocumentReference](Resources/DocumentReference.md) | `http://hl7.org/fhir/StructureDefinition/DocumentReference\|1.0.2` | Base StructureDefinition for DocumentReference Resource | ✔ | ✔ | ✔ | ✔ |
| [DomainResource](Resources/DomainResource.md) | `http://hl7.org/fhir/StructureDefinition/DomainResource\|1.0.2` | Base StructureDefinition for DomainResource Resource | ✔ | ✔ | ✔ | ✔ |
...
| [OperationOutcome](Resources/OperationOutcome.md) | `http://hl7.org/fhir/StructureDefinition/OperationOutcome\|1.0.2` | Base StructureDefinition for OperationOutcome Resource | ✔ | ✔ | ✔ | ✔ |
