...
| Encounter | Encounter | Equivalent | R5 `Encounter` is equivalent to R4B `Encounter`. |
...
| RelatedPerson | RelatedPerson | Equivalent | R5 `RelatedPerson` is equivalent to R4B `RelatedPerson`. |
