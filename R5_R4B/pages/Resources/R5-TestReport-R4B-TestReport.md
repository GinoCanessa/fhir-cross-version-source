...
| ------ | ------ | ------ | ------- |
| TestReport | TestReport | Equivalent | R5 `TestReport` maps as Equivalent to R4B `TestReport` |
| TestReport.contained | TestReport.contained | Equivalent | R5 `TestReport.contained` maps as Equivalent to R4B `TestReport.contained` |
| TestReport.extension | TestReport.extension | SourceIsBroaderThanTarget | R5 `TestReport.extension` maps as SourceIsBroaderThanTarget to R4B `TestReport.extension` - extension has change due to type change: R5 `extension` `Extension` maps as SourceIsBroaderThanTarget for R4B `extension` |
| TestReport.id | TestReport.id | Equivalent | R5 `TestReport.id` maps as Equivalent to R4B `TestReport.id` |
| TestReport.identifier | TestReport.identifier | Equivalent | R5 `TestReport.identifier` maps as Equivalent to R4B `TestReport.identifier` |
| TestReport.implicitRules | TestReport.implicitRules | Equivalent | R5 `TestReport.implicitRules` maps as Equivalent to R4B `TestReport.implicitRules` |
| TestReport.issued | TestReport.issued | Equivalent | R5 `TestReport.issued` maps as Equivalent to R4B `TestReport.issued` |
| TestReport.language | TestReport.language | RelatedTo | R5 `TestReport.language` maps as RelatedTo to R4B `TestReport.language` - language changed the binding strength from Required to Preferred |
| TestReport.meta | TestReport.meta | Equivalent | R5 `TestReport.meta` maps as Equivalent to R4B `TestReport.meta` |
| TestReport.modifierExtension | TestReport.modifierExtension | SourceIsBroaderThanTarget | R5 `TestReport.modifierExtension` maps as SourceIsBroaderThanTarget to R4B `TestReport.modifierExtension` - modifierExtension has change due to type change: R5 `modifierExtension` `Extension` maps as SourceIsBroaderThanTarget for R4B `modifierExtension` |
| TestReport.name | TestReport.name | Equivalent | R5 `TestReport.name` maps as Equivalent to R4B `TestReport.name` |
| TestReport.participant | TestReport.participant | Equivalent | R5 `TestReport.participant` maps as Equivalent to R4B `TestReport.participant` |
| TestReport.participant.display | TestReport.participant.display | Equivalent | R5 `TestReport.participant.display` maps as Equivalent to R4B `TestReport.participant.display` |
| TestReport.participant.extension | TestReport.participant.extension | SourceIsBroaderThanTarget | R5 `TestReport.participant.extension` maps as SourceIsBroaderThanTarget to R4B `TestReport.participant.extension` - extension has change due to type change: R5 `extension` `Extension` maps as SourceIsBroaderThanTarget for R4B `extension` |
| TestReport.participant.id | TestReport.participant.id | Equivalent | R5 `TestReport.participant.id` maps as Equivalent to R4B `TestReport.participant.id` |
| TestReport.participant.modifierExtension | TestReport.participant.modifierExtension | SourceIsBroaderThanTarget | R5 `TestReport.participant.modifierExtension` maps as SourceIsBroaderThanTarget to R4B `TestReport.participant.modifierExtension` - modifierExtension has change due to type change: R5 `modifierExtension` `Extension` maps as SourceIsBroaderThanTarget for R4B `modifierExtension` |
| TestReport.participant.type | TestReport.participant.type | Equivalent | R5 `TestReport.participant.type` maps as Equivalent to R4B `TestReport.participant.type` - type has compatible required binding for code type: http://hl7.org/fhir/ValueSet/report-participant-type|5.0.0 and http://hl7.org/fhir/ValueSet/report-participant-type|4.3.0 (Equivalent) |
| TestReport.participant.uri | TestReport.participant.uri | Equivalent | R5 `TestReport.participant.uri` maps as Equivalent to R4B `TestReport.participant.uri` |
| TestReport.result | TestReport.result | Equivalent | R5 `TestReport.result` maps as Equivalent to R4B `TestReport.result` - result has compatible required binding for code type: http://hl7.org/fhir/ValueSet/report-result-codes|5.0.0 and http://hl7.org/fhir/ValueSet/report-result-codes|4.3.0 (Equivalent) |
| TestReport.score | TestReport.score | Equivalent | R5 `TestReport.score` maps as Equivalent to R4B `TestReport.score` |
| TestReport.setup | TestReport.setup | Equivalent | R5 `TestReport.setup` maps as Equivalent to R4B `TestReport.setup` |
| TestReport.setup.action | TestReport.setup.action | Equivalent | R5 `TestReport.setup.action` maps as Equivalent to R4B `TestReport.setup.action` |
| TestReport.setup.action.assert | TestReport.setup.action.assert | Equivalent | R5 `TestReport.setup.action.assert` maps as Equivalent to R4B `TestReport.setup.action.assert` |
| TestReport.setup.action.assert.detail | TestReport.setup.action.assert.detail | Equivalent | R5 `TestReport.setup.action.assert.detail` maps as Equivalent to R4B `TestReport.setup.action.assert.detail` |
| TestReport.setup.action.assert.extension | TestReport.setup.action.assert.extension | SourceIsBroaderThanTarget | R5 `TestReport.setup.action.assert.extension` maps as SourceIsBroaderThanTarget to R4B `TestReport.setup.action.assert.extension` - extension has change due to type change: R5 `extension` `Extension` maps as SourceIsBroaderThanTarget for R4B `extension` |
| TestReport.setup.action.assert.id | TestReport.setup.action.assert.id | Equivalent | R5 `TestReport.setup.action.assert.id` maps as Equivalent to R4B `TestReport.setup.action.assert.id` |
...
| TestReport.testScript | TestReport.testScript | SourceIsBroaderThanTarget | R5 `TestReport.testScript` maps as SourceIsBroaderThanTarget to R4B `TestReport.testScript` - testScript has change due to type change: R5 testScript canonical has no equivalent or mapped type in R4B testScript |
