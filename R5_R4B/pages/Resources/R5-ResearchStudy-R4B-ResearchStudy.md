...
| ------ | ------ | ------ | ------- |
| ResearchStudy | ResearchStudy | Equivalent | R5 `ResearchStudy` maps as Equivalent to R4B `ResearchStudy` |
...
| ResearchStudy.condition | ResearchStudy.condition | Equivalent | R5 `ResearchStudy.condition` maps as Equivalent to R4B `ResearchStudy.condition` |
| ResearchStudy.contained | ResearchStudy.contained | Equivalent | R5 `ResearchStudy.contained` maps as Equivalent to R4B `ResearchStudy.contained` |
...
| ResearchStudy.description | ResearchStudy.description | Equivalent | R5 `ResearchStudy.description` maps as Equivalent to R4B `ResearchStudy.description` |
