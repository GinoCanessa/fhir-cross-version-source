...
| ------ | ------ | ------ | ------- |
| Appointment | Appointment | Equivalent | R5 `Appointment` maps as Equivalent to R4B `Appointment` |
...
| Appointment.appointmentType | Appointment.appointmentType | Equivalent | R5 `Appointment.appointmentType` maps as Equivalent to R4B `Appointment.appointmentType` |
| Appointment.basedOn | Appointment.basedOn | SourceIsBroaderThanTarget | R5 `Appointment.basedOn` maps as SourceIsBroaderThanTarget to R4B `Appointment.basedOn` - basedOn has change due to type change: R5 `basedOn` `Reference` maps as SourceIsBroaderThanTarget for R4B `basedOn` |
...
| Appointment.contained | Appointment.contained | Equivalent | R5 `Appointment.contained` maps as Equivalent to R4B `Appointment.contained` |
| Appointment.created | Appointment.created | Equivalent | R5 `Appointment.created` maps as Equivalent to R4B `Appointment.created` |
| Appointment.description | Appointment.description | Equivalent | R5 `Appointment.description` maps as Equivalent to R4B `Appointment.description` |
| Appointment.end | Appointment.end | Equivalent | R5 `Appointment.end` maps as Equivalent to R4B `Appointment.end` |
| Appointment.extension | Appointment.extension | SourceIsBroaderThanTarget | R5 `Appointment.extension` maps as SourceIsBroaderThanTarget to R4B `Appointment.extension` - extension has change due to type change: R5 `extension` `Extension` maps as SourceIsBroaderThanTarget for R4B `extension` |
| Appointment.id | Appointment.id | Equivalent | R5 `Appointment.id` maps as Equivalent to R4B `Appointment.id` |
| Appointment.identifier | Appointment.identifier | Equivalent | R5 `Appointment.identifier` maps as Equivalent to R4B `Appointment.identifier` |
| Appointment.implicitRules | Appointment.implicitRules | Equivalent | R5 `Appointment.implicitRules` maps as Equivalent to R4B `Appointment.implicitRules` |
| Appointment.language | Appointment.language | RelatedTo | R5 `Appointment.language` maps as RelatedTo to R4B `Appointment.language` - language changed the binding strength from Required to Preferred |
| Appointment.meta | Appointment.meta | Equivalent | R5 `Appointment.meta` maps as Equivalent to R4B `Appointment.meta` |
| Appointment.minutesDuration | Appointment.minutesDuration | Equivalent | R5 `Appointment.minutesDuration` maps as Equivalent to R4B `Appointment.minutesDuration` |
| Appointment.modifierExtension | Appointment.modifierExtension | SourceIsBroaderThanTarget | R5 `Appointment.modifierExtension` maps as SourceIsBroaderThanTarget to R4B `Appointment.modifierExtension` - modifierExtension has change due to type change: R5 `modifierExtension` `Extension` maps as SourceIsBroaderThanTarget for R4B `modifierExtension` |
...
| Appointment.participant | Appointment.participant | Equivalent | R5 `Appointment.participant` maps as Equivalent to R4B `Appointment.participant` |
| Appointment.participant.actor | Appointment.participant.actor | SourceIsBroaderThanTarget | R5 `Appointment.participant.actor` maps as SourceIsBroaderThanTarget to R4B `Appointment.participant.actor` - actor has change due to type change: R5 `actor` `Reference` maps as SourceIsBroaderThanTarget for R4B `actor` |
| Appointment.participant.extension | Appointment.participant.extension | SourceIsBroaderThanTarget | R5 `Appointment.participant.extension` maps as SourceIsBroaderThanTarget to R4B `Appointment.participant.extension` - extension has change due to type change: R5 `extension` `Extension` maps as SourceIsBroaderThanTarget for R4B `extension` |
| Appointment.participant.id | Appointment.participant.id | Equivalent | R5 `Appointment.participant.id` maps as Equivalent to R4B `Appointment.participant.id` |
...
| Appointment.status | Appointment.status | Equivalent | R5 `Appointment.status` maps as Equivalent to R4B `Appointment.status` - status has compatible required binding for code type: http://hl7.org/fhir/ValueSet/appointmentstatus|5.0.0 and http://hl7.org/fhir/ValueSet/appointmentstatus|4.3.0 (Equivalent) |
