...
| --- | --- | --- | --- | --- | --- |
| Source | SpecimenDefinition |  | A kind of specimen with associated set of requirements. | 72 | 52 |
| Target | SpecimenDefinition |  | A kind of specimen with associated set of requirements. | 48 | 28 |
...
| ------ | ------ | ------ | ------- |
| SpecimenDefinition | SpecimenDefinition | Equivalent | R5 `SpecimenDefinition` maps as Equivalent to R4B `SpecimenDefinition` |
| SpecimenDefinition.approvalDate | - | DoesNotExistInTarget | R5 `SpecimenDefinition.approvalDate` does not appear in the target and has no mapping for `SpecimenDefinition`. |
| SpecimenDefinition.collection | SpecimenDefinition.collection | Equivalent | R5 `SpecimenDefinition.collection` maps as Equivalent to R4B `SpecimenDefinition.collection` |
| SpecimenDefinition.contact | - | DoesNotExistInTarget | R5 `SpecimenDefinition.contact` does not appear in the target and has no mapping for `SpecimenDefinition`. |
| SpecimenDefinition.contained | SpecimenDefinition.contained | Equivalent | R5 `SpecimenDefinition.contained` maps as Equivalent to R4B `SpecimenDefinition.contained` |
| SpecimenDefinition.copyright | - | DoesNotExistInTarget | R5 `SpecimenDefinition.copyright` does not appear in the target and has no mapping for `SpecimenDefinition`. |
| SpecimenDefinition.copyrightLabel | - | DoesNotExistInTarget | R5 `SpecimenDefinition.copyrightLabel` does not appear in the target and has no mapping for `SpecimenDefinition`. |
| SpecimenDefinition.date | - | DoesNotExistInTarget | R5 `SpecimenDefinition.date` does not appear in the target and has no mapping for `SpecimenDefinition`. |
| SpecimenDefinition.derivedFromCanonical | - | DoesNotExistInTarget | R5 `SpecimenDefinition.derivedFromCanonical` does not appear in the target and has no mapping for `SpecimenDefinition`. |
| SpecimenDefinition.derivedFromUri | - | DoesNotExistInTarget | R5 `SpecimenDefinition.derivedFromUri` does not appear in the target and has no mapping for `SpecimenDefinition`. |
| SpecimenDefinition.description | - | DoesNotExistInTarget | R5 `SpecimenDefinition.description` does not appear in the target and has no mapping for `SpecimenDefinition`. |
| SpecimenDefinition.effectivePeriod | - | DoesNotExistInTarget | R5 `SpecimenDefinition.effectivePeriod` does not appear in the target and has no mapping for `SpecimenDefinition`. |
| SpecimenDefinition.experimental | - | DoesNotExistInTarget | R5 `SpecimenDefinition.experimental` does not appear in the target and has no mapping for `SpecimenDefinition`. |
| SpecimenDefinition.extension | SpecimenDefinition.extension | SourceIsBroaderThanTarget | R5 `SpecimenDefinition.extension` maps as SourceIsBroaderThanTarget to R4B `SpecimenDefinition.extension` - extension has change due to type change: R5 `extension` `Extension` maps as SourceIsBroaderThanTarget for R4B `extension` |
| SpecimenDefinition.id | SpecimenDefinition.id | Equivalent | R5 `SpecimenDefinition.id` maps as Equivalent to R4B `SpecimenDefinition.id` |
| SpecimenDefinition.identifier | SpecimenDefinition.identifier | Equivalent | R5 `SpecimenDefinition.identifier` maps as Equivalent to R4B `SpecimenDefinition.identifier` |
| SpecimenDefinition.implicitRules | SpecimenDefinition.implicitRules | Equivalent | R5 `SpecimenDefinition.implicitRules` maps as Equivalent to R4B `SpecimenDefinition.implicitRules` |
...
| SpecimenDefinition.language | SpecimenDefinition.language | RelatedTo | R5 `SpecimenDefinition.language` maps as RelatedTo to R4B `SpecimenDefinition.language` - language changed the binding strength from Required to Preferred |
...
| SpecimenDefinition.meta | SpecimenDefinition.meta | Equivalent | R5 `SpecimenDefinition.meta` maps as Equivalent to R4B `SpecimenDefinition.meta` |
| SpecimenDefinition.modifierExtension | SpecimenDefinition.modifierExtension | SourceIsBroaderThanTarget | R5 `SpecimenDefinition.modifierExtension` maps as SourceIsBroaderThanTarget to R4B `SpecimenDefinition.modifierExtension` - modifierExtension has change due to type change: R5 `modifierExtension` `Extension` maps as SourceIsBroaderThanTarget for R4B `modifierExtension` |
| SpecimenDefinition.name | - | DoesNotExistInTarget | R5 `SpecimenDefinition.name` does not appear in the target and has no mapping for `SpecimenDefinition`. |
| SpecimenDefinition.patientPreparation | SpecimenDefinition.patientPreparation | Equivalent | R5 `SpecimenDefinition.patientPreparation` maps as Equivalent to R4B `SpecimenDefinition.patientPreparation` |
| SpecimenDefinition.publisher | - | DoesNotExistInTarget | R5 `SpecimenDefinition.publisher` does not appear in the target and has no mapping for `SpecimenDefinition`. |
| SpecimenDefinition.purpose | - | DoesNotExistInTarget | R5 `SpecimenDefinition.purpose` does not appear in the target and has no mapping for `SpecimenDefinition`. |
...
| SpecimenDefinition.typeTested.testingDestination | - | DoesNotExistInTarget | R5 `SpecimenDefinition.typeTested.testingDestination` does not appear in the target and has no mapping for `SpecimenDefinition`. |
