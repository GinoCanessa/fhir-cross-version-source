...
| es-ES | - | DoesNotExistInTarget | urn:ietf:bcp:47#es-ES does not exist in target and has no mapping |
...
| pt-PT | - | DoesNotExistInTarget | urn:ietf:bcp:47#pt-PT does not exist in target and has no mapping |
