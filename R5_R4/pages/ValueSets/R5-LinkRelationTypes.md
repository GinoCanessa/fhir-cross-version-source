...
| --- | --- | --- | --- | --- |
| Source | http://hl7.org/fhir/ValueSet/iana-link-relations | LinkRelationTypes | Link Relation Types | Link Relation Types defined at https://www.iana.org/assignments/link-relations/link-relations.xhtml#link-relations-1 |
| Target | - | - | - | - |
...
| Status | Count |
| ------ | ----- |
DoesNotExistInTarget | 120 |


| Source | Target | Status | Message |
| ------ | ------ | ------ | ------- |
| about | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#about does not exist in target and has no mapping |
| acl | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#acl does not exist in target and has no mapping |
| alternate | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#alternate does not exist in target and has no mapping |
| amphtml | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#amphtml does not exist in target and has no mapping |
| appendix | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#appendix does not exist in target and has no mapping |
| apple-touch-icon | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#apple-touch-icon does not exist in target and has no mapping |
| apple-touch-startup-image | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#apple-touch-startup-image does not exist in target and has no mapping |
| archives | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#archives does not exist in target and has no mapping |
| author | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#author does not exist in target and has no mapping |
| blocked-by | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#blocked-by does not exist in target and has no mapping |
| bookmark | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#bookmark does not exist in target and has no mapping |
| canonical | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#canonical does not exist in target and has no mapping |
| chapter | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#chapter does not exist in target and has no mapping |
| cite-as | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#cite-as does not exist in target and has no mapping |
| collection | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#collection does not exist in target and has no mapping |
| contents | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#contents does not exist in target and has no mapping |
| convertedFrom | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#convertedFrom does not exist in target and has no mapping |
| copyright | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#copyright does not exist in target and has no mapping |
| create-form | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#create-form does not exist in target and has no mapping |
| current | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#current does not exist in target and has no mapping |
| describedby | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#describedby does not exist in target and has no mapping |
| describes | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#describes does not exist in target and has no mapping |
| disclosure | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#disclosure does not exist in target and has no mapping |
| dns-prefetch | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#dns-prefetch does not exist in target and has no mapping |
| duplicate | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#duplicate does not exist in target and has no mapping |
| edit | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#edit does not exist in target and has no mapping |
| edit-form | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#edit-form does not exist in target and has no mapping |
...
| modulepreload | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#modulepreload does not exist in target and has no mapping |
...
| service-meta | - | DoesNotExistInTarget | http://hl7.org/fhir/CodeSystem/iana-link-relations#service-meta does not exist in target and has no mapping |
