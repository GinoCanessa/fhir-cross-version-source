...
| --- | --- | --- | --- | --- |
| Source | http://hl7.org/fhir/ValueSet/supplyrequest-status | SupplyRequestStatus | Supply Request Status | Status of the supply request. |
| Target | http://hl7.org/fhir/ValueSet/supplyrequest-status | SupplyRequestStatus | SupplyRequestStatus | Status of the supply request. |
