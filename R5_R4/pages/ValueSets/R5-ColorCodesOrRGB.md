...
| --- | --- | --- | --- | --- |
| Source | http://hl7.org/fhir/ValueSet/color-codes | ColorCodesOrRGB | Color Codes (Names or RGB Values) | This value set includes color codes - either the color names as defined in [CSS4](https://www.w3.org/TR/css-color-4/), or any valid RGB code (```#RRGGBB``` in Hex). |
| Target | - | - | - | - |
...
| Status | Count |
| ------ | ----- |
DoesNotExistInTarget | 148 |


| Source | Target | Status | Message |
| ------ | ------ | ------ | ------- |
| aliceblue | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#aliceblue does not exist in target and has no mapping |
| antiquewhite | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#antiquewhite does not exist in target and has no mapping |
| aqua | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#aqua does not exist in target and has no mapping |
| aquamarine | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#aquamarine does not exist in target and has no mapping |
| azure | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#azure does not exist in target and has no mapping |
| beige | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#beige does not exist in target and has no mapping |
| bisque | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#bisque does not exist in target and has no mapping |
| black | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#black does not exist in target and has no mapping |
| blanchedalmond | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#blanchedalmond does not exist in target and has no mapping |
| blue | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#blue does not exist in target and has no mapping |
| blueviolet | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#blueviolet does not exist in target and has no mapping |
| brown | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#brown does not exist in target and has no mapping |
| burlywood | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#burlywood does not exist in target and has no mapping |
| cadetblue | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#cadetblue does not exist in target and has no mapping |
| chartreuse | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#chartreuse does not exist in target and has no mapping |
| chocolate | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#chocolate does not exist in target and has no mapping |
| coral | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#coral does not exist in target and has no mapping |
| cornflowerblue | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#cornflowerblue does not exist in target and has no mapping |
| cornsilk | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#cornsilk does not exist in target and has no mapping |
| crimson | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#crimson does not exist in target and has no mapping |
| cyan | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#cyan does not exist in target and has no mapping |
| darkblue | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#darkblue does not exist in target and has no mapping |
| darkcyan | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#darkcyan does not exist in target and has no mapping |
| darkgoldenrod | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#darkgoldenrod does not exist in target and has no mapping |
| darkgray | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#darkgray does not exist in target and has no mapping |
| darkgreen | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#darkgreen does not exist in target and has no mapping |
| darkgrey | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#darkgrey does not exist in target and has no mapping |
...
| lavender | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#lavender does not exist in target and has no mapping |
...
| navajowhite | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#navajowhite does not exist in target and has no mapping |
...
| tan | - | DoesNotExistInTarget | http://hl7.org/fhir/color-names#tan does not exist in target and has no mapping |
