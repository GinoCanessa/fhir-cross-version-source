...
| --- | --- | --- | --- | --- |
| Source | http://hl7.org/fhir/ValueSet/medication-admin-status | MedicationAdministrationStatusCodes | MedicationAdministration Status Codes | MedicationAdministration Status Codes |
| Target | http://hl7.org/fhir/ValueSet/medication-admin-status | MedicationAdministration Status Codes | Medication administration  status  codes | MedicationAdministration Status Codes |
...
| not-done | not-done | Equivalent | R5 `not-done` is equivalent to R4 `not-done`. |
