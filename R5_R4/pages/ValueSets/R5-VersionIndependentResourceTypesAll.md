...
| --- | --- | --- | --- | --- |
| Source | http://hl7.org/fhir/ValueSet/version-independent-all-resource-types | VersionIndependentResourceTypesAll | Version Independent Resource Types (All) | Current and past FHIR resource types (deleted or renamed), including abstract types |
| Target | - | - | - | - |
...
| BodySite | - | DoesNotExistInTarget | http://hl7.org/fhir/fhir-old-types#BodySite does not exist in target and has no mapping |
...
| CatalogEntry | - | DoesNotExistInTarget | http://hl7.org/fhir/fhir-old-types#CatalogEntry does not exist in target and has no mapping |
...
| Order | - | DoesNotExistInTarget | http://hl7.org/fhir/fhir-old-types#Order does not exist in target and has no mapping |
...
| ServiceDefinition | - | DoesNotExistInTarget | http://hl7.org/fhir/fhir-old-types#ServiceDefinition does not exist in target and has no mapping |
