...
| --- | --- | --- | --- | --- |
| Source | http://hl7.org/fhir/ValueSet/questionnaire-answers-status | QuestionnaireResponseStatus | Questionnaire Response Status | Lifecycle status of the questionnaire response. |
| Target | http://hl7.org/fhir/ValueSet/questionnaire-answers-status | QuestionnaireResponseStatus | QuestionnaireResponseStatus | Lifecycle status of the questionnaire response. |
