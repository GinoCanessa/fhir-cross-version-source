...
| --- | --- | --- | --- | --- |
| Source | http://hl7.org/fhir/ValueSet/fm-status | FinancialResourceStatusCodes | Financial Resource Status Codes | This value set includes Status codes. |
| Target | http://hl7.org/fhir/ValueSet/fm-status | FinancialResourceStatusCodes | Financial Resource Status Codes | This value set includes Status codes. |
