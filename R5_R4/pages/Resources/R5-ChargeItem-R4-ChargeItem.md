...
| ------ | ------ | ------ | ------- |
| ChargeItem | ChargeItem | SourceIsNarrowerThanTarget | R5 `ChargeItem` is narrower than R4 `ChargeItem` and is compatible. `ChargeItem` is mapped from `ChargeItem` and `ChargeItem.totalPriceComponent`. |
...
| ChargeItem.encounter | ChargeItem.context | SourceIsNarrowerThanTarget | R5 `ChargeItem.encounter` maps as SourceIsNarrowerThanTarget to R4 `ChargeItem.context` - context has change due to type change: R5 `encounter` `Reference` maps as SourceIsNarrowerThanTarget for R4 `context` |
...
| ChargeItem.language | ChargeItem.language | SourceIsNarrowerThanTarget | R5 `ChargeItem.language` maps as SourceIsNarrowerThanTarget to R4 `ChargeItem.language` - language changed the binding strength from Required to Preferred; language has change due to type change: R5 `language` `code` maps as SourceIsNarrowerThanTarget for R4 `language` |
