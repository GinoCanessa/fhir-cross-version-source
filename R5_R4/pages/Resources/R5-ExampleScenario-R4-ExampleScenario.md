...
| ExampleScenario.language | ExampleScenario.language | RelatedTo | R5 `ExampleScenario.language` maps as RelatedTo to R4 `ExampleScenario.language` - language changed the binding strength from Required to Preferred |
...
| ExampleScenario.process.step.process | ExampleScenario.process.step.process | RelatedTo | R5 `ExampleScenario.process.step.process` maps as RelatedTo to R4 `ExampleScenario.process.step.process` - process changed from scalar to array (max cardinality from 1 to *) |
