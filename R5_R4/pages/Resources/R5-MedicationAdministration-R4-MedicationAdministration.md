...
| MedicationAdministration.encounter | MedicationAdministration.context | SourceIsNarrowerThanTarget | R5 `MedicationAdministration.encounter` maps as SourceIsNarrowerThanTarget to R4 `MedicationAdministration.context` - context has change due to type change: R5 `encounter` `Reference` maps as SourceIsNarrowerThanTarget for R4 `context` |
