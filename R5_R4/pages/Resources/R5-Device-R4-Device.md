...
| Device.language | Device.language | RelatedTo | R5 `Device.language` maps as RelatedTo to R4 `Device.language` - language changed the binding strength from Required to Preferred |
