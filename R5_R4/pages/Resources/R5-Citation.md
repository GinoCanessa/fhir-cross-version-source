...
| Status | Count |
| ------ | ----- |
DoesNotExistInTarget | 181 |


| Source | Target | Status | Message |
| ------ | ------ | ------ | ------- |
| Citation | - | DoesNotExistInTarget | Citation does not exist in target and has no mapping |
| Citation.approvalDate | - | DoesNotExistInTarget | Citation.approvalDate does not exist in target and has no mapping |
| Citation.author | - | DoesNotExistInTarget | Citation.author does not exist in target and has no mapping |
| Citation.citedArtifact | - | DoesNotExistInTarget | Citation.citedArtifact does not exist in target and has no mapping |
| Citation.citedArtifact.abstract | - | DoesNotExistInTarget | Citation.citedArtifact.abstract does not exist in target and has no mapping |
| Citation.citedArtifact.abstract.copyright | - | DoesNotExistInTarget | Citation.citedArtifact.abstract.copyright does not exist in target and has no mapping |
| Citation.citedArtifact.abstract.extension | - | DoesNotExistInTarget | Citation.citedArtifact.abstract.extension does not exist in target and has no mapping |
| Citation.citedArtifact.abstract.id | - | DoesNotExistInTarget | Citation.citedArtifact.abstract.id does not exist in target and has no mapping |
| Citation.citedArtifact.abstract.language | - | DoesNotExistInTarget | Citation.citedArtifact.abstract.language does not exist in target and has no mapping |
| Citation.citedArtifact.abstract.modifierExtension | - | DoesNotExistInTarget | Citation.citedArtifact.abstract.modifierExtension does not exist in target and has no mapping |
| Citation.citedArtifact.abstract.text | - | DoesNotExistInTarget | Citation.citedArtifact.abstract.text does not exist in target and has no mapping |
| Citation.citedArtifact.abstract.type | - | DoesNotExistInTarget | Citation.citedArtifact.abstract.type does not exist in target and has no mapping |
| Citation.citedArtifact.classification | - | DoesNotExistInTarget | Citation.citedArtifact.classification does not exist in target and has no mapping |
| Citation.citedArtifact.classification.artifactAssessment | - | DoesNotExistInTarget | Citation.citedArtifact.classification.artifactAssessment does not exist in target and has no mapping |
| Citation.citedArtifact.classification.classifier | - | DoesNotExistInTarget | Citation.citedArtifact.classification.classifier does not exist in target and has no mapping |
| Citation.citedArtifact.classification.extension | - | DoesNotExistInTarget | Citation.citedArtifact.classification.extension does not exist in target and has no mapping |
| Citation.citedArtifact.classification.id | - | DoesNotExistInTarget | Citation.citedArtifact.classification.id does not exist in target and has no mapping |
| Citation.citedArtifact.classification.modifierExtension | - | DoesNotExistInTarget | Citation.citedArtifact.classification.modifierExtension does not exist in target and has no mapping |
| Citation.citedArtifact.classification.type | - | DoesNotExistInTarget | Citation.citedArtifact.classification.type does not exist in target and has no mapping |
| Citation.citedArtifact.contributorship | - | DoesNotExistInTarget | Citation.citedArtifact.contributorship does not exist in target and has no mapping |
| Citation.citedArtifact.contributorship.complete | - | DoesNotExistInTarget | Citation.citedArtifact.contributorship.complete does not exist in target and has no mapping |
| Citation.citedArtifact.contributorship.entry | - | DoesNotExistInTarget | Citation.citedArtifact.contributorship.entry does not exist in target and has no mapping |
| Citation.citedArtifact.contributorship.entry.affiliation | - | DoesNotExistInTarget | Citation.citedArtifact.contributorship.entry.affiliation does not exist in target and has no mapping |
| Citation.citedArtifact.contributorship.entry.contributionInstance | - | DoesNotExistInTarget | Citation.citedArtifact.contributorship.entry.contributionInstance does not exist in target and has no mapping |
| Citation.citedArtifact.contributorship.entry.contributionInstance.extension | - | DoesNotExistInTarget | Citation.citedArtifact.contributorship.entry.contributionInstance.extension does not exist in target and has no mapping |
| Citation.citedArtifact.contributorship.entry.contributionInstance.id | - | DoesNotExistInTarget | Citation.citedArtifact.contributorship.entry.contributionInstance.id does not exist in target and has no mapping |
| Citation.citedArtifact.contributorship.entry.contributionInstance.modifierExtension | - | DoesNotExistInTarget | Citation.citedArtifact.contributorship.entry.contributionInstance.modifierExtension does not exist in target and has no mapping |
...
| Citation.citedArtifact.part.id | - | DoesNotExistInTarget | Citation.citedArtifact.part.id does not exist in target and has no mapping |
...
| Citation.citedArtifact.relatesTo.citation | - | DoesNotExistInTarget | Citation.citedArtifact.relatesTo.citation does not exist in target and has no mapping |
...
| Citation.classification | - | DoesNotExistInTarget | Citation.classification does not exist in target and has no mapping |
...
| Citation.statusDate.id | - | DoesNotExistInTarget | Citation.statusDate.id does not exist in target and has no mapping |
