...
| --- | --- | --- | --- | --- | --- |
| Source | RequestOrchestration |  | A set of related requests that can be used to capture intended activities that have inter-dependencies such as "give this medication after that one". | 95 | 66 |
| Target | - | - | - | - | - |
...
| Status | Count |
| ------ | ----- |
DoesNotExistInTarget | 95 |


| Source | Target | Status | Message |
| ------ | ------ | ------ | ------- |
| RequestOrchestration | - | DoesNotExistInTarget | RequestOrchestration does not exist in target and has no mapping |
| RequestOrchestration.action | - | DoesNotExistInTarget | RequestOrchestration.action does not exist in target and has no mapping |
| RequestOrchestration.action.action | - | DoesNotExistInTarget | RequestOrchestration.action.action does not exist in target and has no mapping |
| RequestOrchestration.action.cardinalityBehavior | - | DoesNotExistInTarget | RequestOrchestration.action.cardinalityBehavior does not exist in target and has no mapping |
| RequestOrchestration.action.code | - | DoesNotExistInTarget | RequestOrchestration.action.code does not exist in target and has no mapping |
| RequestOrchestration.action.condition | - | DoesNotExistInTarget | RequestOrchestration.action.condition does not exist in target and has no mapping |
| RequestOrchestration.action.condition.expression | - | DoesNotExistInTarget | RequestOrchestration.action.condition.expression does not exist in target and has no mapping |
| RequestOrchestration.action.condition.extension | - | DoesNotExistInTarget | RequestOrchestration.action.condition.extension does not exist in target and has no mapping |
| RequestOrchestration.action.condition.id | - | DoesNotExistInTarget | RequestOrchestration.action.condition.id does not exist in target and has no mapping |
| RequestOrchestration.action.condition.kind | - | DoesNotExistInTarget | RequestOrchestration.action.condition.kind does not exist in target and has no mapping |
| RequestOrchestration.action.condition.modifierExtension | - | DoesNotExistInTarget | RequestOrchestration.action.condition.modifierExtension does not exist in target and has no mapping |
| RequestOrchestration.action.definition[x] | - | DoesNotExistInTarget | RequestOrchestration.action.definition[x] does not exist in target and has no mapping |
| RequestOrchestration.action.description | - | DoesNotExistInTarget | RequestOrchestration.action.description does not exist in target and has no mapping |
| RequestOrchestration.action.documentation | - | DoesNotExistInTarget | RequestOrchestration.action.documentation does not exist in target and has no mapping |
| RequestOrchestration.action.dynamicValue | - | DoesNotExistInTarget | RequestOrchestration.action.dynamicValue does not exist in target and has no mapping |
| RequestOrchestration.action.dynamicValue.expression | - | DoesNotExistInTarget | RequestOrchestration.action.dynamicValue.expression does not exist in target and has no mapping |
| RequestOrchestration.action.dynamicValue.extension | - | DoesNotExistInTarget | RequestOrchestration.action.dynamicValue.extension does not exist in target and has no mapping |
| RequestOrchestration.action.dynamicValue.id | - | DoesNotExistInTarget | RequestOrchestration.action.dynamicValue.id does not exist in target and has no mapping |
| RequestOrchestration.action.dynamicValue.modifierExtension | - | DoesNotExistInTarget | RequestOrchestration.action.dynamicValue.modifierExtension does not exist in target and has no mapping |
| RequestOrchestration.action.dynamicValue.path | - | DoesNotExistInTarget | RequestOrchestration.action.dynamicValue.path does not exist in target and has no mapping |
| RequestOrchestration.action.extension | - | DoesNotExistInTarget | RequestOrchestration.action.extension does not exist in target and has no mapping |
| RequestOrchestration.action.goal | - | DoesNotExistInTarget | RequestOrchestration.action.goal does not exist in target and has no mapping |
| RequestOrchestration.action.groupingBehavior | - | DoesNotExistInTarget | RequestOrchestration.action.groupingBehavior does not exist in target and has no mapping |
| RequestOrchestration.action.id | - | DoesNotExistInTarget | RequestOrchestration.action.id does not exist in target and has no mapping |
| RequestOrchestration.action.input | - | DoesNotExistInTarget | RequestOrchestration.action.input does not exist in target and has no mapping |
| RequestOrchestration.action.input.extension | - | DoesNotExistInTarget | RequestOrchestration.action.input.extension does not exist in target and has no mapping |
| RequestOrchestration.action.input.id | - | DoesNotExistInTarget | RequestOrchestration.action.input.id does not exist in target and has no mapping |
...
| RequestOrchestration.action.relatedAction.targetId | - | DoesNotExistInTarget | RequestOrchestration.action.relatedAction.targetId does not exist in target and has no mapping |
