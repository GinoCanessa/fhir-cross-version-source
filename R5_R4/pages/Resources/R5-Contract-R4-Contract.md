...
| ------ | ------ | ------ | ------- |
| Contract | Contract | Equivalent | R5 `Contract` maps as Equivalent to R4 `Contract` |
| Contract.alias | Contract.alias | Equivalent | R5 `Contract.alias` maps as Equivalent to R4 `Contract.alias` |
| Contract.applies | Contract.applies | Equivalent | R5 `Contract.applies` maps as Equivalent to R4 `Contract.applies` |
| Contract.author | Contract.author | Equivalent | R5 `Contract.author` maps as Equivalent to R4 `Contract.author` |
| Contract.authority | Contract.authority | Equivalent | R5 `Contract.authority` maps as Equivalent to R4 `Contract.authority` |
| Contract.contained | Contract.contained | Equivalent | R5 `Contract.contained` maps as Equivalent to R4 `Contract.contained` |
| Contract.contentDefinition | Contract.contentDefinition | Equivalent | R5 `Contract.contentDefinition` maps as Equivalent to R4 `Contract.contentDefinition` |
| Contract.contentDefinition.copyright | Contract.contentDefinition.copyright | Equivalent | R5 `Contract.contentDefinition.copyright` maps as Equivalent to R4 `Contract.contentDefinition.copyright` |
| Contract.contentDefinition.extension | Contract.contentDefinition.extension | SourceIsBroaderThanTarget | R5 `Contract.contentDefinition.extension` maps as SourceIsBroaderThanTarget to R4 `Contract.contentDefinition.extension` - extension has change due to type change: R5 `extension` `Extension` maps as SourceIsBroaderThanTarget for R4 `extension` |
| Contract.contentDefinition.id | Contract.contentDefinition.id | Equivalent | R5 `Contract.contentDefinition.id` maps as Equivalent to R4 `Contract.contentDefinition.id` |
| Contract.contentDefinition.modifierExtension | Contract.contentDefinition.modifierExtension | SourceIsBroaderThanTarget | R5 `Contract.contentDefinition.modifierExtension` maps as SourceIsBroaderThanTarget to R4 `Contract.contentDefinition.modifierExtension` - modifierExtension has change due to type change: R5 `modifierExtension` `Extension` maps as SourceIsBroaderThanTarget for R4 `modifierExtension` |
| Contract.contentDefinition.publicationDate | Contract.contentDefinition.publicationDate | Equivalent | R5 `Contract.contentDefinition.publicationDate` maps as Equivalent to R4 `Contract.contentDefinition.publicationDate` |
| Contract.contentDefinition.publicationStatus | Contract.contentDefinition.publicationStatus | Equivalent | R5 `Contract.contentDefinition.publicationStatus` maps as Equivalent to R4 `Contract.contentDefinition.publicationStatus` - publicationStatus has compatible required binding for code type: http://hl7.org/fhir/ValueSet/contract-publicationstatus|5.0.0 and http://hl7.org/fhir/ValueSet/contract-publicationstatus|4.0.1 (Equivalent) |
| Contract.contentDefinition.publisher | Contract.contentDefinition.publisher | Equivalent | R5 `Contract.contentDefinition.publisher` maps as Equivalent to R4 `Contract.contentDefinition.publisher` |
| Contract.contentDefinition.subType | Contract.contentDefinition.subType | Equivalent | R5 `Contract.contentDefinition.subType` maps as Equivalent to R4 `Contract.contentDefinition.subType` |
| Contract.contentDefinition.type | Contract.contentDefinition.type | Equivalent | R5 `Contract.contentDefinition.type` maps as Equivalent to R4 `Contract.contentDefinition.type` |
| Contract.contentDerivative | Contract.contentDerivative | Equivalent | R5 `Contract.contentDerivative` maps as Equivalent to R4 `Contract.contentDerivative` |
| Contract.domain | Contract.domain | Equivalent | R5 `Contract.domain` maps as Equivalent to R4 `Contract.domain` |
...
| Contract.id | Contract.id | Equivalent | R5 `Contract.id` maps as Equivalent to R4 `Contract.id` |
...
| Contract.signer.signature | Contract.signer.signature | RelatedTo | R5 `Contract.signer.signature` maps as RelatedTo to R4 `Contract.signer.signature` - signature has change due to type change: R5 `signature` `Signature` maps as RelatedTo for R4 `signature` |
...
| Contract.term.action.subject | Contract.term.action.subject | Equivalent | R5 `Contract.term.action.subject` maps as Equivalent to R4 `Contract.term.action.subject` |
...
| Contract.term.asset.subtype | Contract.term.asset.subtype | Equivalent | R5 `Contract.term.asset.subtype` maps as Equivalent to R4 `Contract.term.asset.subtype` |
...
| Contract.term.securityLabel.classification | Contract.term.securityLabel.classification | Equivalent | R5 `Contract.term.securityLabel.classification` maps as Equivalent to R4 `Contract.term.securityLabel.classification` |
