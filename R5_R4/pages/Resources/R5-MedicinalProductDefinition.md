...
| Status | Count |
| ------ | ----- |
DoesNotExistInTarget | 78 |


| Source | Target | Status | Message |
| ------ | ------ | ------ | ------- |
| MedicinalProductDefinition | - | DoesNotExistInTarget | MedicinalProductDefinition does not exist in target and has no mapping |
| MedicinalProductDefinition.additionalMonitoringIndicator | - | DoesNotExistInTarget | MedicinalProductDefinition.additionalMonitoringIndicator does not exist in target and has no mapping |
| MedicinalProductDefinition.attachedDocument | - | DoesNotExistInTarget | MedicinalProductDefinition.attachedDocument does not exist in target and has no mapping |
| MedicinalProductDefinition.characteristic | - | DoesNotExistInTarget | MedicinalProductDefinition.characteristic does not exist in target and has no mapping |
| MedicinalProductDefinition.characteristic.extension | - | DoesNotExistInTarget | MedicinalProductDefinition.characteristic.extension does not exist in target and has no mapping |
| MedicinalProductDefinition.characteristic.id | - | DoesNotExistInTarget | MedicinalProductDefinition.characteristic.id does not exist in target and has no mapping |
| MedicinalProductDefinition.characteristic.modifierExtension | - | DoesNotExistInTarget | MedicinalProductDefinition.characteristic.modifierExtension does not exist in target and has no mapping |
| MedicinalProductDefinition.characteristic.type | - | DoesNotExistInTarget | MedicinalProductDefinition.characteristic.type does not exist in target and has no mapping |
| MedicinalProductDefinition.characteristic.value[x] | - | DoesNotExistInTarget | MedicinalProductDefinition.characteristic.value[x] does not exist in target and has no mapping |
| MedicinalProductDefinition.classification | - | DoesNotExistInTarget | MedicinalProductDefinition.classification does not exist in target and has no mapping |
| MedicinalProductDefinition.clinicalTrial | - | DoesNotExistInTarget | MedicinalProductDefinition.clinicalTrial does not exist in target and has no mapping |
| MedicinalProductDefinition.code | - | DoesNotExistInTarget | MedicinalProductDefinition.code does not exist in target and has no mapping |
| MedicinalProductDefinition.combinedPharmaceuticalDoseForm | - | DoesNotExistInTarget | MedicinalProductDefinition.combinedPharmaceuticalDoseForm does not exist in target and has no mapping |
| MedicinalProductDefinition.comprisedOf | - | DoesNotExistInTarget | MedicinalProductDefinition.comprisedOf does not exist in target and has no mapping |
| MedicinalProductDefinition.contact | - | DoesNotExistInTarget | MedicinalProductDefinition.contact does not exist in target and has no mapping |
| MedicinalProductDefinition.contact.contact | - | DoesNotExistInTarget | MedicinalProductDefinition.contact.contact does not exist in target and has no mapping |
| MedicinalProductDefinition.contact.extension | - | DoesNotExistInTarget | MedicinalProductDefinition.contact.extension does not exist in target and has no mapping |
| MedicinalProductDefinition.contact.id | - | DoesNotExistInTarget | MedicinalProductDefinition.contact.id does not exist in target and has no mapping |
| MedicinalProductDefinition.contact.modifierExtension | - | DoesNotExistInTarget | MedicinalProductDefinition.contact.modifierExtension does not exist in target and has no mapping |
| MedicinalProductDefinition.contact.type | - | DoesNotExistInTarget | MedicinalProductDefinition.contact.type does not exist in target and has no mapping |
| MedicinalProductDefinition.contained | - | DoesNotExistInTarget | MedicinalProductDefinition.contained does not exist in target and has no mapping |
| MedicinalProductDefinition.crossReference | - | DoesNotExistInTarget | MedicinalProductDefinition.crossReference does not exist in target and has no mapping |
| MedicinalProductDefinition.crossReference.extension | - | DoesNotExistInTarget | MedicinalProductDefinition.crossReference.extension does not exist in target and has no mapping |
| MedicinalProductDefinition.crossReference.id | - | DoesNotExistInTarget | MedicinalProductDefinition.crossReference.id does not exist in target and has no mapping |
| MedicinalProductDefinition.crossReference.modifierExtension | - | DoesNotExistInTarget | MedicinalProductDefinition.crossReference.modifierExtension does not exist in target and has no mapping |
| MedicinalProductDefinition.crossReference.product | - | DoesNotExistInTarget | MedicinalProductDefinition.crossReference.product does not exist in target and has no mapping |
| MedicinalProductDefinition.crossReference.type | - | DoesNotExistInTarget | MedicinalProductDefinition.crossReference.type does not exist in target and has no mapping |
...
| MedicinalProductDefinition.operation.effectiveDate | - | DoesNotExistInTarget | MedicinalProductDefinition.operation.effectiveDate does not exist in target and has no mapping |
