...
| ------ | ------ | ------ | ------- |
| SpecimenDefinition | SpecimenDefinition | Equivalent | R5 `SpecimenDefinition` maps as Equivalent to R4 `SpecimenDefinition` |
...
| SpecimenDefinition.collection | SpecimenDefinition.collection | Equivalent | R5 `SpecimenDefinition.collection` maps as Equivalent to R4 `SpecimenDefinition.collection` |
...
| SpecimenDefinition.contained | SpecimenDefinition.contained | Equivalent | R5 `SpecimenDefinition.contained` maps as Equivalent to R4 `SpecimenDefinition.contained` |
...
| SpecimenDefinition.extension | SpecimenDefinition.extension | SourceIsBroaderThanTarget | R5 `SpecimenDefinition.extension` maps as SourceIsBroaderThanTarget to R4 `SpecimenDefinition.extension` - extension has change due to type change: R5 `extension` `Extension` maps as SourceIsBroaderThanTarget for R4 `extension` |
| SpecimenDefinition.id | SpecimenDefinition.id | Equivalent | R5 `SpecimenDefinition.id` maps as Equivalent to R4 `SpecimenDefinition.id` |
...
| SpecimenDefinition.patientPreparation | SpecimenDefinition.patientPreparation | Equivalent | R5 `SpecimenDefinition.patientPreparation` maps as Equivalent to R4 `SpecimenDefinition.patientPreparation` |
