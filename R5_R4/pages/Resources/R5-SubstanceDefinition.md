...
| Status | Count |
| ------ | ----- |
DoesNotExistInTarget | 126 |


| Source | Target | Status | Message |
| ------ | ------ | ------ | ------- |
| SubstanceDefinition | - | DoesNotExistInTarget | SubstanceDefinition does not exist in target and has no mapping |
| SubstanceDefinition.characterization | - | DoesNotExistInTarget | SubstanceDefinition.characterization does not exist in target and has no mapping |
| SubstanceDefinition.characterization.description | - | DoesNotExistInTarget | SubstanceDefinition.characterization.description does not exist in target and has no mapping |
| SubstanceDefinition.characterization.extension | - | DoesNotExistInTarget | SubstanceDefinition.characterization.extension does not exist in target and has no mapping |
| SubstanceDefinition.characterization.file | - | DoesNotExistInTarget | SubstanceDefinition.characterization.file does not exist in target and has no mapping |
| SubstanceDefinition.characterization.form | - | DoesNotExistInTarget | SubstanceDefinition.characterization.form does not exist in target and has no mapping |
| SubstanceDefinition.characterization.id | - | DoesNotExistInTarget | SubstanceDefinition.characterization.id does not exist in target and has no mapping |
| SubstanceDefinition.characterization.modifierExtension | - | DoesNotExistInTarget | SubstanceDefinition.characterization.modifierExtension does not exist in target and has no mapping |
| SubstanceDefinition.characterization.technique | - | DoesNotExistInTarget | SubstanceDefinition.characterization.technique does not exist in target and has no mapping |
| SubstanceDefinition.classification | - | DoesNotExistInTarget | SubstanceDefinition.classification does not exist in target and has no mapping |
| SubstanceDefinition.code | - | DoesNotExistInTarget | SubstanceDefinition.code does not exist in target and has no mapping |
| SubstanceDefinition.code.code | - | DoesNotExistInTarget | SubstanceDefinition.code.code does not exist in target and has no mapping |
| SubstanceDefinition.code.extension | - | DoesNotExistInTarget | SubstanceDefinition.code.extension does not exist in target and has no mapping |
| SubstanceDefinition.code.id | - | DoesNotExistInTarget | SubstanceDefinition.code.id does not exist in target and has no mapping |
| SubstanceDefinition.code.modifierExtension | - | DoesNotExistInTarget | SubstanceDefinition.code.modifierExtension does not exist in target and has no mapping |
| SubstanceDefinition.code.note | - | DoesNotExistInTarget | SubstanceDefinition.code.note does not exist in target and has no mapping |
| SubstanceDefinition.code.source | - | DoesNotExistInTarget | SubstanceDefinition.code.source does not exist in target and has no mapping |
| SubstanceDefinition.code.status | - | DoesNotExistInTarget | SubstanceDefinition.code.status does not exist in target and has no mapping |
| SubstanceDefinition.code.statusDate | - | DoesNotExistInTarget | SubstanceDefinition.code.statusDate does not exist in target and has no mapping |
| SubstanceDefinition.contained | - | DoesNotExistInTarget | SubstanceDefinition.contained does not exist in target and has no mapping |
| SubstanceDefinition.description | - | DoesNotExistInTarget | SubstanceDefinition.description does not exist in target and has no mapping |
| SubstanceDefinition.domain | - | DoesNotExistInTarget | SubstanceDefinition.domain does not exist in target and has no mapping |
| SubstanceDefinition.extension | - | DoesNotExistInTarget | SubstanceDefinition.extension does not exist in target and has no mapping |
| SubstanceDefinition.grade | - | DoesNotExistInTarget | SubstanceDefinition.grade does not exist in target and has no mapping |
| SubstanceDefinition.id | - | DoesNotExistInTarget | SubstanceDefinition.id does not exist in target and has no mapping |
| SubstanceDefinition.identifier | - | DoesNotExistInTarget | SubstanceDefinition.identifier does not exist in target and has no mapping |
| SubstanceDefinition.implicitRules | - | DoesNotExistInTarget | SubstanceDefinition.implicitRules does not exist in target and has no mapping |
...
| SubstanceDefinition.name.official.id | - | DoesNotExistInTarget | SubstanceDefinition.name.official.id does not exist in target and has no mapping |
...
| SubstanceDefinition.sourceMaterial.part | - | DoesNotExistInTarget | SubstanceDefinition.sourceMaterial.part does not exist in target and has no mapping |
