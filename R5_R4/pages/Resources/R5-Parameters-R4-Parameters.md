...
| Parameters.language | Parameters.language | SourceIsNarrowerThanTarget | R5 `Parameters.language` maps as SourceIsNarrowerThanTarget to R4 `Parameters.language` - language changed the binding strength from Required to Preferred; language has change due to type change: R5 `language` `code` maps as SourceIsNarrowerThanTarget for R4 `language` |
