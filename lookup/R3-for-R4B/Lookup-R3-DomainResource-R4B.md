### Lookup for FHIR R3 DomainResource for use in FHIR R4B

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| DomainResource.id | UseElementSameName | DomainResource.id |
| DomainResource.meta | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-DomainResource.meta |
