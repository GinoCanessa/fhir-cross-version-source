### Lookup for FHIR R3 DetectedIssue for use in FHIR R4B

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| DetectedIssue.id | UseElementSameName | DetectedIssue.id |
| DetectedIssue.meta | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-DetectedIssue.meta |
...
| DetectedIssue.identifier | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-DetectedIssue.identifier |
...
| DetectedIssue.date | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-DetectedIssue.date |
