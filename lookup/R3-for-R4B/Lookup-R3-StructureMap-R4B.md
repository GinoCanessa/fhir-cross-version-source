### Lookup for FHIR R3 StructureMap for use in FHIR R4B
...
| StructureMap.group.rule.source.defaultValue[x] | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-StructureMap.group.rule.source.defaultValue |
