### Lookup for FHIR R4 Dosage for use in FHIR R5
...
| Dosage.maxDosePerPeriod | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Dosage.maxDosePerPeriod |
