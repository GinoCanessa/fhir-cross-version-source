### Lookup for FHIR R4 OperationOutcome for use in FHIR R5
...
| OperationOutcome.issue.severity | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-OperationOutcome.issue.severity |
