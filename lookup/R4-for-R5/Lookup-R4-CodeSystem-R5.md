### Lookup for FHIR R4 CodeSystem for use in FHIR R5
...
| CodeSystem.filter.operator | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-CodeSystem.filter.operator |
