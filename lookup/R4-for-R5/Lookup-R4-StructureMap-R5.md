### Lookup for FHIR R4 StructureMap for use in FHIR R5
...
| StructureMap.group.typeMode | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-StructureMap.group.typeMode |
