### Lookup for FHIR R4 Encounter for use in FHIR R5
...
| Encounter.statusHistory | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Encounter.statusHistory |
...
| Encounter.hospitalization.id | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Encounter.hospitalization.id |
| Encounter.hospitalization.extension | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Encounter.hospitalization.extension |
| Encounter.hospitalization.modifierExtension | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Encounter.hospitalization.modifierExtension |
...
| Encounter.hospitalization.dietPreference | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Encounter.hospitalization.dietPreference |
| Encounter.hospitalization.specialCourtesy | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Encounter.hospitalization.specialCourtesy |
| Encounter.hospitalization.specialArrangement | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Encounter.hospitalization.specialArrangement |
