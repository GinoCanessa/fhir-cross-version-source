### Lookup for FHIR R4 PlanDefinition for use in FHIR R5
...
| PlanDefinition.goal.target.detail[x] | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-PlanDefinition.goal.target.detail |
