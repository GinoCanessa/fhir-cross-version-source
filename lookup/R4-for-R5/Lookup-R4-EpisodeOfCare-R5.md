### Lookup for FHIR R4 EpisodeOfCare for use in FHIR R5
...
| EpisodeOfCare.diagnosis.rank | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-EpisodeOfCare.diagnosis.rank |
