### Lookup for FHIR R4 MessageHeader for use in FHIR R5
...
| MessageHeader.response.identifier | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MessageHeader.response.identifier |
