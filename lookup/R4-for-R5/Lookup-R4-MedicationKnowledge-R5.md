### Lookup for FHIR R4 MedicationKnowledge for use in FHIR R5
...
| MedicationKnowledge.packaging.type | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MedicationKnowledge.packaging.type |
| MedicationKnowledge.packaging.quantity | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MedicationKnowledge.packaging.quantity |
...
| MedicationKnowledge.regulatory.schedule | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MedicationKnowledge.regulatory.schedule |
