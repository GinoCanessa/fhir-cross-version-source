### Lookup for FHIR R4 Communication for use in FHIR R5
...
| Communication.reasonCode | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Communication.reasonCode |
