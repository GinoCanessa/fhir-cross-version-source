### Lookup for FHIR R4 Composition for use in FHIR R5
...
| Composition.identifier | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Composition.identifier |
| Composition.status | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Composition.status |
...
| Composition.relatesTo.id | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Composition.relatesTo.id |
| Composition.relatesTo.extension | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Composition.relatesTo.extension |
| Composition.relatesTo.modifierExtension | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Composition.relatesTo.modifierExtension |
| Composition.relatesTo.code | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Composition.relatesTo.code |
