### Lookup for FHIR R4 PractitionerRole for use in FHIR R5
...
| PractitionerRole.telecom | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-PractitionerRole.telecom |
