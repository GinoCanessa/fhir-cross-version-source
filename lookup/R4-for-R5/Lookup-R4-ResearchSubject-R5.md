### Lookup for FHIR R4 ResearchSubject for use in FHIR R5
...
| ResearchSubject.status | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-ResearchSubject.status |
...
| ResearchSubject.individual | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-ResearchSubject.individual |
| ResearchSubject.assignedArm | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-ResearchSubject.assignedArm |
| ResearchSubject.actualArm | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-ResearchSubject.actualArm |
