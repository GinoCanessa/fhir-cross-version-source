### Lookup for FHIR R4 Medication for use in FHIR R5
...
| Medication.ingredient.strength | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Medication.ingredient.strength |
