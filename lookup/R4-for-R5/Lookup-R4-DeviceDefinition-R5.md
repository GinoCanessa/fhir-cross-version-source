### Lookup for FHIR R4 DeviceDefinition for use in FHIR R5
...
| DeviceDefinition.manufacturer[x] | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DeviceDefinition.manufacturer |
...
| DeviceDefinition.deviceName.type | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DeviceDefinition.deviceName.type |
| DeviceDefinition.modelNumber | UseElementSameName | DeviceDefinition.modelNumber |
| DeviceDefinition.type | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DeviceDefinition.type |
| DeviceDefinition.specialization | UseElementRenamed | DeviceDefinition.conformsTo |
| DeviceDefinition.specialization.id | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DeviceDefinition.specialization.id |
| DeviceDefinition.specialization.extension | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DeviceDefinition.specialization.extension |
...
| DeviceDefinition.capability | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DeviceDefinition.capability |
...
| DeviceDefinition.property.valueQuantity | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DeviceDefinition.property.valueQuantity |
| DeviceDefinition.property.valueCode | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DeviceDefinition.property.valueCode |
...
| DeviceDefinition.url | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DeviceDefinition.url |
| DeviceDefinition.onlineInformation | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DeviceDefinition.onlineInformation |
| DeviceDefinition.note | UseElementSameName | DeviceDefinition.note |
| DeviceDefinition.quantity | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DeviceDefinition.quantity |
| DeviceDefinition.parentDevice | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DeviceDefinition.parentDevice |
