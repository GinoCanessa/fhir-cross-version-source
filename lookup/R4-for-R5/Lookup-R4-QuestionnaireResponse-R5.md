### Lookup for FHIR R4 QuestionnaireResponse for use in FHIR R5
...
| QuestionnaireResponse.identifier | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-QuestionnaireResponse.identifier |
