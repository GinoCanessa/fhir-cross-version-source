### Lookup for FHIR R4 Device for use in FHIR R5
...
| Device.deviceName.type | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Device.deviceName.type |
