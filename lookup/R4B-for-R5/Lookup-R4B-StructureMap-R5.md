### Lookup for FHIR R4B StructureMap for use in FHIR R5
...
| StructureMap.group.rule.target.context | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-StructureMap.group.rule.target.context |
| StructureMap.group.rule.target.contextType | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-StructureMap.group.rule.target.contextType |
...
| StructureMap.group.rule.target.parameter.value[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-StructureMap.group.rule.target.parameter.value |
