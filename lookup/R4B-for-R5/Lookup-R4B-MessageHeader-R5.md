...
| MessageHeader.event[x] | UseElementSameName | MessageHeader.event[x] |
...
| MessageHeader.destination.endpoint | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.destination.endpoint |
...
| MessageHeader.source.endpoint | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.source.endpoint |
