### Lookup for FHIR R4B MessageHeader for use in FHIR R5
...
| MessageHeader.destination.endpoint | UseElementRenamed | MessageHeader.destination.endpoint[x] |
...
| MessageHeader.source.endpoint | UseElementRenamed | MessageHeader.source.endpoint[x] |
...
| MessageHeader.response.identifier | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.response.identifier |
