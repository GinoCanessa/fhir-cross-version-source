### Lookup for FHIR R4B DocumentReference for use in FHIR R5
...
| DocumentReference.masterIdentifier | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DocumentReference.masterIdentifier |
| DocumentReference.identifier | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DocumentReference.identifier |
| DocumentReference.status | UseElementSameName | DocumentReference.status |
| DocumentReference.docStatus | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DocumentReference.docStatus |
...
| DocumentReference.content.attachment | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DocumentReference.content.attachment |
| DocumentReference.content.format | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DocumentReference.content.format |
| DocumentReference.context | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DocumentReference.context |
