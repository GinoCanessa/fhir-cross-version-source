### Lookup for FHIR R4B SampledData for use in FHIR R5
...
| SampledData.period | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-SampledData.period |
