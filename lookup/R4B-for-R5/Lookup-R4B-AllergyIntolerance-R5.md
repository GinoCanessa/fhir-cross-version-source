### Lookup for FHIR R4B AllergyIntolerance for use in FHIR R5
...
| AllergyIntolerance.type | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-AllergyIntolerance.type |
