### Lookup for FHIR R4B ClaimResponse for use in FHIR R5
...
| ClaimResponse.item.adjudication.value | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.item.adjudication.value |
