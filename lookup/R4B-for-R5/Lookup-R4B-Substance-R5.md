### Lookup for FHIR R4B Substance for use in FHIR R5
...
| Substance.instance.id | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Substance.instance.id |
| Substance.instance.extension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Substance.instance.extension |
| Substance.instance.modifierExtension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Substance.instance.modifierExtension |
| Substance.instance.identifier | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Substance.instance.identifier |
| Substance.instance.expiry | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Substance.instance.expiry |
| Substance.instance.quantity | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Substance.instance.quantity |
