### Lookup for FHIR R4B DeviceRequest for use in FHIR R5
...
| DeviceRequest.reasonCode | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DeviceRequest.reasonCode |
