### Lookup for FHIR R4B QuestionnaireResponse for use in FHIR R5
...
| QuestionnaireResponse.identifier | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-QuestionnaireResponse.identifier |
