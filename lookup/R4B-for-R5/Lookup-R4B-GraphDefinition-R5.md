### Lookup for FHIR R4B GraphDefinition for use in FHIR R5
...
| GraphDefinition.link.target | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-GraphDefinition.link.target |
