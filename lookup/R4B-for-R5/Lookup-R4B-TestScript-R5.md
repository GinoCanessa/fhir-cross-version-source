### Lookup for FHIR R4B TestScript for use in FHIR R5
...
| TestScript.setup.action.assert.response | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-TestScript.setup.action.assert.response |
