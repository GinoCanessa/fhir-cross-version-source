### Lookup for FHIR R4B PlanDefinition for use in FHIR R5
...
| PlanDefinition.goal.target.detail[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-PlanDefinition.goal.target.detail |
