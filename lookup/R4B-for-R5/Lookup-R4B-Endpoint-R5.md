### Lookup for FHIR R4B Endpoint for use in FHIR R5
...
| Endpoint.status | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Endpoint.status |
| Endpoint.connectionType | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Endpoint.connectionType |
...
| Endpoint.payloadType | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Endpoint.payloadType |
| Endpoint.payloadMimeType | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Endpoint.payloadMimeType |
