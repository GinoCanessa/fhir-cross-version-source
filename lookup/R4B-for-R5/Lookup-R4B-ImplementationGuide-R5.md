### Lookup for FHIR R4B ImplementationGuide for use in FHIR R5
...
| ImplementationGuide.definition.resource.example[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ImplementationGuide.definition.resource.example |
...
| ImplementationGuide.definition.page.name[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ImplementationGuide.definition.page.name |
...
| ImplementationGuide.definition.parameter.code | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ImplementationGuide.definition.parameter.code |
...
| ImplementationGuide.manifest.resource.example[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ImplementationGuide.manifest.resource.example |
