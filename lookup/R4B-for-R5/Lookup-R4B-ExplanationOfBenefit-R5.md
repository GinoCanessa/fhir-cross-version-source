### Lookup for FHIR R4B ExplanationOfBenefit for use in FHIR R5
...
| ExplanationOfBenefit.diagnosis.packageCode | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ExplanationOfBenefit.diagnosis.packageCode |
...
| ExplanationOfBenefit.item.bodySite | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ExplanationOfBenefit.item.bodySite |
| ExplanationOfBenefit.item.subSite | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ExplanationOfBenefit.item.subSite |
...
| ExplanationOfBenefit.item.adjudication.value | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ExplanationOfBenefit.item.adjudication.value |
