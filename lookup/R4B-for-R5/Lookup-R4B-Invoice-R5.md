### Lookup for FHIR R4B Invoice for use in FHIR R5
...
| Invoice.lineItem.priceComponent.id | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Invoice.lineItem.priceComponent.id |
| Invoice.lineItem.priceComponent.extension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Invoice.lineItem.priceComponent.extension |
| Invoice.lineItem.priceComponent.modifierExtension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Invoice.lineItem.priceComponent.modifierExtension |
| Invoice.lineItem.priceComponent.type | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Invoice.lineItem.priceComponent.type |
| Invoice.lineItem.priceComponent.code | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Invoice.lineItem.priceComponent.code |
| Invoice.lineItem.priceComponent.factor | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Invoice.lineItem.priceComponent.factor |
| Invoice.lineItem.priceComponent.amount | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Invoice.lineItem.priceComponent.amount |
