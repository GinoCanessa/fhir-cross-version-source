### Lookup for FHIR R4B Appointment for use in FHIR R5
...
| Appointment.participant.required | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Appointment.participant.required |
