...
| VisionPrescription.lensSpecification.prism.id | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-VisionPrescription.lensSpecification.prism.id |
| VisionPrescription.lensSpecification.prism.extension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-VisionPrescription.lensSpecification.prism.extension |
| VisionPrescription.lensSpecification.prism.modifierExtension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-VisionPrescription.lensSpecification.prism.modifierExtension |
| VisionPrescription.lensSpecification.prism.amount | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-VisionPrescription.lensSpecification.prism.amount |
...
| VisionPrescription.lensSpecification.note | UseElementSameName | VisionPrescription.dispense.notes |
