### Lookup for FHIR R4B DetectedIssue for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| DetectedIssue.id | UseElementSameName | DetectedIssue.id |
| DetectedIssue.meta | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DetectedIssue.meta |
...
| DetectedIssue.identifier | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DetectedIssue.identifier |
| DetectedIssue.status | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DetectedIssue.status |
...
| DetectedIssue.patient | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DetectedIssue.patient |
| DetectedIssue.identified[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DetectedIssue.identified |
| DetectedIssue.author | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DetectedIssue.author |
| DetectedIssue.implicated | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DetectedIssue.implicated |
| DetectedIssue.evidence | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DetectedIssue.evidence |
...
| DetectedIssue.mitigation.author | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DetectedIssue.mitigation.author |
