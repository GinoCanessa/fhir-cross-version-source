...
| Timing.repeat.bounds[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Timing.repeat.bounds |
| Timing.repeat.count | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Timing.repeat.count |
...
| Timing.repeat.frequency | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Timing.repeat.frequency |
| Timing.repeat.frequencyMax | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Timing.repeat.frequencyMax |
