### Lookup for FHIR R4B Substance for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Substance.id | UseElementSameName | Substance.id |
| Substance.meta | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Substance.meta |
...
| Substance.status | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Substance.status |
...
| Substance.ingredient.substance[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Substance.ingredient.substance |
