### Lookup for FHIR R4B Encounter for use in FHIR R2
...
| Encounter.length | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Encounter.length |
...
| Encounter.diagnosis.id | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Encounter.diagnosis.id |
| Encounter.diagnosis.extension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Encounter.diagnosis.extension |
| Encounter.diagnosis.modifierExtension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Encounter.diagnosis.modifierExtension |
