### Lookup for FHIR R4B DeviceMetric for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| DeviceMetric.id | UseElementSameName | DeviceMetric.id |
| DeviceMetric.meta | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DeviceMetric.meta |
...
| DeviceMetric.identifier | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DeviceMetric.identifier |
...
| DeviceMetric.parent | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DeviceMetric.parent |
| DeviceMetric.operationalStatus | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-DeviceMetric.operationalStatus |
