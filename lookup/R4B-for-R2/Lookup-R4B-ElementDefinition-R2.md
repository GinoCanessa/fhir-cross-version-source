### Lookup for FHIR R4B ElementDefinition for use in FHIR R2
...
| ElementDefinition.modifierExtension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.modifierExtension |
...
| ElementDefinition.sliceIsConstraining | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.sliceIsConstraining |
...
| ElementDefinition.slicing.discriminator.id | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.slicing.discriminator.id |
| ElementDefinition.slicing.discriminator.extension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.slicing.discriminator.extension |
| ElementDefinition.slicing.discriminator.type | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.slicing.discriminator.type |
| ElementDefinition.slicing.discriminator.path | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.slicing.discriminator.path |
...
| ElementDefinition.min | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.min |
...
| ElementDefinition.base.min | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.base.min |
| ElementDefinition.base.max | UseElementSameName | ElementDefinition.base.max |
| ElementDefinition.contentReference | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.contentReference |
...
| ElementDefinition.type.code | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.type.code |
| ElementDefinition.type.profile | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.type.profile |
| ElementDefinition.type.targetProfile | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.type.targetProfile |
| ElementDefinition.type.aggregation | UseElementSameName | ElementDefinition.type.aggregation |
| ElementDefinition.type.versioning | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.type.versioning |
...
| ElementDefinition.orderMeaning | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.orderMeaning |
...
| ElementDefinition.example | UseElementSameName | ElementDefinition.example[x] |
| ElementDefinition.example.id | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.example.id |
| ElementDefinition.example.extension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.example.extension |
| ElementDefinition.example.label | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.example.label |
...
| ElementDefinition.minValue[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.minValue |
| ElementDefinition.maxValue[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.maxValue |
...
| ElementDefinition.constraint.expression | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.constraint.expression |
| ElementDefinition.constraint.xpath | UseElementSameName | ElementDefinition.constraint.xpath |
| ElementDefinition.constraint.source | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.constraint.source |
...
| ElementDefinition.isModifierReason | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.isModifierReason |
...
| ElementDefinition.mapping.comment | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ElementDefinition.mapping.comment |
