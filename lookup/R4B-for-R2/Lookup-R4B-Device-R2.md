### Lookup for FHIR R4B Device for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Device.id | UseElementSameName | Device.id |
| Device.meta | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Device.meta |
...
| Device.udiCarrier | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Device.udiCarrier |
...
| Device.version | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Device.version |
...
| Device.owner | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Device.owner |
| Device.contact | UseElementSameName | Device.contact |
| Device.location | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Device.location |
