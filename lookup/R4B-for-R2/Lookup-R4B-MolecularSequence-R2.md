### Lookup for FHIR R4B MolecularSequence for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| MolecularSequence | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MolecularSequence |
