### Lookup for FHIR R4B EnrollmentResponse for use in FHIR R2
...
| EnrollmentResponse.status | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-EnrollmentResponse.status |
