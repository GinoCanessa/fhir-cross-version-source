### Lookup for FHIR R4B ClaimResponse for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| ClaimResponse.id | UseElementSameName | ClaimResponse.id |
| ClaimResponse.meta | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.meta |
...
| ClaimResponse.status | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.status |
| ClaimResponse.type | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.type |
| ClaimResponse.subType | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.subType |
| ClaimResponse.use | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.use |
| ClaimResponse.patient | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.patient |
| ClaimResponse.created | UseElementSameName | ClaimResponse.created |
| ClaimResponse.insurer | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.insurer |
| ClaimResponse.requestor | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.requestor |
| ClaimResponse.request | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.request |
| ClaimResponse.outcome | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.outcome |
| ClaimResponse.disposition | UseElementSameName | ClaimResponse.disposition |
| ClaimResponse.preAuthRef | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.preAuthRef |
| ClaimResponse.preAuthPeriod | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.preAuthPeriod |
| ClaimResponse.payeeType | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.payeeType |
...
| ClaimResponse.item.adjudication.category | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.item.adjudication.category |
| ClaimResponse.item.adjudication.reason | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ClaimResponse.item.adjudication.reason |
