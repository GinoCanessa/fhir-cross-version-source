### Lookup for FHIR R4B List for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| List.id | UseElementSameName | List.id |
| List.meta | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-List.meta |
...
| List.encounter | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-List.encounter |
...
| List.note | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-List.note |
...
| List.entry.item | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-List.entry.item |
