### Lookup for FHIR R4B OperationOutcome for use in FHIR R2
...
| OperationOutcome.issue.expression | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-OperationOutcome.issue.expression |
