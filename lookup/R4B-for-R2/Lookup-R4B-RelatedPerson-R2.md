### Lookup for FHIR R4B RelatedPerson for use in FHIR R2
...
| RelatedPerson.name | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-RelatedPerson.name |
