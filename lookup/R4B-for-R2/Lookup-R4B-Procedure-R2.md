### Lookup for FHIR R4B Procedure for use in FHIR R2
...
| Procedure.focalDevice.action | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Procedure.focalDevice.action |
