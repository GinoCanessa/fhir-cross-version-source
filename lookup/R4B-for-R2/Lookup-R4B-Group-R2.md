### Lookup for FHIR R4B Group for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Group.id | UseElementSameName | Group.id |
| Group.meta | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Group.meta |
...
| Group.active | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Group.active |
...
| Group.managingEntity | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Group.managingEntity |
...
| Group.characteristic.value[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Group.characteristic.value |
