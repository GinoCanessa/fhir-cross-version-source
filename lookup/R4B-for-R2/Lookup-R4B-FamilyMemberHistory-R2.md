### Lookup for FHIR R4B FamilyMemberHistory for use in FHIR R2
...
| FamilyMemberHistory.age[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-FamilyMemberHistory.age |
...
| FamilyMemberHistory.deceased[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-FamilyMemberHistory.deceased |
| FamilyMemberHistory.reasonCode | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-FamilyMemberHistory.reasonCode |
| FamilyMemberHistory.reasonReference | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-FamilyMemberHistory.reasonReference |
...
| FamilyMemberHistory.condition.contributedToDeath | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-FamilyMemberHistory.condition.contributedToDeath |
| FamilyMemberHistory.condition.onset[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-FamilyMemberHistory.condition.onset |
