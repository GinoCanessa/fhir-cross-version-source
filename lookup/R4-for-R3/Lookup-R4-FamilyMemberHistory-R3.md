### Lookup for FHIR R4 FamilyMemberHistory for use in FHIR R3
...
| FamilyMemberHistory.sex | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-FamilyMemberHistory.sex |
