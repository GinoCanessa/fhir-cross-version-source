### Lookup for FHIR R4 MeasureReport for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| MeasureReport.id | UseElementSameName | MeasureReport.id |
| MeasureReport.meta | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MeasureReport.meta |
...
| MeasureReport.identifier | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MeasureReport.identifier |
| MeasureReport.status | UseElementSameName | MeasureReport.status |
| MeasureReport.type | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MeasureReport.type |
| MeasureReport.measure | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MeasureReport.measure |
| MeasureReport.subject | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MeasureReport.subject |
...
| MeasureReport.improvementNotation | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MeasureReport.improvementNotation |
...
| MeasureReport.group.code | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MeasureReport.group.code |
...
| MeasureReport.group.population.subjectResults | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MeasureReport.group.population.subjectResults |
...
| MeasureReport.group.stratifier.code | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MeasureReport.group.stratifier.code |
...
| MeasureReport.group.stratifier.stratum.component | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MeasureReport.group.stratifier.stratum.component |
...
| MeasureReport.group.stratifier.stratum.population.subjectResults | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MeasureReport.group.stratifier.stratum.population.subjectResults |
...
| MeasureReport.evaluatedResource | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-MeasureReport.evaluatedResource |
