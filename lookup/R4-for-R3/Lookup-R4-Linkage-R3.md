### Lookup for FHIR R4 Linkage for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Linkage.id | UseElementSameName | Linkage.id |
| Linkage.meta | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Linkage.meta |
...
| Linkage.author | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Linkage.author |
...
| Linkage.item.resource | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Linkage.item.resource |
