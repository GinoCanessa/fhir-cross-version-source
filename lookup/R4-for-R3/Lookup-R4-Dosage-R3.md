### Lookup for FHIR R4 Dosage for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Dosage.id | UseElementSameName | Dosage.id |
| Dosage.extension | UseElementSameName | Dosage.extension |
| Dosage.modifierExtension | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Dosage.modifierExtension |
...
| Dosage.timing | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Dosage.timing |
...
| Dosage.doseAndRate | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Dosage.doseAndRate |
