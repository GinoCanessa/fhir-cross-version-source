...
| Questionnaire.item.initial.id | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Questionnaire.item.initial.id |
| Questionnaire.item.initial.extension | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Questionnaire.item.initial.extension |
| Questionnaire.item.initial.modifierExtension | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Questionnaire.item.initial.modifierExtension |
| Questionnaire.item.initial.value[x] | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Questionnaire.item.initial.value |
