### Lookup for FHIR R4 Slot for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Slot.id | UseElementSameName | Slot.id |
| Slot.meta | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Slot.meta |
...
| Slot.schedule | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Slot.schedule |
