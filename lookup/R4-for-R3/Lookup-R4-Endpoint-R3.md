### Lookup for FHIR R4 Endpoint for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Endpoint.id | UseElementSameName | Endpoint.id |
| Endpoint.meta | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Endpoint.meta |
...
| Endpoint.managingOrganization | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Endpoint.managingOrganization |
