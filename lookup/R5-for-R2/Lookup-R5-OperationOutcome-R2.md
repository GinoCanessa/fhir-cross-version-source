### Lookup for FHIR R5 OperationOutcome for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| OperationOutcome.id | UseElementSameName | OperationOutcome.id |
| OperationOutcome.meta | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-OperationOutcome.meta |
...
| OperationOutcome.issue.expression | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-OperationOutcome.issue.expression |
