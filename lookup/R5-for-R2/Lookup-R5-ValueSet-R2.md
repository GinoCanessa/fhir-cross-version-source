...
| ValueSet.meta | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-ValueSet.meta |
...
| ValueSet.modifierExtension | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-ValueSet.modifierExtension |
| ValueSet.url | UseElementSameName | ValueSet.url |
| ValueSet.identifier | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-ValueSet.identifier |
...
| ValueSet.status | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-ValueSet.status |
...
| ValueSet.compose.include.modifierExtension | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-ValueSet.compose.include.modifierExtension |
...
| ValueSet.compose.include.concept.designation | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-ValueSet.compose.include.concept.designation |
...
| ValueSet.compose.include.concept.designation.additionalUse | UseExtensionFromAncestor | - |
...
| ValueSet.expansion.parameter.value[x] | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-ValueSet.expansion.parameter.value |
