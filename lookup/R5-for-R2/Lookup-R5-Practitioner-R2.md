### Lookup for FHIR R5 Practitioner for use in FHIR R2
...
| Practitioner.name | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Practitioner.name |
