### Lookup for FHIR R5 RiskAssessment for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| RiskAssessment.id | UseElementSameName | RiskAssessment.id |
| RiskAssessment.meta | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.meta |
...
| RiskAssessment.identifier | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.identifier |
| RiskAssessment.basedOn | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.basedOn |
| RiskAssessment.parent | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.parent |
| RiskAssessment.status | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.status |
| RiskAssessment.method | UseElementSameName | RiskAssessment.method |
| RiskAssessment.code | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.code |
| RiskAssessment.subject | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.subject |
| RiskAssessment.encounter | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.encounter |
| RiskAssessment.occurrence[x] | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.occurrence |
| RiskAssessment.condition | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.condition |
...
| RiskAssessment.basis | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.basis |
...
| RiskAssessment.prediction.qualitativeRisk | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.prediction.qualitativeRisk |
...
| RiskAssessment.note | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.note |
