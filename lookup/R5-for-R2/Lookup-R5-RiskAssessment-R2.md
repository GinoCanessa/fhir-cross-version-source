...
| RiskAssessment.occurrence[x] | UseElementSameName | RiskAssessment.date |
...
| RiskAssessment.prediction.probability[x] | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-RiskAssessment.prediction.probability |
