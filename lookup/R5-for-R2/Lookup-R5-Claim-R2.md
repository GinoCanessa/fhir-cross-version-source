...
| Claim.meta | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.meta |
...
| Claim.patient | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.patient |
...
| Claim.insurer | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.insurer |
| Claim.provider | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.provider |
| Claim.priority | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.priority |
| Claim.fundsReserve | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.fundsReserve |
...
| Claim.payee.type | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.payee.type |
...
| Claim.diagnosis.diagnosis[x] | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.diagnosis.diagnosis |
...
| Claim.insurance.coverage | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.insurance.coverage |
...
| Claim.insurance.claimResponse | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.insurance.claimResponse |
| Claim.accident | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.accident |
...
| Claim.item.productOrService | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.item.productOrService |
...
| Claim.item.modifier | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.item.modifier |
| Claim.item.programCode | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.item.programCode |
| Claim.item.serviced[x] | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.item.serviced |
...
| Claim.item.factor | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.item.factor |
...
| Claim.item.udi | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.item.udi |
...
| Claim.item.detail.productOrService | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.item.detail.productOrService |
...
| Claim.item.detail.factor | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.item.detail.factor |
...
| Claim.item.detail.udi | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.item.detail.udi |
...
| Claim.item.detail.subDetail.productOrService | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.item.detail.subDetail.productOrService |
...
| Claim.item.detail.subDetail.factor | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.item.detail.subDetail.factor |
...
| Claim.item.detail.subDetail.udi | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.item.detail.subDetail.udi |
