...
| MedicationRequest.medication | UseElementSameName | MedicationRequest.medication[x] |
...
| MedicationRequest.reason | UseElementSameName | MedicationRequest.reasonCode |
