...
| Procedure.occurrence[x] | UseElementSameName | Procedure.performed[x] |
...
| Procedure.reason | UseElementSameName | Procedure.reasonCode |
...
| Procedure.used | UseElementSameName | Procedure.usedReference |
