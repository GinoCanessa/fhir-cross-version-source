### Lookup for FHIR R2 RiskAssessment for use in FHIR R4B

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| RiskAssessment.id | UseElementSameName | RiskAssessment.id |
| RiskAssessment.meta | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-RiskAssessment.meta |
...
| RiskAssessment.subject | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-RiskAssessment.subject |
| RiskAssessment.date | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-RiskAssessment.date |
| RiskAssessment.condition | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-RiskAssessment.condition |
...
| RiskAssessment.identifier | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-RiskAssessment.identifier |
| RiskAssessment.method | UseElementSameName | RiskAssessment.method |
| RiskAssessment.basis | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-RiskAssessment.basis |
