### Lookup for FHIR R2 ImagingStudy for use in FHIR R4B

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| ImagingStudy.id | UseElementSameName | ImagingStudy.id |
| ImagingStudy.meta | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-ImagingStudy.meta |
...
| ImagingStudy.extension | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-ImagingStudy.extension |
...
| ImagingStudy.accession | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-ImagingStudy.accession |
| ImagingStudy.identifier | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-ImagingStudy.identifier |
...
| ImagingStudy.series.extension | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-ImagingStudy.series.extension |
...
| ImagingStudy.series.uid | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-ImagingStudy.series.uid |
...
| ImagingStudy.series.instance.uid | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-ImagingStudy.series.instance.uid |
