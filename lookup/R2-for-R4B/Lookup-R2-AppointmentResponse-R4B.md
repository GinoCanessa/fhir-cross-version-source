### Lookup for FHIR R2 AppointmentResponse for use in FHIR R4B

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| AppointmentResponse.id | UseElementSameName | AppointmentResponse.id |
| AppointmentResponse.meta | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-AppointmentResponse.meta |
...
| AppointmentResponse.appointment | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-AppointmentResponse.appointment |
...
| AppointmentResponse.actor | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-AppointmentResponse.actor |
