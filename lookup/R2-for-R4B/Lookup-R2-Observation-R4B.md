### Lookup for FHIR R2 Observation for use in FHIR R4B

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Observation.id | UseElementSameName | Observation.id |
| Observation.meta | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Observation.meta |
...
| Observation.status | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Observation.status |
| Observation.category | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Observation.category |
...
| Observation.effective[x] | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Observation.effective |
...
| Observation.interpretation | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Observation.interpretation |
...
| Observation.specimen | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Observation.specimen |
| Observation.device | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Observation.device |
...
| Observation.referenceRange.meaning | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Observation.referenceRange.meaning |
...
| Observation.related.id | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Observation.related.id |
| Observation.related.extension | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Observation.related.extension |
| Observation.related.modifierExtension | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Observation.related.modifierExtension |
| Observation.related.type | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Observation.related.type |
| Observation.related.target | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Observation.related.target |
