### Lookup for FHIR R2 List for use in FHIR R4B

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| List.id | UseElementSameName | List.id |
| List.meta | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-List.meta |
...
| List.note | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-List.note |
