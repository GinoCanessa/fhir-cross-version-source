### Lookup for FHIR R2 ClaimResponse for use in FHIR R4B

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| ClaimResponse.id | UseElementSameName | ClaimResponse.id |
| ClaimResponse.meta | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-ClaimResponse.meta |
