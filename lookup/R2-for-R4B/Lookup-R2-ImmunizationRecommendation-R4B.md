### Lookup for FHIR R2 ImmunizationRecommendation for use in FHIR R4B

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| ImmunizationRecommendation.id | UseElementSameName | ImmunizationRecommendation.id |
| ImmunizationRecommendation.meta | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-ImmunizationRecommendation.meta |
...
| ImmunizationRecommendation.recommendation | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-ImmunizationRecommendation.recommendation |
...
| ImmunizationRecommendation.recommendation.date | UseExtensionFromAncestor | - |
...
| ImmunizationRecommendation.recommendation.protocol | UseExtensionFromAncestor | - |
| ImmunizationRecommendation.recommendation.protocol.id | UseExtensionFromAncestor | - |
| ImmunizationRecommendation.recommendation.protocol.extension | UseExtensionFromAncestor | - |
| ImmunizationRecommendation.recommendation.protocol.modifierExtension | UseExtensionFromAncestor | - |
| ImmunizationRecommendation.recommendation.protocol.doseSequence | UseExtensionFromAncestor | - |
| ImmunizationRecommendation.recommendation.protocol.description | UseExtensionFromAncestor | - |
| ImmunizationRecommendation.recommendation.protocol.authority | UseExtensionFromAncestor | - |
| ImmunizationRecommendation.recommendation.protocol.series | UseExtensionFromAncestor | - |
