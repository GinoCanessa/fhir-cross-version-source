### Lookup for FHIR R2 CarePlan for use in FHIR R4B
...
| CarePlan.activity.detail.category | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-CarePlan.activity.detail.category |
