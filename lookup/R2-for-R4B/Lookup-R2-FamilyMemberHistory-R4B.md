### Lookup for FHIR R2 FamilyMemberHistory for use in FHIR R4B

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| FamilyMemberHistory.id | UseElementSameName | FamilyMemberHistory.id |
| FamilyMemberHistory.meta | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-FamilyMemberHistory.meta |
...
| FamilyMemberHistory.patient | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-FamilyMemberHistory.patient |
...
| FamilyMemberHistory.gender | UseElementRenamed | FamilyMemberHistory.sex |
...
| FamilyMemberHistory.note | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-FamilyMemberHistory.note |
...
| FamilyMemberHistory.condition.note | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-FamilyMemberHistory.condition.note |
