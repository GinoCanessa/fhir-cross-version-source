...
| FamilyMemberHistory.gender | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-FamilyMemberHistory.gender |
| FamilyMemberHistory.born[x] | UseElementSameName | FamilyMemberHistory.born[x] |
| FamilyMemberHistory.age[x] | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-FamilyMemberHistory.age |
| FamilyMemberHistory.deceased[x] | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-FamilyMemberHistory.deceased |
...
| FamilyMemberHistory.condition.onset[x] | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-FamilyMemberHistory.condition.onset |
