### Lookup for FHIR R4 MedicationStatement for use in FHIR R4B
...
| MedicationStatement.basedOn | UseElementSameName | MedicationStatement.basedOn |
...
| MedicationStatement.statusReason | UseElementSameName | MedicationStatement.statusReason |
