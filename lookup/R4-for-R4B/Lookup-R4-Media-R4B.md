### Lookup for FHIR R4 Media for use in FHIR R4B
...
| Media.basedOn | UseElementSameName | Media.basedOn |
| Media.partOf | UseElementSameName | Media.partOf |
| Media.status | UseElementSameName | Media.status |
| Media.type | UseElementSameName | Media.type |
| Media.modality | UseElementSameName | Media.modality |
| Media.view | UseElementSameName | Media.view |
| Media.subject | UseElementSameName | Media.subject |
| Media.encounter | UseElementSameName | Media.encounter |
| Media.created[x] | UseElementSameName | Media.created[x] |
| Media.issued | UseElementSameName | Media.issued |
...
| Media.deviceName | UseElementSameName | Media.deviceName |
