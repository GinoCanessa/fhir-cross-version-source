### Lookup for FHIR R2 Condition for use in FHIR R3
...
| Condition.stage.assessment | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Condition.stage.assessment |
