### Lookup for FHIR R2 Claim for use in FHIR R3
...
| Claim.diagnosis.diagnosis | UseElementRenamed | Claim.diagnosis.diagnosis[x] |
...
| Claim.item.service | UseElementSameName | Claim.item.service |
...
| Claim.item.detail.service | UseElementSameName | Claim.item.detail.service |
...
| Claim.item.detail.subDetail.service | UseElementSameName | Claim.item.detail.subDetail.service |
