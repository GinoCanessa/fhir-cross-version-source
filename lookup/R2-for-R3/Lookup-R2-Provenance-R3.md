### Lookup for FHIR R2 Provenance for use in FHIR R3
...
| Provenance.agent.relatedAgent.type | UseOneOfElements | Provenance.agent.relatedAgentType,Provenance.agent.relatedAgentType |
