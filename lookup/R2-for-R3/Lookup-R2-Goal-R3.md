...
| Goal.target[x] | UseElementRenamed | Goal.target |
...
| Goal.outcome | UseElementRenamed | Goal |
| Goal.outcome.id | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Goal.outcome.id |
| Goal.outcome.extension | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Goal.outcome.extension |
| Goal.outcome.modifierExtension | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Goal.outcome.modifierExtension |
| Goal.outcome.result[x] | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Goal.outcome.result |
