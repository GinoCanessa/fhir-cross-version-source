### Lookup for FHIR R2 ValueSet for use in FHIR R3
...
| ValueSet.useContext | UseOneOfElements | ValueSet.useContext,ValueSet.jurisdiction |
...
| ValueSet.extensible | UseElementSameName | ValueSet.extensible |
