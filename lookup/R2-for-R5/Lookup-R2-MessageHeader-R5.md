### Lookup for FHIR R2 MessageHeader for use in FHIR R5
...
| MessageHeader.response.identifier | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-MessageHeader.response.identifier |
