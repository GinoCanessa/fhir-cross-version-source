...
| TestScript.contact | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-TestScript.contact |
| TestScript.contact.id | UseExtensionFromAncestor | - |
| TestScript.contact.extension | UseExtensionFromAncestor | - |
| TestScript.contact.modifierExtension | UseExtensionFromAncestor | - |
| TestScript.contact.name | UseExtensionFromAncestor | - |
...
| TestScript.setup.action.assert.response | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-TestScript.setup.action.assert.response |
