### Lookup for FHIR R2 Organization for use in FHIR R5
...
| Organization.contact | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Organization.contact |
