### Lookup for FHIR R2 SupplyDelivery for use in FHIR R5

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| SupplyDelivery.id | UseElementSameName | SupplyDelivery.id |
| SupplyDelivery.meta | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-SupplyDelivery.meta |
...
| SupplyDelivery.identifier | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-SupplyDelivery.identifier |
...
| SupplyDelivery.type | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-SupplyDelivery.type |
