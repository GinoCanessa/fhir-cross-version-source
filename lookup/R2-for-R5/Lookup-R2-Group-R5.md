### Lookup for FHIR R2 Group for use in FHIR R5

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Group.id | UseElementSameName | Group.id |
| Group.meta | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Group.meta |
...
| Group.actual | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Group.actual |
...
| Group.characteristic.value[x] | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Group.characteristic.value |
