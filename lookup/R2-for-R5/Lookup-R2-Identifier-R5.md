### Lookup for FHIR R2 Identifier for use in FHIR R5

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Identifier.id | UseElementSameName | Identifier.id |
| Identifier.extension | UseElementSameName | Identifier.extension |
| Identifier.use | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Identifier.use |
...
| Identifier.assigner | UseExtension | http://hl7.org/fhir/1.0/StructureDefinition/extension-Identifier.assigner |
