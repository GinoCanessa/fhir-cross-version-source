...
| Claim.accident.id | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Claim.accident.id |
| Claim.accident.extension | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Claim.accident.extension |
| Claim.accident.modifierExtension | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Claim.accident.modifierExtension |
| Claim.accident.date | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Claim.accident.date |
| Claim.accident.type | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Claim.accident.type |
| Claim.accident.location[x] | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Claim.accident.location |
...
| Claim.item.category | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Claim.item.category |
...
| Claim.item.detail.category | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Claim.item.detail.category |
...
| Claim.item.detail.subDetail.category | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Claim.item.detail.subDetail.category |
