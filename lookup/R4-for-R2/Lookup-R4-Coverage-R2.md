### Lookup for FHIR R4 Coverage for use in FHIR R2
...
| Coverage.identifier | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Coverage.identifier |
| Coverage.status | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Coverage.status |
| Coverage.type | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Coverage.type |
...
| Coverage.dependent | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Coverage.dependent |
| Coverage.relationship | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Coverage.relationship |
...
| Coverage.order | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Coverage.order |
| Coverage.network | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Coverage.network |
