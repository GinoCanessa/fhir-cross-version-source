### Lookup for FHIR R4 AllergyIntolerance for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| AllergyIntolerance.id | UseElementSameName | AllergyIntolerance.id |
| AllergyIntolerance.meta | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-AllergyIntolerance.meta |
...
| AllergyIntolerance.clinicalStatus | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-AllergyIntolerance.clinicalStatus |
| AllergyIntolerance.verificationStatus | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-AllergyIntolerance.verificationStatus |
| AllergyIntolerance.type | UseElementSameName | AllergyIntolerance.type |
| AllergyIntolerance.category | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-AllergyIntolerance.category |
...
| AllergyIntolerance.onset[x] | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-AllergyIntolerance.onset |
...
| AllergyIntolerance.note | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-AllergyIntolerance.note |
...
| AllergyIntolerance.reaction.extension | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-AllergyIntolerance.reaction.extension |
...
| AllergyIntolerance.reaction.note | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-AllergyIntolerance.reaction.note |
