### Lookup for FHIR R4 RiskAssessment for use in FHIR R2
...
| RiskAssessment.prediction.probability[x] | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-RiskAssessment.prediction.probability |
