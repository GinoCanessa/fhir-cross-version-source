### Lookup for FHIR R4 DeviceMetric for use in FHIR R2
...
| DeviceMetric.operationalStatus | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DeviceMetric.operationalStatus |
