### Lookup for FHIR R4 Patient for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Patient.id | UseElementSameName | Patient.id |
| Patient.meta | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Patient.meta |
...
| Patient.contact.organization | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Patient.contact.organization |
...
| Patient.generalPractitioner | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Patient.generalPractitioner |
| Patient.managingOrganization | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Patient.managingOrganization |
...
| Patient.link.other | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Patient.link.other |
| Patient.link.type | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Patient.link.type |
