### Lookup for FHIR R4 Person for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Person.id | UseElementSameName | Person.id |
| Person.meta | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Person.meta |
...
| Person.managingOrganization | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Person.managingOrganization |
...
| Person.link.target | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Person.link.target |
