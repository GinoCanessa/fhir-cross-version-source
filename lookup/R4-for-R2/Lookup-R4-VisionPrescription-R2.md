### Lookup for FHIR R4 VisionPrescription for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| VisionPrescription.id | UseElementSameName | VisionPrescription.id |
| VisionPrescription.meta | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-VisionPrescription.meta |
...
| VisionPrescription.status | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-VisionPrescription.status |
| VisionPrescription.created | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-VisionPrescription.created |
| VisionPrescription.patient | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-VisionPrescription.patient |
| VisionPrescription.encounter | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-VisionPrescription.encounter |
...
| VisionPrescription.lensSpecification.product | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-VisionPrescription.lensSpecification.product |
...
| VisionPrescription.lensSpecification.prism | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-VisionPrescription.lensSpecification.prism |
...
| VisionPrescription.lensSpecification.note | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-VisionPrescription.lensSpecification.note |
