### Lookup for FHIR R4 Timing for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Timing.id | UseElementSameName | Timing.id |
| Timing.extension | UseElementSameName | Timing.extension |
| Timing.modifierExtension | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Timing.modifierExtension |
...
| Timing.repeat.bounds[x] | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Timing.repeat.bounds |
...
| Timing.repeat.dayOfWeek | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Timing.repeat.dayOfWeek |
| Timing.repeat.timeOfDay | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Timing.repeat.timeOfDay |
| Timing.repeat.when | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Timing.repeat.when |
| Timing.repeat.offset | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Timing.repeat.offset |
