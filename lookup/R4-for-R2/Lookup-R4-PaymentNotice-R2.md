### Lookup for FHIR R4 PaymentNotice for use in FHIR R2
...
| PaymentNotice.status | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-PaymentNotice.status |
...
| PaymentNotice.paymentDate | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-PaymentNotice.paymentDate |
...
| PaymentNotice.paymentStatus | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-PaymentNotice.paymentStatus |
