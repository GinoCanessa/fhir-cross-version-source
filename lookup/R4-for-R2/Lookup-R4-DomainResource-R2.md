### Lookup for FHIR R4 DomainResource for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| DomainResource.id | UseElementSameName | DomainResource.id |
| DomainResource.meta | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-DomainResource.meta |
