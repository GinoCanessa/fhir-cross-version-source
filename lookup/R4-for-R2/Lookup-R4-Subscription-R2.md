### Lookup for FHIR R4 Subscription for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Subscription.id | UseElementSameName | Subscription.id |
| Subscription.meta | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Subscription.meta |
...
| Subscription.channel.payload | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Subscription.channel.payload |
| Subscription.channel.header | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Subscription.channel.header |
