### Lookup for FHIR R4 PractitionerRole for use in FHIR R2

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| PractitionerRole | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-PractitionerRole |
