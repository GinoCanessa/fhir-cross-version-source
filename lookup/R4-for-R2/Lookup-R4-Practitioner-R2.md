### Lookup for FHIR R4 Practitioner for use in FHIR R2
...
| Practitioner.name | UseExtension | http://hl7.org/fhir/4.0/StructureDefinition/extension-Practitioner.name |
