### Lookup for FHIR R5 SupplyRequest for use in FHIR R4B

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| SupplyRequest.id | UseElementRenamed | SupplyRequest.id |
| SupplyRequest.meta | UseElementRenamed | SupplyRequest.meta |
| SupplyRequest.implicitRules | UseElementRenamed | SupplyRequest.implicitRules |
| SupplyRequest.language | UseElementRenamed | SupplyRequest.language |
| SupplyRequest.text | UseElementRenamed | SupplyRequest.text |
| SupplyRequest.contained | UseElementRenamed | SupplyRequest.contained |
| SupplyRequest.extension | UseElementRenamed | SupplyRequest.extension |
| SupplyRequest.modifierExtension | UseElementRenamed | SupplyRequest.modifierExtension |
| SupplyRequest.identifier | UseElementRenamed | SupplyRequest.identifier |
| SupplyRequest.status | UseElementRenamed | SupplyRequest.status |
...
| SupplyRequest.parameter.extension | UseElementRenamed | SupplyRequest.parameter.extension |
| SupplyRequest.parameter.modifierExtension | UseElementRenamed | SupplyRequest.parameter.modifierExtension |
| SupplyRequest.parameter.code | UseElementRenamed | SupplyRequest.parameter.code |
