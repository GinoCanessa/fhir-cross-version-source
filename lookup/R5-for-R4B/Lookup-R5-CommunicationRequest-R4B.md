### Lookup for FHIR R5 CommunicationRequest for use in FHIR R4B
...
| CommunicationRequest.reason | UseOneOfElements | CommunicationRequest.reasonCode,CommunicationRequest.reasonReference |
