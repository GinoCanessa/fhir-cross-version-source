### Lookup for FHIR R3 OperationOutcome for use in FHIR R2
...
| OperationOutcome.issue.expression | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-OperationOutcome.issue.expression |
