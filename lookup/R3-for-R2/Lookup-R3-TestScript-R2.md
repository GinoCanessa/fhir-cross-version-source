### Lookup for FHIR R3 TestScript for use in FHIR R2
...
| TestScript.title | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.title |
| TestScript.status | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.status |
...
| TestScript.contact | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.contact |
| TestScript.description | UseElementSameName | TestScript.description |
| TestScript.useContext | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.useContext |
...
| TestScript.origin | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.origin |
...
| TestScript.destination | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.destination |
...
| TestScript.metadata.capability.origin | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.metadata.capability.origin |
...
| TestScript.metadata.capability.capabilities | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.metadata.capability.capabilities |
...
| TestScript.fixture.resource | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.fixture.resource |
| TestScript.profile | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.profile |
...
| TestScript.variable.defaultValue | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.variable.defaultValue |
| TestScript.variable.description | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.variable.description |
| TestScript.variable.expression | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.variable.expression |
| TestScript.variable.headerField | UseElementSameName | TestScript.variable.headerField |
| TestScript.variable.hint | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.variable.hint |
...
| TestScript.rule | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.rule |
| TestScript.rule.id | UseExtensionFromAncestor | - |
| TestScript.rule.extension | UseExtensionFromAncestor | - |
| TestScript.rule.modifierExtension | UseExtensionFromAncestor | - |
| TestScript.rule.resource | UseExtensionFromAncestor | - |
| TestScript.rule.param | UseExtensionFromAncestor | - |
| TestScript.rule.param.id | UseExtensionFromAncestor | - |
| TestScript.rule.param.extension | UseExtensionFromAncestor | - |
| TestScript.rule.param.modifierExtension | UseExtensionFromAncestor | - |
| TestScript.rule.param.name | UseExtensionFromAncestor | - |
| TestScript.rule.param.value | UseExtensionFromAncestor | - |
| TestScript.ruleset | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.ruleset |
| TestScript.ruleset.id | UseExtensionFromAncestor | - |
| TestScript.ruleset.extension | UseExtensionFromAncestor | - |
| TestScript.ruleset.modifierExtension | UseExtensionFromAncestor | - |
| TestScript.ruleset.resource | UseExtensionFromAncestor | - |
| TestScript.ruleset.rule | UseExtensionFromAncestor | - |
| TestScript.ruleset.rule.id | UseExtensionFromAncestor | - |
| TestScript.ruleset.rule.extension | UseExtensionFromAncestor | - |
| TestScript.ruleset.rule.modifierExtension | UseExtensionFromAncestor | - |
| TestScript.ruleset.rule.ruleId | UseExtensionFromAncestor | - |
| TestScript.ruleset.rule.param | UseExtensionFromAncestor | - |
| TestScript.ruleset.rule.param.id | UseExtensionFromAncestor | - |
| TestScript.ruleset.rule.param.extension | UseExtensionFromAncestor | - |
| TestScript.ruleset.rule.param.modifierExtension | UseExtensionFromAncestor | - |
| TestScript.ruleset.rule.param.name | UseExtensionFromAncestor | - |
| TestScript.ruleset.rule.param.value | UseExtensionFromAncestor | - |
...
| TestScript.setup.action.operation.resource | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.operation.resource |
...
| TestScript.setup.action.operation.accept | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.operation.accept |
| TestScript.setup.action.operation.contentType | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.operation.contentType |
...
| TestScript.setup.action.operation.origin | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.operation.origin |
...
| TestScript.setup.action.operation.requestId | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.operation.requestId |
...
| TestScript.setup.action.assert.compareToSourceExpression | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.assert.compareToSourceExpression |
| TestScript.setup.action.assert.compareToSourcePath | UseElementSameName | TestScript.setup.action.assert.compareToSourcePath |
| TestScript.setup.action.assert.contentType | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.assert.contentType |
| TestScript.setup.action.assert.expression | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.assert.expression |
...
| TestScript.setup.action.assert.operator | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.assert.operator |
| TestScript.setup.action.assert.path | UseElementSameName | TestScript.setup.action.assert.path |
| TestScript.setup.action.assert.requestMethod | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.assert.requestMethod |
| TestScript.setup.action.assert.requestURL | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.assert.requestURL |
| TestScript.setup.action.assert.resource | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.assert.resource |
...
| TestScript.setup.action.assert.rule | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.assert.rule |
| TestScript.setup.action.assert.rule.id | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.rule.extension | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.rule.modifierExtension | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.rule.ruleId | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.rule.param | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.rule.param.id | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.rule.param.extension | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.rule.param.modifierExtension | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.rule.param.name | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.rule.param.value | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-TestScript.setup.action.assert.ruleset |
| TestScript.setup.action.assert.ruleset.id | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.extension | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.modifierExtension | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.rulesetId | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.rule | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.rule.id | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.rule.extension | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.rule.modifierExtension | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.rule.ruleId | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.rule.param | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.rule.param.id | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.rule.param.extension | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.rule.param.modifierExtension | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.rule.param.name | UseExtensionFromAncestor | - |
| TestScript.setup.action.assert.ruleset.rule.param.value | UseExtensionFromAncestor | - |
