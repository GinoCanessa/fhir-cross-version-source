### Lookup for FHIR R3 RiskAssessment for use in FHIR R2
...
| RiskAssessment.status | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-RiskAssessment.status |
| RiskAssessment.method | UseElementSameName | RiskAssessment.method |
| RiskAssessment.code | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-RiskAssessment.code |
...
| RiskAssessment.prediction.probability[x] | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-RiskAssessment.prediction.probability |
| RiskAssessment.prediction.qualitativeRisk | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-RiskAssessment.prediction.qualitativeRisk |
