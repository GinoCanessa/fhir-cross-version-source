...
| Encounter.incomingReferral | UseElementRenamed | Encounter.incomingReferral |
...
| Encounter.length | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Encounter.length |
| Encounter.reason | UseElementRenamed | Encounter.reason |
| Encounter.diagnosis | UseElementSameName | Encounter.hospitalization |
| Encounter.diagnosis.id | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Encounter.diagnosis.id |
| Encounter.diagnosis.extension | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Encounter.diagnosis.extension |
| Encounter.diagnosis.modifierExtension | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Encounter.diagnosis.modifierExtension |
