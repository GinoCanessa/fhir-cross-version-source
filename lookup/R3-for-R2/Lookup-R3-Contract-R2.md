...
| Contract.action | UseElementRenamed | Contract.action |
| Contract.actionReason | UseElementRenamed | Contract.actionReason |
...
| Contract.agent.actor | UseElementRenamed | Contract.actor.entity |
...
| Contract.valuedItem | UseElementRenamed | Contract.valuedItem |
| Contract.valuedItem.id | UseElementRenamed | Contract.valuedItem.id |
| Contract.valuedItem.extension | UseElementRenamed | Contract.valuedItem.extension |
| Contract.valuedItem.modifierExtension | UseElementRenamed | Contract.valuedItem.modifierExtension |
| Contract.valuedItem.entity[x] | UseElementRenamed | Contract.valuedItem.entity[x] |
| Contract.valuedItem.identifier | UseElementRenamed | Contract.valuedItem.identifier |
| Contract.valuedItem.effectiveTime | UseElementRenamed | Contract.valuedItem.effectiveTime |
| Contract.valuedItem.quantity | UseElementRenamed | Contract.valuedItem.quantity |
| Contract.valuedItem.unitPrice | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Contract.valuedItem.unitPrice |
| Contract.valuedItem.factor | UseElementRenamed | Contract.valuedItem.factor |
| Contract.valuedItem.points | UseElementRenamed | Contract.valuedItem.points |
| Contract.valuedItem.net | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Contract.valuedItem.net |
...
| Contract.term.topic | UseElementRenamed | Contract.term.subject |
| Contract.term.action | UseElementSameName | Contract.term.action |
| Contract.term.actionReason | UseElementRenamed | Contract.term.actionReason |
...
| Contract.term.agent.actor | UseElementRenamed | Contract.term.actor.entity |
...
| Contract.term.valuedItem | UseElementRenamed | Contract.term.valuedItem |
| Contract.term.valuedItem.id | UseElementRenamed | Contract.term.valuedItem.id |
| Contract.term.valuedItem.extension | UseElementRenamed | Contract.term.valuedItem.extension |
| Contract.term.valuedItem.modifierExtension | UseElementRenamed | Contract.term.valuedItem.modifierExtension |
| Contract.term.valuedItem.entity[x] | UseElementRenamed | Contract.term.valuedItem.entity[x] |
| Contract.term.valuedItem.identifier | UseElementRenamed | Contract.term.valuedItem.identifier |
| Contract.term.valuedItem.effectiveTime | UseElementRenamed | Contract.term.valuedItem.effectiveTime |
| Contract.term.valuedItem.quantity | UseElementRenamed | Contract.term.valuedItem.quantity |
| Contract.term.valuedItem.unitPrice | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Contract.term.valuedItem.unitPrice |
| Contract.term.valuedItem.factor | UseElementRenamed | Contract.term.valuedItem.factor |
| Contract.term.valuedItem.points | UseElementRenamed | Contract.term.valuedItem.points |
| Contract.term.valuedItem.net | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Contract.term.valuedItem.net |
| Contract.term.group | UseElementSameName | Contract.term.group |
| Contract.binding[x] | UseElementRenamed | Contract.binding[x] |
