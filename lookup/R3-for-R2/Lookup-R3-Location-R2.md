### Lookup for FHIR R3 Location for use in FHIR R2
...
| Location.operationalStatus | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Location.operationalStatus |
| Location.name | UseElementSameName | Location.name |
| Location.alias | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Location.alias |
