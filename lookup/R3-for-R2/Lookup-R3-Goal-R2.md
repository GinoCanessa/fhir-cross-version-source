...
| Goal.status | UseElementRenamed | Goal.status |
...
| Goal.target.id | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Goal.target.id |
| Goal.target.extension | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Goal.target.extension |
| Goal.target.modifierExtension | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Goal.target.modifierExtension |
| Goal.target.measure | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Goal.target.measure |
| Goal.target.detail[x] | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Goal.target.detail |
| Goal.target.due[x] | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Goal.target.due |
| Goal.statusDate | UseElementSameName | Goal.statusDate |
| Goal.statusReason | UseElementSameName | Goal.statusReason |
| Goal.expressedBy | UseElementSameName | Goal.author |
