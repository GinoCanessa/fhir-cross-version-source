### Lookup for FHIR R3 EpisodeOfCare for use in FHIR R2
...
| EpisodeOfCare.status | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-EpisodeOfCare.status |
...
| EpisodeOfCare.statusHistory.status | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-EpisodeOfCare.statusHistory.status |
...
| EpisodeOfCare.diagnosis | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-EpisodeOfCare.diagnosis |
