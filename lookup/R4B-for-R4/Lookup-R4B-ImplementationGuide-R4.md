### Lookup for FHIR R4B ImplementationGuide for use in FHIR R4
...
| ImplementationGuide.definition.resource.example[x] | UseOneOfElements | ImplementationGuide.definition.resource.example[x],ImplementationGuide.definition.resource.example[x],ImplementationGuide.definition.resource.example[x],ImplementationGuide.definition.resource.example[x] |
...
| ImplementationGuide.definition.page.name[x] | UseOneOfElements | ImplementationGuide.definition.page.name[x],ImplementationGuide.definition.page.name[x] |
...
| ImplementationGuide.manifest.resource.example[x] | UseOneOfElements | ImplementationGuide.manifest.resource.example[x],ImplementationGuide.manifest.resource.example[x] |
