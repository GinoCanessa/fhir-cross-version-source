### Lookup for FHIR R4B ImagingStudy for use in FHIR R4
...
| ImagingStudy.interpreter | UseElementRenamed | ImagingStudy.interpreter |
...
| ImagingStudy.procedureReference | UseElementRenamed | ImagingStudy.procedureReference |
| ImagingStudy.procedureCode | UseElementRenamed | ImagingStudy.procedureCode |
| ImagingStudy.location | UseElementSameName | ImagingStudy.location |
| ImagingStudy.reasonCode | UseElementRenamed | ImagingStudy.reasonCode |
| ImagingStudy.reasonReference | UseElementRenamed | ImagingStudy.reasonReference |
