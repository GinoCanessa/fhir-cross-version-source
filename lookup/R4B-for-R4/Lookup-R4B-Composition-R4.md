### Lookup for FHIR R4B Composition for use in FHIR R4
...
| Composition.confidentiality | UseElementRenamed | Composition.confidentiality |
...
| Composition.relatesTo.id | UseElementRenamed | Composition.relatesTo.id |
| Composition.relatesTo.extension | UseElementRenamed | Composition.relatesTo.extension |
| Composition.relatesTo.modifierExtension | UseElementRenamed | Composition.relatesTo.modifierExtension |
| Composition.relatesTo.code | UseElementRenamed | Composition.relatesTo.code |
| Composition.relatesTo.target[x] | UseElementRenamed | Composition.relatesTo.target[x] |
...
| Composition.event.code | UseElementRenamed | Composition.event.code |
...
| Composition.section.mode | UseElementRenamed | Composition.section.mode |
