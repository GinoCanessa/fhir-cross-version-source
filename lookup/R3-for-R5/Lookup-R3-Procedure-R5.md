...
| Procedure.meta | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Procedure.meta |
...
| Procedure.notDone | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Procedure.notDone |
| Procedure.notDoneReason | UseElementRenamed | Procedure.statusReason |
| Procedure.category | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Procedure.category |
...
| Procedure.performed[x] | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Procedure.performed |
