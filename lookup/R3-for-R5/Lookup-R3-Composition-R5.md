...
| Composition.meta | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Composition.meta |
...
| Composition.identifier | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Composition.identifier |
| Composition.status | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Composition.status |
| Composition.type | UseElementSameName | Composition.type |
| Composition.class | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Composition.class |
...
| Composition.custodian | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Composition.custodian |
| Composition.relatesTo | UseElementSameName | Composition.relatesTo |
| Composition.relatesTo.id | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Composition.relatesTo.id |
| Composition.relatesTo.extension | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Composition.relatesTo.extension |
| Composition.relatesTo.modifierExtension | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Composition.relatesTo.modifierExtension |
| Composition.relatesTo.code | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Composition.relatesTo.code |
| Composition.relatesTo.target[x] | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Composition.relatesTo.target |
...
| Composition.event.detail | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Composition.event.detail |
...
| Composition.section.entry | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Composition.section.entry |
