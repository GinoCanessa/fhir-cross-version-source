### Lookup for FHIR R3 Dosage for use in FHIR R5
...
| Dosage.maxDosePerPeriod | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Dosage.maxDosePerPeriod |
