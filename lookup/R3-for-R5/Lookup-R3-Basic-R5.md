### Lookup for FHIR R3 Basic for use in FHIR R5

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Basic.id | UseElementSameName | Basic.id |
| Basic.meta | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Basic.meta |
...
| Basic.subject | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Basic.subject |
| Basic.created | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Basic.created |
| Basic.author | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Basic.author |
