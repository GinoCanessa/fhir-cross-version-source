### Lookup for FHIR R3 PaymentNotice for use in FHIR R5

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| PaymentNotice.id | UseElementSameName | PaymentNotice.id |
| PaymentNotice.meta | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-PaymentNotice.meta |
