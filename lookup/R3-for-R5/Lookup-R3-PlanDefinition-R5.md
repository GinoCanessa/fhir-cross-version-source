### Lookup for FHIR R3 PlanDefinition for use in FHIR R5
...
| PlanDefinition.library | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-PlanDefinition.library |
...
| PlanDefinition.action.code | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-PlanDefinition.action.code |
...
| PlanDefinition.action.triggerDefinition | UseElementRenamed | PlanDefinition.action.trigger |
...
| PlanDefinition.action.type | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-PlanDefinition.action.type |
...
| PlanDefinition.action.definition | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-PlanDefinition.action.definition |
| PlanDefinition.action.transform | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-PlanDefinition.action.transform |
...
| PlanDefinition.action.dynamicValue.description | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-PlanDefinition.action.dynamicValue.description |
| PlanDefinition.action.dynamicValue.path | UseElementSameName | PlanDefinition.action.dynamicValue.path |
| PlanDefinition.action.dynamicValue.language | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-PlanDefinition.action.dynamicValue.language |
| PlanDefinition.action.dynamicValue.expression | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-PlanDefinition.action.dynamicValue.expression |
