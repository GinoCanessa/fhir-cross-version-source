### Lookup for FHIR R3 Practitioner for use in FHIR R5

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Practitioner.id | UseElementSameName | Practitioner.id |
| Practitioner.meta | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Practitioner.meta |
...
| Practitioner.photo | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Practitioner.photo |
