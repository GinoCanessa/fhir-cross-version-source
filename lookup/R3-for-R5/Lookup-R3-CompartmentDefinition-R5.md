### Lookup for FHIR R3 CompartmentDefinition for use in FHIR R5
...
| CompartmentDefinition.code | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-CompartmentDefinition.code |
