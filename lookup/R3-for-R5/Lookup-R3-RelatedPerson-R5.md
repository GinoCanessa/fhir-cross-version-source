### Lookup for FHIR R3 RelatedPerson for use in FHIR R5

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| RelatedPerson.id | UseElementSameName | RelatedPerson.id |
| RelatedPerson.meta | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-RelatedPerson.meta |
...
| RelatedPerson.photo | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-RelatedPerson.photo |
