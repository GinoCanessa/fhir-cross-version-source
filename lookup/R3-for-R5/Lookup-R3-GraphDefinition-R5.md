### Lookup for FHIR R3 GraphDefinition for use in FHIR R5
...
| GraphDefinition.link.target | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-GraphDefinition.link.target |
