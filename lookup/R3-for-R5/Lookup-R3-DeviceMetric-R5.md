### Lookup for FHIR R3 DeviceMetric for use in FHIR R5
...
| DeviceMetric.color | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-DeviceMetric.color |
