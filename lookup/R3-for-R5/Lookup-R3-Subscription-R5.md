### Lookup for FHIR R3 Subscription for use in FHIR R5
...
| Subscription.status | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Subscription.status |
...
| Subscription.criteria | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Subscription.criteria |
| Subscription.error | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Subscription.error |
| Subscription.channel | UseExtension | http://hl7.org/fhir/3.0/StructureDefinition/extension-Subscription.channel |
