### Lookup for FHIR R4B RelatedArtifact for use in FHIR R3
...
| RelatedArtifact.label | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-RelatedArtifact.label |
