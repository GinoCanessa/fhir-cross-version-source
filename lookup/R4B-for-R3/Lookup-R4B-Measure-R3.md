### Lookup for FHIR R4B Measure for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Measure.id | UseElementSameName | Measure.id |
| Measure.meta | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.meta |
...
| Measure.subtitle | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.subtitle |
| Measure.status | UseElementSameName | Measure.status |
| Measure.experimental | UseElementSameName | Measure.experimental |
| Measure.subject[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.subject |
...
| Measure.author | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.author |
| Measure.editor | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.editor |
| Measure.reviewer | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.reviewer |
| Measure.endorser | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.endorser |
| Measure.relatedArtifact | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.relatedArtifact |
| Measure.library | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.library |
...
| Measure.improvementNotation | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.improvementNotation |
...
| Measure.group.code | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.group.code |
...
| Measure.group.population.criteria | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.group.population.criteria |
...
| Measure.group.stratifier.extension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.group.stratifier.extension |
| Measure.group.stratifier.modifierExtension | UseElementSameName | Measure.group.stratifier.modifierExtension |
| Measure.group.stratifier.code | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.group.stratifier.code |
| Measure.group.stratifier.description | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.group.stratifier.description |
| Measure.group.stratifier.criteria | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.group.stratifier.criteria |
| Measure.group.stratifier.component | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.group.stratifier.component |
...
| Measure.supplementalData.extension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.supplementalData.extension |
| Measure.supplementalData.modifierExtension | UseElementSameName | Measure.supplementalData.modifierExtension |
| Measure.supplementalData.code | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.supplementalData.code |
| Measure.supplementalData.usage | UseElementSameName | Measure.supplementalData.usage |
| Measure.supplementalData.description | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.supplementalData.description |
| Measure.supplementalData.criteria | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Measure.supplementalData.criteria |
