### Lookup for FHIR R4B ConceptMap for use in FHIR R3
...
| ConceptMap.group.unmapped.url | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ConceptMap.group.unmapped.url |
