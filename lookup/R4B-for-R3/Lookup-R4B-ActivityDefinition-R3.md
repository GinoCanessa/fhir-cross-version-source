### Lookup for FHIR R4B ActivityDefinition for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| ActivityDefinition.id | UseElementSameName | ActivityDefinition.id |
| ActivityDefinition.meta | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.meta |
...
| ActivityDefinition.subtitle | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.subtitle |
...
| ActivityDefinition.author | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.author |
| ActivityDefinition.editor | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.editor |
| ActivityDefinition.reviewer | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.reviewer |
| ActivityDefinition.endorser | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.endorser |
| ActivityDefinition.relatedArtifact | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.relatedArtifact |
| ActivityDefinition.library | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.library |
| ActivityDefinition.kind | UseElementSameName | ActivityDefinition.kind |
| ActivityDefinition.profile | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.profile |
| ActivityDefinition.code | UseElementSameName | ActivityDefinition.code |
| ActivityDefinition.intent | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.intent |
| ActivityDefinition.priority | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.priority |
| ActivityDefinition.doNotPerform | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.doNotPerform |
| ActivityDefinition.timing[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.timing |
| ActivityDefinition.location | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.location |
...
| ActivityDefinition.participant.type | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.participant.type |
| ActivityDefinition.participant.role | UseElementSameName | ActivityDefinition.participant.role |
| ActivityDefinition.product[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.product |
| ActivityDefinition.quantity | UseElementSameName | ActivityDefinition.quantity |
| ActivityDefinition.dosage | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.dosage |
| ActivityDefinition.bodySite | UseElementSameName | ActivityDefinition.bodySite |
| ActivityDefinition.specimenRequirement | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.specimenRequirement |
| ActivityDefinition.observationRequirement | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.observationRequirement |
| ActivityDefinition.observationResultRequirement | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.observationResultRequirement |
| ActivityDefinition.transform | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.transform |
...
| ActivityDefinition.dynamicValue.expression | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ActivityDefinition.dynamicValue.expression |
