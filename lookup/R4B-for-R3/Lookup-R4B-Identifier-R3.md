### Lookup for FHIR R4B Identifier for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Identifier.id | UseElementSameName | Identifier.id |
| Identifier.extension | UseElementSameName | Identifier.extension |
| Identifier.use | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Identifier.use |
...
| Identifier.assigner | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Identifier.assigner |
