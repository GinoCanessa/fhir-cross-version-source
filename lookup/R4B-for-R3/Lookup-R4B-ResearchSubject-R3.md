### Lookup for FHIR R4B ResearchSubject for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| ResearchSubject.id | UseElementSameName | ResearchSubject.id |
| ResearchSubject.meta | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ResearchSubject.meta |
...
| ResearchSubject.identifier | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ResearchSubject.identifier |
...
| ResearchSubject.study | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-ResearchSubject.study |
