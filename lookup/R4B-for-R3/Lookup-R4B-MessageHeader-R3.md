### Lookup for FHIR R4B MessageHeader for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| MessageHeader.id | UseElementSameName | MessageHeader.id |
| MessageHeader.meta | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.meta |
...
| MessageHeader.event[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.event |
...
| MessageHeader.destination.target | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.destination.target |
| MessageHeader.destination.endpoint | UseElementSameName | MessageHeader.destination.endpoint |
| MessageHeader.destination.receiver | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.destination.receiver |
| MessageHeader.sender | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.sender |
| MessageHeader.enterer | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.enterer |
| MessageHeader.author | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.author |
...
| MessageHeader.responsible | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.responsible |
...
| MessageHeader.response.details | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.response.details |
| MessageHeader.focus | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.focus |
| MessageHeader.definition | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-MessageHeader.definition |
