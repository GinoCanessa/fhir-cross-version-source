### Lookup for FHIR R4B RiskAssessment for use in FHIR R3
...
| RiskAssessment.encounter | UseElementSameName | RiskAssessment.context |
...
| RiskAssessment.note | UseElementSameName | RiskAssessment.comment |
