### Lookup for FHIR R4B Composition for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Composition.id | UseElementSameName | Composition.id |
| Composition.meta | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Composition.meta |
...
| Composition.category | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Composition.category |
| Composition.subject | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Composition.subject |
| Composition.encounter | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Composition.encounter |
| Composition.date | UseElementSameName | Composition.date |
| Composition.author | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Composition.author |
...
| Composition.attester.party | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Composition.attester.party |
| Composition.custodian | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Composition.custodian |
...
| Composition.event.detail | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Composition.event.detail |
...
| Composition.section.author | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Composition.section.author |
| Composition.section.focus | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Composition.section.focus |
...
| Composition.section.entry | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Composition.section.entry |
