### Lookup for FHIR R4B SearchParameter for use in FHIR R3
...
| SearchParameter.component.definition | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-SearchParameter.component.definition |
