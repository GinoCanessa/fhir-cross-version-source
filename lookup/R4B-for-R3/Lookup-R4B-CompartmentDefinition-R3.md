### Lookup for FHIR R4B CompartmentDefinition for use in FHIR R3
...
| CompartmentDefinition.version | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-CompartmentDefinition.version |
