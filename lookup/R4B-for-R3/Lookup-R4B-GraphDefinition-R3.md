### Lookup for FHIR R4B GraphDefinition for use in FHIR R3
...
| GraphDefinition.link.target.params | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-GraphDefinition.link.target.params |
| GraphDefinition.link.target.profile | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-GraphDefinition.link.target.profile |
...
| GraphDefinition.link.target.compartment.use | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-GraphDefinition.link.target.compartment.use |
