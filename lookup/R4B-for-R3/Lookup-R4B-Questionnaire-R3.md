...
| Questionnaire.item.type | UseOneOfElements | Questionnaire.item.type,Questionnaire.item.type |
...
| Questionnaire.item.enableWhen.operator | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Questionnaire.item.enableWhen.operator |
| Questionnaire.item.enableWhen.answer[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Questionnaire.item.enableWhen.answer |
...
| Questionnaire.item.answerValueSet | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Questionnaire.item.answerValueSet |
