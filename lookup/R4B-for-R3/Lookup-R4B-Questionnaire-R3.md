### Lookup for FHIR R4B Questionnaire for use in FHIR R3
...
| Questionnaire.item.enableWhen.operator | UseElementSameName | Questionnaire.item.enableWhen.hasAnswer |
| Questionnaire.item.enableWhen.answer[x] | UseElementSameName | Questionnaire.item.enableWhen.hasAnswer |
...
| Questionnaire.item.answerValueSet | UseElementSameName | Questionnaire.item.options |
...
| Questionnaire.item.answerOption.value[x] | UseElementSameName | Questionnaire.item.option.value[x] |
...
| Questionnaire.item.initial | UseElementSameName | Questionnaire.item.initial[x] |
| Questionnaire.item.initial.id | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Questionnaire.item.initial.id |
| Questionnaire.item.initial.extension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Questionnaire.item.initial.extension |
| Questionnaire.item.initial.modifierExtension | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Questionnaire.item.initial.modifierExtension |
| Questionnaire.item.initial.value[x] | UseExtension | http://hl7.org/fhir/4.3/StructureDefinition/extension-Questionnaire.item.initial.value |
