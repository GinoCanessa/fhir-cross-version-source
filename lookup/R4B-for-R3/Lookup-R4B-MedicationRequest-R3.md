### Lookup for FHIR R4B MedicationRequest for use in FHIR R3
...
| MedicationRequest.encounter | UseElementSameName | MedicationRequest.context |
...
| MedicationRequest.instantiatesCanonical | UseElementSameName | MedicationRequest.definition |
...
| MedicationRequest.substitution.allowed[x] | UseElementSameName | MedicationRequest.substitution.allowed |
