### Lookup for FHIR R5 Timing for use in FHIR R3
...
| Timing.repeat.count | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Timing.repeat.count |
...
| Timing.repeat.frequency | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Timing.repeat.frequency |
| Timing.repeat.frequencyMax | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Timing.repeat.frequencyMax |
