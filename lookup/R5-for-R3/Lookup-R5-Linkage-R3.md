### Lookup for FHIR R5 Linkage for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Linkage.id | UseElementSameName | Linkage.id |
| Linkage.meta | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Linkage.meta |
...
| Linkage.author | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Linkage.author |
...
| Linkage.item.resource | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Linkage.item.resource |
