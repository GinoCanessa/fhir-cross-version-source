### Lookup for FHIR R5 Claim for use in FHIR R3
...
| Claim.related.claim | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.related.claim |
...
| Claim.careTeam.provider | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.careTeam.provider |
...
| Claim.supportingInfo | UseElementSameName | Claim.information |
| Claim.supportingInfo.id | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.supportingInfo.id |
| Claim.supportingInfo.extension | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.supportingInfo.extension |
| Claim.supportingInfo.modifierExtension | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.supportingInfo.modifierExtension |
| Claim.supportingInfo.sequence | UseElementSameName | Claim.information.sequence |
| Claim.supportingInfo.category | UseElementSameName | Claim.information.category |
| Claim.supportingInfo.code | UseElementSameName | Claim.information.code |
| Claim.supportingInfo.timing[x] | UseElementSameName | Claim.information.timing[x] |
| Claim.supportingInfo.value[x] | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.supportingInfo.value |
| Claim.supportingInfo.reason | UseElementSameName | Claim.information.reason |
...
| Claim.procedure.type | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.procedure.type |
| Claim.procedure.date | UseElementSameName | Claim.procedure.date |
| Claim.procedure.procedure[x] | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.procedure.procedure |
| Claim.procedure.udi | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.procedure.udi |
...
| Claim.item.careTeamSequence | UseElementSameName | Claim.item.careTeamLinkId |
| Claim.item.diagnosisSequence | UseElementSameName | Claim.item.diagnosisLinkId |
| Claim.item.procedureSequence | UseElementSameName | Claim.item.procedureLinkId |
| Claim.item.informationSequence | UseElementSameName | Claim.item.informationLinkId |
