...
| Claim.supportingInfo | UseElementRenamed | Claim.information |
...
| Claim.supportingInfo.sequence | UseElementRenamed | Claim.information.sequence |
| Claim.supportingInfo.category | UseElementRenamed | Claim.information.category |
| Claim.supportingInfo.code | UseElementRenamed | Claim.information.code |
| Claim.supportingInfo.timing[x] | UseElementRenamed | Claim.information.timing[x] |
| Claim.supportingInfo.value[x] | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.supportingInfo.value |
| Claim.supportingInfo.reason | UseElementRenamed | Claim.information.reason |
...
| Claim.item.careTeamSequence | UseElementRenamed | Claim.item.careTeamLinkId |
| Claim.item.diagnosisSequence | UseElementRenamed | Claim.item.diagnosisLinkId |
| Claim.item.procedureSequence | UseElementRenamed | Claim.item.procedureLinkId |
| Claim.item.informationSequence | UseElementRenamed | Claim.item.informationLinkId |
| Claim.item.revenue | UseElementSameName | Claim.item.revenue |
| Claim.item.category | UseElementSameName | Claim.item.category |
| Claim.item.productOrService | UseElementRenamed | Claim.item.service |
...
| Claim.item.detail.productOrService | UseElementRenamed | Claim.item.detail.service |
...
| Claim.item.detail.subDetail.productOrService | UseElementRenamed | Claim.item.detail.subDetail.service |
