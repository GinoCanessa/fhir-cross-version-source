### Lookup for FHIR R5 Contributor for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Contributor.id | UseElementSameName | Contributor.id |
| Contributor.extension | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Contributor.extension |
