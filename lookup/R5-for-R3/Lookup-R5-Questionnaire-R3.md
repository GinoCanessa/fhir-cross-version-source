### Lookup for FHIR R5 Questionnaire for use in FHIR R3
...
| Questionnaire.item.initial.id | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Questionnaire.item.initial.id |
| Questionnaire.item.initial.extension | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Questionnaire.item.initial.extension |
| Questionnaire.item.initial.modifierExtension | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Questionnaire.item.initial.modifierExtension |
