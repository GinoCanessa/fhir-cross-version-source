### Lookup for FHIR R5 Identifier for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Identifier.id | UseElementSameName | Identifier.id |
| Identifier.extension | UseElementSameName | Identifier.extension |
| Identifier.use | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Identifier.use |
...
| Identifier.assigner | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Identifier.assigner |
