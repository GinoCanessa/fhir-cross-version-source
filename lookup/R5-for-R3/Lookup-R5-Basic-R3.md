### Lookup for FHIR R5 Basic for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| Basic.id | UseElementSameName | Basic.id |
| Basic.meta | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Basic.meta |
...
| Basic.subject | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-Basic.subject |
