### Lookup for FHIR R5 MedicationDispense for use in FHIR R3
...
| MedicationDispense.performer.function | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-MedicationDispense.performer.function |
