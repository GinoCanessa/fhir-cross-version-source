### Lookup for FHIR R5 ChargeItem for use in FHIR R3

| Source Element | Usage | Target |
| -------------- | ----- | ------ |
| ChargeItem.id | UseElementSameName | ChargeItem.id |
| ChargeItem.meta | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-ChargeItem.meta |
...
| ChargeItem.account | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-ChargeItem.account |
| ChargeItem.note | UseElementSameName | ChargeItem.note |
| ChargeItem.supportingInformation | UseExtension | http://hl7.org/fhir/5.0/StructureDefinition/extension-ChargeItem.supportingInformation |
