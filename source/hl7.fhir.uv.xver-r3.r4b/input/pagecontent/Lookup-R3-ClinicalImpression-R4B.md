### Lookup for [FHIR R3](https://hl7.org/fhir/STU3/) [ClinicalImpression](https://hl7.org/fhir/STU3/ClinicalImpression.html) for use in [FHIR R4B](https://hl7.org/fhir/R4B/)
