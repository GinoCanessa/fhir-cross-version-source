### Lookup for [FHIR R2](https://hl7.org/fhir/DSTU2/) [ClinicalImpression](https://hl7.org/fhir/DSTU2/ClinicalImpression.html) for use in [FHIR R4](https://hl7.org/fhir/R4/)
