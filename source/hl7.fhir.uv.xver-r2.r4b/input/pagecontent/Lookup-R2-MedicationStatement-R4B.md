### Lookup for [FHIR R2](https://hl7.org/fhir/DSTU2/) [MedicationStatement](https://hl7.org/fhir/DSTU2/MedicationStatement.html) for use in [FHIR R4B](https://hl7.org/fhir/R4B/)
